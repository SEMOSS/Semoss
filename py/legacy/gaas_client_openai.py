...
class OpenAiClient(BaseClient):
  ...
  def __init__(self, template_file=None, endpoint=None, model_name='vicuna-7b-v1.3', api_key="EMPTY", **kwargs):
  ...
  def ask(self, question=None, context=None, template_name=None, history=None, page_size=100, max_new_tokens=100, stop_sequences=["#", ";"], temperature_val=0.01, top_p_val=0.5, **kwargs):
    # convert to map
    prompt = ""
    text = ""
    final_output = {}
