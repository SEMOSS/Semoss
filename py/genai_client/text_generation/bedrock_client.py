        ...
        **kwargs,
        ...
        try:
            ...
            if FULL_PROMPT not in kwargs.keys():
                ...
                elif self.modelId == "amazon.titan-text-express-v1" or self.modelId == "meta.llama3-8b-instruct-v1:0":
                    prompt_content = kwargs[FULL_PROMPT]
                elif self.modelId == "meta.llama3-8b-instruct-v1:0":
                    prompt_content = ("<|begin_of_text|><|start_header_id|>system<|end_header_id|>{" + kwargs[FULL_PROMPT] + "}<|eot_id|><|start_header_id|>assistant<|end_header_id|>")
