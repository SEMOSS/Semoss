...
class AbstractEmbedder(ABC):
    ...
    @abstractmethod
    def embeddings_call(self, strings_to_embed, **kwargs: Any) -> EmbeddingsModelEngineResponse:
        pass
    ...
    def to_keybert_embedder(
        ...
        class CfgEmbedderBackend(BaseEmbedder):
            ...
            def embed(self, documents: List[str], verbose: bool = False) -> np.ndarray:
                ...
                embeddings = self.embedding_model.embeddings_call(strings_to_embed=documents)
