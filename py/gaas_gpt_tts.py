...
class SpeechEngine(ServerProxy):
    def __init__(
        self, engine_id: Optional[str] = None, insight_id: Optional[str] = None
    ):
        super().__init__()
    ...
    def generate_speech(
        ...
        return super().call(
            ...
            method_args=[prompt, voice_file_path, insight_id, param_dict],
            method_arg_types=["str", "str", "str", "dict"],
            insight_id=insight_id,
        )
