...
/* Filters */
angular.module('rdfeditor.filters', [])
    .filter('shortenValueFilter', function() {
...
}).filter('replaceForwardSlashWithCaretFilter', function() {
        return function(str) {
...
}).filter('namespaceFilter', function() {
...
}).filter('relationshipsFilter', function($filter) {
	//gets last value in url after the /
