...
Timeline._Impl.prototype._initialize = function() {
     ...
     */
    var elmtCopyright = SimileAjax.Graphics.createTranslucentImage(Timeline.urlPrefix + (this.isHorizontal() ? "../img/copyright-vertical.png" : "../img/copyright.png"));
    ...
    message.contentDiv.innerHTML = "<img src='" + Timeline.urlPrefix + "../img/progress-running.gif' /> Loading...";
