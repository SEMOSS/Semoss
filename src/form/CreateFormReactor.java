...
public class CreateFormReactor extends AbstractReactor {

	private static final Logger classLogger = LogManager.getLogger(CreateFormReactor.class);

	private static final String CLASS_NAME = CreateFormReactor.class.getName();
	...
	protected void buildTask() {
		...
		if(this.override || this.newTable) {
			...
			try(WriteOWLEngine owler = targetEngine.getOWLEngineFactory().getWriteOWL()) {
