...
public class InsightPanel {
	...
	/**
	 * Merge new panel configuration options into the existing panel config map This
	 * will merge child maps together if possible
	 *
	 * @param config
	 */
	...
	/**
	 * Merge new ornaments into the existing ornament map This will merge child maps
	...
	/**
	 * Merge new event info into the existing event map This will merge child maps
	 * together if possible
	 *
	 * @param ornaments
	 */
	...
	/**
	 * traversalPath is a period delimited key traversal to go through the ornaments
	 * object
	 *
	 * @param traversalPath
	 * @return
	...
	/**
	 * Return the map of additional formatting stored on the panel for export
	 * functionality
	 *
			...
			for (int i = 0; i < arr.size(); i++) {
				if (arr.get(i) instanceof Map) {
					...
					if (innerMap.get("dimension") != null) {
						...
						if (innerMap.get("dimensionType") != null && innerMap.get("date") != null
