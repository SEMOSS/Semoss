...
public class Dashboard implements IDataMaker {
	...
	public Map<String, String> getScriptReactors() {
		...
		// reactorNames.put(PKQLEnum.DASHBOARD_UNJOIN,
		// "prerna.sablecc.DashboardUnjoinReactor");
		...
		// reactorNames.put(PKQLEnum.DASHBOARD_ADD,
		// "prerna.sablecc.DashboardAddReactor");
		// reactorNames.put(PKQLEnum.VIZ, "prerna.sablecc.VizReactor");
		// reactorNames.put(PKQLEnum.EXPR_TERM, "prerna.sablecc.ExprReactor");
		// reactorNames.put(PKQLEnum.EXPR_SCRIPT, "prerna.sablecc.ExprReactor");
		// reactorNames.put(PKQLReactor.MATH_FUN.toString(),"prerna.sablecc.MathReactor");
		// reactorNames.put(PKQLEnum.CLEAR_DATA,
		// "prerna.sablecc.DashboardClearDataReactor");
		return reactorNames;
	}
