...
public class DBCMEdge {
  ...
  public transient DBCMVertex inVertex = null;
  public transient DBCMVertex outVertex = null;
  String uri = null;

  transient Hashtable uriHash = new Hashtable();
  public Hashtable<String, Object> propHash = new Hashtable();
  static final transient Logger logger = LogManager.getLogger(DBCMEdge.class.getName());

  /**
   * @param inVertex
   * @param outVertex
   * @param uri Vertex1 (OutVertex) -------> Vertex2 (InVertex) (OutEdge) (InEdge)
   */
  ...
  public void setProperty(String propNameURI, Object propValue) {
    ...
    if (!converted) propHash.put(instanceName, propValue);
