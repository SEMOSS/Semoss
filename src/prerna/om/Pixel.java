...
public class Pixel {
  ...
  /**
   * Is this pixel a refresh panel task Important for being able to determine if this is the last
   * pixel on the frame That we need to grab the original pixel that was used for painting
   *
   * @return
   */
  ...
  /**
   * Set if this pixel is a refresh panel task Important for being able to determine if this is the
   * last pixel on the frame That we need to grab the original pixel that was used for painting
   *
   * @return
   */
  ...
  public static void translationMerge(Pixel pixelObj, Pixel mergePixel) {
    if (mergePixel != null) {
      ...
      pixelObj.setCodeDetails(
          mergePixel.isCodeExecution(),
          mergePixel.getCodeExecuted(),
          mergePixel.getLanguage(),
          mergePixel.isUserScript());
   ...
   * @return
   */
  public static Map<String, String> getFrameHeadersToDataType(
      Map<String, Map<String, Object>> headersObject, String frameName) {
