...
//	     
    ...
    private Map<String, Object> createFunctionEngineMap() {
        ...
        parameters.put("type", "object"); // value is DYNAMIC
        parameters.put("properties", parametersProperties); 
        parameters.put("required", new String[]{"<PARAM 1 NAME>", "<PARAM 2 NAME>"}); // Add more required parameters as needed
        parameters.put("description", "<PARAM OBJECT DESCRIPTION>");
