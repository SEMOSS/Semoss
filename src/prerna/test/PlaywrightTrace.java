...
public class PlaywrightTrace {
  ...
  public static void main(String[] args) {
    ...
    try (Playwright playwright = Playwright.create()) {
      ...
      do {
        ...
        // where = page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Where
        // to?"));
        ...
        */
        ...
        page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("23 Nov 2024 40.00"))
            .click();
        page.getByLabel("OK, Got it").click();
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Close")).click();
        page.locator("panel")
            .filter(new Locator.FilterOptions().setHasText("VA Virginia, VA 0.00 8.00 8."))
            .getByLabel("Expand Tax Jurisdiction")
            .click();
        ...
        page.getByText("DOD00159-02-01-01-0110 SEMOSS Bus Analytics 2001 00")
            .getByLabel("Attendance Hours entry for Monday")
            .click();
  ...
  public static List<Cookie> getCookies() {
    ...
    Cookie c13 =
        new Cookie(
            "SIDCC", "AKEyXzWjVHyvMKbuPGUC1e1QgvjlkgKTmVMCFFDrlQq90sNoldRkSWmoYwpmpMNfY1zmE0sps5M");
