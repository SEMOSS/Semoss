...
public interface ICloudClient {
   ...
   * @throws InterruptedException
   */
  void pullEngine(String engineId, IEngine.CATALOG_TYPE engineType)
   ...
   * @throws InterruptedException
   */
  void pushEngineSmss(String engineId, IEngine.CATALOG_TYPE engineType)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pullEngineSmss(String engineId, IEngine.CATALOG_TYPE engineType)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void deleteEngine(String engineId, IEngine.CATALOG_TYPE engineType)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void copyLocalFileToEngineCloudFolder(
      String engineId, CATALOG_TYPE engineType, String localFilePath)
      throws IOException, InterruptedException;

  /**
   * Copy engine file path to local file path, based on where the corresponding storage location
   * should be
   *
   * @param engineId
   * @param engineType
   ...
   * @throws InterruptedException
   */
  void copyEngineCloudFileToLocalFile(
      String engineId, CATALOG_TYPE engineType, String localFilePath)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pullEngineAndProjectImageFolder(CATALOG_TYPE engineType)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pushEngineAndProjectImage(CATALOG_TYPE engineType, String fileName)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void deleteEngineAndProjectImage(CATALOG_TYPE engineType, String fileName)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pushLocalDatabaseFile(String databaseId, RdbmsTypeEnum dbType)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pullLocalDatabaseFile(String databaseId, RdbmsTypeEnum rdbmsType)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pushOwl(String databaseId, WriteOWLEngine owlEngine)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pullOwl(String databaseId, WriteOWLEngine owlEngine)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pullProject(String projectId, boolean projectAlreadyLoaded)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pullUserAssetOrWorkspace(String projectId, boolean isAsset, boolean projectAlreadyLoaded)
      throws IOException, InterruptedException;
   ...
   * @throws InterruptedException
   */
  void pushUserAssetOrWorkspace(String projectId, boolean isAsset)
      throws IOException, InterruptedException;
