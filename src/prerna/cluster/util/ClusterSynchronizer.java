...
public class ClusterSynchronizer {
  ...
  private void initalizeClusterSyncronizer() {
    ...
    // what is the host ip of the container/pod/box - this is used as a unique id for the
    // container/singleton
                  ...
                  public void childEvent(CuratorFramework client, PathChildrenCacheEvent event)
                    ...
                    if (event.getType() == PathChildrenCacheEvent.Type.CHILD_UPDATED) {
                      ByteArrayInputStream byteIn =
                          new ByteArrayInputStream(event.getData().getData());
                      ...
                      if (!updatedByNodeId.equals(host)) {
                        ...
                        classLogger.info(
                            fullPath + " updated, pulling latest data from cloud storage");
                        String id;
                        boolean pull;
                        ...
                        if (pull) {
                          try {
                            ...
                            Method method =
                                ClusterUtil.class.getMethod(
                                    dataMap.get("methodName").toString(), paramTypes);
  ...
  public void publishEngineChange(String engineId, String methodName, Object... params)
      throws Exception {
    ...
    classLogger.info(
        "Publishing change for engine " + engineId + " and for nodes to " + methodName);
  ...
  public void publishProjectChange(String projectId, String methodName, Object... params)
      throws Exception {
    ...
    classLogger.info(
        "Publishing change for project " + projectId + " and for nodes to " + methodName);
    Map<String, Object> dataMap = new HashMap<>();
    dataMap.put("nodeId", host);
    dataMap.put("methodName", methodName);
    List<Object> paramList = Arrays.asList(params);
  ...
  //		//TODO - pass a full map as the data where host will be a key along with the function used -
  // ex. pushOwl, pushInsightDB
