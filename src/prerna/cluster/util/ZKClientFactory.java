...
/**
 * Factory class to get the appropriate ZooKeeper client implementation based on
...
public class ZKClientFactory {
	...
	/**
	 * Gets the appropriate ZooKeeper client implementation based on environment
	 * variables.
	 *
