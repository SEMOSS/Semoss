...
public class ClusterUtil {
	...
	public static final boolean IS_CLUSTER = System.getenv().containsKey(IS_CLUSTER_KEY)
			...
			public static final boolean REMOTE_RSERVE = System.getenv().containsKey(REMOTE_RSERVE_KEY)
					...
					public static final boolean SEMOSS_USER_RSERVE = System.getenv().containsKey(SEMOSS_USER_RSERVE_KEY)
							? Boolean.parseBoolean(System.getenv(SEMOSS_USER_RSERVE_KEY)) : false;
	...
	/*
	private static final String MULTIPLE_STORAGE_ACCOUNTS_KEY = "MULTIPLE_STORAGE_ACCOUNTS";
	public static final boolean MULTIPLE_STORAGE_ACCOUNTS = System.getenv().containsKey(MULTIPLE_STORAGE_ACCOUNTS_KEY)
					? Boolean.parseBoolean(System.getenv(MULTIPLE_STORAGE_ACCOUNTS_KEY)) : false;	

	private static final String MAIN_STORAGE_ACCOUNT_KEY = "MAIN_STORAGE_ACCOUNT";
	public static final String MAIN_STORAGE_ACOUNT = System.getenv(MAIN_STORAGE_ACCOUNT_KEY);


	//redis table info
	public static final String REDIS_STORAGE_ACCOUNT = "storageAccount";
	public static final String REDIS_TIMESTAMP = "timestamp";
									 */
