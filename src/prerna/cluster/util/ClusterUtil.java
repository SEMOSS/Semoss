...
public class ClusterUtil {
  ...
  public static final boolean IS_CLUSTER =
      (Utility.getDIHelperProperty(IS_CLUSTER_KEY) != null
  ...
  public static final boolean IS_CLUSTER_ZK =
      (Utility.getDIHelperProperty(IS_CLUSTER_ZK_KEY) != null
  ...
  public static final String STORAGE_PROVIDER =
      (Utility.getDIHelperProperty(STORAGE_PROVIDER_KEY) != null
  ...
  public static final boolean REMOTE_RSERVE =
      (Utility.getDIHelperProperty(REMOTE_RSERVE_KEY) != null
              && !(Utility.getDIHelperProperty(IS_CLUSTER_KEY).isEmpty()))
  ...
  public static final boolean LOAD_ENGINES_LOCALLY =
      (Utility.getDIHelperProperty(LOAD_ENGINES_LOCALLY_KEY) != null
              && !(Utility.getDIHelperProperty(IS_CLUSTER_KEY).isEmpty()))
  ...
  public static final boolean IS_CLUSTERED_SCHEDULER =
      (Utility.getDIHelperProperty(IS_CLUSTERED_SCHEDULER_KEY) != null
  ...
  public static boolean isSchedulerExecutor() {
    if (ClusterUtil.IS_CLUSTER) {
      ...
      //				throw new IllegalArgumentException("Hostname is null or empty along with no reference to
      // scheduler execution in RDF_Map or env vars");
      //			}
      //		    try {
    ...
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        SemossPixelException err =
            new SemossPixelException("Failed to pull engine '" + engineId + "' from cloud storage");
  ...
  public static void pushEngine(String engineId) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException("Failed to push engine '" + engineId + "' to cloud storage");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
   ...
   * @param filePath
   */
  public static void copyLocalFileToEngineCloudFolder(
      String engineId, IEngine.CATALOG_TYPE engineType, String filePath) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
   ...
   * @param filePath
   */
  public static void copyEngineCloudFileToLocalFile(
      String engineId, IEngine.CATALOG_TYPE engineType, String filePath) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
   ...
   * @param filePath
   */
  public static void deleteEngineCloudFile(
      String engineId, IEngine.CATALOG_TYPE engineType, String filePath) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        SemossPixelException err =
            new SemossPixelException("Failed to delete storage file in engine '" + engineId + "'");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
  ...
  public static void pullEngineAndProjectImageFolder(IEngine.CATALOG_TYPE engineType) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException("Failed to pull database image folder to cloud storage");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
  ...
  public static void pushEngineAndProjectImage(IEngine.CATALOG_TYPE engineType, String fileName) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException("Failed to push database image to cloud storage");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
  ...
  public static void deleteEngineAndProjectImage(IEngine.CATALOG_TYPE engineType, String fileName) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException("Failed to delete database image from the cloud storage");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
   ...
   * @param fileName
   */
  public static void deleteEngineAndProjectImageById(
      IEngine.CATALOG_TYPE engineType, String engineId) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        SemossPixelException err =
            new SemossPixelException(
                "Failed to publish project '"
                    + projectId
                    + "' to sync with ZK cluster to pull insight db");
        err.setContinueThreadOfExecution(true);
        throw err;
      }
    }
  ...
  public static void pushProject(String projectId) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        NounMetadata noun =
            new NounMetadata(
                "Failed to push project '" + projectId + "' to cloud storage",
  ...
  public static void pushProjectSmss(String projectId) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        NounMetadata noun =
            new NounMetadata(
                "Failed to push project '" + projectId + "' smss to cloud storage",
                PixelDataType.CONST_STRING,
                PixelOperationType.ERROR);
        SemossPixelException err = new SemossPixelException(noun);
        err.setContinueThreadOfExecution(false);
   ...
   */
  public static void pushProjectFolder(
      String projectId, String absolutePath, String remoteRelativePath) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        getCentralStorageClient().pushProjectFolder(projectId, absolutePath, remoteRelativePath);
      } catch (Exception e) {
        SemossPixelException err =
            new SemossPixelException("Failed to push project '" + projectId + "' folder");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
    if (ClusterUtil.IS_CLUSTER_ZK) {
      try {
        getClusterSynchronizer()
            .publishProjectChange(
                projectId, "pullProjectFolder", projectId, absolutePath, remoteRelativePath);
      } catch (Exception e) {
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException(
   ...
   * @param remoteRelativePath
   */
  public static void pullProjectFolder(
      String projectId, String absolutePath, String remoteRelativePath) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException("Failed to pull project '" + projectId + "' folder");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
   ...
   * @param remoteRelativePath
   */
  public static void pushEngineFolder(
      String engineId, String absolutePath, String remoteRelativePath) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        getCentralStorageClient().pushEngineFolder(engineId, absolutePath, remoteRelativePath);
      } catch (Exception e) {
        SemossPixelException err =
            new SemossPixelException("Failed to push engine '" + engineId + "' folder");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
    if (ClusterUtil.IS_CLUSTER_ZK) {
      try {
        getClusterSynchronizer()
            .publishEngineChange(
                engineId, "pullEngineFolder", engineId, absolutePath, remoteRelativePath);
      } catch (Exception e) {
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException(
   ...
   * @param remoteRelativePath
   */
  public static void pullEngineFolder(
      String engineId, String absolutePath, String remoteRelativePath) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException("Failed to pull engine '" + engineId + "' folder");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
  ...
  public static void pushInsightImage(
      String projectId, String insightId, String oldImageName, String imageFileName) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        getCentralStorageClient()
            .pushInsightImage(projectId, insightId, oldImageName, imageFileName);
      } catch (Exception e) {
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException("Failed to push insight image to cloud storage");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
  ...
  public static void pushUserWorkspace(String projectId, boolean isAsset) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException("Failed to push user/workplace project");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
    ...
    if (ClusterUtil.IS_CLUSTER_ZK) {
      try {
        getClusterSynchronizer()
            .publishProjectChange(projectId, "pullUserWorkspace", projectId, isAsset);
      } catch (Exception e) {
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException(
  ...
  public static void pullUserWorkspace(String projectId, boolean isAsset) {
    if (ClusterUtil.IS_CLUSTER) {
      try {
        ...
        classLogger.error(Constants.STACKTRACE, e);
        SemossPixelException err =
            new SemossPixelException("Failed to pull user/workplace project");
        err.setContinueThreadOfExecution(false);
        throw err;
      }
    }
   ...
   * @throws Exception
   */
  public static File getEngineAndProjectImage(String engineId, IEngine.CATALOG_TYPE engineType)
      throws Exception {
    ...
    File[] images =
        localEngineImageFolder.listFiles(
            new FilenameFilter() {
              @Override
  ...
  public static void addHiddenFileToDir(File folder) {
    File hiddenFile =
        new File(folder.getAbsolutePath() + DIR_SEPARATOR + Constants.HIDDEN_FILE_EXTENSION);
    try {
