...
public class NginxClient implements Watcher {
	...
	protected static final Logger classLogger = LogManager.getLogger(NginxClient.class);
	 ...
	 * multiple containers on the same box
	 * 
...
//	}
	...
	public void reloadNginx() {
		...
		/*
		 * try { // and then execute a kill -HUP ProcessBuilder pb = new
