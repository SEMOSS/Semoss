...
public class NginxClient implements Watcher {
  ...
  */
  ...
  public void process(WatchedEvent event) {
    ...
    if (type == EventType.NodeCreated) nodeChildChanged(Utility.getClassName(event.getPath()));
    else if (type == EventType.NodeDeleted) nodeChildChanged(Utility.getClassName(event.getPath()));
    else if (type == EventType.NodeChildrenChanged) nodeChildChanged(event.getPath());
