	...
	public void parseQuery() {
		...
		try {
			...
			if (statement instanceof Select) {
				...
				parseAllPropertiesAndVarsFromQuery(statement); // generate the return variables list and properties list
																// as well other part
				// of the joins

			} else {
				System.err.println(
						"An error occurred, the sql statement you are trying to parse is not parseable " + query);
			}
	...
	private static void basicParseTest() {
		...
		for (String key : propsVariables.keySet()) {
			...
			for (String singleVariable : variablesInTable.keySet()) {
				System.out.println("props table : " + key + " column alias " + singleVariable + " column name "
		...
		for (String key : returnVariables.keySet()) {
			...
			for (String singleVariable : variablesInTable.keySet()) {
				System.out.println("returns table : " + key + " column alias " + singleVariable + " column name "
						+ variablesInTable.get(singleVariable));
			}
		}
