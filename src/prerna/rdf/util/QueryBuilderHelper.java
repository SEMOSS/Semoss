...
public class QueryBuilderHelper {
  ...
  public String[][] getRelationInstance(
      String fromType, String fromInstanceName, String relationName, String toType) {
    ...
    try {
      ...
      Var typeRelation =
          new Var(
              "y",
              vf.createURI(
                  "http://www.w3.org/1999/02/22-rdf-syntax-ns#type")); // , factory.createURI(...));
      // URI y1 = vf
      ...
      TupleExpr query2 =
          new Projection(
              ...
              new ProjectionElemList(
                  new ProjectionElem("x"), new ProjectionElem("t")
