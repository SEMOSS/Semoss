...
public class SesameQueryExpression {
	...
	// this wont work when I actually have multiple things going into the same
	// system
	...
	public void addTriple(String subjectName, String predicateName, String objectName, String subjectVal,
			String predicateVal, Object objectVal, boolean uri) {
