...
public class SesameQueryExpression {
  ...
  public void addTriple(
    ...
    if (subjectVal != null) new Var(subjectName, vf.createURI(subjectVal));
    Var vPredicate = new Var(predicateName);
    if (predicateVal != null) new Var(predicateName, vf.createURI(predicateVal));
    Var vObject = new Var(objectName);
    if (objectVal != null) {
      // understand the object and create the value accordingly
      // logic for string
      if (uri) vObject = new Var(objectName, vf.createURI(objectVal + ""));
  ...
  public void addTypeProjection(String classType) {
    ...
    if (proj.getProjectionElemList() != null) list = proj.getProjectionElemList();
  ...
  public String addPropertyTriple(String classType, String propertyType) {
    ...
    if (!typeInstanceHash.containsKey(classType + propertyType)) {
      ...
      // classInstance propertyType propertyInstance
      addTriple(
          classInstanceName, outputInstanceProp, outputProjection, null, propertyType, null, true);
    }
  ...
  public void addPropertyInstanceProjection(
      String classType, String propertyType, String constantURI) {
  ...
  public void addRelationInstanceProjection(
      String fromType, String relationType, String toType, String constantURI) {
  ...
  // relationtype
  public void addRelationTypeBinding(
      String fromType, String relationType, String toType, String constantURI) {
  ...
  //		expr.addRelationTriple("http://semoss.org/concept/system",
  // "http://semoss.org/relation/provide", "http://semoss.org/concept/do");
  //		expr.addRelationTriple("http://semoss.org/concept/service",
  // "http://semoss.org/relation/exposes", "http://semoss.org/concept/do");
