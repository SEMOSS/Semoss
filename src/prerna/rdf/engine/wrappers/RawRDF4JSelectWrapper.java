...
public class RawRDF4JSelectWrapper extends AbstractWrapper implements IRawSelectWrapper {
	...
	private static final Logger classLogger = LogManager.getLogger(RawRDF4JSelectWrapper.class.getName());
				...
				// if datetime
					...
					try {
						...
						SemossDate date = new SemossDate(d, "yyyy-MM-dd HH:mm:ss",
								ZoneId.of(Utility.getApplicationZoneId()));
						return date;
					} catch (Exception e) {
	...
	public SemossDataType[] getTypes() {
		if (this.types == null) {
			try {
				...
				CustomRdf4JSparqlAggregationParser aggregationVisitor = new CustomRdf4JSparqlAggregationParser();
