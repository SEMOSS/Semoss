...
public final class WrapperManager {
	...
	{
		ignoreDatabases.addAll(SystemDefaultEngines.getIgnoreDatabaseOwlList());
	...
	public IRawSelectWrapper getRawWrapper(IDatabaseEngine engine, SelectQueryStruct qs, boolean delayExecIfPossible)
			throws Exception {
		...
		try {
			...
			case R: {
				...
				// since R will still run even if the limit+offset is > numRows and return null
				// entries
