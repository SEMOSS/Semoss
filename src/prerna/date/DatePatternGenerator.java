...
public class DatePatternGenerator {
  ...
  //////////////////////////////////////////////////////////////////////////////
	...
	private static String[][] getMonth() {
		return new String[][]{new String[]{"[1-9]", "M"}, new String[]{"[1][0-2]", "M"},
				new String[]{"[0][1-9]", "MM"}};
	}

	private static String[][] getPartialMonth(boolean basic) {
		if (basic) {
			return new String[][]{new String[]{"[a-zA-Z]{3}", "MMM"},};
		} else {
			return new String[][]{new String[]{"[a-zA-Z]{3}", "MMM"}, new String[]{"[a-zA-Z]{3},", "MMM,"},};
		}
	}
	...
	private static String[][] getDay(boolean basic) {
		if (basic) {
			return new String[][]{new String[]{"[1-9]", "d"}, new String[]{"[1-3][0-9]", "d"},
					new String[]{"[0][1-9]", "dd"}};
		} else {
			return new String[][]{
					// without comma
					new String[]{"[1-9]", "d"}, new String[]{"[1-3][0-9]", "d"}, new String[]{"[0][1-9]", "dd"},
					// with comma
					new String[]{"[1-9],", "d,"}, new String[]{"[1-3][0-9],", "d,"}, new String[]{"[0][1-9],", "dd,"}};
		}
	}
  ...
  //////////////////////////////////////////////////////////////////////////////
	...
	private static String[][] getHour() {
		return new String[][]{new String[]{"[0][0-9]", "HH"}, new String[]{"[0-9]", "H"}, new String[]{"[1][0-9]", "H"},
				new String[]{"[2][0-3]", "H"}};
	}

	private static String[][] getMinute() {
		return new String[][]{new String[]{"[0][0-9]", "mm"}, new String[]{"[1-5][0-9]", "m"},
				new String[]{"[6][0]", "m"}};
	}

	private static String[][] getSecond() {
		return new String[][]{new String[]{"[0][0-9]", "ss"}, new String[]{"[1-5][0-9]", "s"},
				new String[]{"[6][0]", "s"}};
	}

	private static String[][] getMilliSecond() {
		return new String[][]{new String[]{"[0-9]{4}", "S"}, new String[]{"[0][0-9]{3}", "SS"},
				new String[]{"[0][0][0-9]{2}", "SSS"}, new String[]{"[0][0][0][0-9]{1}", "SSSS"}};
	}
  ...
  //////////////////////////////////////////////////////////////////////////////
	 ...
	 * @param separator
	 */
	private static void genSimpleCombinations(List<String[]> retValues, String[][] comb1, String[][] comb2,
			String separator) {
	 ...
	 */
	private static void genSimpleCombinations(List<String[]> retValues, String[][] comb1, String[][] comb2,
			String[][] comb3, String[][] comb4, String separator, String finalSeparator) {
		String patternSep = separator;
			...
			for (int j = 0; j < size2; j++) {
				...
				for (int k = 0; k < size3; k++) {
					...
					for (int l = 0; l < size4; l++) {
						...
						StringBuilder regexMatch = new StringBuilder();
						regexMatch.append(val1[0]).append(separator).append(val2[0]).append(separator).append(val3[0])
								.append(finalPSep).append(val4[0]);

						StringBuilder pattern = new StringBuilder();
						pattern.append(val1[1]).append(patternSep).append(val2[1]).append(patternSep).append(val3[1])
								.append(finalPSep).append(val4[1]);
	...
	/**
	 * Combine 2 sets of possiblities Used when combining all date possibilities
	 * with time possibilities
	 *
	 * @param retValues
	 * @param comb1
	 * @param comb2
	 ...
	 */
	private static void combineCombinations(List<String[]> retValues, List<String[]> comb1, List<String[]> comb2,
			String combinationSep) {
  ...
  //////////////////////////////////////////////////////////////////////////////
	...
	// DatePatternGenerator.getPartialMonthDateFormats();
	// for(String[] vals : dateValues) {
	// System.out.println(Arrays.toString(vals));
	// }
	// }
	...
	private static SemossDate genDateObjContainingLetters(String input) {
		String[][] dateMatches = new String[][]{
				 ...
				 * Wed, Mar 12 2015
				 */
				new String[]{"[a-zA-Z]{3},\\s*[a-zA-Z]{3}\\s*[0-9]\\s*[0-9]{4}", "EEE, MMM d yyyy"}, // this matches
																										// EEE, MMM d
																										// yyyy
				new String[]{"[a-zA-Z]{3},\\s*[a-zA-Z]{3}\\s*[0-3][0-9]\\s*[0-9]{4}", "EEE, MMM dd yyyy"}, // this
																											// matches
																											// EEE, MMM
																											// dd yyyy
				 ...
				 * Wed, 12 Mar 2015
				 */
				new String[]{"[a-zA-Z]{3},\\s*[0-9]\\s*[a-zA-Z]{3}\\s*[0-9]{4}", "EEE, d MMM yyyy"}, // this matches
																										// EEE, d MMM
																										// yyyy
				new String[]{"[a-zA-Z]{3},\\s*[0-3][0-9]\\s*[a-zA-Z]{3}\\s*[0-9]{4}", "EEE, dd MMM yyyy"}, // this
																											// matches
																											// EEE, dd
																											// MMM yyyy
		...
		dateMatches = new String[][]{
				 ...
				 * January 1st, 2015
				 */
				new String[]{MONTH_REPLACEMENT + "\\s*[0-9][a-zA-z]{2},\\s*[0-9]{4}", "MMMMM d'%s', yyyy"}, // this
																											// matches
																											// MMMM
																											// d'%s',
																											// yyyy
				new String[]{MONTH_REPLACEMENT + "\\s*[0-3][0-9][a-zA-z]{2},\\s*[0-9]{4}", "MMMMM dd'%s', yyyy"}, // this
																													// matches
																													// MMMM
																													// dd'%s',
																													// yyyy
				 ...
				 * January 1, 2015
				 */
				new String[]{MONTH_REPLACEMENT + "\\s*[0-9],\\s*[0-9]{4}", "MMMMM d, yyyy"}, // this matches MMMM d,
																								// yyyy
				new String[]{MONTH_REPLACEMENT + "\\s*[0-3][0-9],\\s*[0-9]{4}", "MMMMM dd, yyyy"} // this matches MMMM
																									// dd, yyyy
		};
