...
public class DatePatternGenerator {
   ...
   * @param separator
   */
  private static void genSimpleCombinations(
      List<String[]> retValues, String[][] comb1, String[][] comb2, String separator) {
  ...
  /**
   * Combine 2 sets of possiblities Used when combining all date possibilities with time
   * possibilities
   *
   * @param retValues
   * @param comb1
  ...
  private static void combineCombinations(
      List<String[]> retValues, List<String[]> comb1, List<String[]> comb2, String combinationSep) {
  ...
  private static SemossDate genDateObjContainingLetters(String input) {
    String[][] dateMatches =
        new String[][] {
           ...
           */
          new String[] {
            "[0-3][0-9]\\s*[a-zA-Z]{3}\\s*[0-9]{4}", "dd MMM yyyy"
          }, // this matches dd MMM yyyy
          new String[] {
            "[0-9]\\s*[a-zA-Z]{3}\\s*[0-9]{4}", "d MMM yyyy"
          }, // this matches d MMM yyyy
          new String[] {
            "[0-3][0-9]\\s*[a-zA-Z]{3},\\s*[0-9]{4}", "dd MMM, yyyy"
          }, // this matches dd MMM, yyyy
          new String[] {
           ...
           */
          new String[] {
            "[0-3][0-9]\\s*[a-zA-Z]{3}\\s*[0-9][0-9]", "dd MMM yy"
          }, // this matches dd MMM yy
          new String[] {"[0-9]\\s*[a-zA-Z]{3}\\s*[0-9][0-9]", "d MMM yy"}, // this matches d MMM yy
          new String[] {
            "[0-3][0-9]\\s*[a-zA-Z]{3},\\s*[0-9][0-9]", "dd MMM, yy"
          }, // this matches dd MMM, yy
          new String[] {
            "[0-9]\\s*[a-zA-Z]{3},\\s*[0-9][0-9]", "d MMM, yy"
          }, // this matches d MMM, yy

          /*
           * Mar 12 2012
           */
          new String[] {
            "[a-zA-Z]{3}\\s*[0-3][0-9]\\s*[0-9]{4}", "MMM dd yyyy"
          }, // this matches MMM dd yyyy
          new String[] {
            "[a-zA-Z]{3}\\s*[0-9]\\s*[0-9]{4}", "MMM d yyyy"
          }, // this matches MMM d yyyy
          new String[] {
            "[a-zA-Z]{3}\\s*[0-3][0-9],\\s*[0-9]{4}", "MMM dd, yyyy"
          }, // this matches MMM dd, yyyy
          new String[] {
           ...
           */
          new String[] {
            "[a-zA-Z]{3}\\s*[0-3][0-9]\\s*[0-9][0-9]", "MMM dd yy"
          }, // this matches MMM dd yy
          new String[] {"[a-zA-Z]{3}\\s*[0-9]\\s*[0-9][0-9]", "MMM d yy"}, // this matches MMM d yy
          new String[] {
            "[a-zA-Z]{3}\\s*[0-3][0-9],\\s*[0-9][0-9]", "MMM dd, yy"
          }, // this matches MMM dd, yy
          new String[] {
            "[a-zA-Z]{3}\\s*[0-9],\\s*[0-9][0-9]", "MMM d, yy"
          }, // this matches MMM d, yy
           ...
           */
          new String[] {
            "[a-zA-Z]{3},\\s*[a-zA-Z]{3}\\s*[0-9]\\s*[0-9]{4}", "EEE, MMM d yyyy"
          }, // this matches EEE, MMM d yyyy
          new String[] {
            "[a-zA-Z]{3},\\s*[a-zA-Z]{3}\\s*[0-3][0-9]\\s*[0-9]{4}", "EEE, MMM dd yyyy"
          }, // this matches EEE, MMM dd yyyy
           ...
           */
          new String[] {
            "[a-zA-Z]{3},\\s*[0-9]\\s*[a-zA-Z]{3}\\s*[0-9]{4}", "EEE, d MMM yyyy"
          }, // this matches EEE, d MMM yyyy
          new String[] {
            "[a-zA-Z]{3},\\s*[0-3][0-9]\\s*[a-zA-Z]{3}\\s*[0-9]{4}", "EEE, dd MMM yyyy"
          }, // this matches EEE, dd MMM yyyy
    ...
    dateMatches =
        new String[][] {
           ...
           */
          new String[] {
            MONTH_REPLACEMENT + "\\s*[0-9][a-zA-z]{2},\\s*[0-9]{4}", "MMMMM d'%s', yyyy"
          }, // this matches MMMM d'%s', yyyy
          new String[] {
            MONTH_REPLACEMENT + "\\s*[0-3][0-9][a-zA-z]{2},\\s*[0-9]{4}", "MMMMM dd'%s', yyyy"
          }, // this matches MMMM dd'%s', yyyy

          /*
           * January 1, 2015
           */
          new String[] {
            MONTH_REPLACEMENT + "\\s*[0-9],\\s*[0-9]{4}", "MMMMM d, yyyy"
          }, // this matches MMMM d, yyyy
          new String[] {
            MONTH_REPLACEMENT + "\\s*[0-3][0-9],\\s*[0-9]{4}", "MMMMM dd, yyyy"
          } // this matches MMMM dd, yyyy
        };
