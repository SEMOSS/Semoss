...
public class DateManipulationReactor extends AbstractReactor {
	...
	// how to use
	// Frame() | Select( ...... ) | Filter (DATE_COLUMN_NAME >=
	// DateManipulation("subtract", Date(),
	// 7, "days") ) |
	// different flows
	...
	private NounMetadata performManip(String type) {
		...
		// based on the type of operation we will do the specific date manipulations
		// here
	...
	private SemossDataType determineReturnOutput() {
		...
		if (type.equalsIgnoreCase("add") || type.equalsIgnoreCase("addition") || type.equalsIgnoreCase("subtract")
				|| type.equalsIgnoreCase("sub") || type.equalsIgnoreCase("subtraction")) {
