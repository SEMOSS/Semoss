...
public interface IQueryFilter {
  ...
  public static boolean comparatorsRegexConflicting(String comparator1, String comparator2) {
    if (comparator1.equals("==") && comparator2.equals("?nlike")) {
      ...
      return true;
    } else if (comparator1.equals("?like")
        && (comparator2.equals("!=") || comparator2.equals("<>"))) {
      return true;
    } else if (comparator2.equals("?like")
        && (comparator1.equals("!=") || comparator1.equals("<>"))) {
      return true;
  ...
  public static boolean newComparatorOvershadowsExisting(
      String existingComparator, String newComparator) {
  ...
  public static boolean comparatorsRequireOrStatement(
      String existingComparator, String newComparator) {
    if (existingComparator.equals("==") && newComparator.equals("?like")) {
      return true;
  ...
  /**
   * Method to provide the reverse of a given numeric comparator Otherwise, return the same value
   *
   * @param comparator
   * @return
   */
