...
public interface IQueryFilter {
	...
	enum QUERY_FILTER_TYPE {
		AND, OR, SIMPLE, SUBQUERY, FUNCTION, BETWEEN
	};
  ...
  ////////////////////////////////////////////////////////////////
	...
	public static boolean isRegexComparator(String comparator) {
		if (comparator.equals("?like") || comparator.equals("?nlike") || comparator.equals("?begins")
				|| comparator.equals("?nbegins") || comparator.equals("?ends") || comparator.equals("?nends")) {
			return true;
		}
		return false;
	}
	...
	public static boolean newComparatorOvershadowsExisting(String existingComparator, String newComparator) {
		if (existingComparator.equals("==") && newComparator.equals("?like")) {
			return true;
		} else if ((existingComparator.equals("!=") || existingComparator.equals("<>"))
				&& newComparator.equals("?nlike")) {
			return true;
		}
		return false;
	}
	...
	public static boolean comparatorsAreConflicting(String comparator1, String comparator2) {
		if ((comparator1.equals("==") || comparator1.equals("?like"))
				&& (comparator2.equals("!=") || comparator2.equals("<>") || comparator2.equals("?nlike"))) {
			return true;
		} else if ((comparator2.equals("==") || comparator2.equals("?like"))
				&& (comparator1.equals("!=") || comparator1.equals("<>") || comparator1.equals("?nlike"))) {
			return true;
		}
		return false;
	}
	...
	/**
	 * Method to provide the reverse of a given numeric comparator Otherwise, return
	 * the same value
	 *
	 * @param comparator
	 * @return
	...
	public static boolean comparatorNotNumeric(String comparator) {
		if (comparator.equals("==") || comparator.equals("!=") || comparator.equals("<>") || comparator.equals("?like")
				|| comparator.equals("?nlike") || comparator.equals("?begins") || comparator.equals("?nbegins")
	...
	public static boolean comparatorIsValidSQL(String comparator) {
		if (comparator.equals("=") || comparator.equals("in") || comparator.equals("!=") || comparator.equals("<>")
				|| comparator.equals(">") || comparator.equals(">=") || comparator.equals("<")
				|| comparator.equals("<=") || comparator.equals("like") || comparator.equals("and")
	...
	public static boolean comparatorIsEquals(String comparator) {
		...
		return comparator == null || comparator.equals("") || comparator.equals("==") || comparator.equals("=");
	}
