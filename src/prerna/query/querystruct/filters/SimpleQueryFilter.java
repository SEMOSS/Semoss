...
public class SimpleQueryFilter implements IQueryFilter {
	...
	public static enum FILTER_TYPE {
		COL_TO_QUERY, QUERY_TO_COL, COL_TO_COL, COL_TO_VALUES, VALUES_TO_COL, VALUE_TO_VALUE, COL_TO_LAMBDA, LAMBDA_TO_COL
	};
  ...
  ////////////////////////////////////////////////////////////////
	 ...
	 *
	 * @param colQs
	 *            The string representing the pixel for a unique column
	 * @param comparator
	 *            The comparator for the filter
	 * @param values
	 *            The value for the filter - can be List or scalar (interpreter
	 *            handles both)
	 * @return
	 */
	 ...
	 *            handles both)
	 * @param rightDataType
	 *            The data type for the object (if list, the values inside the list)
	 * @return
	 */
	public static SimpleQueryFilter makeColToValFilter(String colQs, String comparator, Object values,
