...
public class QueryIfSelector extends AbstractQuerySelector {
	 ...
	 * @return
	 */
	public static QueryIfSelector makeQueryIfSelector(IQueryFilter condition, String qsName1, String qsName2,
			String alias) {
		return makeQueryIfSelector(condition, new QueryColumnSelector(qsName1), new QueryColumnSelector(qsName2),
				alias);
	}
	 ...
	 * @return
	 */
	public static QueryIfSelector makeQueryIfSelector(IQueryFilter condition, IQuerySelector precedent,
			IQuerySelector antecedent, String alias) {
