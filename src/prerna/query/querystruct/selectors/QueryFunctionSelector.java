...
public class QueryFunctionSelector extends AbstractQuerySelector {
   ...
   * @return
   */
  public static QueryFunctionSelector makeFunctionSelector(
      String function, String qsName, String alias) {
   ...
   */
  public static QueryFunctionSelector makeFunctionSelector(
      String function, IQuerySelector selector, String alias) {
   ...
   * @return
   */
  public static QueryFunctionSelector makeCol2ColCoalesceSelector(
      String qsName1, String qsName2, String alias) {
    return makeCoalesceSelector(
        new QueryColumnSelector(qsName1), new QueryColumnSelector(qsName2), alias);
  }
   ...
   * @return
   */
  public static QueryFunctionSelector makeCol2ValCoalesceSelector(
      String qsName1, Object value, String alias) {
    return makeCoalesceSelector(
        new QueryColumnSelector(qsName1), new QueryConstantSelector(value), alias);
  }
   ...
   * @return
   */
  public static QueryFunctionSelector makeConcat2ColumnsFunction(
      String qsName1, String qsName2, String alias) {
    QueryFunctionSelector fun = new QueryFunctionSelector();
   ...
   * @return
   */
  public static QueryFunctionSelector makeCoalesceSelector(
      IQuerySelector selector1, IQuerySelector selector2, String alias) {
    QueryFunctionSelector fun = new QueryFunctionSelector();
