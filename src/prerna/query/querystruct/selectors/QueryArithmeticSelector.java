...
public class QueryArithmeticSelector extends AbstractQuerySelector {
  ...
  private static final IQuerySelector.SELECTOR_TYPE SELECTOR_TYPE =
      IQuerySelector.SELECTOR_TYPE.ARITHMETIC;
  ...
  public String getAlias() {
    if (this.alias == null || this.alias.equals("")) {
      return this.leftSelector.getAlias()
          + "_"
          + getEnglishForMath()
          + "_"
          + this.rightSelector.getAlias();
    }
    return this.alias;
  }
  ...
  public int hashCode() {
    String allString =
        leftSelector + ":::" + this.mathExpr + ":::" + this.rightSelector + ":::" + alias;
    return allString.hashCode();
  }

  /**
   * Used for the default alias since most languages will not support the string version of the math
   * expression (for obvious reasons)
   *
   * @return
   */
   ...
   * @return
   */
  public static QueryArithmeticSelector makeCol2ColSelector(
      String leftColQs, String rightColQs, String mathExpr, String alias) {
    return makeCol2ColSelector(
        new QueryColumnSelector(leftColQs), new QueryColumnSelector(rightColQs), mathExpr, alias);
  }
   ...
   */
  public static QueryArithmeticSelector makeCol2ColSelector(
      IQuerySelector leftSelector, IQuerySelector rightSelector, String mathExpr, String alias) {
