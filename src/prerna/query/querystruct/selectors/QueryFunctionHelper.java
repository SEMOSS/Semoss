...
public class QueryFunctionHelper {
  ...
  /**
   * DUE TO THE LARGE VARIANCE IN SQL THIS IS PUSHED TO THE {{@link prerna.util.sql.SQLQueryUtil}}
   * AND IS USED BY METHOD {{@link prerna.util.sql.SQLQueryUtil#getSqlFunctionSyntax()}}
   *
   * <p>INDIVIDUAL QUERY UTIL IMPLEMENTATIONS CAN OVERRIDE THE SUBMETHODS FOR THEIR VERSION OF THE
   * QUERY FUNCTION
   */
  ...
  public static String determineTypeOfFunction(String inputFunction) {
    if (inputFunction.equalsIgnoreCase(CONCAT)
      ...
      return "INT";
        ...
        || inputFunction.equalsIgnoreCase(DATE_ADD)) {
      return "DATE";
    }
  ...
  public static String getPrettyName(String inputFunction) {
    ...
    } else if (inputFunction.equalsIgnoreCase(UNIQUE_MEAN)
        || inputFunction.equalsIgnoreCase(UNIQUE_AVERAGE_1)
        || inputFunction.equalsIgnoreCase(UNIQUE_AVERAGE_2)) {
