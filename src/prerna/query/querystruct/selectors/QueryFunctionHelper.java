...
public class QueryFunctionHelper {
	...
	/**
	 * DUE TO THE LARGE VARIANCE IN SQL THIS IS PUSHED TO THE
	 * {{@link prerna.util.sql.SQLQueryUtil}} AND IS USED BY METHOD
	 * {{@link prerna.util.sql.SQLQueryUtil#getSqlFunctionSyntax()}}
	 *
	 * <p>
	 * INDIVIDUAL QUERY UTIL IMPLEMENTATIONS CAN OVERRIDE THE SUBMETHODS FOR THEIR
	 * VERSION OF THE QUERY FUNCTION
	 */
	...
	// inputFunction = "MAX";
	// } else if(inputFunction.equalsIgnoreCase(MEAN) ||
	// inputFunction.equalsIgnoreCase(AVERAGE_1) ||
	// inputFunction.equalsIgnoreCase(AVERAGE_2)
	// || inputFunction.equalsIgnoreCase(UNIQUE_MEAN) ||
	// inputFunction.equalsIgnoreCase(UNIQUE_AVERAGE_1) ||
	// inputFunction.equalsIgnoreCase(UNIQUE_AVERAGE_2)) {
	// inputFunction = "AVG";
	// } else if(inputFunction.equalsIgnoreCase(MEDIAN)) {
	// inputFunction = "MEDIAN";
	// } else if(inputFunction.equalsIgnoreCase(SUM) ||
	// inputFunction.equalsIgnoreCase(UNIQUE_SUM)) {
	// inputFunction = "SUM";
	// } else if(inputFunction.equalsIgnoreCase(STDEV_1) ||
	// inputFunction.equalsIgnoreCase(STDEV_2))
	// {
	...
	public static String convertFunctionToRSyntax(String inputFunction) {
		if (inputFunction.equalsIgnoreCase(MIN)) {
			...
			inputFunction = "max";
		} else if (inputFunction.equalsIgnoreCase(MEAN) || inputFunction.equalsIgnoreCase(AVERAGE_1)
				|| inputFunction.equalsIgnoreCase(AVERAGE_2) || inputFunction.equalsIgnoreCase(UNIQUE_MEAN)
				|| inputFunction.equalsIgnoreCase(UNIQUE_AVERAGE_1)
				|| inputFunction.equalsIgnoreCase(UNIQUE_AVERAGE_2)) {
			inputFunction = "mean";
		} else if (inputFunction.equalsIgnoreCase(MEDIAN)) {
	...
	/**
	 * Try to predict the function type Default to number
	 *
	 * @param inputFunction
	 * @return
	 */
	public static String determineTypeOfFunction(String inputFunction) {
		if (inputFunction.equalsIgnoreCase(CONCAT) || inputFunction.equalsIgnoreCase(GROUP_CONCAT)
				|| inputFunction.equalsIgnoreCase(UNIQUE_GROUP_CONCAT) || inputFunction.equalsIgnoreCase(LOWER)
				|| inputFunction.equalsIgnoreCase(COALESCE) || inputFunction.equalsIgnoreCase(SUBSTRING)
				|| inputFunction.equalsIgnoreCase(MONTH_NAME) || inputFunction.equalsIgnoreCase(DAY_NAME)) {
			return "STRING";
		} else if (inputFunction.equalsIgnoreCase(COUNT) || inputFunction.equalsIgnoreCase(UNIQUE_COUNT)) {
			return "INT";
	...
	public static String getPrettyName(String inputFunction) {
		...
		} else if (inputFunction.equalsIgnoreCase(UNIQUE_MEAN) || inputFunction.equalsIgnoreCase(UNIQUE_AVERAGE_1)
				|| inputFunction.equalsIgnoreCase(UNIQUE_AVERAGE_2)) {
