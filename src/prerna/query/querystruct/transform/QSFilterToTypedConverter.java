...
public class QSFilterToTypedConverter {
	...
	public static List<IQueryFilter> convertFilters(List<IQueryFilter> origFilters, String tableName, Map<String, SemossDataType> typeMap) {
	 ...
	 * @return
	 */
	public static IQueryFilter convertFilter(IQueryFilter queryFilter, String tableName, Map<String, SemossDataType> typeMap) {
	...
	private static IQueryFilter convertOrQueryFilter(OrQueryFilter queryFilter, String tableName, Map<String, SemossDataType> typeMap) {
	...
	private static IQueryFilter convertAndQueryFilter(AndQueryFilter queryFilter, String tableName, Map<String, SemossDataType> typeMap) {
	...
	private static SimpleQueryFilter convertSimpleQueryFilter(SimpleQueryFilter queryFilter, String tableName, Map<String, SemossDataType> typeMap) {
		NounMetadata newL = null;
		NounMetadata origL = queryFilter.getLComparison();
		if(origL.getNounType() == PixelDataType.COLUMN) {
			// need to convert
			newL = new NounMetadata( convertSelector((IQuerySelector) origL.getValue(), tableName, typeMap) , PixelDataType.COLUMN);
		} 
...
//		} 
		...
		if(origR.getNounType() == PixelDataType.COLUMN) {
			// need to convert
			newR = new NounMetadata( convertSelector((IQuerySelector) origR.getValue(), tableName, typeMap) , PixelDataType.COLUMN);
		} 
		// Not going to handle a subquery against the pgvector at this point..
...
//		} 
	...
	private static BetweenQueryFilter convertBetweenQueryFilter(BetweenQueryFilter queryFilter, String tableName, Map<String, SemossDataType> typeMap) {
	 ...
	 * @return
	 */
	public static IQuerySelector convertSelector(IQuerySelector selector, String tableName, Map<String, SemossDataType> typeMap) {
	...
	private static IQuerySelector convertIfElseSelector(QueryIfSelector selector, String tableName, Map<String, SemossDataType> typeMap)
	{
		...
		if(antecedent != null)
			selector.setAntecedent(convertSelector(antecedent, tableName, typeMap));
		
		return selector;
	}
	

	private static IQuerySelector convertColumnSelector(QueryColumnSelector selector, String tableName, Map<String, SemossDataType> typeMap) {
	...
	private static IQuerySelector convertArithmeticSelector(QueryArithmeticSelector selector, String tableName, Map<String, SemossDataType> typeMap) {
	...
	private static IQuerySelector convertFunctionSelector(QueryFunctionSelector selector, String tableName, Map<String, SemossDataType> typeMap) {
