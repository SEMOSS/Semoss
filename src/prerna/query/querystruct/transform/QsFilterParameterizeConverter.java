...
public class QsFilterParameterizeConverter {
  ...
  public static IQueryFilter modifyFilter(
      IQueryFilter filter, String colToParameterize, Map<String, List<String>> colToComparators) {
    if (filter.getQueryFilterType() == IQueryFilter.QUERY_FILTER_TYPE.SIMPLE) {
      return convertSimpleQueryFilter(
          (SimpleQueryFilter) filter, colToParameterize, colToComparators);
  ...
  public static IQueryFilter convertOrQueryFilter(
      OrQueryFilter filter, String colToParameterize, Map<String, List<String>> colToComparators) {
  ...
  public static IQueryFilter convertAndQueryFilter(
      AndQueryFilter filter, String colToParameterize, Map<String, List<String>> colToComparators) {
      ...
      newL =
          new NounMetadata(
              "<"
                  + colToParameterize
                  + "__"
                  + IQueryFilter.getSimpleNameForComparator(comparator)
                  + ">",
  ...
  private static void addToColToParam(
      Map<String, List<String>> colToComparators, String col, String comparator) {
