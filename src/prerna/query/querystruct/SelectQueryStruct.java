...
public class SelectQueryStruct extends AbstractQueryStruct {
  ...
  ////////////////////////////////////////////////////
	 ...
	 * @param incomingQS
	 *            <p>
	 *            This method is responsible for merging "incomingQS's" data with
	 *            THIS querystruct
	 */
  ...
  ////////////////////////////////////////////////////
	...
	// * This takes into consideration intermediary nodes that should not be added
	// to the return hash
	...
	// * @param edgeHash The existing edge hash to determine what the current
	// selectors are
	// */
	// private void processRelationship(String startNode, Map<String, List> relMap,
	// Map<String,
	// Set<String>> edgeHash) {
	...
	// * @param endNode The endNode that is node a selector which we are trying to
	// find the
	// shortest path to
	// * @param edgeHash The edgeHash to find the current selectors
	// * @param newEndNodeList The list of endNodes that have been found using the
	// logic to find
	// the shortest
	// * path for connected nodes
	// */
	// private void determineShortestEndNodePath(String endNode, Map<String,
	// Set<String>> edgeHash,
	...
	// // if this connection is a selector (i.e. key in the edgeHash), then we need
	// to add it to
	// the newEndNodeList
	...
	// String concept = possibleNewEndNode.substring(0,
	// possibleNewEndNode.indexOf("__"));
	// if(edgeHash.containsKey(concept)) {
	// // we found the parent.. therefore we add it
	...
	public Map<String, Set<String>> getReturnConnectionsHash() {
		...
		// continue;
		// }
		// // mergeQSEdgeHash needs this to be the concept__property... plus need to
		// keep it
		...
		// // the relMap contains the joinType pointing to a list of columns to be
		// joined to
