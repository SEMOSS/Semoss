...
public class SetParamsReactor extends AbstractReactor {
	public SetParamsReactor() {
		...
		this.keysToGet = new String[]{ReactorKeysEnum.PIXEL_ID.getKey(), ReactorKeysEnum.ID_TYPE.getKey(),
				ReactorKeysEnum.VALUE.getKey(), ReactorKeysEnum.COLUMN.getKey(), ReactorKeysEnum.TABLE.getKey(),
				ReactorKeysEnum.OPERATOR.getKey(), ReactorKeysEnum.OPERATORU.getKey()};
