...
public class BasicRelationship implements IRelation {
	...
	public BasicRelationship(String fromConcept, String joinType, String toConcept, String comparator,
			String relationName) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof BasicRelationship) {
			...
			if (this.fromConcept.equals(otherRel.fromConcept) && this.joinType.equals(otherRel.joinType)
