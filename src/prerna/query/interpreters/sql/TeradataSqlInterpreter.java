...
public class TeradataSqlInterpreter extends SqlInterpreter {
	...
	public String composeQuery() {
		...
		// If the smss says this app is part of a big data engine, then some changes
		// happen.
		...
		// if(bigDataProp!= null){
		// bigDataEngine =
		// Boolean.parseBoolean(this.engine.getProp().get(Constants.BIG_DATA_ENGINE).toString());
		// }
		...
		// if there it is a big data engine, dont put distinct onto qs's with task
		// options
