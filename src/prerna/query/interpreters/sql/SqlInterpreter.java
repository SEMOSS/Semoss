...
public class SqlInterpreter extends AbstractQueryInterpreter {
	 ...
	 * @return
	 */
	public String processSelector(IQuerySelector selector, boolean addProcessedColumn) {
	...
	protected String processFunctionSelector(QueryFunctionSelector selector) {
		return this.queryUtil.buildFunctionSyntax(selector, this);
	}
	 ...
	 * @param toCol        The ending column, this can be just a table or
	 *                     table__column
	 */
