...
public class SqlTranslator {
	...
	// sql = "select min(a)from(select distinct b from t order by salary desc)where
	// rownum<=2;";
	// sql = "Select * from Employee a where rowid <>( select max(rowid) from
	// Employee b where
	...
	// sql = "select distinct salary from employee a where 3 >= (select
