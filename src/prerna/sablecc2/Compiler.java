							...
							new Lexer(
									new PushbackReader(
											...
											new InputStreamReader(new StringBufferInputStream(""
													...
													+ "select(s=[a,b,c], props=[type=\"reduce\"]).as([select_a]) |  groupby(s=[select_a],props=[type=\"reduce\"]).as([group_b]) | filter(a,b,select_a, group_b);" // | trial(s=[a,b,c],props=[name=\"samiksha\"]);"
