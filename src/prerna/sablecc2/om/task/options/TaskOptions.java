...
public class TaskOptions {
	...
	/*
	 * Please note - this is basically a wrapper around the Map<String, Object>
	 * options The keys to this map should always be panel ids Do not add random
	 * keys inside - this will break other logic that assumes that we can determine
	...
	/**
	 * Swap the current panel ids Boolean to pass if to remove all the other panels
	 * and keep only the new panelId
	 *
	 * @param newPanelId
