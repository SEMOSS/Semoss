...
public abstract class AbstractTask implements ITask {
	...
	// logger
	protected static transient Logger classLogger = LogManager.getLogger(AbstractTask.class);
	...
	/**
	 * Returns structure based on the formatter: Example for Table { data : List of
	 * Arrays of Data, headers: headers of my data }
	 */
