...
//	APP("app", 													"Name of the app on the local SEMOSS instance"),
	...
	EDITCOMMAND ("editcommand",									"The shell editcommand to execute. Commands allowed cd, dir, ls, copy, cp, mv, move, del <specific file>, rm <specific file>, git"),
	...
	DOCID("docid",                                              "This key can represent the unique id of the Docs"),
	DOCNAME("docname",                                          "This is the document name"),
	...
	ENDINDEX("endindex", 												"A specified end index for an object (e.g., the frame filter)"),
  ...
  SECTION("section", 											"The section to use as input from addBlockReactor"),
	...
	LAST_USED("lastdate",                                       "Last ddte updated"),
