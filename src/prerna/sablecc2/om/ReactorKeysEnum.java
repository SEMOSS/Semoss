...
//	APP("app", 													"Name of the app on the local SEMOSS instance"),
	...
	ATTENDEES("attendees",                                      "The number of attendees for the event"),
	...
	EMAIL("email",                                              "The email account to be added for google calender."),
	...
	ENDDATE("enddate",                                          "The end date of the event"),
	...
	FREQUENCY("frequency",                                      "The no of time the event will be repeated"),
	...
	LOCATION("location",                                        "The location for the event"),
	...
	OLDSUMMARY("oldsummary",                                    "The old summary of the event"),
  ...
  SECTION("section", 											"The section to use as input from addBlockReactor"),
	...
	STARTDATE("startdate",                                      "The start date of the event"),
	...
	SUMMARY("summary",                                          "The summary of the event"),
	...
	UNTIL("until",                                              "The date till which we want the recurring event"),
	...
	VIDEO("video",                                              "Enable video conferencing or disable"),
