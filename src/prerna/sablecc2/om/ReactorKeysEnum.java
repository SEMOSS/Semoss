...
//	APP("app", 													"Name of the app on the local SEMOSS instance"),
	...
	GITLAB_JOB_SCOPE("gitlabJobScope",							"The scope of jobs to show. Either one of or an array of the following: created, pending, running, failed, success, canceled, skipped, waiting_for_resource, or manual. All jobs are returned if scope is not provided."),
	GITLAB_PRIVATE_TOKEN("gitlabPrivateToken",					"The private token to access the project"),
	GITLAB_PROJECT_ID("gitlabProjectId",						"The unqiue project id (integer) value for the project"),
