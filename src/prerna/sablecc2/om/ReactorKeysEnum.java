...
//	APP("app", 													"Name of the app on the local SEMOSS instance"),
	...
	GUIDANCE_SCALE("guidance_scale", 							"Controls adherence to the prompt, higher values follow prompt more strictly for ImageReactor"),
	...
	NEGATIVE_PROMPT("negative_prompt",							"Specifies aspects to avoid in the generated image"),
	...
	NUM_IMAGES("num_images", 									"Number of images to generate with ImageReactor"),
	NUM_INFERENCE_STEPS("num_inference_steps",					"Number of steps for the image generation process"),
	...
	SEED("seed", 												"Random seed for reproducability"),
