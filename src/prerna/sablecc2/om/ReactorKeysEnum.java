...
//	APP("app", 													"Name of the app on the local SEMOSS instance"),
	...
	BODY("body",                                                "The body of the Google email"),
	...
	NUMBER("number",                                            "The number of unread emails to get or to sumarise"),
  ...
  SECTION("section", 											"The section to use as input from addBlockReactor"),
	...
	SUBJECT("subject",                                          "The subject of the Google email"),
    ...
    TOEMAIL("toemail",                                          "The Google email to whom sender is sending mail."),
