...
//	APP("app", 													"Name of the app on the local SEMOSS instance"),
	API_ID("appId", 											"App Id of the app on the local SEMOSS instance"),
	...
	CLIENT_ID("clientId", 										"Client ID of the OAuth client created on serviceNow portal to interact with serviceNow APIs"),
	CLIENT_SECRET("clientSecret", 								"Client Secret of the OAuth client created on serviceNow portal to interact with serviceNow APIs"),
	...
	INSTANCE_URL("instanceURL", 								"URL of the serviceNow instance using which user can interact with APIs"),
	...
	KEY_NAME("keyname",											"The key name used to identify each entry in the database."),
	...
	REDIRECT_URL("redirectURL", 								"URL to be redirected to after user have accesstoken for serviceNow"),
  ...
  SECTION("section", 											"The section to use as input from addBlockReactor"),
	...
	SERVICE_NOW_AUTOADD("autoAdd",							    "Auto parameter value to add accesstoken automatically to the hashset where accesstoken is stored for loggedin user"),
	SERVICE_NOW_BEANPROPS("beanProps",							"Servicenow beabprops for which data will taken after hitting servicenow userinfo url"),
	SERVICE_NOW_CODE_CHALLENGE_METHOD("codeChallengeMethod",	"Servicenow code challenge method to use while generating access token for the user logged in"),
	SERVICE_NOW_JSON_PATTERN("jsonPattern",						"Servicenow json pattern using which data will be retreived from result object in response of servicenow userinfo url"),
	SERVICE_NOW_LOGIN_ALLOWED("loginAllowed",					"Servicenow login allowed to mention in DB is credentials can be used for login"),
	SERVICE_NOW_USERINFO_URL("userinfoURL",						"Servicenow userinfo URL to retrive information of the user for which accesstoken is generated in service now for login"),
	SERVICE_NOW_SCOPE("scope",									"Servicenow scope to mention while generating accesstoken to have access to all service now REST APIs"),
	SERVICE_NOW_ACCESSKEY_KEYS_ALLOWED("accessKeysAllowed",		"Servicenow scope access keys parameter true/false while logging in for a user"),
	...
	SYS_ID("sysId", 											"Sys_id to be provided to retrieve single record from serviceNow table"),
	...
	TABLE_DATA("tableData", 									"Table data to be added in serviceNow table "),
	...
	UUID("uuid",												"The UUID of the user which will be used for performaing transactions"),
	URL("url",													"The url"),
	...
	USERID("userID",                   	               			"Userid of the user registered in SEMOSSS Platform"),
