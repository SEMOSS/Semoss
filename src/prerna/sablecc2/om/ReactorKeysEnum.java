...
public enum ReactorKeysEnum {
	...
	APP("app", 													"The id of the app/project"),
	...
	ENABLED("enabled",											"Boolean whether a feature or item is enabled"),
	...
	FEATURE_ID("featureId",										"The id of a feature within an app profile"),
	FEATURE_KEY("featureKey",									"The string key identifier for an app feature"),
	...
	IS_DEFAULT("isDefault",										"Whether this profile is the default/fallback profile for the app"),
	IS_GROUP("isGroup",											"Whether this profile is a group-style profile containing sub-groups"),
	...
	PROFILE_ID("profileId",										"The id of the app profile"),
	PERMISSION_FILTERS("permissionFilters",						"Additional filter to append based on permission level (1=Owner, 2=Editor, 3=ReadOnly)"),
	PINNED("pinned",                                            "Optional boolean filter; true to return only pinned items, false to return only non-pinned items, omit for no filter."),
	...
	SUBGROUP_ID("subgroupId",									"The id of a sub-group within a group-style app profile"),
	...
	USER_ID("userId",											"The id of a user"),
