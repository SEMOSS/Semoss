...
//	APP("app", 													"Name of the app on the local SEMOSS instance"),
	...
	API_ID("apiId",                                             "API id of your service"),
	...
	CLIENT_ID("clientId",                                       "Salesforce Client Id"),
	CLIENT_SECRET("clientSecret",                               "Salesforce Client Secret"),
	...
	INSTANCE_URL("instanceUrl",                                 "Salesforce Instance URL"),
	...
	RECORD_ID("recordId",                                       "The Salesforce record Id"),
	REDIRECT_URI("redirectUri",                                 "Redirect Uri for Salesforce"),
	...
	SOBJECT_NAME("sObjectName",                                  "Name of the salesforce Object"),
	SORT("sort", 												"Sort direction: ascending (\"asc\") or decending (\"desc\")"),
	SOSL_QUERY("soslQuery",                                     "The SOSL query"),
	SOQL_QUERY("soqlQuery",                                     "The SOQL query"),
	...
	USERID("userId",                                            "Unique identifier for the user who gets the permission"),
