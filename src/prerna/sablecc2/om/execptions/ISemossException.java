...
public interface ISemossException {
	...
	/**
	 * Get if this exception should stop the thread and return to the FE or if we
	 * should continue and try to run through the other steps
	 *
	 * @return
	 */
	...
	/**
	 * Set if this exception should stop the thread and return to the FE or if we
	 * should continue and try to run through the other steps
	 *
	 * @return
	 */
