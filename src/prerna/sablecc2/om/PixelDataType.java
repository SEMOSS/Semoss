...
public enum PixelDataType {
	...
	SUB_QUERY_EXPRESSION("SUB_QUERY_EXPRESSION", null), NULL_VALUE("NULL_VALUE", null), // null input
	...
	EXPORT("EXPORT", null), LAMBDA("LAMBDA", null), ALIAS("ALIAS", ReactorKeysEnum.ALIAS), IN_MEM_STORE("STORE",
			null), PLANNER("PLANNER", null), CACHED_CLASS("CACHED_CLASS", null), VECTOR("VECTOR", null), MAP("MAP",
					null), BOOLEAN("BOOLEAN", null), ERROR("ERROR", null), INVALID_SYNTAX("INVALID_SYNTAX",
							null), R_CONNECTION("R_CONNECTION", null), R_ENGINE("R_ENGINE", null),
	...
	PROJECT_EMAIL_SESSION("PROJECT_EMAIL_SESSION", ReactorKeysEnum.EMAIL_SESSION), PROJECT_AUTHORIZATION_HEADER(
			"PROJECT_AUTHORIZATION_HEADER", ReactorKeysEnum.HEADERS_MAP),

	PIXEL_OBJECT("PIXEL_OBJECT", null), JSON_OBJECT("JSON_OBJECT", null), CUSTOM_DATA_STRUCTURE("CUSTOM_DATA_STRUCTURE",
			null),

	// running cached and new insights
	CACHED_PIXEL_RUNNER("CACHED_PIXEL_RUNNER", null), PIXEL_RUNNER("PIXEL_RUNNER", null),
