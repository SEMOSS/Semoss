...
public class GenRowStruct implements Serializable {
	...
	// SQL expression - SQL expression - something that can be done in the realm of
	// SQL
	...
	// do a check to find which of these can bbe done through SQL vs. which ones
