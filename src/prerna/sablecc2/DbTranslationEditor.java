...
public class DbTranslationEditor extends DepthFirstAdapter {
	...
	// // String expression = "CreateFrame(py); Database(Movie_RDBMS) |
	// Select(Title,
	// Title__Movie_Budget) | Import();";
	...
	// IRawSelectWrapper idWrapper =
	// WrapperManager.getInstance().getRawWrapper(insightEngine,
	// query);
	...
	// admin.updateInsight(in.getRdbmsId(), in.getInsightName(), layout,
	// newRecipe.toArray(new
	// String[]{}));
	// }
	//
