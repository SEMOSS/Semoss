...
public class NLSQueryHelperReactor extends AbstractRFrameReactor {
	...
	public NounMetadata execute() {
		...
		File algo2 = new File(baseFolder + DIR_SEPARATOR + "R" + DIR_SEPARATOR + "AnalyticsRoutineScripts" + DIR_SEPARATOR + "refine_nli.R");
		File history = new File(baseFolder + DIR_SEPARATOR + "R" + DIR_SEPARATOR + "AnalyticsRoutineScripts" + DIR_SEPARATOR + "nlq_history.txt");
		File historyRDS = new File(baseFolder + DIR_SEPARATOR + "R" + DIR_SEPARATOR + "AnalyticsRoutineScripts" + DIR_SEPARATOR + "nli_history.rds");
	...
	private String[] generateAndRunScript(String query, List<Object[]> allTableCols) {
		...
		rsb.append(rHistoryTable + " <- " + "readRDS(\"nli_history.rds\");");
		rsb.append(result + " <- next_item(\"" + query + "\" , " + rTempTable + ");");
