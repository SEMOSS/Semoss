...
public class NLPQueryReactor extends AbstractReactor {
	...
	public NounMetadata execute() {
		...
		String model = "tscholak/3vnuv1vf";
		...
		if(frameCreated)
		{
			...
			String finalOutput = "Query Generated : " + sqlDFQuery + " Data : " + frameName;
			finalOutput = finalOutput + "\r\n To start working with this frame  GenerateFrameFrom" + frameType + "Variable('" + frameName + "')";
			return new NounMetadata(finalOutput + "https://semoss.org", PixelDataType.CONST_STRING);
		}
		else
		{
