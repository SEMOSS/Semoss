...
public class ChangeAppNameReactor extends AbstractInsightReactor {
	...
	public NounMetadata execute() {
		...
		try {
			...
			e.printStackTrace();
			// close new insights db
			if (newInsightsRdbms != null) {
				newInsightsRdbms.closeDB();
			}
			...
			try {
				...
				// hm do I need to do all this?
				RDBMSNativeEngine oldInsightDB = (RDBMSNativeEngine) UploadUtilities.generateInsightsDatabase(appId, oldAppName);
				engine.setInsightDatabase(oldInsightDB);
