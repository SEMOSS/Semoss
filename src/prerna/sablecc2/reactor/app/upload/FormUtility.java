...
public class FormUtility {
	...
	public static String getInputComponent(String dataModelComp) {
		return new StringBuilder(
				" <smss-input ng-model=\"form.dataModel." + dataModelComp + ".selected\">" + "</smss-input>\\n")
						.toString();
	}

	public static String getDropdownComponent(String dataModelComp) {
		return new StringBuilder("<smss-dropdown model=\"form.dataModel." + dataModelComp
				+ ".selected\" options=\"form.dataModel.Genre.options\""
				+ " placeholder=\"Select One\">\\n</smss-dropdown>\\n").toString();
	}

	public static String getNumberPickerComponent() {
		return new StringBuilder("<smss-number-picker model=\"item.selected\">" + "</smss-number-picker>\\n")
				.toString();
	}
	...
	public static String getSubmitComponent() {
		return new StringBuilder("<div smss-form-model=\"Submit\"><smss-btn class=\"smss-btn--primary\""
