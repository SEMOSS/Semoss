...
public class AddOwlRelationshipReactor extends AbstractMetaEditorReactor {
	...
	public NounMetadata execute() {
		...
		try {
			...
			noun.addAdditionalReturn(new NounMetadata("An error occured attempting to add the relationship between " + startT + " and " + endT, 
					PixelDataType.CONST_STRING, PixelOperationType.ERROR));
			return noun;
		}
		
		NounMetadata noun = new NounMetadata(true, PixelDataType.BOOLEAN);
		noun.addAdditionalReturn(new NounMetadata("Successfully adding relationship between " + startT + " and " + endT, 
