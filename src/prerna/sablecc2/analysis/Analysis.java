...
public interface Analysis extends Switch
{
    ...
    void caseASimpleScalarValues(ASimpleScalarValues node);
    void caseAVectorValues(AVectorValues node);
    void caseANestedMapValues(ANestedMapValues node);
    void caseAMapScalarList(AMapScalarList node);
    void caseAOtherScalar(AOtherScalar node);
