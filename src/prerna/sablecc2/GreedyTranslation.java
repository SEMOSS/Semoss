...
public class GreedyTranslation extends LazyTranslation {
	...
	protected void deInitReactor() {
		...
		// value.. we should
		// possibly keep this as an object as well
		// - When the expression is typically added, it should add the components i.e.
		// the projectors to
		// the block and add the other portion of the code to the block to indicate
		...
		// frame if you would
		// like the to think of it that way..
