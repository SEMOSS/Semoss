...
public class ReplaceDatasourceTranslation extends AbstractDatasourceModificationTranslation {
      ...
      if (process) {
        ...
        if (this.replacementSourcePixel != null && this.origPixelPortion != null) {
          ...
          if (this.importQs != null && this.headerMods != null) {
            ...
            newExpression =
                this.replacementSourcePixel
                    + " | "
                    + QsToPixelConverter.getPixel(
                        QSRenameColumnConverter.convertQs(this.importQs, this.headerMods, true),
                        false)
                    + " | "
                    + this.importStr
                    + ";";
          ...
          expression =
              PixelUtility.recreateOriginalPixelExpression(
                  expression, encodingList, encodedToOriginal);
  ...
  //		String expression = "AddPanel ( 0 ) ;Panel ( 0 ) | AddPanelEvents ( { \"onSingleClick\" : {
