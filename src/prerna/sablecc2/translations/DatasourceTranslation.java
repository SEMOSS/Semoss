...
public class DatasourceTranslation extends AbstractDatasourceModificationTranslation {
	...
	// \"panel\" :
	// \"\" , \"query\" : \"UnfilterFrame(%3CSelectedColumn%3E)%3B\" , \"options\" :
	// { } , \"refresh\"
	// : false , \"default\" : true , \"disabledVisuals\" : [ \"Grid\" ] ,
	// \"disabled\" : false } ] }
	// , \"onBrush\" : { \"Filter\" : [ { \"panel\" : \"\" , \"query\" :
	// \"if(IsEmpty(%3CSelectedValues%3E)%2C%20UnfilterFrame(%3CSelectedColumn%3E)%2C%20SetFrameFilter(%3CSelectedColumn%3E%3D%3D%3CSelectedValues%3E))%3B\"
	// , \"options\" : { } , \"refresh\" : false , \"default\" : true , \"disabled\"
	// : false } ] } } ) ; "
	// + "Panel ( 0 ) | RetrievePanelEvents ( ) ; "
	// + "Panel ( 0 ) | SetPanelView ( \"visualization\" ,
	// \"%7B%22type%22%3A%22echarts%22%7D\" )
	// ; "
	// + "Panel ( 0 ) | SetPanelView ( \"federate-view\" ,
	// \"%7B%22core_engine%22%3A%22NEWSEMOSSAPP%22%7D\" ) ; "
	// + "CreateFrame ( Grid ) .as ( [ 'FRAME549443' ] ) ; "
	////				  + "GoogleSheetSource ( id=[ \"1EZbv_mXn_tnguDG02awFwQ30EqGMoWKZBflUVlcLgxY\" ] ,
	// sheetNames=[ \"diabetes\" ] , type=[ \".spreadsheet\" ] ) | Import ( ) ;"
	// +
	...
	// RottenTomatoes_Audience]) | Filter(DND__Genre == \"Drama\") |
	// Filter(DND__MovieBudget > 10) |Import ( ) ; "
	// + "Database(Movie_RDBMS) | Select(Title, Title__MovieBudget, Studio) |
	// Join((Title,
	...
	// [ \"Grid\" ]
	// ) | Collect ( 500 ) ; "
	////				  + "if ( ( HasDuplicates ( Drug ) ) , ( Select ( Drug , Average ( id ) ) .as ( [ Drug ,
	// Averageofid ] ) | Group ( Drug ) | With ( Panel ( 0 ) ) | Format ( type = [
	// 'table' ] ) |
	// TaskOptions ( { \"0\" : { \"layout\" : \"Pie\" , \"alignment\" : { \"label\"
	// : [ \"Drug\" ] ,
	// \"value\" : [ \"Averageofid\" ] , \"facet\" : [ ] } } } ) | Collect ( 500 ) )
	// , ( Select ( Drug
	// , id ) .as ( [ Drug , id ] ) | With ( Panel ( 0 ) ) | Format ( type = [
	// 'table' ] ) |
	// TaskOptions ( { \"0\" : { \"layout\" : \"Pie\" , \"alignment\" : { \"label\"
	// : [ \"Drug\" ] ,
	// \"value\" : [ \"id\" ] , \"facet\" : [ ] } } } ) | Collect ( 500 ) ) ) ; "
