...
public final class ASimpleScalarValues extends PValues
{
    private PScalar _scalar_;

    public ASimpleScalarValues()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimpleScalarValues(
    ...
    {
        ((Analysis) sw).caseASimpleScalarValues(this);
    }
