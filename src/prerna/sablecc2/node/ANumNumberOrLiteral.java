...
public final class ANumNumberOrLiteral extends PNumberOrLiteral
{
    private PDecimal _decimal_;

    public ANumNumberOrLiteral()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANumNumberOrLiteral(
    ...
    {
        ((Analysis) sw).caseANumNumberOrLiteral(this);
    }
