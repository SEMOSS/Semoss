...
public final class AExplicitRelComparator extends PExplicitRelComparator
{
    ...
    public Object clone()
    {
        return new AExplicitRelComparator(
    ...
    {
        ((Analysis) sw).caseAExplicitRelComparator(this);
    }
