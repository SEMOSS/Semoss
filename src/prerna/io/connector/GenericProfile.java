...
//	private static String jsonPattern = "[displayName,id,mail]";
	...
	@Override
	public String execute(User user, Map params) {
	...
	public static String fillAccessToken(AccessToken acToken, String userInfoURL, String beanProps, String jsonPattern, Map<String, Object> params, Boolean sanitizeResponse) {
		if(params == null) {
			params = new HashMap<>();
		}
