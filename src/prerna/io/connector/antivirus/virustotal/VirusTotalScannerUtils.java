...
public class VirusTotalScannerUtils implements IVirusScanner {
  ...
  private String uploadFileEndpoint(
      String name, InputStream is, String keyStore, String keyStorePass, String keyPass) {
   ...
   * @param keyStorePass
   */
  private Map<String, Collection<String>> analysesEndpoint(
      String analysisFileId, String name, String keyStore, String keyStorePass, String keyPass) {
    ...
    try {
      ...
      JsonObject jsonResponse = Json.parse(responseData).asObject();
      JsonObject dataAttributesJson =
          jsonResponse.get("data").asObject().get("attributes").asObject();
