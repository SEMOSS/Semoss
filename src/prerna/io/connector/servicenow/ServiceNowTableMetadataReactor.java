...
public class ServiceNowTableMetadataReactor extends AbstractReactor {
	...
	public NounMetadata execute() {
		...
		try {
			...
			Map<String, Object> tableMetadata = ServiceNowHelper.getTableMetadata(instanceURL, accessToken, table);
			return new NounMetadata(tableMetadata, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.OPERATION);
		} catch (Exception e) {
			classLogger.error("Error retrieving ServiceNow table metadata.", e);
	...
	public String getReactorDescription() {
		return "Fetches metadata (fields, schema details, and related information) for the specified ServiceNow table via OAuth authentication.";
	}
