...
public class TwitterSearcher implements IConnectorIOp {
	...
	String[] beanProps = {"review", "author", "authorId", "location", "repeatCount", "favCount", "followerCount"}; // add
																													// is
																													// done
																													// when
																													// you
	...
	public Object execute(User user, Map<String, Object> params) {
		...
		if (twitToken == null) {
			SemossPixelException exception = new SemossPixelException(new NounMetadata("Requires login to twiiter",
