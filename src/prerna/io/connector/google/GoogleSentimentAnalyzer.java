...
public class GoogleSentimentAnalyzer implements IConnectorIOp {
  ...
  String jsonPattern =
      "sentences[].{sentence: text.content, magnitude: sentiment.magnitude, score:sentiment.score}";
  ...
  public Object execute(User user, Map<String, Object> params) {
    ...
    Object returnObj =
        BeanFiller.fillFromJson(jsonString, jsonPattern, beanProps, new SentimentAnalysis());
    return returnObj;
  }
}
