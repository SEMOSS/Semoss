...
public class GetAllGoogleSheetsReactor extends AbstractReactor {
    ...
    private static final Logger classLogger = LogManager.getLogger(GoogleSpreadSheetAllDetailsReactorlsReactor.class);
    ...
    /**
	 * @param accessToken
	 * @return a list of all spreadsheets, their titles, and sheet names for the user.
	 */
    private List<Map<String, Object>> fetchSpreadsheetMetadata(String accessToken) {
        ...
        try {
            ...
            for (int i = 0; i < files.length(); i++) {
                ...
                String sheetsUrl = GOOGLESHEETS_URL + spreadsheetId + "?fields=sheets(properties(title))";
                ...
                // Store only the spreadsheet title and sheet names
