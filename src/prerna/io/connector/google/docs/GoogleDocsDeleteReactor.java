...
public class GoogleDocsDeleteReactor extends AbstractGoogleReactor {
	...
	protected NounMetadata executeAuthenticated() {
		...
		try {
			...
			classLogger.error("Error while deleting a Google Docs document", e);
			throw e;
		} catch (Exception e) {
			classLogger.error("Failed to delete a Google Docs document", e);
	...
	protected String getDescriptionForKey(String key) {
		if (key.equals(ReactorKeysEnum.ID.getKey())) {
			return "Unique identifier of the Google Docs document to delete (" + ReactorKeysEnum.ID.getKey() + ").";
		}
