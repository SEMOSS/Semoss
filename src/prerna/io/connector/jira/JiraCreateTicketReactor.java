...
public class JiraCreateTicketReactor extends AbstractReactor {
	...
	public NounMetadata execute() {
		try {
			...
			return JiraHelper.createIssue(user, projectKey, summary, nullSafe(description), issueType,
					nullSafe(assigneeAccountId), nullSafe(priority), nullSafe(dueDate), nullSafe(parentKey), nullSafe(status));
