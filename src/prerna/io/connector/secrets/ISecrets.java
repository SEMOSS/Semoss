...
public interface ISecrets {
   ...
   * @return
   */
  Map<String, Object> getEngineSecrets(
   ...
   * @return
   */
  Map<String, Object> getInsightEncryptionSecrets(
   ...
   * @return
   */
  boolean writeInsightEncryptionSecrets(
      String projectId, String projectName, String insightId, Map<String, Object> nameValuePairs);
}
