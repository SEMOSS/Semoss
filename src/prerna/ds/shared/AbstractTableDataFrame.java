...
public abstract class AbstractTableDataFrame implements ITableDataFrame {
  ...
  @Deprecated public static final String SELECTORS = "selectors";
  @Deprecated public static final String DE_DUP = "dedup";
  @Deprecated public static final String TEMPORAL_BINDINGS = "temporalBindings";
  ...
  protected transient Map<String, CachedIterator> queryCache =
      new HashMap<String, CachedIterator>();
  ...
  protected void saveMeta(
      CachePropFileFrameObject cf, String folderDir, String fileName, Cipher cipher)
      throws IOException {
    // save frame metadata
  ...
  public Iterator<List<Object[]>> scaledUniqueIterator(
      String columnName, List<String> attributeUniqueHeaderName) {
    ...
    ScaledUniqueFrameIterator iterator =
        new ScaledUniqueFrameIterator(
            this, columnName, max, min, dataTypes, attributeUniqueHeaderName);
    return iterator;
  }
  ...
  public Map<String, String> getScriptReactors() {
    ...
    //		reactorNames.put(PKQLReactor.DATA_FRAME_HEADER.toString(),
    // "prerna.sablecc.DataFrameHeaderReactor");
    //		reactorNames.put(PKQLEnum.COL_RENAME, "prerna.sablecc.ColRenameReactor");
    //		reactorNames.put(PKQLEnum.REMOTE_RDBMS_QUERY_API,
    // "prerna.sablecc.RemoteRdbmsQueryApiReactor");
    return reactorNames;
  }
  ...
  public void processPostTransformations(
    ...
    for (ISEMOSSTransformation transform : transforms) {
      ...
      transform.setDataMakerComponent(dmc);
      transform.runMethod();
      //			this.join(dataFrame, transform.getOptions().get(0).getSelected()+"",
      // transform.getOptions().get(1).getSelected()+"", 1.0, (IAnalyticRoutine)transform);
  ...
  public Object querySQL(String query) {
    throw new IllegalArgumentException(
        "Method not implemented for frame = " + this.getClass().getSimpleName());
  }
  ...
  //	@Override
  //	@Deprecated
  //	public List<Object> processActions(DataMakerComponent dmc, List<ISEMOSSAction> actions,
