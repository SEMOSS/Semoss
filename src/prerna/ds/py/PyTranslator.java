...
public class PyTranslator {
	 ...
	 *            If we have a User invoking an engine python process The engine
	 *            python process has its own unique insight for variable
	 *            encapsulation However, we need to know from what insight is the
	 *            user invoking this request So that if the engine is making a call
	 *            back/reactor request It knows which User invoked for security
	 *            permissions
	 * @param script
	 * @return
	 */
