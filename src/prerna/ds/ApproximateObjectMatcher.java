...
//
//public class ApproximateObjectMatcher implements IMatcher {
//
...
//	
//		List<TreeNode[]> results = performMatch(treeLevelIterator1, treeLevelIterator2, col1IsNumeric);
//		
//		return results;
//	}
//
//	private List<TreeNode[]> performMatch(IndexTreeIterator it1, IndexTreeIterator it2, boolean isNumeric) {		
...
//		while(it1.hasNext()) {
//			TreeNode table1ColVal = it1.next();
//			while(it2.hasNext()) {
//				TreeNode table2ColVal = it2.next();
//				boolean match = false;
//				
//				if(isNumeric) {
