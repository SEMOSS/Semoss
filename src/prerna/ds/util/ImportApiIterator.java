...
public class ImportApiIterator implements Iterator<IHeadersDataRow>{

	private ImportApiHelper helper;
	...
	public ImportApiIterator(String api, Map<String, String> dataTypeMap) throws IOException {
		this.helper = new ImportApiHelper();
		filters = new HashMap<String, Set<Object>>();
		helper.setApi(api);
		helper.parse();
