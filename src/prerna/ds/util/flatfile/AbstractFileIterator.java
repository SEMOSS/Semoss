...
public abstract class AbstractFileIterator implements IFileIterator {
	...
	/*
	 * Trying to hold a common interface between loading via csv file or loading via
	 * excel file
	 *
	 * Tried to shift the methods that do not use CSVFileHelper or XLFileHelper into
	 * this class to help reduce redundancies within the code
	 *
	 */
