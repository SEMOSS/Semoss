...
public abstract class AbstractTableGraphExporter extends AbstractGraphExporter {
	...
	/*
	 * This class is for abstracting out the methods required in processing the edge
	 * hash (how vertices are related to each other) within a table to export as a
	 * graph
	 */
	...
	/**
	 * Parse the edge hash to get lists of each individual node and relationship
	 * that we need to create an iterator for
	 *
	 * @param edgeHash
	 */
