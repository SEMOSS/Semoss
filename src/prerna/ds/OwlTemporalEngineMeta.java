...
public class OwlTemporalEngineMeta {
  ...
  /////////////////////////////////////////////////////////////////////
	...
	/**
	 * Currently, this is only used by tinker when on the meta we create a System_2
	 * node but the actual tinker vertices are type System
	 *
	 * @param vertexName
	 * @param physical
	 */
	...
	/*
	 * The following are used for native frame selectors which requires a bit more
	 * work since we need to construct the selector type to get the syntax
	 */
  ...
  /////////////////////////////////////////////////////////////////////
	...
	/**
	 * Need to validate if a unique name for a table or property is valid Return of
	 * true means it is valid Return of false means it is not valid
	 *
	 * @param uniqueName
	 * @return
	 */
	...
	/*
	 * Flush out the data from the OWL to a POJO This is the return we want from the
	...
	/**
	 * Get all upstream relationships to the node This means the input node is the
	 * target
	 *
	 * @param node
	 * @return
	...
	/**
	 * Get all downstream relationships to the node This means the input node is the
	 * source
	 *
	 * @param node
	 * @return
		...
		if (dataTypes == null || dataTypes.length == 0) {
			...
			for (int i = 0; i < dataTypes.length; i++) {
				...
				if (dataTypes[i].toUpperCase().equals("NUMBER")) {
					...
					filter.append("?dt = \"").append(SemossDataType.INT.toString()).append("\"").append(" || ")
							.append("?dt = \"").append(SemossDataType.DOUBLE.toString()).append("\"");
				} else {
	...
	public Map<String, Object> getComplexMetamodel() {
		...
		try {
			...
			while (it.hasNext()) {
				...
				Map<String, Map<String, Object>> propertiesMap = (Map<String, Map<String, Object>>) node
						.get("properties");
		...
		for (String key : nodesMap.keySet()) {
			Map<String, Map<String, Object>> properties = (Map<String, Map<String, Object>>) nodesMap.get(key)
					.get("properties");
	...
	/**
	 * Get the metamodel view of the data The payload should match:
  ...
  /////////////////////////////////////////////////////////////////////
	...
	public void modifyVertexName(String oldTableName, String newTableName) {
		/*
		 * This method is used in instances when we must modify the table name Mostly
		 * used when pushing a frame from H2 into R and vice versa Since the column
		 * names stay the same, but tablename/rvarname get modified
		 */
		...
		for (Object[] headerPropRow : headerProperties) {
			...
			String newPropertyUri = SEMOSS_PROPERTY_PREFIX + "/" + newTableName + "__"
	...
	public void dropProperty(String propertyName, String tableName) {
		/*
		 * This method is used in instances when we want to drop a column from a given
		 * table
		 */
  ...
  /////////////////////////////////////////////////////////////////////
	...
	// if (predStr.equals(RDFS.SUBCLASSOF.toString()) ||
	// predStr.equals(RDF.TYPE.toString()) ||
	// predStr.equals(SEMOSS_PROPERTY_PREFIX) ||
	// predStr.equals(RDFS.SUBPROPERTYOF.toString()) ||
