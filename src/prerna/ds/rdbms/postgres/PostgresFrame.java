...
public class PostgresFrame extends AbstractRdbmsFrame {
	...
	// FileInputStream(DIHelper.getInstance().getProperty(Constants.BASE_FOLDER) +
	// DIR_SEPARATOR +
	// CONFIGURATION_FILE)) {
	// Properties prop = new Properties();
	//
	...
	//
	// logger.info("host: " +
	// Utility.cleanLogString(prop.getProperty(POSTGRES_HOST)));
	// logger.info("port: " +
	// Utility.cleanLogString(prop.getProperty(POSTGRES_PORT)));
	// //logger.info("username: " +
	// Utility.cleanLogString(prop.getProperty(POSTGRES_USERNAME)));
	// //logger.info("password: " +
	// Utility.cleanLogString(prop.getProperty(POSTGRES_PASSWORD)));
	// } catch (IOException ex) {
