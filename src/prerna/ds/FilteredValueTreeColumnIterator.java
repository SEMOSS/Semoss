...
public class FilteredValueTreeColumnIterator implements Iterator<SimpleTreeNode>{
	 ...
	 */
	public FilteredValueTreeColumnIterator(TreeNode rootLevel) {
		iterator = new IndexTreeIterator(rootLevel);
		instances = new LinkedList<>();
		addInstances();
	}
	
//	public FilteredValueTreeColumnIterator(TreeNode rootLevel, boolean iterateAll) {
