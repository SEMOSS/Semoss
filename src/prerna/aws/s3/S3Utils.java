...
public class S3Utils {
  ...
  public static String[] addCommonS3Keys(String[] additionalKeys) {
    String[] base =
        new String[] {ENDPOINT, REGION, CONFIG_PATH, PROFILE, ACCESS_KEY, SECRET, NO_DEFAULT_CREDS};
  ...
  public static String getDescriptionForCommonS3Key(String key) {
    if (key.equals(ENDPOINT)) {
      ...
      return "Region name for request signing and service endpoint modification. Defaults to "
