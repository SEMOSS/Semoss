	...
	public boolean deleteUser(String userIdToDelete, String userTypeToDelete) {
		...
		// TODO: need to start binding on userId + type
		{
			String[] deleteQueries = new String[] { "DELETE FROM ENGINEPERMISSION WHERE USERID=?",
					...
					"DELETE FROM SMSS_USER_ACCESS_KEYS WHERE USERID=?", "DELETE FROM SMSS_USER WHERE ID=?", };
...
//		}
	 ...
	 * @throws IllegalAccessException
	 */
	public static void editEngineUserPermissions(String engineId, List<Map<String, String>> requests, User user,
...
//		}
	 ...
	 * @param endDate
	 */
	public static void approveEngineUserAccessRequests(String userId, String userType, String engineId,
	 ...
	 * @param requests
	 */
	public static void denyEngineUserAccessRequests(String userId, String userType, String engineId,
	 ...
	 * @param endDate
	 */
	public static void approveProjectUserAccessRequests(String userId, String userType, String projectId,
			List<Map<String, Object>> requests, String endDate) {
		Timestamp startDate = Utility.getCurrentSqlTimestampUTC();
		Timestamp verifiedEndDate = null;
		if (endDate != null) {
	 ...
	 * @param requests
	 */
	public static void denyProjectUserAccessRequests(String userId, String userType, String projectId,
	 ...
	 * @param endDate
	 */
	public static void approveInsightUserAccessRequests(String userId, String userType, String projectId,
			String insightId, List<Map<String, Object>> requests, String endDate) {
		Timestamp startDate = Utility.getCurrentSqlTimestampUTC();
		Timestamp verifiedEndDate = null;
		if (endDate != null) {
			verifiedEndDate = AbstractSecurityUtils.calculateEndDate(endDate);
	 ...
	 * @param requests
	 */
	public static void denyInsightUserAccessRequests(String userId, String userType, String projectId, String insightId,
			List<String> RequestIdList) {
