...
public class SecurityAdminUtils extends AbstractSecurityUtils {
	...
	public static Boolean userIsAdmin(User user) {
		...
		// String query = "SELECT * FROM SMSS_USER WHERE ADMIN=TRUE AND ID IN " +
		// userFilters + " LIMIT
		// 1;";
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 *
	 * @param userId
	 *            String - The user id we are providing permissions to
	 * @param permission
	 *            String - The permission level for the access
	 * @param isAddNew
	 *            boolean - If false, modifying existing project permissions to the
	 *            new permission level If true, adding new projects with the
	...
	public void grantAllEngines(String userId, String permission, boolean isAddNew, List<String> engineTypes,
			User user) {
		String logETypes = (engineTypes == null || engineTypes.isEmpty())
				? "[ALL]"
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////
	...
	public List<Object[]> getUserEmailsGettingLocked() {
		...
		// String dateDiff = queryUtil.getDateDiffFunctionSyntax("day",
		// "SMSS_USER.LASTLOGIN",
		// queryUtil.getCurrentSqlTimestampUTC());
		//
		// String query = "SELECT DISTINCT SMSS_USER.EMAIL, (" + dateDiff + ") as
		// DAYS_SINCE_LASTLOGIN
		// FROM SMSS_USER WHERE "
		// + "(LOCKED IS NULL OR LOCKED='false') AND (" + dateDiff + ") > " +
		// (daysToLock -
		// daysToLockEmail);
		//
		// IRawSelectWrapper wrapper = null;
