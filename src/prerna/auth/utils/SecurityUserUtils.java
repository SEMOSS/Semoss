...
public class SecurityUserUtils extends AbstractSecurityUtils {
	...
	public static boolean updateMetakeyOptions(List<Map<String, Object>> metaoptions) {
		...
		try {
			...
			insertPs = securityDb
					.bulkInsertPreparedStatement(new Object[]{"USERMETAKEYS", Constants.METAKEY, Constants.SINGLE_MULTI,
							Constants.DISPLAY_ORDER, Constants.DISPLAY_OPTIONS, Constants.DEFAULT_VALUES});
