...
class SecurityUserProjectUtils extends AbstractSecurityUtils {
  ...
  public static String getHighestProjectPermission(
  ...
  public static List<Map<String, Object>> getProjectUsers(
    ...
    qs.addSelector(
        new QueryColumnSelector("PROJECTPERMISSION__PERMISSIONGRANTEDBY", "permission_granted_by"));
    qs.addSelector(
        new QueryColumnSelector(
            "PROJECTPERMISSION__PERMISSIONGRANTEDBYTYPE", "permission_granted_by_type"));
   ...
   * @param userId
   */
  public static boolean projectPermissionIsExpired(String userId, String projectId)
      throws Exception {
