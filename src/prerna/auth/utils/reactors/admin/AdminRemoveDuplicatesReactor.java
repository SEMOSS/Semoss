...
public class AdminRemoveDuplicatesReactor extends AbstractReactor {
  ...
  public AdminRemoveDuplicatesReactor() {
    this.keysToGet =
        new String[] {
          ReactorKeysEnum.DATABASE.getKey(), ReactorKeysEnum.TABLE.getKey(), DROP_OLD_TABLE
        };
  }
  ...
  public NounMetadata execute() {
    ...
    String oldTableName =
        "OLD_" + tableName + "_" + Utility.getLocalDateTimeUTC(LocalDateTime.now());
    ...
    return new NounMetadata(
        "Time to complete the operation = " + (end - start) + "ms", PixelDataType.CONST_STRING);
  }
}
