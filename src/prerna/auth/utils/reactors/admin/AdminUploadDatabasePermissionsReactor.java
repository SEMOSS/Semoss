...
public class AdminUploadDatabasePermissionsReactor extends AbstractReactor {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(AdminUploadDatabasePermissionsReactor.class);
  ...
  private void loadExcelFile(
      Connection conn, AbstractSqlQueryUtil queryUtil, ExcelSheetFileIterator helper)
      throws Exception {
    ...
    try {
      ...
      while ((helper.hasNext())) {
        ...
        if (permission == null) {
          throw new IllegalArgumentException(
              "Must have a valid permission role - check row " + counter);
        }
