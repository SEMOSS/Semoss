...
public class RemoveProjectTeamTokenLimitReactor extends AbstractPrincipalTokenLimitReactor {

	public RemoveProjectTeamTokenLimitReactor() {
	...
	public NounMetadata execute() {
		...
		SecurityPrincipalTokenLimitUtils.removeProjectTeamTokenLimit(value(GROUP_ID_KEY), value(GROUP_TYPE_KEY),
				projectId, value(SCOPED_ENGINE_ID_KEY), usageFrequency);
