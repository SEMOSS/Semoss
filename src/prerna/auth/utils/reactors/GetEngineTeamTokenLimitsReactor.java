...
public class GetEngineTeamTokenLimitsReactor extends AbstractPrincipalTokenLimitReactor {

	public GetEngineTeamTokenLimitsReactor() {
		this.keysToGet = new String[] { ENGINE_ID_KEY, GROUP_ID_KEY, GROUP_TYPE_KEY };
	}
