...
public class SecurityShareSessionUtils extends AbstractSecurityUtils {
   ...
   * @throws SQLException
   */
  public static String createShareToken(User user, String sessionId, String routeId)
      throws SQLException {
   ...
   * @throws SQLException
   */
  public static String createAuthToken(User user, String sessionId, String routeId)
      throws SQLException {
  ...
  public static String createToken(
      User user, String sessionId, String routeId, boolean sessionToken, boolean authToken)
      throws SQLException {
   ...
   * @throws SQLException
   */
  public static String logSessionUsed(String shareToken, ZonedDateTime zdt, boolean success)
      throws SQLException {
    PreparedStatement ps = null;
    try {
      ps =
   ...
   */
  public static AccessToken generateAccessTokenForShareAuth(Object[] shareDetails)
      throws IllegalAccessException {
    int index = 0;
    String shareToken = (String) shareDetails[index++];
    String sessionVal = (String) shareDetails[index++];
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(SMSS_USER_USERTYPE_COL, "==", userType));
