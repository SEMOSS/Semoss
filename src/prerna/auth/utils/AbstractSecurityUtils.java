	...
	public static void initialize() throws Exception {
		...
		try {
			...
			colNames = new String[] { "ENGINEID", "MODELID", "CATALOGMODELKEY", "MODELPROVIDER", "SERVINGPROVIDER",
					...
					"INPUTTOKENCREDIT", "OUTPUTTOKENCREDIT", "CACHETOKENREADMULTIPLIER", "CACHETOKENWRITEMULTIPLIER",
					"PRICING" };
			types = new String[] { VARCHAR_255, VARCHAR_255, VARCHAR_255, VARCHAR_255, VARCHAR_255, VARCHAR_255,
					...
					CLOB_DATATYPE_NAME, DOBLE_DATATYPE_NAME, DOBLE_DATATYPE_NAME, DOBLE_DATATYPE_NAME,
					DOBLE_DATATYPE_NAME, CLOB_DATATYPE_NAME };
			if (allowIfExistsTable) {
			...
			colNames = new String[] { "USERID", "PERMISSION", "ENGINEID", "VISIBILITY", "FAVORITE",
					...
					"MAXTOKENS", "MAXRESPONSETIME", "USAGEFREQUENCY", "MAXCREDITS" };
			types = new String[] { VARCHAR_255, INTEGER_DATATYPE_NAME, VARCHAR_255, BOOLEAN_DATATYPE_NAME,
					...
					VARCHAR_255, INTEGER_DATATYPE_NAME, DOBLE_DATATYPE_NAME, VARCHAR_255, DOBLE_DATATYPE_NAME };
			...
			colNames = new String[] { "NAME", "EMAIL", "TYPE", "ID", "PASSWORD", "SALT", "USERNAME", "ADMIN",
					...
					"MODELUSAGEFREQUENCY", "MODELMAXCREDITS" };
			types = new String[] { VARCHAR_255, VARCHAR_255, VARCHAR_255, VARCHAR_255, VARCHAR_255, VARCHAR_255,
					...
					VARCHAR_255, DOBLE_DATATYPE_NAME };
			...
			colNames = new String[] { "ID", "TYPE", "DESCRIPTION", "DATEADDED", "USERID", "USERIDTYPE",
					...
					"MODELMAXCREDITS", "GROUPBUDGETTYPE" };
			types = new String[] { VARCHAR_255, VARCHAR_255, CLOB_DATATYPE_NAME, TIMESTAMP_DATATYPE_NAME, VARCHAR_255,
					VARCHAR_255, VARCHAR_255, VARCHAR_255, INTEGER_DATATYPE_NAME, DOBLE_DATATYPE_NAME,
					DOBLE_DATATYPE_NAME, VARCHAR_255 };
			if (allowIfExistsTable) {
			...
			colNames = new String[] { "ID", "TYPE", "ENGINEID", "PERMISSION", "DATEADDED", "ENDDATE",
					...
					"MAXTOKENS", "MAXRESPONSETIME", "MAXCREDITS", "GROUPBUDGETTYPE" };
			types = new String[] { VARCHAR_255, VARCHAR_255, VARCHAR_255, INTEGER_DATATYPE_NAME,
					TIMESTAMP_DATATYPE_NAME, TIMESTAMP_DATATYPE_NAME, VARCHAR_255, VARCHAR_255, VARCHAR_255,
					VARCHAR_255, INTEGER_DATATYPE_NAME, DOBLE_DATATYPE_NAME, DOBLE_DATATYPE_NAME, VARCHAR_255 };
			if (allowIfExistsTable) {
