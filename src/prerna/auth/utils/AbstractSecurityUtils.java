...
public abstract class AbstractSecurityUtils {
	...
	public static void initialize() throws Exception {
		...
		try {
			...
			// ENGINEPERMISSION
			colNames = new String[]{"USERID", "PERMISSION", "ENGINEID", "VISIBILITY", "FAVORITE", "PERMISSIONGRANTEDBY",
					"PERMISSIONGRANTEDBYTYPE", "DATEADDED", "ENDDATE", "USAGERESTRICTION", "MAXTOKENS",
					"MAXRESPONSETIME", "USAGEFREQUENCY"};
			types = new String[]{"VARCHAR(255)", INTEGER_DATATYPE_NAME, "VARCHAR(255)", BOOLEAN_DATATYPE_NAME,
					...
					"VARCHAR(255)"};
			defaultValues = new Object[]{null, null, null, true, false, null, null, null, null, null, null, null, null};
			if (allowIfExistsTable) {
			...
			colNames = new String[]{"PROJECTNAME", "PROJECTID", "GLOBAL", "DISCOVERABLE", "CREATEDBY", "CREATEDBYTYPE",
					"DATECREATED", "DATELASTEDITED", "TYPE", "COST", "CATALOGNAME", "HASPORTAL", "PORTALNAME",
			...
			colNames = new String[]{"USERID", "PROJECTID", "INSIGHTID", "PERMISSION", "FAVORITE", "PERMISSIONGRANTEDBY",
					"PERMISSIONGRANTEDBYTYPE", "DATEADDED", "ENDDATE"};
			...
			colNames = new String[]{"NAME", "EMAIL", "TYPE", "ID", "PASSWORD", "SALT", "USERNAME", "ADMIN", "PUBLISHER",
					"EXPORTER", "DATECREATED", "LASTLOGIN", "LASTPASSWORDRESET", "LOCKED", "PHONE", "PHONEEXTENSION",
					"COUNTRYCODE", "MODELUSAGERESTRICTION", "MODELMAXTOKENS", "MODELMAXRESPONSETIME",
					"MODELUSAGEFREQUENCY"};
			types = new String[]{"VARCHAR(255)", "VARCHAR(255)", "VARCHAR(255)", "VARCHAR(255)", "VARCHAR(255)",
			...
			colNames = new String[]{"USERID", "TYPE", "ACCESSKEY", "SECRETKEY", "SECRETSALT", "DATECREATED", "LASTUSED",
			...
			colNames = new String[]{"ID", "TYPE", "PROJECTID", "INSIGHTID", "PERMISSION", "DATEADDED", "ENDDATE",
					"PERMISSIONGRANTEDBY", "PERMISSIONGRANTEDBYTYPE"};
			types = new String[]{"VARCHAR(255)", "VARCHAR(255)", "VARCHAR(255)", "VARCHAR(255)", INTEGER_DATATYPE_NAME,
					TIMESTAMP_DATATYPE_NAME, TIMESTAMP_DATATYPE_NAME, "VARCHAR(255)", "VARCHAR(255)"};
			if (allowIfExistsTable) {
				...
				try {
					...
					if (wrapper.hasNext()) {
						...
						if (numrows > 3) {
							...
							securityDb.insertData(
									queryUtil.insertIntoTable("PERMISSION", colNames, types, new Object[]{1, "OWNER"}));
							securityDb.insertData(
									queryUtil.insertIntoTable("PERMISSION", colNames, types, new Object[]{2, "EDIT"}));
