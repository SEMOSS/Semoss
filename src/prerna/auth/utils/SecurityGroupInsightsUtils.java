...
public class SecurityGroupInsightsUtils extends AbstractSecurityUtils {
	...
	// * @return
	// */
	// public static boolean userCanViewInsight(User user, String projectId, String
	// insightId) {
	// Integer bestUserInsightPermission = getBestInsightPermission(user, projectId,
	// insightId);
	...
	// * @return
	// */
	// public static boolean userCanEditInsight(User user, String projectId, String
	// insightId) {
	// Integer bestUserInsightPermission = getBestInsightPermission(user, projectId,
	// insightId);
	// return bestUserInsightPermission != null &&
	...
	//
	// /**
	// * Determine if the user is the owner of an insight including group
	// permissions
	// * @param userFilters
	// * @param insightId
	// * @return
	// */
	// public static boolean userIsOwner(User user, String projectId, String
	// insightId) {
	// Integer bestUserInsightPermission = getBestInsightPermission(user, projectId,
	// insightId);
	// return bestUserInsightPermission != null &&
