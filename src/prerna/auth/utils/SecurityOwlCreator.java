...
public class SecurityOwlCreator extends AbstractOwlCreator {
	...
	public void createColumnsAndTypes(AbstractSqlQueryUtil queryUtil) {
		...
		addTable("MODELMETADATA", Arrays.asList(
				...
				Pair.with("INPUTTOKENCREDIT", DOUBLE_DATATYPE_NAME),
				Pair.with("OUTPUTTOKENCREDIT", DOUBLE_DATATYPE_NAME),
				Pair.with("CACHETOKENREADMULTIPLIER", DOUBLE_DATATYPE_NAME),
				Pair.with("CACHETOKENWRITEMULTIPLIER", DOUBLE_DATATYPE_NAME),
				Pair.with("BATCHINPUTTOKENCREDIT", DOUBLE_DATATYPE_NAME),
				Pair.with("BATCHOUTPUTTOKENCREDIT", DOUBLE_DATATYPE_NAME),
		...
		addTable("ENGINEPERMISSION", Arrays.asList(
				...
				Pair.with("MAXCREDITS", DOUBLE_DATATYPE_NAME)));
		...
		addTable("SMSS_USER", Arrays.asList(
				...
				Pair.with("MODELMAXCREDITS", DOUBLE_DATATYPE_NAME)));
