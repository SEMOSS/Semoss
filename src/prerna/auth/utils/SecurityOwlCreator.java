...
public class SecurityOwlCreator {
	...
	private void writeNewOwl(WriteOWLEngine owler) throws Exception {
		...
		owler.addRelation("SMSS_GROUP", "ENGINETEAMTOKENLIMIT", "SMSS_GROUP.ID.ENGINETEAMTOKENLIMIT.GROUP_ID");
		owler.addRelation("SMSS_GROUP", "ENGINETEAMTOKENLIMIT", "SMSS_GROUP.TYPE.ENGINETEAMTOKENLIMIT.GROUP_TYPE");
		owler.addRelation("ENGINE", "ENGINETEAMTOKENLIMIT", "ENGINE.ENGINEID.ENGINETEAMTOKENLIMIT.ENGINE_ID");
		...
		owler.addRelation("SMSS_GROUP", "PROJECTTEAMTOKENLIMIT", "SMSS_GROUP.ID.PROJECTTEAMTOKENLIMIT.GROUP_ID");
		owler.addRelation("SMSS_GROUP", "PROJECTTEAMTOKENLIMIT", "SMSS_GROUP.TYPE.PROJECTTEAMTOKENLIMIT.GROUP_TYPE");
		owler.addRelation("PROJECT", "PROJECTTEAMTOKENLIMIT", "PROJECT.PROJECTID.PROJECTTEAMTOKENLIMIT.PROJECT_ID");
		owler.addRelation("ENGINE", "PROJECTTEAMTOKENLIMIT", "ENGINE.ENGINEID.PROJECTTEAMTOKENLIMIT.ENGINE_ID");
