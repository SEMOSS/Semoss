...
public class SecurityPasswordResetUtils extends AbstractSecurityUtils {
  ...
  public static String allowUserResetPassword(String email, String type) throws Exception {
    ...
    if (!SecurityPasswordResetUtils.userEmailExists(email, provider.toString())) {
      throw new IllegalArgumentException(
          "The email '" + email + "' does not exist for provider " + provider);
    }
    ...
    try {
      ...
      classLogger.error(Constants.STACKTRACE, e);
      throw new IllegalArgumentException(
          "Error occurred inserting the request to update the password");
    } finally {
      if (ps != null) {
        ps.close();
      }
   ...
   * @throws Exception
   */
  public static Map<String, Object> userResetPassword(String token, String newPassword)
      throws Exception {
    ...
    if (provider == AuthProvider.NATIVE) {
      ...
      throw new IllegalArgumentException(
          "The ability to update the password for this provider ("
              + type
