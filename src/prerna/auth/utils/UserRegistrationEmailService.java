...
public class UserRegistrationEmailService {
  ...
  public boolean sendPasswordResetRequestEmail(
      String recipient, String customUrl, String customEmailSubject) {
    ...
    try {
      message =
          new String(
              Files.readAllBytes(Paths.get(this.emailTemplatesFolder + "passResetRequest.html")));
  ...
  public boolean sendPasswordResetSuccessEmail(String recipient, String customEmailSubject) {
    ...
    try {
      message =
          new String(
              Files.readAllBytes(Paths.get(this.emailTemplatesFolder + "passResetSuccess.html")));
    } catch (IOException e) {
      logger.error(Constants.STACKTRACE, e);
      return false;
    }
