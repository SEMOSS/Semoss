...
public class SecurityEngineUtils extends AbstractSecurityUtils {
   ...
   *
   * @param engineId
   *     <p>PLEASE DEFINE GLOBAL {@link #addEngine(String, boolean, User)}
   */
  @Deprecated
  ...
  public static void addEngine(String engineId, boolean global, User user) {
    ...
    String smssFile =
        DIHelper.getInstance().getEngineProperty(engineId + "_" + Constants.STORE) + "";
    ...
    if (engineExists) {
      ...
      updateEngineTypeAndSubType(
          engineId, (IEngine.CATALOG_TYPE) typeAndCost[0], (String) typeAndCost[1]);
      classLogger.info(
          "Security database already contains engine of type "
              + typeAndCost[0]
              + " with unique id = "
      ...
      addEngine(
          engineId,
          engineName,
          (IEngine.CATALOG_TYPE) typeAndCost[0],
          (String) typeAndCost[1],
          (String) typeAndCost[2],
          global,
          user);
    }
  ...
  /**
   * Utility method to get the engine type, subtype, and cost This returns ENGINETYPE as the enum
   * IEngine.CATALOG_TYPE and not the String format it is stored in
   *
   * @param prop
   * @return
   */
  ...
  /**
   * This returns ENGINETYPE as the enum IEngine.CATALOG_TYPE and not the String format it is stored
   * in
   *
   * @param engineId
   * @return
  ...
  public static void addEngine(
      ...
      User user) {
    String query =
        "INSERT INTO ENGINE (ENGINEID, ENGINENAME, ENGINETYPE, ENGINESUBTYPE, COST, GLOBAL, DISCOVERABLE, CREATEDBY, CREATEDBYTYPE, DATECREATED) "
            + "VALUES (?,?,?,?,?,?,?,?,?,?)";
  ...
  public static void updateEngineTypeAndSubType(
      String engineId, IEngine.CATALOG_TYPE engineType, String engineSubType) {
  ...
  public static void addEngineOwner(String engineId, String userId) {
    String query =
        "INSERT INTO ENGINEPERMISSION (USERID, PERMISSION, ENGINEID, VISIBILITY, DATEADDED) VALUES (?,?,?,?,?)";
  ...
  public static String getActualUserEnginePermission(User user, String engineId) {
    ...
    List<String> groupUserPermissions =
        SecurityUserEngineUtils.getActualGroupUserEnginePermission(user, engineId);
      ...
      qs1.addSelector(new QueryColumnSelector("ENGINE__ENGINEID"));
      {
        ...
        orFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                "ENGINE__DISCOVERABLE", "==", Arrays.asList(true, null), PixelDataType.BOOLEAN));
        orFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                "ENGINEPERMISSION__USERID", "==", getUserFiltersQs(user)));
  ...
  public static Integer getUserAccessRequestEnginePermission(String userId, String databaseId) {
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("ENGINEACCESSREQUEST__ENGINEID", "==", databaseId));
    qs.addExplicitFilter(
   ...
   * @param requests
   */
  public static void approveEngineUserAccessRequests(
      User user, String engineId, List<Map<String, String>> requests, String endDate)
    ...
    if (!AccessPermissionEnum.isEditor(userPermissionLvl)) {
      throw new IllegalAccessException(
          "Insufficient privileges to modify this engine's permissions.");
    }
   ...
   * @param requests
   */
  public static void denyEngineUserAccessRequests(
      User user, String engineId, List<String> requestIds) throws IllegalAccessException {
  ...
  public static List<Map<String, Object>> getUserAccessRequestsByEngine(String engineId) {
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("ENGINEACCESSREQUEST__ENGINEID", "==", engineId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
  ...
  public static List<Map<String, Object>> getEngineUsers(
      User user, String engineId, String searchParam, String permission, long limit, long offset)
      throws IllegalAccessException {
   ...
   * @throws IllegalAccessException
   */
  public static long getEngineUsersCount(
      User user, String engineId, String searchParam, String permission)
      throws IllegalAccessException {
    if (!userCanViewEngine(user, engineId)) {
      throw new IllegalAccessException("The user does not have access to view this engine");
    }
   ...
   * @throws IllegalAccessException
   */
  public static void addEngineUser(
      User user,
      String newUserId,
      String engineId,
      String permission,
   ...
   * @throws IllegalAccessException
   */
  public static void addEngineUserPermissions(
      User user, String engineId, List<Map<String, Object>> permission)
      throws IllegalAccessException {
    // make sure user can edit the database
    int userPermissionLvl = getMaxUserEnginePermission(user, engineId);
    if (!AccessPermissionEnum.isEditor(userPermissionLvl)) {
   ...
   * @throws IllegalAccessException
   */
  public static void editEngineUserPermission(
      User user,
  ...
  public static void editEngineUserPermissions(
    ...
    if (!AccessPermissionEnum.isEditor(userPermissionLvl)) {
      throw new IllegalAccessException(
          "Insufficient privileges to modify this database's permissions.");
    }
    ...
    if (!AccessPermissionEnum.isOwner(userPermissionLvl)) {
      ...
      for (Map<String, Object> req : permission) {
        if (AccessPermissionEnum.OWNER.getId()
            == AccessPermissionEnum.getIdByPermission((String) req.get("permission"))) {
          throw new IllegalArgumentException(
  ...
  public static void removeEngineUser(User user, String existingUserId, String engineId)
    ...
    try {
      ...
      classLogger.error(Constants.STACKTRACE, e);
      throw new IllegalArgumentException(
          "An error occurred removing the user permissions for this engine");
    } finally {
      ConnectionUtils.closeAllConnectionsIfPooling(securityDb, ps);
    }
  }
   ...
   * @throws IllegalAccessException
   */
  public static boolean setEngineGlobal(User user, String engineId, boolean global)
      throws IllegalAccessException {
  ...
  public static void setEngineVisibility(User user, String engineId, boolean visibility)
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("ENGINEPERMISSION__ENGINEID", "==", engineId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("ENGINEPERMISSION__USERID", "==", userIdFilters));
    ...
    try {
      ...
      if (wrapper.hasNext()) {
        ...
        PreparedStatement ps =
            securityDb.getPreparedStatement(
                "UPDATE ENGINEPERMISSION SET VISIBILITY=? WHERE USERID=?");
        if (ps == null) {
          throw new IllegalArgumentException(
              "Error generating prepared statement to set engine visibility");
        }
        try {
  ...
  /**
   * Change the user favorite (is favorite / not favorite) for an engine. Without removing its
   * permissions.
   *
   * @param user
   * @param engineId
  ...
  public static void setEngineFavorite(User user, String engineId, boolean isFavorite)
    ...
    try {
      ...
      if (wrapper.hasNext()) {
        ...
        PreparedStatement ps =
            securityDb.getPreparedStatement(
                "UPDATE ENGINEPERMISSION SET FAVORITE=? WHERE USERID=? AND ENGINEID=?");
        if (ps == null) {
          throw new IllegalArgumentException(
              "Error generating prepared statement to set engine favorites");
        }
        try {
          // we will set the permission to read only
          for (AuthProvider loginType : user.getLogins()) {
  ...
  /**
   * Update the engine metadata Will delete existing values and then perform a bulk insert
   *
   * @param engineId
   * @param insightId
   * @param tags
    ...
    String query =
        securityDb
            ...
            .createInsertPreparedStatementString(
                "ENGINEMETA", new String[] {"ENGINEID", "METAKEY", "METAVALUE", "METAORDER"});
    PreparedStatement ps = null;
    try {
      ps = securityDb.getPreparedStatement(query);
      for (String field : metadata.keySet()) {
   ...
   * @throws Exception
   */
  public static IRawSelectWrapper getEngineMetadataWrapper(
      Collection<String> engineIds, List<String> metaKeys, boolean ignoreMarkdown)
      throws Exception {
    SelectQueryStruct qs = new SelectQueryStruct();
    // selectors
    ...
    if (engineIds != null && !engineIds.isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINEMETA__ENGINEID", "==", engineIds));
    }
    if (metaKeys != null && !metaKeys.isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINEMETA__METAKEY", "==", metaKeys));
    }
   ...
   * @return
   */
  public static Map<String, Object> getAggregateEngineMetadata(
      String engineId, List<String> metaKeys, boolean ignoreMarkdown) {
   ...
   * @throws Exception
   */
  public static boolean checkUserHasAccessToDatabase(String engineId, String userId)
      throws Exception {
   ...
   * @throws Exception
   */
  public static void copyEnginePermissions(String sourceEngineId, String targetEngineId)
      throws Exception {

    String insertTargetEnginePermissionSql =
        "INSERT INTO ENGINEPERMISSION (ENGINEID, USERID, PERMISSION, VISIBILITY, USAGERESTRICTION, USAGEFREQUENCY, MAXTOKENS, MAXRESPONSETIME) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    PreparedStatement insertTargetEnginePermissionStatement =
        securityDb.getPreparedStatement(insertTargetEnginePermissionSql);
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("ENGINEPERMISSION__ENGINEID", "==", sourceEngineId));
    IRawSelectWrapper wrapper = null;
    try {
      wrapper = WrapperManager.getInstance().getRawWrapper(securityDb, qs);
      while (wrapper.hasNext()) {
    ...
    try {
      ...
      ConnectionUtils.closeAllConnectionsIfPooling(
          securityDb, insertTargetEnginePermissionStatement);
    }
  }
   ...
   * @return
   */
  public static List<Map<String, Object>> getEngineUsersNoCredentials(
      User user, String engineId, String searchTerm, long limit, long offset)
      throws IllegalAccessException {
    /*
  ...
  public static boolean engineIsDiscoverable(String engineId) {
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "ENGINE__DISCOVERABLE", "==", true, PixelDataType.BOOLEAN));
    qs.addExplicitFilter(SimpleQueryFilter.makeColToValFilter("ENGINE__ENGINEID", "==", engineId));
    IRawSelectWrapper wrapper = null;
    try {
      wrapper = WrapperManager.getInstance().getRawWrapper(securityDb, qs);
  ...
  public static void setUserAccessRequest(
      ...
      String userType,
      String engineId,
      String requestReasonComment,
      int permission,
      User user) {
    // first mark previously undecided requests as old
    String updateQ =
        "UPDATE ENGINEACCESSREQUEST SET APPROVER_DECISION = 'OLD' WHERE REQUEST_USERID=? AND REQUEST_TYPE=? AND ENGINEID=? AND APPROVER_DECISION='NEW_REQUEST'";
    PreparedStatement updatePs = null;
    ...
    String insertQ =
        "INSERT INTO ENGINEACCESSREQUEST "
    ...
    try {
      ...
      securityQueryUtil.handleInsertionOfClob(
          insertPs.getConnection(), insertPs, requestReasonComment, index++, new Gson());
  ...
  public static int getUserPendingAccessRequest(User user, String engineId) {
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "ENGINEACCESSREQUEST__REQUEST_USERID", "==", requesterDetails.getValue0()));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "ENGINEACCESSREQUEST__REQUEST_TYPE", "==", requesterDetails.getValue1()));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("ENGINEACCESSREQUEST__ENGINEID", "==", engineId));
   ...
   * @throws Exception
   */
  public static List<Map<String, Object>> getUserRequestableEngines(
      Collection<String> allUserEngines) {
    SelectQueryStruct qs = new SelectQueryStruct();
    qs.addSelector(new QueryColumnSelector("ENGINE__ENGINEID"));
    qs.addSelector(new QueryColumnSelector("ENGINE__ENGINENAME"));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("ENGINE__ENGINEID", "!=", allUserEngines));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "ENGINE__DISCOVERABLE", "==", true, PixelDataType.BOOLEAN));
    return QueryExecutionUtility.flushRsToMap(securityDb, qs);
  ...
  public static List<Map<String, Object>> getUserEngineList(
      User user,
  ...
  public static List<Map<String, Object>> getUserEngineList(
    ...
    // add a join to get the user permission level, if favorite, and the visibility
    {
      ...
      QueryFunctionSelector castFavorite =
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.CAST, "ENGINEPERMISSION__FAVORITE", "castFavorite");
      ...
      QueryFunctionSelector castVisibility =
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.CAST, "ENGINEPERMISSION__VISIBILITY", "castVisibility");
      ...
      qs2.addSelector(
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.MIN, "ENGINEPERMISSION__PERMISSION", "PERMISSION"));
      qs2.addGroupBy(new QueryColumnSelector("ENGINEPERMISSION__ENGINEID", "ENGINEID"));
      qs2.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINEPERMISSION__USERID", "==", userIds));
      IRelation subQuery =
          new SubqueryRelationship(
              qs2,
              "USER_PERMISSIONS",
    ...
    // add a join to get the group permission level
    {
      ...
      qs3.addSelector(
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.MIN, groupEnginePermission + "PERMISSION", "PERMISSION"));
      ...
      for (AuthProvider login : logins) {
        ...
        andFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupEnginePermission + "TYPE",
                "==",
                user.getAccessToken(login).getUserGroupType()));
        andFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupEnginePermission + "ID", "==", user.getAccessToken(login).getUserGroups()));
      ...
      if (!groupEngineOrFilters.isEmpty()) {
        ...
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(groupEnginePermission + "TYPE", "==", null));
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(groupEnginePermission + "ID", "==", null));
    ...
    if (engineIdFilters != null && !engineIdFilters.isEmpty()) {
      qs1.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINE__ENGINEID", "==", engineIdFilters));
    }
    if (engineTypes != null && !engineTypes.isEmpty()) {
      qs1.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINE__ENGINETYPE", "==", engineTypes));
    ...
    OrQueryFilter orFilter = new OrQueryFilter();
    {
      orFilter.addFilter(
          SimpleQueryFilter.makeColToValFilter(
              "ENGINE__GLOBAL", "==", true, PixelDataType.BOOLEAN));
      orFilter.addFilter(
          SimpleQueryFilter.makeColToValFilter(
              "USER_PERMISSIONS__PERMISSION", "!=", null, PixelDataType.CONST_INT));
      qs1.addExplicitFilter(orFilter);
    ...
    // group permissions
    {
      ...
      if (!groupEngineOrFilters.isEmpty()) {
        ...
        orFilter.addFilter(
            SimpleQueryFilter.makeColToSubQuery(enginePrefix + "ENGINEID", "==", subQs));
   ...
   * @return
   */
  public static List<String> getUserEngineIdList(
      User user,
      List<String> engineTypes,
    ...
    if (includeGlobal) {
      orFilter.addFilter(
          SimpleQueryFilter.makeColToValFilter(
              enginePrefix + "GLOBAL", "==", true, PixelDataType.BOOLEAN));
    }
    if (includeDiscoverable) {
      orFilter.addFilter(
          SimpleQueryFilter.makeColToValFilter(
              enginePrefix + "DISCOVERABLE", "==", true, PixelDataType.BOOLEAN));
    }
    if (engineTypes != null && !engineTypes.isEmpty()) {
      qs1.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(enginePrefix + "ENGINETYPE", "==", engineTypes));
    }
    ...
    }
    {
      ...
      orFilter.addFilter(
          SimpleQueryFilter.makeColToSubQuery(
              enginePrefix + "ENGINEID", existingAccessComparator, qs2));
    }
    {
      // filter on groups
      OrQueryFilter groupEngineOrFilters = new OrQueryFilter();
      ...
      for (AuthProvider login : logins) {
        ...
        andFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupEnginePermissionPrefix + "TYPE",
                "==",
                user.getAccessToken(login).getUserGroupType()));
        andFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupEnginePermissionPrefix + "ID",
                "==",
      ...
      if (!groupEngineOrFilters.isEmpty()) {
        SelectQueryStruct qs3 = new SelectQueryStruct();
        qs3.addSelector(
            new QueryColumnSelector(groupEnginePermissionPrefix + "ENGINEID", "ENGINEID"));
        qs3.addExplicitFilter(groupEngineOrFilters);
        orFilter.addFilter(
            SimpleQueryFilter.makeColToSubQuery(
                enginePrefix + "ENGINEID", existingAccessComparator, qs3));
      }
    }
  ...
  public static Map<String, Object> getLatestUpdatedAuthor(String engineId) {
    ...
    List<Map<String, Object>> list =
        (List<Map<String, Object>>) QueryExecutionUtility.flushRsToMap(securityDb, qs);
    if (list.isEmpty()) {
  ...
  public static List<Map<String, Object>> getAvailableMetaValues(
      List<String> engineFilters, List<String> metaKeys) {
    SelectQueryStruct qs = new SelectQueryStruct();
    // selectors
    qs.addSelector(new QueryColumnSelector("ENGINEMETA__METAKEY"));
    qs.addSelector(new QueryColumnSelector("ENGINEMETA__METAVALUE"));
    ...
    if (engineFilters != null && !engineFilters.isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINEMETA__ENGINEID", "==", engineFilters));
    }
    // group
  ...
  //	 * @return
  //	 */
  //	public static List<Map<String, Object>> getAllEngineList(List<String> engineType, List<String>
  // engineIdFilters, Map<String, Object> engineMetadataFilter,
   ...
   */
  public static List<Map<String, Object>> getUserEngineList(
      User user, String engineFilter, List<String> engineTypeFilter) {
    ...
    if (engineTypeFilter != null && !engineTypeFilter.isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINE__ENGINETYPE", "==", engineTypeFilter));
    }
    {
      OrQueryFilter orFilter = new OrQueryFilter();
      orFilter.addFilter(
      ...
      if (!groupIds.isEmpty()) {
        orFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter("GROUPENGINEPERMISSION__ID", "==", groupIds));
      }
      qs.addExplicitFilter(orFilter);
    }
    qs.addRelation("ENGINE", "ENGINEPERMISSION", "left.outer.join");
   ...
   */
  public static List<Map<String, Object>> getUserEngineList(
      User user, List<String> engineTypeFilter, Integer limit, Integer offset) {
    Collection<String> userIds = getUserFiltersQs(user);
    ...
    }
    {
      ...
      subQs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              "ENGINEPERMISSION__VISIBILITY", "==", false, PixelDataType.BOOLEAN));
      subQs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINEPERMISSION__USERID", "==", userIds));
    }
    // joins
   ...
   * @return
   */
  public static List<Map<String, Object>> getDiscoverableEngineList(
      String engineFilter, List<String> engineTypeFilter) {
    SelectQueryStruct qs = new SelectQueryStruct();
    qs.addSelector(new QueryColumnSelector("ENGINE__ENGINEID", "database_id"));
    qs.addSelector(new QueryColumnSelector("ENGINE__ENGINENAME", "database_name"));
    qs.addSelector(new QueryColumnSelector("ENGINE__ENGINETYPE", "database_type"));
  ...
  /**
   * Get the list of the database information that the user does not have access to, but is
   * discoverable
   *
   * @param user
   * @param engineTypes
   ...
   * @return
   */
  public static List<Map<String, Object>> getUserDiscoverableEngineList(
      User user,
      List<String> engineTypes,
    ...
    // remove user permission access
    {
      ...
      subQsUser.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINEPERMISSION__USERID", "==", userIds));
      qs1.addExplicitFilter(
          SimpleQueryFilter.makeColToSubQuery("ENGINE__ENGINEID", "!=", subQsUser));
    }
    {
      ...
      for (AuthProvider login : logins) {
        ...
        andFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                "GROUPENGINEPERMISSION__ID", "==", user.getAccessToken(login).getUserGroups()));
        orFilter.addFilter(andFilter);
      }
      if (!orFilter.isEmpty()) {
        subQsGroup.addExplicitFilter(orFilter);
        qs1.addExplicitFilter(
            SimpleQueryFilter.makeColToSubQuery("ENGINE__ENGINEID", "!=", subQsGroup));
      }
    }
    // filters
    if (engineFilters != null && !engineFilters.isEmpty()) {
      qs1.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINE__ENGINEID", "==", engineFilters));
    }
    if (engineTypes != null && !engineTypes.isEmpty()) {
      qs1.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINE__ENGINETYPE", "==", engineTypes));
  ...
  public static List<String> getFullUserEngineIds(User user) {
    //		String userFilters = getUserFilters(user);
    //		String query = "SELECT DISTINCT ENGINEID FROM ENGINEPERMISSION WHERE USERID IN " +
    // userFilters;
    //		IRawSelectWrapper wrapper = WrapperManager.getInstance().getRawWrapper(securityDb, query);
  ...
  public static List<Map<String, Object>> getMetakeyOptions(String metakey) {
    ...
    if (metakey != null && !metakey.isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("ENGINEMETAKEYS__METAKEY", "==", metakey));
    }
    return QueryExecutionUtility.flushRsToMap(securityDb, qs);
  }
  ...
  public static List<Map<String, Object>> getEngineUsagePermissionMap(User user, String engineId) {
    ...
    qs.addSelector(
        new QueryColumnSelector(
            "SMSS_USER__MODELUSAGERESTRICTION", Constants.USER_USAGE_RESTRICTION_KEY));
    qs.addSelector(
        new QueryColumnSelector(
            "SMSS_USER__MODELUSAGEFREQUENCY", Constants.USER_MODEL_USAGE_FREQUENCY_KEY));
    qs.addSelector(
        new QueryColumnSelector("SMSS_USER__MODELMAXTOKENS", Constants.USER_MODEL_MAX_TOKEN_KEY));
    qs.addSelector(
        new QueryColumnSelector(
            "SMSS_USER__MODELMAXRESPONSETIME", Constants.USER_MODEL_MAX_RESPONSE_TIME_KEY));

    qs.addSelector(
        new QueryColumnSelector(
            "ENGINEPERMISSION__USAGERESTRICTION", Constants.ENGINE_USAGE_RESTRICTION_KEY));
    qs.addSelector(
        new QueryColumnSelector(
            "ENGINEPERMISSION__USAGEFREQUENCY", Constants.ENGINE_USAGE_FREQUENCY_KEY));
    qs.addSelector(
        new QueryColumnSelector("ENGINEPERMISSION__MAXTOKENS", Constants.ENGINE_MAX_TOKEN_KEY));
    qs.addSelector(
        new QueryColumnSelector(
            "ENGINEPERMISSION__MAXRESPONSETIME", Constants.ENGINE_MAX_RESPONSE_TIME_KEY));

    // filter to the engine
    Pair<String, String> userDetails = User.getPrimaryUserIdAndTypePair(user);
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "ENGINEPERMISSION__USERID", "==", userDetails.getValue0()));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("ENGINEPERMISSION__ENGINEID", "==", engineId));
  ...
  public static List<String> getModelEngineIdsWithRestrictions(User user, String engineId) {
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "ENGINEPERMISSION__USAGERESTRICTION", "!=", Arrays.asList("", null)));
    qs.addRelation("SMSS_USER", "ENGINEPERMISSION", "left.outer.join");
  ...
  /**
   * Updates the permissions for a user on specific engines by replacing existing permissions.
   *
   * @param user
   * @param enginePermissions
   * @throws Exception
   */
  public static List<Map<String, Object>> updateEngineUserPermissions(
      User user, List<Map<String, Object>> enginePermissions) throws Exception {
    ...
    try {
      ...
      if (enginePermissions != null && !enginePermissions.isEmpty()) {
        String insertQuery =
            "INSERT INTO ENGINEPERMISSION (USERID, PERMISSION, ENGINEID, DATEADDED) VALUES (?, ?, ?, ?)";
      ...
      classLogger.error(Constants.STACKTRACE, e);
      throw new IllegalArgumentException(
          "An error occurred while updating the user engine permissions in db ");
    } finally {
