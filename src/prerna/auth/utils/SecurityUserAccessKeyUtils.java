...
public class SecurityUserAccessKeyUtils extends AbstractSecurityUtils {
  ...
  private static final String SECRET_KEY_SALT_COL =
      SMSS_USER_ACCESS_KEYS_TABLE_NAME + "__SECRETSALT";
  ...
  private static final String TOKEN_DESCRIPTION_COL =
      SMSS_USER_ACCESS_KEYS_TABLE_NAME + "__TOKENDESCRIPTION";
   ...
   * @throws SQLException
   */
  public static Map<String, String> createUserAccessToken(
      AccessToken accessToken, String tokenName, String tokenDescription) throws SQLException {
  ...
  public static void updateAccessTokenLastUsed(String accessKey) {
    ...
    String insertQuery =
        "UPDATE " + SMSS_USER_ACCESS_KEYS_TABLE_NAME + " SET LASTUSED=? WHERE ACCESSKEY=?";
   ...
   * @return
   */
  public static List<Map<String, Object>> getUserAccessKeyInfo(
      AccessToken token, String accessKey) {
    SelectQueryStruct qs = new SelectQueryStruct();
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(TYPE_COL, "==", token.getProvider().toString()));
