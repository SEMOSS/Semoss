...
public class SecurityProjectUtils extends AbstractSecurityUtils {
	...
	// /**
	// * Get project settings - if projectFilter passed will filter to that project
	// otherwise returns
	// all
	// * @param user
	// * @param projectFilter
	...
	// qs.addSelector(new QueryColumnSelector("PROJECT__GLOBAL", "project_global"));
	//
	// qs.addSelector(QueryFunctionSelector.makeCol2ValCoalesceSelector("PROJECTPERMISSION__VISIBILITY",
	// true, "project_visibility"));
	...
	// }
	//
	// // we dont need to run 2nd query if we are filtering to one db and already
	// have it
	...
	// qs.addSelector(QueryFunctionSelector.makeCol2ValCoalesceSelector("PROJECTPERMISSION__VISIBILITY",
	// true, "project_visibility"));
	// qs.addExplicitFilter(SimpleQueryFilter.makeColToValFilter("PROJECT__GLOBAL",
	// "==", true,
	// PixelDataType.BOOLEAN));
