...
public class SecurityInsightUtils extends AbstractSecurityUtils {
  ...
  public static Insight getInsight(String projectId, String insightId) {
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHT__PROJECTID", "==", projectId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHT__INSIGHTID", "==", insightId));
  ...
  public static String insightNameExists(String projectId, String insightName) {
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            fun, "==", insightName.toLowerCase(), PixelDataType.CONST_STRING));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHT__PROJECTID", "==", projectId));
  ...
  public static String makeInsightSchemaNameUnique(String projectId, String schemaName) {
    ...
    do {
      ...
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              fun, "==", schemaName.toLowerCase(), PixelDataType.CONST_STRING));
   ...
   * @return
   */
  public static boolean insightNameExistsMinusId(
      String projectId, String insightName, String currInsightId) {
    SelectQueryStruct qs = new SelectQueryStruct();
    qs.addSelector(new QueryColumnSelector("INSIGHT__INSIGHTID"));
    QueryFunctionSelector fun = new QueryFunctionSelector();
    fun.setFunction(QueryFunctionHelper.LOWER);
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHT__PROJECTID", "==", projectId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHT__INSIGHTID", "!=", currInsightId));
   ...
   * @return
   */
  public static String getActualUserInsightPermission(
      User user, String projectId, String insightId) {
   ...
   * @return
   */
  public static List<String> getUserInsightIdList(
      User user, boolean includeGlobal, boolean includeExistingAccess) {
    ...
    if (includeGlobal) {
      ...
      // store the subqs
      orFilter.addFilter(
          SimpleQueryFilter.makeColToSubQuery(insightPrefix + "PROJECTID", "==", subQs));
      ...
      subQs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              insightPrefix + "GLOBAL", "==", true, PixelDataType.BOOLEAN));

      // project access (or global)
      SelectQueryStruct subQs2 = new SelectQueryStruct();
      // store the subquery
      subQs.addExplicitFilter(
          SimpleQueryFilter.makeColToSubQuery(insightPrefix + "PROJECTID", "==", subQs2));
      ...
      projectSubset.addFilter(
          SimpleQueryFilter.makeColToValFilter(
              projectPrefix + "GLOBAL", "==", true, PixelDataType.BOOLEAN));
      projectSubset.addFilter(
          SimpleQueryFilter.makeColToValFilter(userProjectPrefix + "USERID", "==", userIds));
    ...
    }
    {
      ...
      qs2.addSelector(
          new QueryColumnSelector(userInsightPermissionPrefix + "INSIGHTID", "INSIGHTID"));
      qs2.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              userInsightPermissionPrefix + "USERID", "==", userIds));
      orFilter.addFilter(
          SimpleQueryFilter.makeColToSubQuery(
              insightPrefix + "INSIGHTID", existingAccessComparator, qs2));
    }
    {
      // project access
      SelectQueryStruct qs2 = new SelectQueryStruct();
      ...
      orFilter.addFilter(
          SimpleQueryFilter.makeColToSubQuery(
              insightPrefix + "PROJECTID", existingAccessComparator, qs2));
    }
    {
      // group insight access
      SelectQueryStruct qs3 = new SelectQueryStruct();
      qs3.addSelector(
          new QueryColumnSelector(groupInsightPermissionPrefix + "INSIGHTID", "INSIGHTID"));
      ...
      for (AuthProvider login : logins) {
        ...
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupInsightPermissionPrefix + "TYPE",
                "==",
                user.getAccessToken(login).getUserGroupType()));
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupInsightPermissionPrefix + "ID",
                "==",
        ...
        andFilter2.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupProjectPermissionPrefix + "TYPE",
                "==",
                user.getAccessToken(login).getUserGroupType()));
        andFilter2.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupProjectPermissionPrefix + "ID",
                "==",
                user.getAccessToken(login).getUserGroups()));
      ...
      if (!groupInsightOrFilters.isEmpty()) {
        ...
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupInsightPermissionPrefix + "TYPE", "==", null));
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(groupInsightPermissionPrefix + "ID", "==", null));
        qs3.addExplicitFilter(andFilter1);
      }
      orFilter.addFilter(
          SimpleQueryFilter.makeColToSubQuery(
              insightPrefix + "INSIGHTID", existingAccessComparator, qs3));
    }
    {
      // group project permission
      SelectQueryStruct qs4 = new SelectQueryStruct();
      qs4.addSelector(
          new QueryColumnSelector(groupProjectPermissionPrefix + "PROJECTID", "PROJECTID"));
      OrQueryFilter groupProjectOrFilters = new OrQueryFilter();
      List<AuthProvider> logins = user.getLogins();
      for (AuthProvider login : logins) {
        if (user.getAccessToken(login).getUserGroups().isEmpty()) {
      ...
      if (!groupProjectOrFilters.isEmpty()) {
        ...
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupProjectPermissionPrefix + "TYPE", "==", null));
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(groupProjectPermissionPrefix + "ID", "==", null));
        qs4.addExplicitFilter(andFilter1);
      }
      orFilter.addFilter(
          SimpleQueryFilter.makeColToSubQuery(
              insightPrefix + "INSIGHTID", existingAccessComparator, qs4));
    }
  ...
  public static List<Map<String, Object>> getUserEditableInsights(User user, String projectId) {
    ...
    if (permission.equals(AccessPermissionEnum.OWNER.getPermission())) {
      ...
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("INSIGHT__PROJECTID", "==", projectId));
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("USERINSIGHTPERMISSION__USERID", "==", userIds));
      ...
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              "USERINSIGHTPERMISSION__PERMISSION", "==", permissions));
      qs.addOrderBy(new QueryColumnOrderBySelector("INSIGHT__INSIGHTNAME"));
      return QueryExecutionUtility.flushRsToMap(securityDb, qs);
    }
  }
   ...
   * @return
   */
  public static Integer getUserInsightPermission(
      String singleUserId, String projectId, String insightId) {
    //		String query = "SELECT DISTINCT USERINSIGHTPERMISSION.PERMISSION FROM USERINSIGHTPERMISSION
    // "
    //				+ "WHERE ENGINEID='" + engineId + "' AND INSIGHTID='" + insightId + "' AND USERID='" +
    // singleUserId + "'";
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("USERINSIGHTPERMISSION__USERID", "==", singleUserId));
   ...
   * @return
   */
  public static Map<String, Integer> getUserInsightPermissions(
      List<String> userIds, String projectId, String insightId) {
   ...
   * @return
   */
  public static IRawSelectWrapper getUserInsightPermissionsWrapper(
      List<String> userIds, String projectId, String insightId) throws Exception {
    SelectQueryStruct qs = new SelectQueryStruct();
  ...
  public static boolean insightIsGlobal(String projectId, String insightId) {
    ...
    //				+ "WHERE ENGINEID='" + engineId + "' AND INSIGHTID='" + insightId + "' AND
    // INSIGHT.GLOBAL=TRUE";
    //		IRawSelectWrapper wrapper = WrapperManager.getInstance().getRawWrapper(securityDb, query);
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHT__INSIGHTID", "==", insightId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHT__GLOBAL", "==", true, PixelDataType.BOOLEAN));
    IRawSelectWrapper wrapper = null;
    try {
      wrapper = WrapperManager.getInstance().getRawWrapper(securityDb, qs);
      if (wrapper.hasNext()) {
  ...
  /**
   * Determine if the user can edit the insight User must be database owner OR be given explicit
   * permissions on the insight
   *
   * @param userId
   * @param projectId
   * @param insightId
  ...
  /**
   * Determine if the user is an owner of an insight User must be database owner OR be given
   * explicit permissions on the insight
   *
   * @param userId
   * @param projectId
   * @param insightId
   ...
   */
  public static void setInsightGlobalWithinProject(
      User user, String projectId, String insightId, boolean isPublic)
      throws IllegalAccessException {
  ...
  /**
   * Change the user favorite (is favorite / not favorite) for a database. Without removing its
   * permissions.
   *
   * @param user
   * @param projectId
   ...
   * @throws IllegalAccessException
   */
  public static void setInsightFavorite(
      User user, String projectId, String insightId, boolean isFavorite)
   ...
   * @throws IllegalAccessException
   */
  public static List<Map<String, Object>> getInsightUsers(
      User user,
      String projectId,
      String insightId,
      String searchTerm,
      ...
      long offset)
      throws IllegalAccessException {
    return SecurityUserInsightUtils.getInsightUsers(
        user, projectId, insightId, searchTerm, permission, limit, offset);
  }
   ...
   * @return
   */
  public static long getInsightUsersCount(
      User user, String projectId, String insightId, String userId, String permission)
      throws IllegalAccessException {
    return SecurityUserInsightUtils.getInsightUsersCount(
        user, projectId, insightId, userId, permission);
  }
  ...
  public static void addInsight(
      ...
      String schemaName) {
    String insertQuery =
        "INSERT INTO INSIGHT (PROJECTID, INSIGHTID, INSIGHTNAME, GLOBAL, EXECUTIONCOUNT, "
  ...
  public static void addUserInsightCreator(User user, String projectId, String insightId) {
    ...
    String query =
        "INSERT INTO USERINSIGHTPERMISSION (USERID, PROJECTID, INSIGHTID, PERMISSION, PERMISSIONGRANTEDBY, PERMISSIONGRANTEDBYTYPE, DATEADDED) VALUES (?,?,?,?,?,?,?)";
    PreparedStatement ps = null;
    try {
      ps = securityDb.getPreparedStatement(query);
      for (AuthProvider login : logins) {
   ...
   * @param recipe
   */
  public static void updateInsight(
      String projectId,
      String insightId,
      String insightName,
      boolean global,
      ...
      String schemaName) {
    String updateQuery =
        "UPDATE INSIGHT SET INSIGHTNAME=?, GLOBAL=?, LASTMODIFIEDON=?, "
  ...
  public static void updateInsightName(String projectId, String insightId, String insightName) {
    ...
    String query =
        "UPDATE INSIGHT SET INSIGHTNAME=?, LASTMODIFIEDON=? WHERE INSIGHTID=? AND PROJECTID=?";
    PreparedStatement ps = null;
    try {
      ps = securityDb.getPreparedStatement(query);
      int parameterIndex = 1;
   ...
   * @param cacheEncrypt
   */
  public static void updateInsightCache(
      String projectId,
      String insightId,
      boolean cacheInsight,
      int cacheMinutes,
      String cacheCron,
      LocalDateTime cachedOn,
      boolean cacheEncrypt) {
    java.sql.Timestamp timestamp = Utility.getCurrentSqlTimestampUTC();

    String query =
        "UPDATE INSIGHT SET CACHEABLE=?, CACHEMINUTES=?, CACHECRON=?, CACHEDON=?, CACHEENCRYPT=?, LASTMODIFIEDON=? WHERE INSIGHTID=? AND PROJECTID=?";
    PreparedStatement ps = null;
    try {
      ps = securityDb.getPreparedStatement(query);
      int parameterIndex = 1;
   ...
   * @param cacheEncrypt
   */
  public static void updateInsightCachedOn(
      String projectId, String insightId, ZonedDateTime cachedOn) {
  ...
  /**
   * Update the insight metadata for the insight Will delete existing values and then perform a bulk
   * insert
   *
   * @param projectId
   * @param insightId
   * @param metadata
   */
  public static void updateInsightMetadata(
      String projectId, String insightId, Map<String, Object> metadata) {
    // first do a delete
  ...
  /**
   * Update the insight description Will perform an insert if the description doesn't currently
   * exist
   *
   * @param projectId
   * @param insideId
   * @param description
   */
  public static void updateInsightDescription(
      String projectId, String insightId, String description) {
    // try to do an update
    ...
    String query =
        "UPDATE INSIGHTMETA SET METAVALUE=? WHERE METAKEY=? AND INSIGHTID=? AND PROJECTID=?";
    PreparedStatement ps = null;
    try {
      ps = securityDb.getPreparedStatement(query);
      int parameterIndex = 1;
    ...
    if (updateCount <= 0) {
      try {
        query =
            "INSERT INTO INSIGHTMETA (PROJECTID, INSIGHTID, METAKEY, METAVALUE, METAORDER) VALUES (?,?,?,?,?)";
        ps = securityDb.getPreparedStatement(query);
        int parameterIndex = 1;
        ps.setString(parameterIndex++, projectId);
        ps.setString(parameterIndex++, insightId);
  ...
  /**
   * Update the insight tags for the insight Will delete existing values and then perform a bulk
   * insert
   *
   * @param projectId
   * @param insightId
   ...
   * @param insightFrames
   */
  public static void updateInsightFrames(
      String projectId, String insightId, Set<ITableDataFrame> insightFrames) {
    // first do a delete
  ...
  public static void updateExecutionCount(String projectId, String insightId) {
    String query =
        "UPDATE INSIGHT SET EXECUTIONCOUNT = EXECUTIONCOUNT + 1 WHERE PROJECTID=? AND INSIGHTID=?";
    PreparedStatement ps = null;
    try {
      ps = securityDb.getPreparedStatement(query);
      int parameterIndex = 1;
   ...
   * @return
   */
  public static void addInsightUser(
      User user,
      String newUserId,
      String projectId,
      String insightId,
    ...
    if (!AccessPermissionEnum.isEditor(userPermissionLvl)) {
      throw new IllegalArgumentException(
          "Insufficient privileges to modify this insight's permissions.");
    }
    ...
    try {
      ps =
          securityDb.getPreparedStatement(
      ...
      classLogger.error(Constants.STACKTRACE, e);
      throw new IllegalArgumentException(
          "An error occurred adding user permissions for this insight");
    } finally {
      ConnectionUtils.closeAllConnectionsIfPooling(securityDb, ps);
    }
  }
   ...
   * @throws IllegalAccessException
   */
  public static void editInsightUserPermission(
      User user,
    ...
    if (!AccessPermissionEnum.isOwner(userPermissionLvl)) {
      ...
      if (AccessPermissionEnum.OWNER.getId() == existingUserPermission) {
        throw new IllegalAccessException(
            "The user doesn't have the high enough permissions to modify this users insight permission.");
      }
    ...
    try {
      ...
      classLogger.error(Constants.STACKTRACE, e);
      throw new IllegalArgumentException(
          "An error occurred updating the user permissions for this insight");
    } finally {
      ConnectionUtils.closeAllConnectionsIfPooling(securityDb, ps);
    }
  }
   ...
   * @throws IllegalAccessException
   */
  public static void editInsightUserPermissions(
      User user,
      String projectId,
      String insightId,
    ...
    Map<String, Integer> existingUserPermission =
        SecurityInsightUtils.getUserInsightPermissions(existingUserIds, projectId, insightId);
   ...
   * @throws IllegalAccessException
   */
  public static void removeInsightUser(
      User user, String existingUserId, String projectId, String insightId)
      throws IllegalAccessException {
    // make sure user can edit the insight
    int userPermissionLvl = getMaxUserInsightPermission(user, projectId, insightId);
    if (!AccessPermissionEnum.isEditor(userPermissionLvl)) {
    ...
    String deleteQuery =
        "DELETE FROM USERINSIGHTPERMISSION WHERE USERID=? AND PROJECTID=? AND INSIGHTID=?";
    PreparedStatement ps = null;
    try {
      ...
      classLogger.error(Constants.STACKTRACE, e);
      throw new IllegalArgumentException(
          "An error occurred removing the user permissions for this insight");
    } finally {
      ConnectionUtils.closeAllConnectionsIfPooling(securityDb, ps);
    }
  }
  ...
  /**
   * User has access to specific insights within a project User can access if: 1) Is Owner, Editer,
   * or Reader of insight 2) Insight is global 3) Is Owner of project
   *
   * <p>TODO >>> Kunal: change app_name and app_name_id to project references
   *
   * @param projectId
   * @param userId
   * @param searchTerm
   ...
   * @return
   */
  public static List<Map<String, Object>> searchUserInsights(
      User user,
      List<String> projectFilter,
      String searchTerm,
      Boolean favoritesOnly,
      QueryColumnOrderBySelector sortBy,
      Map<String, Object> insightMetadataFilter,
      String limit,
      String offset) {
    ...
    qs.addSelector(
        QueryFunctionSelector.makeFunctionSelector(
            QueryFunctionHelper.LOWER, insightPrefix + "INSIGHTNAME", "low_name"));
    // add the USER PERMISSIONS subquery returns
    qs.addSelector(
        new QueryColumnSelector("INSIGHT_USER_PERMISSIONS__PERMISSION", "insight_permission"));
    qs.addSelector(
        new QueryColumnSelector("PROJECT_USER_PERMISSIONS__PERMISSION", "project_permission"));
    qs.addSelector(
        new QueryColumnSelector(
            "INSIGHT_GROUP_PERMISSIONS__PERMISSION", "insight_group_permission"));
    qs.addSelector(
        new QueryColumnSelector(
            "PROJECT_GROUP_PERMISSIONS__PERMISSION", "project_group_permission"));
    qs.addSelector(
        new QueryColumnSelector("INSIGHT_USER_PERMISSIONS__FAVORITE", "insight_favorite"));
    ...
    // if both non null - return max permissions
    {
      ...
      and.addFilter(
          SimpleQueryFilter.makeColToValFilter(
              "INSIGHT_GROUP_PERMISSIONS__PERMISSION", "==", null, PixelDataType.CONST_INT));
      and.addFilter(
          SimpleQueryFilter.makeColToValFilter(
              "INSIGHT_USER_PERMISSIONS__PERMISSION", "==", null, PixelDataType.CONST_INT));
      ...
      SimpleQueryFilter maxPermFilter =
          SimpleQueryFilter.makeColToColFilter(
              "INSIGHT_USER_PERMISSIONS__PERMISSION", "<", "INSIGHT_GROUP_PERMISSIONS__PERMISSION");
      SimpleQueryFilter userOwnerFilter =
          SimpleQueryFilter.makeColToValFilter(
              "PROJECT_USER_PERMISSIONS__PERMISSION",
              "==",
              AccessPermissionEnum.OWNER.getId(),
              PixelDataType.CONST_INT);
      SimpleQueryFilter groupOwnerFilter =
          SimpleQueryFilter.makeColToValFilter(
              "PROJECT_GROUP_PERMISSIONS__PERMISSION",
              "==",
              AccessPermissionEnum.OWNER.getId(),
              PixelDataType.CONST_INT);

      // logic
      QueryIfSelector qis5 =
    ...
    // add a join to get the user permission level and if favorite
    {
      ...
      QueryFunctionSelector castFavorite =
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.CAST, userInsightPrefix + "FAVORITE", "castFavorite");
      castFavorite.setDataType(securityDb.getQueryUtil().getIntegerDataTypeName());
      qs2.addSelector(
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.MAX, castFavorite, "FAVORITE"));

      qs2.addSelector(
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.MIN, userInsightPrefix + "PERMISSION", "PERMISSION"));
      qs2.addGroupBy(new QueryColumnSelector(userInsightPrefix + "INSIGHTID", "INSIGHTID"));
      qs2.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(userInsightPrefix + "USERID", "==", userIds));
      IRelation subQuery = null;
      if (favoritesOnly) {
        qs2.addExplicitFilter(
            SimpleQueryFilter.makeColToValFilter(
                userInsightPrefix + "FAVORITE", "==", true, PixelDataType.BOOLEAN));
        // we can set this to inner join if only favorites
        subQuery =
            new SubqueryRelationship(
                qs2,
                "INSIGHT_USER_PERMISSIONS",
                "inner.join",
                new String[] {
                  "INSIGHT_USER_PERMISSIONS__INSIGHTID", insightPrefix + "INSIGHTID", "="
                });
      } else {
        subQuery =
            new SubqueryRelationship(
    ...
    // add a join to get the user project permission
    {
      ...
      qs2.addSelector(
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.MIN, userProjectPrefix + "PERMISSION", "PERMISSION"));
      ...
      IRelation subQuery =
          new SubqueryRelationship(
              ...
              "left.outer.join",
              new String[] {
                "PROJECT_USER_PERMISSIONS__PROJECTID", insightPrefix + "PROJECTID", "="
              });
      qs.addRelation(subQuery);
    }
    ...
    // add a join to get the group insight permission level
    {
      ...
      qs3.addSelector(
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.MIN, groupInsightPermission + "PERMISSION", "PERMISSION"));
      ...
      for (AuthProvider login : logins) {
        ...
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupInsightPermission + "TYPE",
                "==",
                user.getAccessToken(login).getUserGroupType()));
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupInsightPermission + "ID", "==", user.getAccessToken(login).getUserGroups()));
        groupInsightOrFilters.addFilter(andFilter1);

        AndQueryFilter andFilter2 = new AndQueryFilter();
        andFilter2.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupProjectPermission + "TYPE",
                "==",
                user.getAccessToken(login).getUserGroupType()));
        andFilter2.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupProjectPermission + "ID", "==", user.getAccessToken(login).getUserGroups()));
        groupProjectOrFilters.addFilter(andFilter2);
      }
      ...
      if (!groupInsightOrFilters.isEmpty()) {
        ...
        AndQueryFilter andFilter1 = new AndQueryFilter();
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(groupInsightPermission + "TYPE", "==", null));
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(groupInsightPermission + "ID", "==", null));
        qs3.addExplicitFilter(andFilter1);
      }
    ...
    // add a join to get the group project permission level
    {
      ...
      qs4.addSelector(
          QueryFunctionSelector.makeFunctionSelector(
              QueryFunctionHelper.MIN, groupProjectPermission + "PERMISSION", "PERMISSION"));
      ...
      if (!groupProjectOrFilters.isEmpty()) {
        ...
        AndQueryFilter andFilter1 = new AndQueryFilter();
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(groupProjectPermission + "TYPE", "==", null));
        andFilter1.addFilter(
            SimpleQueryFilter.makeColToValFilter(groupProjectPermission + "ID", "==", null));
        qs4.addExplicitFilter(andFilter1);
      }
      ...
      IRelation subQuery =
          new SubqueryRelationship(
              ...
              "left.outer.join",
              new String[] {
                "PROJECT_GROUP_PERMISSIONS__PROJECTID", insightPrefix + "PROJECTID", "="
              });
      qs.addRelation(subQuery);
    }
    ...
    // remove hidden projects
    {
      ...
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToSubQuery(projectPrefix + "PROJECTID", "!=", subQs));
      ...
      subQs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              userProjectPrefix + "VISIBILITY", "==", false, PixelDataType.BOOLEAN));
      subQs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(userProjectPrefix + "USERID", "==", userIds));
    }
    // optional filters
    ...
    if (hasSearchTerm) {
      ...
      searchFilter.addFilter(
          securityDb.getQueryUtil().getSearchRegexFilter(insightPrefix + "INSIGHTID", searchTerm));
      searchFilter.addFilter(
          securityDb
              .getQueryUtil()
              .getSearchRegexFilter(insightPrefix + "INSIGHTNAME", searchTerm));
      qs.addExplicitFilter(searchFilter);
    }
    // filtering by insight meta key-value pairs (i.e. <tag>:value): for each pair, add in-filter
    // against insightids from subquery
    if (insightMetadataFilter != null && !insightMetadataFilter.isEmpty()) {
      for (String k : insightMetadataFilter.keySet()) {
        ...
        subQs.addExplicitFilter(
            SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__METAKEY", "==", k));
        subQs.addExplicitFilter(
            SimpleQueryFilter.makeColToValFilter(
                "INSIGHTMETA__METAVALUE", "==", insightMetadataFilter.get(k)));
        qs.addExplicitFilter(
            SimpleQueryFilter.makeColToSubQuery("INSIGHT__INSIGHTID", "==", subQs));
      }
    }
    ...
    // 1 - insights i have access to
    {
      ...
      // store first and fill in sub query after
      orFilter.addFilter(
          SimpleQueryFilter.makeColToSubQuery(insightPrefix + "INSIGHTID", "==", subQs));
    ...
    // 4 insights i have access to from group permissions
    {
      ...
      if (!groupProjectOrFilters.isEmpty()) {
        ...
        subQs.addExplicitFilter(
            SimpleQueryFilter.makeColToValFilter(
                groupProjectPermission + "PERMISSION",
                "==",
                AccessPermissionEnum.OWNER.getId(),
                PixelDataType.CONST_INT));
      }
  ...
  //	 * @return
  //	 */
  //	public static List<Map<String, Object>> searchInsights(List<String> projectFilter, String
  // searchTerm,
  //			QueryColumnOrderBySelector sortBy, Map<String, Object> insightMetadataFilter, String limit,
  // String offset) {
  ...
  //			qs.addExplicitFilter(SimpleQueryFilter.makeColToValFilter("INSIGHT__PROJECTID", "==",
  // projectFilter));
  //		}
  ...
  ////		boolean tagFiltering = tags != null && !tags.isEmpty();
  ////		if(tagFiltering) {
  ////			qs.addExplicitFilter(SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__METAKEY", "==",
  // "tag"));
  ////			qs.addExplicitFilter(SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__METAVALUE", "==",
  // tags));
  ////		}
  ////		// joins
  //		qs.addRelation("PROJECT", "INSIGHT", "inner.join");
  ...
  //		}
  //		// filtering by insightmeta key-value pairs (i.e. <tag>:value): for each pair, add in-filter
  // against insightids from subquery
  //		if (insightMetadataFilter!=null && !insightMetadataFilter.isEmpty()) {
  //			for (String k : insightMetadataFilter.keySet()) {
  //				SelectQueryStruct subQs = new SelectQueryStruct();
  //				subQs.addSelector(new QueryColumnSelector("INSIGHTMETA__INSIGHTID"));
  //				subQs.addExplicitFilter(SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__METAKEY", "==",
  // k));
  //				subQs.addExplicitFilter(SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__METAVALUE", "==",
  // insightMetadataFilter.get(k)));
  //				qs.addExplicitFilter(SimpleQueryFilter.makeColToSubQuery("INSIGHT__INSIGHTID", "==",
  // subQs));
  //			}
  //		}
  //
  ...
  /**
   * User has access to specific insights within a project User can access if: 1) Is Owner, Editer,
   * or Reader of insight 2) Insight is global 3) Is Owner of database
   *
   * @param projectId
   * @param userId
   * @param searchTerm
   ...
   * @return
   */
  public static SelectQueryStruct searchUserInsightsUsage(
      User user, List<String> projectFilter, String searchTerm, List<String> tags) {
    ...
    if (hasEngineFilters) {
      ...
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("INSIGHT__PROJECTID", "==", projectFilter));
      ...
      OrQueryFilter orFilter = new OrQueryFilter();
      {
        ...
        orFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                "INSIGHT__GLOBAL", "==", true, PixelDataType.BOOLEAN));
        AndQueryFilter embedAndFilter = new AndQueryFilter();
        embedAndFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                "PROJECTPERMISSION__PERMISSION", "==", 1, PixelDataType.CONST_INT));
        embedAndFilter.addFilter(
      ...
      {
        firstOrFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                "PROJECT__GLOBAL", "==", true, PixelDataType.BOOLEAN));
        firstOrFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter("PROJECTPERMISSION__USERID", "==", userIds));
      }
      ...
      // remove those engines you have visibility as false
      {
        ...
        // store first and fill in sub query after
        qs.addExplicitFilter(
            SimpleQueryFilter.makeColToSubQuery("PROJECT__PROJECTID", "!=", subQs));

        // fill in the sub query with the single return + filters
        subQs.addSelector(new QueryColumnSelector("PROJECTPERMISSION__PROJECTID"));
        subQs.addExplicitFilter(
            SimpleQueryFilter.makeColToValFilter(
                "PROJECTPERMISSION__VISIBILITY", "==", false, PixelDataType.BOOLEAN));
        subQs.addExplicitFilter(
            SimpleQueryFilter.makeColToValFilter("PROJECTPERMISSION__USERID", "==", userIds));
      }
      ...
      OrQueryFilter secondOrFilter = new OrQueryFilter();
      {
        ...
        embedAndFilter.addFilter(
            SimpleQueryFilter.makeColToValFilter(
                "PROJECTPERMISSION__VISIBILITY", "==", true, PixelDataType.BOOLEAN));
    ...
    if (searchTerm != null && !searchTerm.trim().isEmpty()) {
      OrQueryFilter searchFilter = new OrQueryFilter();
      searchFilter.addFilter(
          securityDb.getQueryUtil().getSearchRegexFilter("INSIGHT__INSIGHTID", searchTerm));
      searchFilter.addFilter(
          securityDb.getQueryUtil().getSearchRegexFilter("INSIGHT__INSIGHTNAME", searchTerm));
      qs.addExplicitFilter(searchFilter);
    }
    // if we have tag filters
    boolean tagFiltering = tags != null && !tags.isEmpty();
    if (tagFiltering) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__METAKEY", "==", "tag"));
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__METAVALUE", "==", tags));
    }
    // joins
    qs.addRelation("PROJECT", "INSIGHT", "inner.join");
  ...
  //	 * @return
  //	 */
  //	public static SelectQueryStruct searchInsightsUsage(List<String> projectFilter, String
  // searchTerm, List<String> tags) {
  //		SelectQueryStruct qs = new SelectQueryStruct();
  //		// selectors
  //		qs.addSelector(new QueryColumnSelector("INSIGHT__PROJECTID", "app_id"));
  //		qs.addSelector(new QueryColumnSelector("PROJECT__PROJECTNAME", "app_name"));
   ...
   * @return
   */
  public static IRawSelectWrapper getInsightMetadataWrapper(
      String projectId, Collection<String> insightIds, List<String> metaKeys) {
    SelectQueryStruct qs = new SelectQueryStruct();
    // selectors
    ...
    // filters
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__PROJECTID", "==", projectId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__INSIGHTID", "==", insightIds));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__METAKEY", "==", metaKeys));
    // order
    qs.addSelector(new QueryColumnSelector("INSIGHTMETA__METAORDER"));
   ...
   */
  public static IRawSelectWrapper getInsightMetadataWrapper(
      Map<String, List<String>> projectToInsightMap, List<String> metaKeys) {
    SelectQueryStruct qs = new SelectQueryStruct();
    // selectors
    qs.addSelector(new QueryColumnSelector("INSIGHTMETA__PROJECTID"));
    qs.addSelector(new QueryColumnSelector("INSIGHTMETA__INSIGHTID"));
    ...
    for (String projectId : projectToInsightMap.keySet()) {
      ...
      andFilter.addFilter(
          SimpleQueryFilter.makeColToValFilter(
              "INSIGHTMETA__INSIGHTID", "==", projectToInsightMap.get(projectId)));
   ...
   * @return
   */
  public static Map<String, Object> getSpecificInsightMetadata(
      String projectId, String insightId, List<String> metaKeys) {
    SelectQueryStruct qs = new SelectQueryStruct();
    // selectors
    qs.addSelector(new QueryColumnSelector("INSIGHTMETA__PROJECTID"));
    qs.addSelector(new QueryColumnSelector("INSIGHTMETA__INSIGHTID"));
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__PROJECTID", "==", projectId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__INSIGHTID", "==", insightId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__METAKEY", "==", metaKeys));
    // order
    qs.addSelector(new QueryColumnSelector("INSIGHTMETA__METAORDER"));
   ...
   * @return
   */
  public static Map<String, Object> getSpecificInsightCacheDetails(
      String projectId, String insightId) {
    SelectQueryStruct qs = new SelectQueryStruct();
    // selectors
    qs.addSelector(new QueryColumnSelector("INSIGHT__CACHEABLE"));
    qs.addSelector(new QueryColumnSelector("INSIGHT__CACHEMINUTES"));
   ...
   * @return
   */
  public static List<Map<String, Object>> getAvailableInsightTagsAndCounts(
    ...
    if (projectFilters != null && !projectFilters.isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__PROJECTID", "==", projectFilters));
    }
    // group
   ...
   * @return
   */
  public static List<Object[]> getInsightFrames(
      String projectId, String insightId, String frameNamePattern) {
    SelectQueryStruct qs = new SelectQueryStruct();
    // selectors
    ...
    // filters
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTFRAMES__INSIGHTID", "==", insightId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTFRAMES__PROJECTID", "==", projectId));
    // if frame pattern passed
    if (frameNamePattern != null && !(frameNamePattern = frameNamePattern.trim()).isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              "INSIGHTFRAMES__TABLENAME", "?like", frameNamePattern));
    }
  ...
  /**
   * User will see specific insight predictions for their searches User can see records if: 1) Is
   * Owner, Editer, or Reader of insight 2) Insight is global 3) Is Owner of database
   *
   * @param userId
   * @param searchTerm
   * @param limit
   ...
   * @return
   */
  public static List<String> predictUserInsightSearch(
      User user, String searchTerm, String limit, String offset) {
    ...
    // "
    //				+ ( (searchTerm != null && !searchTerm.trim().isEmpty()) ? "AND
    // REGEXP_LIKE(INSIGHT.INSIGHTNAME, '"+
    // RdbmsQueryBuilder.escapeForSQLStatement(RdbmsQueryBuilder.escapeRegexCharacters(searchTerm))
    // + "', 'i')" : "")
  ...
  public static List<String> predictInsightSearch(String searchTerm, String limit, String offset) {
    ...
    //				+ "LOWER(INSIGHT.INSIGHTNAME) as \"low_name\" "
    //				+ "FROM INSIGHT "
    //				+ ( (searchTerm != null && !searchTerm.trim().isEmpty()) ? "WHERE
    // REGEXP_LIKE(INSIGHT.INSIGHTNAME, '"+
    // RdbmsQueryBuilder.escapeForSQLStatement(RdbmsQueryBuilder.escapeRegexCharacters(searchTerm))
    // + "', 'i')" : "")
    //				+ "ORDER BY LOWER(INSIGHT.INSIGHTNAME) "
   ...
   * @throws SQLException
   */
  public static void copyInsightPermissions(
      String sourceProjectId,
      String sourceInsightId,
      String targetProjectId,
      String targetInsightId)
      throws Exception {
    String insertTargetAppInsightPermissionSql =
        "INSERT INTO USERINSIGHTPERMISSION (ENGINEID, INSIGHTID, USERID, PERMISSION) VALUES (?, ?, ?, ?)";
    PreparedStatement insertTargetAppInsightPermissionStatement =
        securityDb.getPreparedStatement(insertTargetAppInsightPermissionSql);
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "USERINSIGHTPERMISSION__PERMISSION", "==", sourceProjectId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "USERINSIGHTPERMISSION__INSIGHTID", "==", sourceInsightId));
    IRawSelectWrapper wrapper = null;
    try {
      wrapper = WrapperManager.getInstance().getRawWrapper(securityDb, qs);
      while (wrapper.hasNext()) {
    ...
    String deleteTargetAppPermissionsSql =
        "DELETE FROM USERINSIGHTPERMISSION WHERE PROJECTID = '"
            + AbstractSqlQueryUtil.escapeForSQLStatement(targetProjectId)
            + "' AND INSIGHTID = '"
   ...
   * @throws IllegalAccessException
   */
  public static List<Map<String, Object>> getInsightUsersNoCredentials(
      User user, String projectId, String insightId, String searchTerm, long limit, long offset)
      throws IllegalAccessException {
    /*
    ...
    // Filter for sub-query
    {
      ...
      subQs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              "USERINSIGHTPERMISSION__PROJECTID", "==", projectId));
      subQs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              "USERINSIGHTPERMISSION__INSIGHTID", "==", insightId));
      subQs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(
              "USERINSIGHTPERMISSION__PERMISSION", "!=", null, PixelDataType.NULL_VALUE));
    }
    if (searchTerm != null && !(searchTerm = searchTerm.trim()).isEmpty()) {
      ...
      or.addFilter(
          SimpleQueryFilter.makeColToValFilter("SMSS_USER__USERNAME", "?like", searchTerm));
  ...
  public static List<Map<String, Object>> getMetakeyOptions(String metakey) {
    ...
    if (metakey != null && !metakey.isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("INSIGHTMETAKEYS__METAKEY", "==", metakey));
    }
    return QueryExecutionUtility.flushRsToMap(securityDb, qs);
  }
   ...
   * @return
   */
  public static List<Map<String, Object>> getAvailableMetaValues(
      List<String> insightFilter, List<String> metaKeys) {
    SelectQueryStruct qs = new SelectQueryStruct();
    // selectors
    qs.addSelector(new QueryColumnSelector("INSIGHTMETA__METAKEY"));
    qs.addSelector(new QueryColumnSelector("INSIGHTMETA__METAVALUE"));
    ...
    if (insightFilter != null && !insightFilter.isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter("INSIGHTMETA__INSIGHTID", "==", insightFilter));
    }
    // group
   ...
   * @return
   */
  public static void addInsightUserPermissions(
      User user,
      String projectId,
      String insightId,
    ...
    List<String> userIds =
        permission.stream().map(map -> map.get("userid")).collect(Collectors.toList());
    // this returns a list of existing permissions
    Map<String, Integer> existingUserPermission =
        SecurityInsightUtils.getUserInsightPermissions(userIds, projectId, insightId);
    ...
    if (!AccessPermissionEnum.isOwner(userPermissionLvl)) {
      List<String> permissionList =
          permission.stream().map(map -> map.get("permission")).collect(Collectors.toList());
   ...
   * @return
   */
  public static void removeInsightUsers(
      User user, List<String> existingUserIds, String projectId, String insightId)
      throws IllegalAccessException {
    // make sure user can edit the insight
    int userPermissionLvl = getMaxUserInsightPermission(user, projectId, insightId);
    if (!AccessPermissionEnum.isEditor(userPermissionLvl)) {
   ...
   * @param requests
   */
  public static void approveInsightUserAccessRequests(
      User user,
      String projectId,
      String insightId,
      List<Map<String, String>> requests,
    ...
    if (!AccessPermissionEnum.isEditor(userPermissionLvl)) {
      throw new IllegalAccessException(
          "Insufficient privileges to modify this project's permissions.");
    }
    ...
    String updateQ =
        "UPDATE INSIGHTACCESSREQUEST SET PERMISSION = ?, APPROVER_USERID = ?, APPROVER_TYPE = ?, APPROVER_DECISION = ?, APPROVER_TIMESTAMP = ? WHERE ID = ?";
    ...
    try {
      ...
      for (int i = 0; i < requests.size(); i++) {
        int index = 1;
        updatePs.setInt(
            index++, AccessPermissionEnum.getIdByPermission(requests.get(i).get("permission")));
   ...
   * @param requests
   */
  public static void denyInsightUserAccessRequests(
      User user, String projectId, String insightId, List<String> requestIdList)
      throws IllegalAccessException {
    // make sure user has right permission level to approve access requests
    int userPermissionLvl = getMaxUserInsightPermission(user, projectId, insightId);
    if (!AccessPermissionEnum.isEditor(userPermissionLvl)) {
    ...
    String updateQ =
        "UPDATE INSIGHTACCESSREQUEST SET APPROVER_USERID = ?, APPROVER_TYPE = ?, APPROVER_DECISION = ?, APPROVER_TIMESTAMP = ? WHERE ID = ?";
    PreparedStatement ps = null;
    try {
      Timestamp timestamp = Utility.getCurrentSqlTimestampUTC();
      ps = securityDb.getPreparedStatement(updateQ);
   ...
   * @return
   */
  public static Integer getUserAccessRequestInsightPermission(
      String userId, String projectId, String insightId) {
    SelectQueryStruct qs = new SelectQueryStruct();
    qs.addSelector(new QueryColumnSelector("INSIGHTACCESSREQUEST__PERMISSION"));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTACCESSREQUEST__REQUEST_USERID", "==", userId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTACCESSREQUEST__PROJECTID", "==", projectId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter("INSIGHTACCESSREQUEST__INSIGHTID", "==", insightId));
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "INSIGHTACCESSREQUEST__APPROVER_DECISION", "==", null));
   ...
   * @return
   */
  public static List<Map<String, Object>> getUserAccessRequestsByInsight(
      String projectId, String insightId) {
    SelectQueryStruct qs = new SelectQueryStruct();
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "INSIGHTACCESSREQUEST__APPROVER_DECISION", "==", "NEW_REQUEST"));
  ...
  public static List<String> getInsightOwners(String projectId, String insightId) {
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(
            "PERMISSION__ID", "==", AccessPermissionEnum.OWNER.getId()));
   ...
   * @param user
   */
  public static void setUserAccessRequest(
      String userId,
      String userType,
      String projectId,
    ...
    // first do a delete
    String updateQ =
        "UPDATE INSIGHTACCESSREQUEST SET APPROVER_DECISION = 'OLD' WHERE REQUEST_USERID=? AND REQUEST_TYPE=? AND PROJECTID=? AND INSIGHTID=? AND APPROVER_DECISION='NEW_REQUEST'";
    PreparedStatement updatePs = null;
    ...
    String insertQ =
        "INSERT INTO INSIGHTACCESSREQUEST "
    ...
    try {
      ...
      securityQueryUtil.handleInsertionOfClob(
          insertPs.getConnection(), insertPs, requestReason, index++, new Gson());
      ...
      classLogger.error(Constants.STACKTRACE, e);
      throw new IllegalArgumentException(
          "An error occurred while adding user access request detailed message = "
              + e.getMessage());
    } finally {
      ConnectionUtils.closeAllConnectionsIfPooling(securityDb, insertPs);
    }
