...
public class InsightAdministrator {
  ...
  public String addInsight(
      String insightName,
      String layout,
      Collection<String> pixelRecipeToSave,
      boolean global,
      boolean cacheable,
      int cacheMinutes,
      String cacheCron,
    ...
    return addInsight(
        insightName,
        layout,
        pixelRecipeToSave.toArray(new String[] {}),
        global,
        cacheable,
        cacheMinutes,
        cacheCron,
  ...
  public String addInsight(
    ...
    logger.info(
        "Adding new question with recipe :::: "
            + Utility.cleanLogString(Arrays.toString(pixelRecipeToSave)));
  ...
  public String batchInsight(
      PreparedStatement ps,
      String insightId,
      String insightName,
      String layout,
      List<String> pixelRecipeToSave,
      boolean global,
      boolean cacheable,
      int cacheMinutes,
      String cacheCron,
  ...
  public void updateInsightTags(String insightId, List<String> tags) {
    ...
    if (tags != null && !tags.isEmpty()) {
      ...
      query =
          this.queryUtil.createInsertPreparedStatementString(
  ...
  public void updateInsightDescription(String insightId, String description) {
    ...
    try {
      ps =
          this.insightEngine.getPreparedStatement(
      ...
      if (ps.getUpdateCount() == 0) {
        ...
        insertStatement =
            insightEngine.getPreparedStatement(
  ...
  public void updateInsightName(String existingRdbmsId, String insightName) {
    ...
    String query =
        "UPDATE " + TABLE_NAME + " SET " + QUESTION_NAME_COL + "=? WHERE " + QUESTION_ID_COL + "=?";
  ...
  public void updateInsightSchemaName(String existingRdbmsId, String schemaName) {
    ...
    String query =
        "UPDATE " + TABLE_NAME + " SET " + SCHEMA_NAME_COL + "=? WHERE " + QUESTION_ID_COL + "=?";
  ...
  public void updateInsightCache(
      String existingRdbmsId,
      boolean cacheable,
      int cacheMinutes,
      String cacheCron,
  ...
  public void updateInsightCachedOn(String existingRdbmsId, ZonedDateTime cachedOn) {
    ...
    String query =
        "UPDATE " + TABLE_NAME + " SET " + CACHED_ON_COL + "=? WHERE " + QUESTION_ID_COL + "=?";
  ...
  public void batchInsightMetadata(
      PreparedStatement insertPs, String insightId, String metaKey, String metaValue, int order) {
    try {
  ...
  public PreparedStatement getAddInsightPreparedStatement() {
    ...
    try {
      ps =
          insightEngine.bulkInsertPreparedStatement(
              new String[] {
                TABLE_NAME,
                QUESTION_ID_COL,
                QUESTION_NAME_COL,
