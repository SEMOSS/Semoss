...
public class MinioStorageEngine extends AbstractRCloneStorageEngine {
  ...
  /**
   * Yes, this is the minio engine But the keys are the same as S3 with exception of requiring
   * endpoint
   */
  ...
  //		// docker run -p 9000:9000 -p 9001:9001 quay.io/minio/minio server /data --console-address
  // ":9001"
