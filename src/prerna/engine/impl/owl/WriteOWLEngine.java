...
public class WriteOWLEngine extends AbstractOWLEngine implements Closeable {
	...
	// private final SimpleDateFormat DATE_FORMATTER = new
  ...
  // //////////////////////////////////
	 ...
	 *
	 * @param tableName
	 *            For RDF: This is the name of the concept For RDBMS: This is the
	 *            name of the table where the concept exists. If the concept doesn't
	 *            exist, it is assumed the column name of the concept is the same as
	 *            the table name
	 * @param propertyCol
	 *            This will be the name of the property
	 * @param dataType
	 *            The dataType for the property
	 * @param adtlDataType
	 *            Additional data type for the property
  ...
  // //////////////////////////////////
	 ...
	 *
	 * @param childType
	 *            The child concept node
	 * @param parentType
	 *            The parent concept node
	 */
  ...
  // //////////////////////////////////
	 ...
	 *
	 * @param triple
	 *            The triple to load into the engine and into baseDataHash
	 */
