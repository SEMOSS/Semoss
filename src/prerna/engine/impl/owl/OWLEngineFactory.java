...
public class OWLEngineFactory {
  ...
  public OWLEngineFactory(
    ...
    this.writer =
        new WriteOWLEngine(
            this.writeSemaphore, this.baseDataEngine, this.dbType, this.engineId, this.engineName);
  }
  ...
  /**
   * Provides a construct to allow writes to the OWL Must close the WriteOWLEngine to release the
   * lock
   *
   * @return
