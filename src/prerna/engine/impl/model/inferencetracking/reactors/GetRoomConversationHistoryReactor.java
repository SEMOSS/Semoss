...
public class GetRoomConversationHistoryReactor extends AbstractReactor {
	...
	private static final Logger logger = LogManager.getLogger(GetRoomConversationHistoryReactor.class);
	...
	public NounMetadata execute() {
		...
		try {
			...
			logger.error("Unable to load room history for {}", roomId, e);
	...
	private static Map<String, Object> buildPair(InputMessage question, ResponseMessage answer, boolean complete) {
		...
		pair.put("questionType", question != null && question.getMessageType() != null
				? question.getMessageType().name()
				: null);
