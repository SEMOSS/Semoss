...
public class GetRoomMessages2Reactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    List<AbstractMessage> page =
        RoomUtils.getPagedMessages(room.getMessages(), dateSort, offset, limit);
  ...
  private static Map<String, Object> messageToMap(AbstractMessage m) {
    ...
    if (m instanceof prerna.engine.impl.model.message.InputMessage) {
      prerna.engine.impl.model.message.InputMessage im =
          (prerna.engine.impl.model.message.InputMessage) m;
      ...
      prerna.engine.impl.model.message.ResponseMessage rm =
          (prerna.engine.impl.model.message.ResponseMessage) m;
