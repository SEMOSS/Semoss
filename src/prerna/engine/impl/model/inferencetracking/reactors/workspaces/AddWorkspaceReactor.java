	...
	public NounMetadata execute() {
		...
		try {
			ModelInferenceLogsUtils.createNewWorkspaceEntry(workspaceId, owner.getPrimaryLoginToken().getId(),
					workspaceName, workspaceDescription, workspaceSystemPrompt, sharingEnabled, workspaceResources);
		} catch (Exception e) {
		...
		if (sharingEnabled) {
			try {
				ModelInferenceLogsUtils.createWorkspaceProject(owner, workspaceId,
