...
public class SetRoomWorkspaceReactor extends AbstractReactor {
  ...
  public SetRoomWorkspaceReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.ROOM_ID.getKey(), ReactorKeysEnum.WORKSPACE_ID.getKey()};
  ...
  public NounMetadata execute() {
    ...
    ModelInferenceLogsUtils.setRoomWorkspaceId(
        roomId, user.getPrimaryLoginToken().getId(), workspaceId);
