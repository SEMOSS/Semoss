...
public class UpdateRoomOptionsReactor extends AbstractReactor {
	...
	// consider changing to just take in an options param so that diff apps can do
	// what they want
	public UpdateRoomOptionsReactor() {
		this.keysToGet = new String[]{ReactorKeysEnum.ROOM_ID.getKey(), ReactorKeysEnum.VECTORDB.getKey(),
