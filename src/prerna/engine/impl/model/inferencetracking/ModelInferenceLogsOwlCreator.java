...
public class ModelInferenceLogsOwlCreator {
  ...
  private List<Pair<String, Pair<List<String>, Pair<List<String>, List<String>>>>> foreignKeys =
      null;
  ...
  //				Pair.with("WORKSPACE_RESOURCE", Pair.with(Arrays.asList("WORKSPACE_RESOURCE_ID"),
  // Arrays.asList("VARCHAR(255)")))
  //			);
  //	}
  //
  ...
  //				//Pair.with("ROOM", Pair.with(Arrays.asList("AGENT_ID"), Pair.with(Arrays.asList("AGENT"),
  // Arrays.asList("AGENT_ID")))),
  //				Pair.with("MESSAGE", Pair.with(Arrays.asList("INSIGHT_ID","AGENT_ID"),
  // Pair.with(Arrays.asList("ROOM","AGENT"), Arrays.asList("INSIGHT_ID","AGENT_ID")))),
  //				Pair.with("FEEDBACK", Pair.with(Arrays.asList("MESSAGE_ID,MESSAGE_TYPE"),
  // Pair.with(Arrays.asList("MESSAGE"), Arrays.asList("MESSAGE_ID,MESSAGE_TYPE")))),
  ...
  public List<Pair<String, Pair<List<String>, Pair<List<String>, List<String>>>>>
      getDBForeignKeys() {
