...
public class AskTTSModelEngineResponse extends AskModelEngineResponse<Map<String, Object>> {
	 ...
	 *
	 * @param response
	 *            The response map containing TTS data
	 * @param numberOfTokensInPrompt
	 *            Number of tokens in the input prompt
	 * @param numberOfTokensInResponse
	 *            Number of tokens in the response
	 */
	public AskTTSModelEngineResponse(Map<String, Object> response, Integer numberOfTokensInPrompt,
	 ...
	 *
	 * @param response
	 *            JSONObject response from KServe TTS model
	...
	public String getStringResponse() {
		...
		for (Map.Entry<String, Object> entry : response.entrySet()) {
			try {
				...
				classLogger.warn("Failed to add key '{}' to JSON response: {}", entry.getKey(), e.getMessage());
			}
		}
