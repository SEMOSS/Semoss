...
public class ImageModelEngineResponse extends AbstractImageModelEngineResponse<String> {
    ...
    public ImageModelEngineResponse(
        ...
        super(base64Image, file_path, generation_time, seed, prompt, negative_prompt, guidance_scale, num_inference_steps, height, width, model_name, vae_model_name);
    }

    public static ImageModelEngineResponse fromMap(Map<String, Object> modelResponse) {
    	String base64Image = (String) modelResponse.get(BASE64_IMAGE);
        ...
        Number guidance_scale = (Double) modelResponse.get(GUIDANCE_SCALE);
        ...
        return new ImageModelEngineResponse(base64Image, file_path, generation_time, seed, prompt, negative_prompt, guidance_scale, num_inference_steps, height, width, model_name, vae_model_name);
    }
