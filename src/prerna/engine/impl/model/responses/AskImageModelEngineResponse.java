...
public class AskImageModelEngineResponse extends AskModelEngineResponse<Map<String, Object>> {
   ...
   */
  public AskImageModelEngineResponse(
   ...
   */
  public static AskImageModelEngineResponse getOpenAIImageResponse(
      List<String> imageList, Integer numberOfTokensInPrompt, Integer numberOfTokensInResponse) {
    ...
    return new AskImageModelEngineResponse(
        responseMap, numberOfTokensInPrompt, numberOfTokensInResponse);
  }
