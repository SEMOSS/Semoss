...
public class AskStringModelEngineResponse extends AskModelEngineResponse<String> {
	...
	public AskStringModelEngineResponse(String response, Integer numberOfTokensInPrompt,
	...
	/**
	 * Creates an AskModelEngineResponse from a JSONObject returned by the KServe
	 * adapter
	 *
	 * @param jsonResponse
	 *            The JSONObject from makeModelRequest
	...
	public static AskStringModelEngineResponse fromJson(JSONObject jsonResponse) {
		...
		AskStringModelEngineResponse response = new AskStringModelEngineResponse(responseText, promptTokens,
				responseTokens);
