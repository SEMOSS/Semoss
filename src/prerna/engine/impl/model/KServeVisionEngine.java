...
public class KServeVisionEngine extends AbstractRemoteModelEngine {
  ...
  @Override
  public AskStringModelEngineResponse askCall(
      String question,
      Object fullPrompt,
      String context,
      Insight insight,
    ...
    if (hyperParameters != null && hyperParameters.containsKey("image_url")) {
      ...
      AskStringModelEngineResponse response =
          new AskStringModelEngineResponse("Please provide an image parameter.", 0, 0);
      return response;
    }
    ...
    try {
      ...
      return new AskStringModelEngineResponse(
          "An error occurred while processing the request: " + e.getMessage(), 0, 10);
    }
  }
