	...
	public List<String> keywordExtraction(Object input, Insight insight, Map<String, Object> parameters) {
		...
		if (inferenceLogsEnbaled) {
			...
			Thread inferenceRecorder = new Thread(new ModelEngineInferenceLogsWorker(/* messageId */ messageId,
					/* messageMethod */ "textKeywords", /* engine */ this, /* insightId */ insight.getInsightId(),
					...
					/* roomId */ ThreadStore.getInsightId(), /* context */ null, /* prompt */ input + "",
					/* fullPrompt */ null, /* promptTokens */ null, /* inputTime */ inputTime,
					/* response */ PyUtils.determineStringType(keywordExtractionResponse), /* responseTokens */ null,
