 ...
 *
 * <p>Builder requires Room; you cannot use it without.
 */
public class InputMessage extends AbstractMessage {
  ...
  private Map<String, Object>
      toolParameterValues; // For tool parameter values that produced the output
  ...
  public void addImage(String imagePath, Room room) {
    ...
    ImageInfo imageData =
        ImageInfo.fromFile(imagePath, room.getId(), messageId, room.getRoomFolderPath());
  ...
  public static InputMessage toolExecution(
      Room room,
      String toolCallId,
      String toolName,
      String content,
  ...
  public static class Builder {
    ...
    public Builder withToolExecution(
        String toolCallId, String name, String content, Map<String, Object> toolParameterValues) {
