...
public class TextGenerationInferenceRestEngine extends AbstractRESTModelEngine {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(TextGenerationInferenceRestEngine.class);
  ...
  public void open(Properties smssProp) throws Exception {
    ...
    if (maxTokensStr != null && !(maxTokensStr = maxTokensStr.trim()).isEmpty()) {
      try {
        ...
        classLogger.error(
            "Invalid maxTokens input for engine "
    ...
    if (maxInputTokensStr != null && !(maxInputTokensStr = maxInputTokensStr.trim()).isEmpty()) {
      try {
        ...
        classLogger.error(
            "Invalid maxInputTokens input for engine "
                + SmssUtilities.getUniqueName(this.engineName, this.engineId));
        classLogger.error(Constants.STACKTRACE, e);
      }
    }
  ...
  private Map<String, Object> adjustHyperParameters(Map<String, Object> hyperParameters) {
    ...
    if (hyperParameters.get("best_of") != null
        && !(hyperParameters.get("best_of") instanceof Integer)) {
    ...
    if (hyperParameters.get("decoder_input_details") != null
        && !(hyperParameters.get("decoder_input_details") instanceof Boolean)) {
      throw new IllegalArgumentException(
          "The hyperparameter decoder_input_details is set but is not a boolean.");
    }
    ...
    if (!hyperParameters.containsKey("do_sample")) {
      ...
      throw new IllegalArgumentException(
          "The hyperparameter do_sample is set but is not a boolean.");
    }

    if (hyperParameters.get("max_new_tokens") != null
        && !(hyperParameters.get("max_new_tokens") instanceof Integer)) {
      throw new IllegalArgumentException(
          "The hyperparameter max_new_tokens is set but is not a integer.");
    }
    ...
    if (!hyperParameters.containsKey("return_full_text")) {
      ...
      throw new IllegalArgumentException(
          "The hyperparameter top_logprobs is set but is not an boolean.");
    }

    if (hyperParameters.get("seed") != null && !(hyperParameters.get("seed") instanceof Integer)) {
      throw new IllegalArgumentException(
          "The hyperparameter do_sample is set but is not a integer.");
    }
    ...
    if (hyperParameters.get("stop") != null) {
      ...
      if (stopListObject instanceof List<?>) {
        ...
        if (!allStrings) {
          throw new IllegalArgumentException(
              "The hyperparameter 'stop' is set but is not a list of strings.");
        }
      } else {
    ...
    if (hyperParameters.get("top_k") != null
        && !(hyperParameters.get("top_k") instanceof Integer)) {
    ...
    if (hyperParameters.get("typical_p") != null
        && !(hyperParameters.get("typical_p") instanceof Number)) {
      throw new IllegalArgumentException(
          "The hyperparameter typical_p is set but is not a number.");
    }
    ...
    if (hyperParameters.get("watermark") != null
        && !(hyperParameters.get("watermark") instanceof Boolean)) {
      throw new IllegalArgumentException(
          "The hyperparameter watermark is set but is not an boolean.");
    }
   ...
   * @return
   */
  protected IModelEngineResponseHandler handleDeserialization(
      String responseData, Class<? extends IModelEngineResponseHandler> responseType) {
    Gson gson = new Gson();
  ...
  public static class TextGenPayload implements IModelEngineResponseHandler {
    ...
    public Object getResponse() {
      return this.response != null
          ? this.response
          : this.getGeneratedItems().get(0).getGenerated_text();
    }

    public List<GeneratedTextItem> getGeneratedItems() {
      return this.generatedItems;
    }

    public void setGeneratedItems(List<GeneratedTextItem> generatedItems) {
    ...
    public class GeneratedTextItem {
      ...
      public GeneratedTextDetails getDetails() {
        return this.details;
      }

      public void setDetails(GeneratedTextDetails details) {
      ...
      public class GeneratedTextDetails {
        ...
        private List<Object>
            prefill; // Use List<Object> if the type of list elements is unknown or can vary
        ...
        public void setGeneratedTokens(int generatedTokens) {
          this.generated_tokens = generatedTokens;
        }
        ...
        public List<Object> getPrefill() {
          return this.prefill;
        }

        public void setPrefill(List<Object> prefill) {
  ...
  //		AskModelEngineResponse response = engine.ask("tell me a joke", null, insight, new
  // HashMap<>());
