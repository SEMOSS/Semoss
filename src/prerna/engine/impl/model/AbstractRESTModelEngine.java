...
public abstract class AbstractRESTModelEngine extends AbstractModelEngine {
  ...
  /**
   * This method defined what should happen when the timeout is reached. Currently this is an
   * abstract method until conversation history / chains are standardized.
   */
   ...
   * @return
   */
  protected IModelEngineResponseHandler postRequestStringBody(
      String url,
    ...
    try {
      ...
      if (statusCode >= 200 && statusCode < 300) {
            ...
            try (BufferedReader reader =
              ...
              while ((line = reader.readLine()) != null) {
                ...
                if (line.startsWith("data:")) {
                  ...
                  IModelEngineResponseStreamHandler partialObject =
                      new Gson().fromJson(jsonPart, responseObject.getStreamHandlerClass());
        ...
        throw new IllegalArgumentException(
            "Connected to " + url + " but received error = " + errorResponse);
      }
  ...
  /**
   * This method is intended to be overridden in an implementing class if the responseData requires
   * more unique deserialization than gson.fromJson() can provide
   *
   * @param responseData
   * @param responseType
   * @return
