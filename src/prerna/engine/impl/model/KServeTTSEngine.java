...
public class KServeTTSEngine extends AbstractRemoteModelEngine {
  ...
  @Override
  public AskTTSModelEngineResponse askCall(
      String question,
      Object fullPrompt,
      String context,
      Insight insight,
    ...
    try {
      ...
      if (modelResponse != null) {
        AskTTSModelEngineResponse ttsResponse =
            AskTTSModelEngineResponse.getKServeTTSResponse(modelResponse);

        classLogger.debug(
            "TTS response received - Format: {}, Duration: {}, Voice: {}",
