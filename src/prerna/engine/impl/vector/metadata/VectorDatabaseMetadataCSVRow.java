...
public class VectorDatabaseMetadataCSVRow {
	...
	public VectorDatabaseMetadataCSVRow(String source, String attribute, String strValue, Number intValue,
			Number numValue, Boolean boolValue, SemossDate dateValue, SemossDate timestampValue) {
		this.source = source;
