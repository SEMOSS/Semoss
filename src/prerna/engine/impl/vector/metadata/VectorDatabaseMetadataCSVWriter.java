...
public class VectorDatabaseMetadataCSVWriter {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(VectorDatabaseMetadataCSVWriter.class);
  ...
  protected void writeHeader() {
    StringBuffer row =
        new StringBuffer()
            .append(VectorDatabaseMetadataCSVTable.SOURCE)
            .append(",")
            .append(VectorDatabaseMetadataCSVTable.ATTRIBUTE)
            .append(",")
            .append(VectorDatabaseMetadataCSVTable.STR_VALUE)
            .append(",")
            .append(VectorDatabaseMetadataCSVTable.INT_VALUE)
            .append(",")
            .append(VectorDatabaseMetadataCSVTable.NUM_VALUE)
            .append(",")
            .append(VectorDatabaseMetadataCSVTable.BOOL_VALUE)
            .append(",")
            .append(VectorDatabaseMetadataCSVTable.DATE_VAL)
            .append(",")
  ...
  public void writeRow(
    ...
    StringBuilder row =
        new StringBuilder()
            ...
            .append(",")
            .append("\"")
            .append(cleanString(attributeName))
            .append("\"")
            .append(",")
            .append("\"")
            .append(cleanStringRetEmpty(strValue))
            .append("\"")
            .append(",")
            .append(intValue)
            .append(",")
