...
public class VectorDatabaseMetadataCSVWriter {
	...
	protected void writeHeader() {
		StringBuffer row = new StringBuffer().append(VectorDatabaseMetadataCSVTable.SOURCE).append(",")
				...
				.append(VectorDatabaseMetadataCSVTable.TIMESTAMP_VAL).append("\r\n");
		this.pw.print(row + "");
	...
	public void writeRow(String source, String attributeName, String strValue, Integer intValue, Number numValue,
		...
		StringBuilder row = new StringBuilder().append("\"").append(cleanString(source)).append("\"").append(",")
				.append("\"").append(cleanString(attributeName)).append("\"").append(",").append("\"")
				.append(cleanStringRetEmpty(strValue)).append("\"").append(",").append(intValue).append(",")
				.append(numValue).append(",").append(boolValue).append(",").append("\"").append(dateValue).append("\"")
				.append(",").append("\"").append(timestampValue).append("\"").append("\r\n");
