...
public final class PGVectorQueryMetaFitlerTranslationHelper {
  ...
  public static List<IQueryFilter> convertFilters(
      List<IQueryFilter> origFilters, String tableName) {
  ...
  private static IQueryFilter convertSimpleQueryFilter(
      SimpleQueryFilter queryFilter, String tableName) {
    /*
    ...
    if (origL.getNounType() == PixelDataType.COLUMN) {
      ...
      SimpleQueryFilter attributeFilter =
          new SimpleQueryFilter(
              new NounMetadata(
                  new QueryColumnSelector(
                      tableName + "__" + VectorDatabaseMetadataCSVTable.ATTRIBUTE),
                  PixelDataType.COLUMN),
              "==",
              new NounMetadata(
                  ((QueryColumnSelector) origL.getValue()).getTable(), PixelDataType.CONST_STRING));
    ...
    //		}
      ...
      SimpleQueryFilter valueFilter =
          constructValueFilter(origL, tableName, queryFilter.getComparator());
    ...
    if (origR.getNounType() == PixelDataType.COLUMN) {
      ...
      SimpleQueryFilter attributeFilter =
          new SimpleQueryFilter(
              ...
              "==",
              new NounMetadata(
                  ((QueryColumnSelector) origR.getValue()).getTable(), PixelDataType.CONST_STRING));
      newAndFilter.addFilter(attributeFilter);
    }
    // Not going to handle a subquery against the pgvector at this point..
    ...
    //		}
      ...
      SimpleQueryFilter valueFilter =
          constructValueFilter(origR, tableName, queryFilter.getComparator());
      newAndFilter.addFilter(valueFilter);
    }
  ...
  private static SimpleQueryFilter constructValueFilter(
      NounMetadata existingValue, String tableName, String comparator) {
    ...
    if (dataType == PixelDataType.CONST_STRING) {
      SimpleQueryFilter valueFilter =
          new SimpleQueryFilter(
              new NounMetadata(
                  new QueryColumnSelector(
                      tableName + "__" + VectorDatabaseMetadataCSVTable.STR_VALUE),
                  PixelDataType.COLUMN),
              comparator,
      ...
      SimpleQueryFilter valueFilter =
          new SimpleQueryFilter(
              new NounMetadata(
                  new QueryColumnSelector(
                      tableName + "__" + VectorDatabaseMetadataCSVTable.INT_VALUE),
                  PixelDataType.COLUMN),
              comparator,
      ...
      SimpleQueryFilter valueFilter =
          new SimpleQueryFilter(
              new NounMetadata(
                  new QueryColumnSelector(
                      tableName + "__" + VectorDatabaseMetadataCSVTable.NUM_VALUE),
                  PixelDataType.COLUMN),
              comparator,
      ...
      SimpleQueryFilter valueFilter =
          new SimpleQueryFilter(
              new NounMetadata(
                  new QueryColumnSelector(
                      tableName + "__" + VectorDatabaseMetadataCSVTable.BOOL_VALUE),
                  PixelDataType.COLUMN),
              comparator,
      ...
      SimpleQueryFilter valueFilter =
          new SimpleQueryFilter(
              new NounMetadata(
                  new QueryColumnSelector(
                      tableName + "__" + VectorDatabaseMetadataCSVTable.DATE_VAL),
                  PixelDataType.COLUMN),
              comparator,
      ...
      SimpleQueryFilter valueFilter =
          new SimpleQueryFilter(
              new NounMetadata(
                  new QueryColumnSelector(
                      tableName + "__" + VectorDatabaseMetadataCSVTable.TIMESTAMP_VAL),
                  PixelDataType.COLUMN),
              comparator,
