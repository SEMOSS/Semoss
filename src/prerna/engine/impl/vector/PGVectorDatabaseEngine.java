...
public class PGVectorDatabaseEngine extends RDBMSNativeEngine implements IVectorDatabaseEngine {
	...
	public void open(Properties smssProp) throws Exception {
		...
		// this.defaultExtractionMethod =
		// this.smssProp.getProperty(Constants.EXTRACTION_METHOD,
		// "None");
	...
	public List<FileEmbeddingStatus> addEmbeddings(VectorDatabaseCSVTable vectorCsvTable, Insight insight,
		...
		try {
			...
			// if
			// (parameters.containsKey(VectorDatabaseParamOptionsEnum.KEYWORD_SEARCH_PARAM.getKey()))
			// {
  ...
  //////////////////////////////////////////////////////////////////////////
	...
	public List<FileEmbeddingStatus> addDocument(List<String> filePaths, Map<String, Object> parameters)
		...
		// if
		// (parameters.containsKey(VectorDatabaseParamOptionsEnum.EXTRACTION_METHOD.getKey()))
		// {
	...
	public List<Map<String, Object>> nearestNeighbor(Insight insight, String searchStatement, Number limit,
		...
		if (inferenceLogsEnbaled && this.keepInputOutput) {
			...
			Thread inferenceRecorder = new Thread(new ModelEngineInferenceLogsWorker(
					/* messageId */ UUID.randomUUID().toString(), /* messageMethod */ "nearestNeighbor",
					/* engine */ this, /* insightId */ insight.getInsightId(),
					...
					/* roomId */ ThreadStore.getInsightId(), /* context */ null, /* prompt */ searchStatement,
					/* fullPrompt */ null, /* promptTokens */ null, /* inputTime */ inputTime,
					/* response */ gson.toJson(vectorSearchResponse), /* responseTokens */ null,
