...
//		}
	...
	private String getDefaultBM25IndexDir() {
	    File bm25Dir = new File(this.schemaFolder, "bm25_index");
	    if (!bm25Dir.exists()) {
	        bm25Dir.mkdirs(); // Ensure the directory exists
	    }
	    return bm25Dir.getAbsolutePath();
	}
}
