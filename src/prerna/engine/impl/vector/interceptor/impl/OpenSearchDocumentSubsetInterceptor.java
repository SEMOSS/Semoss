...
public class OpenSearchDocumentSubsetInterceptor extends AbstractDocumentSubsetInterceptor {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(OpenSearchDocumentSubsetInterceptor.class);
  protected static final String FILE_SEPARATOR = "/";

  public static final Set<String> INTERCEPTED_METHOD_NAMES =
      Sets.newHashSet(
          "listAllRecords",
          "listDocuments",
          "nearestNeighbor",
  ...
  public OpenSearchDocumentSubsetInterceptor(
  ...
  @Override
  public Object intercept(Object obj, Method method, Object[] args, MethodProxy proxyMethod)
      throws Throwable {
  ...
  @SuppressWarnings("unchecked")
  public Object doIntercept(Object obj, Method method, Object[] args, MethodProxy proxy)
      throws Throwable {
  ...
  /**
   * Persist the filtered documents subset to disk, in the proxy's .smss Updates the
   * TARGET_PARAMETERS field, which is a JSON array
   */
  private void writeBackDocumentSubset(AbstractEngine proxyEngine, Set<String> subset)
      throws IOException {
  ...
  public String getDocumentsFilesPath(AbstractVectorDatabaseEngine proxyEngine, String indexClass) {
    ...
    String engineDir =
        EngineUtility.getSpecificEngineAssetsFolder(
            IEngine.CATALOG_TYPE.VECTOR, proxyEngine.getEngineId(), proxyEngine.getEngineName());
