...
public abstract class AbstractInterceptor implements MethodInterceptor {
	...
	public AbstractInterceptor(IVectorDatabaseEngine proxyEngine, IVectorDatabaseEngine targetEngine,
	...
	public static MethodInterceptor buildInterceptor(String interceptorClassName, IVectorDatabaseEngine proxy,
			IVectorDatabaseEngine target, Object[] constructorArgs) throws Exception {
	...
	@SuppressWarnings("unchecked")
	public static <T extends MethodInterceptor> T buildInterceptor(Class<T> interceptorClass,
			IVectorDatabaseEngine proxy, IVectorDatabaseEngine target, Object[] constructorArgs) throws Exception {
		Constructor<?> constructor;
		try {
			constructor = interceptorClass.getConstructor(IVectorDatabaseEngine.class, IVectorDatabaseEngine.class,
					Object[].class);
