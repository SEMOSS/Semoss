...
/**
 * The intention of this class is to build the new project structure from legacy old db folders.
 * Assumption is that this code just runs once. It will read the existing app data from the existing
 * baseFolder/db/ folder and populate the baseFolder/project/ folder. Below is how the new folder
 * structure will be(might need changes).
 *
 * <p>baseFolder | |- db | |- Name1__UUID | |- Name2__UUID | |- project | |- Project1__UUID | | |-
 * version | | |- insights.db | | | |- Project2_UUID | | |- version | | |- insights.db | |- user |
 * |- Asset__UUID | | |- version | |- Asset__UUID | | |- version
 */
public class LegacyToProjectRestructurerHelper {

  private static final Logger classLogger =
      LogManager.getLogger(LegacyToProjectRestructurerHelper.class);
  ...
  public void userCopyDataToNewFolderStructure(
      String dbFolderName, String baseProjFolder, String dbDir, boolean isAsset)
      throws IOException {
  ...
  public void userScanAndCopyVersionsIntoNewProjectFolder(
      String newUserFolder, String dbFolder, boolean isAsset) throws IOException {
  ...
  public void userScanAndCopyInsightsDatabaseIntoNewProjectFolder(
      String newUserFolder, String dbFolder, boolean isAsset) throws IOException {
  ...
  // Create the project smss file. Do we need to modify the existing smss under /db? For now leaving
  // that modification.
  private void userCreateSmssFiles(
      String dbDir,
      String newProjectFolder,
      String dbSmssFileName,
      String projectName,
      String projectId,
      boolean isAsset)
      throws IOException {
  ...
  private void userCreateProjectSmssFile(
      String projectName, String projectId, boolean isAsset, String dbSmssFile) throws IOException {
    ...
    File tempProjectSmss =
        SmssUtilities.createTemporaryAssetAndWorkspaceSmss(
            projectId, projectName, isAsset, existingRdbmsType);
  ...
  private void modifyOldDBSmss(String oldSmssFilePath, String oldSmssFileName) throws IOException {
    String newSmssPath =
        this.baseFolder + ENGINE_DIRECTORY + oldSmssFileName + ".temp_app_breakout";
  ...
  // Helper method to copy versions to the project folder.
  private void scanAndCopyVersionsIntoNewProjectFolder(String newProjectFolder, String dbFolder)
      throws IOException {
    String newVersionPath =
        newProjectFolder + DIR_SEPARATOR + "app_root" + DIR_SEPARATOR + "version";
  ...
  // Helper method to copy insights db to the project folder.
  private void scanAndCopyInsightsDatabaseIntoNewProjectFolder(
      String newProjectFolder, String dbFolder) throws IOException {
    String oldInsightsDatabase_mv_db = dbFolder + DIR_SEPARATOR + "insights_database.mv.db";
  ...
  // Create the project smss
  private void createProjectSmssFile(String projectName, String projectId, String dbSmssFile)
      throws IOException {
