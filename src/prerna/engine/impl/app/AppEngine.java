...
public class AppEngine extends AbstractDatabaseEngine {
	...
	/**
	 * Overriding the default behavior Do not need to do anything except load the
	 * insights database
	 *
	 * @throws Exception
	 */
  ...
  ////////////////////////////////////////////////////////////
	...
	/*
	 * Need to clean the interface to allow for what we are doing APP is a wrapper
	 * around a set of insights (parameterized insights) Where we allow the swapping
	 * of data on the insights
	 *
