...
/**
 * A Properties implementation that treats string keys in a case-insensitive manner.
 * All string keys are normalized to uppercase internally for consistent lookup.
 */
public class CaseInsensitiveProperties extends Properties implements Serializable {
    ...
    /**
     * Returns an enumeration of the property names, preserving the normalized (uppercase) form.
     * Note: The returned keys will be in uppercase form as they are stored internally.
     */
    @Override
    ...
    /**
     * Returns a set of keys, preserving the normalized (uppercase) form.
     * Note: The returned keys will be in uppercase form as they are stored internally.
     */
    @Override
