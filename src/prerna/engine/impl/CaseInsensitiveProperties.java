...
/**
 * A Properties implementation that treats string keys in a case-insensitive
 * manner. All string keys are normalized to uppercase internally for consistent
 * lookup.
 */
public class CaseInsensitiveProperties extends Properties implements Serializable {
	...
	/**
	 * Creates a case-insensitive properties object with the same mappings as the
	 * given Properties. All string keys from the source properties are normalized
	 * to uppercase.
	 *
	 * @param properties
	 ...
	 * @return the normalized key (uppercase if string), or the original key if not
	 *         a string
	 */
	...
	/**
	 * Returns an enumeration of the property names, preserving the normalized
	 * (uppercase) form. Note: The returned keys will be in uppercase form as they
	...
	/**
	 * Returns a set of keys, preserving the normalized (uppercase) form. Note: The
	 * returned keys will be in uppercase form as they are stored internally.
	 */
	@Override
