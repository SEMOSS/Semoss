...
public class TinkerEngine extends AbstractDatabaseEngine {
  ...
  public void commit() {
    try {
      ...
      TINKER_DRIVER tinkerDriver =
          TINKER_DRIVER.valueOf(smssProp.getProperty(Constants.TINKER_DRIVER));
      ...
      classLogger.info(
          "Successfully saved graph to file: "
  ...
  public Vector<Object> getEntityOfType(String typeUri) {
    ...
    // case for concept
      ...
      vertIt =
          g.traversal()
              .V()
              .has(TinkerFrame.TINKER_TYPE, conceptType)
              .values(TinkerFrame.TINKER_NAME);
    }
  ...
  public IQueryInterpreter getQueryInterpreter() {
    GremlinNoEdgeBindInterpreter interp =
        new GremlinNoEdgeBindInterpreter(this.g.traversal(), this.typeMap, this.nameMap, this);
  ...
  public Vertex upsertVertex(Object[] args) {
    ...
    GraphTraversal<Vertex, Vertex> gt =
        g.traversal().V().has(TinkerFrame.TINKER_ID, type + ":" + data);
    ...
    if (gt.hasNext()) {
      ...
      retVertex =
          g.addVertex(
              ...
              type + ":" + data,
              TinkerFrame.TINKER_TYPE,
              type,
              TinkerFrame.TINKER_NAME,
              data);
    }
    return retVertex;
  }
