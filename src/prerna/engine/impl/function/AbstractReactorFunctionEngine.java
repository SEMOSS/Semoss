...
public abstract class AbstractReactorFunctionEngine extends AbstractReactor
    implements IReactorFunctionEngine {

  private static final Logger classLogger =
      LogManager.getLogger(AbstractReactorFunctionEngine.class);
  ...
  protected void checkOptional(Map<String, String> keyValue) {
    ...
    for (int keyIndex = 0;
        this.keyRequired != null && keyIndex < this.keyRequired.length;
        keyIndex++) {
  ...
  public void delete() throws IOException {
    classLogger.debug(
        "Delete function engine " + SmssUtilities.getUniqueName(this.engineName, this.engineId));
    try {
      this.close();
    } catch (IOException e) {
