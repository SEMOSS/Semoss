...
public class LocalPythonCustomEmbeddingsFunctionEngine extends LocalPythonFunctionEngine
  ...
  private static final Logger classLogger =
      LogManager.getLogger(LocalPythonCustomEmbeddingsFunctionEngine.class);
  ...
  public int processDocument(
    ...
    callMaker
        .append("(outputCsvFilePath=")
        .append(PyUtils.determineStringType(outputCsvFilePath))
        .append(",fileToProcess=")
        .append(PyUtils.determineStringType(fileToProcess))
        .append(",parameters=")
