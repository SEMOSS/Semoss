...
public class DataStaxGraphIterator implements Iterator<IHeadersDataRow> {
  ...
  public DataStaxGraphIterator(
      Iterator composeIterator, SelectQueryStruct qs, Map<String, String> typeMap) {
  ...
  public DataStaxGraphIterator(
      Iterator composeIterator, SelectQueryStruct qs, OwlTemporalEngineMeta meta) {
    this.baseIterator = composeIterator;
    this.qs = qs;
