...
/**
 * Holds the database in memory, and uses the Jena API to facilitate querying of
 * RDF data sources.
 */
public class InMemoryJenaEngine extends AbstractDatabaseEngine implements IRDFDatabase {
	 ...
	 *
	 * @param jenaModel
	 *            Model - Name of the model that this is being set to.
	 */
	...
	/**
	 * Processes a SELECT query just like {@link #execSelectQuery(String)} but then
	 * parses the results to get only their instance names. These instance names are
	 * then returned as the Vector of Strings.
	 *
	 * @param sparqlQuery
