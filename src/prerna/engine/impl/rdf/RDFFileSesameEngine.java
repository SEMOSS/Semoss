...
/**
 * References the RDF source and uses the Sesame API to query a database stored
 * in an RDF file
 */
public class RDFFileSesameEngine extends AbstractDatabaseEngine implements ISesameRDFEngine {
	...
	public void exportDB() throws Exception {
		...
		try (OutputStreamWriter writer = new OutputStreamWriter(new FileOutputStream(Utility.normalizePath(filePath)),
