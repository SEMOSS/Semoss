...
public class RdfUploadReactorUtility {
	 ...
	 *            String containing the subject node type
	 * @param objectNodeType
	 *            String containing the object node type
	 * @param instanceSubjectName
	 *            String containing the name of the subject instance
	 * @param instanceObjectName
	 *            String containing the name of the object instance
	 * @param relName
	 *            String containing the name of the relationship between the subject
	 *            and object
	 * @param propHash
	 *            Hashtable that contains all properties
	 * @param allStatementInserts
	 *            Store all the triples in this list
	 */
	 ...
	 *
	 * @param propInstanceURI
	 *            String containing the URI of the property at the instance level
	 * @param basePropURI
	 *            String containing the base URI of the property at SEMOSS level
	 * @param subjectNodeURI
	 *            String containing the URI of the subject at the instance level
	 * @param allStatementInserts
	 */
