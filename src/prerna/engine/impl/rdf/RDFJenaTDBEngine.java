...
/**
 * References the RDF source and uses the Jena API to query a database stored in
 * an RDF file
 */
public class RDFJenaTDBEngine extends AbstractDatabaseEngine implements IRDFDatabase {
	...
	public void open(Properties smssProp) throws Exception {
		super.open(smssProp);
		this.fileLocation = EngineUtility.getSpecificEngineBaseFolder(this.getCatalogType(), this.getEngineId(),
				this.getEngineName());
