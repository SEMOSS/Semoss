...
//		final String DOUBLE_DATATYPE_NAME = queryUtil.getDoubleDataTypeName();
		...
		this.auditLogsColumns = Arrays.asList(Pair.with("LOG_ID", "VARCHAR(255)"),
				...
				Pair.with("USER_TYPE", "VARCHAR(255)"), Pair.with("SPAN_ID", "VARCHAR(255)"),
				Pair.with("INSIGHT_ID", "VARCHAR(255)"), Pair.with("PROJECT_ID", "VARCHAR(255)"),
				Pair.with("PROJECT_NAME", "VARCHAR(255)"), Pair.with("ROOM_ID", "VARCHAR(255)"),
				Pair.with("ENGINE_ID", "VARCHAR(255)"), Pair.with("ENGINE_NAME", "VARCHAR(255)"),
				Pair.with("ENGINE_TYPE", "VARCHAR(255)"), Pair.with("METHOD_NAME", "VARCHAR(255)"),
				Pair.with("ENGINE_SUBTYPE", "VARCHAR(255)"), Pair.with("INPUT_REACTOR_NAME", "VARCHAR(255)"),
				Pair.with("OUTPUT_REACTOR_NAME", "VARCHAR(255)"), Pair.with("MESSAGE", CLOB_DATATYPE_NAME),
