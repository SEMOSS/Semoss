...
public enum FunctionTypeEnum {
  ...
  AWS_TEXTRACT_CUSTOM_EMBEDDINGS(
      "AWS_TEXTRACT_CUSTOM_EMBEDDINGS", AWSTextractCustomEmbeddingsFunctionEngine.class.getName()),
  AZURE_DOCUMENT_INTELLIGENCE_CUSTOM_EMBEDDINGS(
      "AZURE_DOCUMENT_INTELLIGENCE_CUSTOM_EMBEDDINGS",
      AzureDocumentIntelligenceCustomEmbeddingsFuntionEngine.class.getName()),
  GOOGLE_OCR_CUSTOM_EMBEDDINGS(
      "GOOGLE_OCR_CUSTOM_EMBEDDINGS", GoogleOCRCustomEmbeddingsFunctionEngine.class.getName()),
