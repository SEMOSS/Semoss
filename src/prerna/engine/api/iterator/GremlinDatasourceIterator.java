...
public class GremlinDatasourceIterator extends AbstractDatasourceIterator {
	...
	public GremlinDatasourceIterator(GremlinInterpreter interp, SelectQueryStruct qs) {
		this.interp = interp;
		this.qs = qs;
		this.nameMap = interp.getNameMap();
	}
	
	public GremlinDatasourceIterator(GremlinInterpreter interp, SelectQueryStruct qs, OwlTemporalEngineMeta meta) {
		this.interp = interp;
		this.qs = qs;
	}
	...
	public static void main(String[] args) {
		...
		GremlinDatasourceIterator it = new GremlinDatasourceIterator(interp, qs);
		it.execute();
