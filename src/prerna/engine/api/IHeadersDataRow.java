...
public interface IHeadersDataRow {
  ...
  /**
   * Get the raw headers This is useful when we alias headers to be unique during loops
   *
   * @return
   */
  ...
  /**
   * Get the raw values This is useful if you want to see full URIs from a RDF engine
   *
   * @return
   */
  Object[] getRawValues();
