...
public interface IRCloneStorage extends IStorageEngine {
  ...
  /**
   * This method is responsible for creating the specific r clone configuration object for this
   * storage type
   *
   * @throws IOException
  ...
  /**
   * Lists the folders and files for the relative path provided Note - not recursive
   *
   * @param path
   * @param rCloneConfig
   * @return
   ...
   * @throws InterruptedException
   */
  List<Map<String, Object>> listDetails(String path, String rCloneConfig)
  ...
  /**
   * Delete the folder or file from the storage engine Will delete the directory structure
   *
   * @param storageFilePath
   * @param rCloneConfig
   * @throws IOException
   * @throws InterruptedException
   */
  void deleteFromStorage(String storageFilePath, String rCloneConfig)
      throws IOException, InterruptedException;
