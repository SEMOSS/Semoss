...
public abstract class AbstractReactor implements IScriptReactor {
	...
	//
	protected String[] whatIReactTo = { PKQLEnum.EXPLAIN };
	...
	private String[] pkqlDefinition = { "title", "pkqlCommand", "description", "showMenu", "pinned", "input",
			"console" };
	...
	public void setPKQLMetaData(String title, String pkqlCommand, String description, boolean showMenu,
		...
		for (String pkqlDef : pkqlDefinition) {
			switch (pkqlDef) {
			case "title":
				this.pkqlMetaData.put(pkqlDef, title);
				break;
			case "pkqlCommand":
				this.pkqlMetaData.put(pkqlDef, pkqlCommand);
				break;
			case "description":
				this.pkqlMetaData.put(pkqlDef, description);
				break;
			case "showMenu":
				this.pkqlMetaData.put(pkqlDef, showMenu);
				break;
			case "pinned":
				this.pkqlMetaData.put(pkqlDef, pinned);
				break;
			}
		}
	}
