...
public final class AInsightidJoinGroup extends PJoinGroup
{
    private PWordOrNum _wordOrNum_;

    public AInsightidJoinGroup()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AInsightidJoinGroup(
    ...
    {
        ((Analysis) sw).caseAInsightidJoinGroup(this);
    }
