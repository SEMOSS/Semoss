...
public final class ARawApiImportBlock extends PImportBlock
{
    private PRawApiBlock _rawApiBlock_;

    public ARawApiImportBlock()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseARawApiImportBlock(this);
    }
