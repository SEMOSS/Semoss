...
// parentReactor.getName().equalsIgnoreCase("EXPR"))
// }
//
// @Override
// public Object Out()
...
//
// // additionally.. if I do see a parent reactor.. I should add this as the
// input to the parent
...
// */
// }
// // the case below should not actually happen.. it should be done through the
// script chain
...
// baseClass = "LambdaPy";
// }
// if(language.toLowerCase().contains("r")) // good luck if you want prolog it
// will still be R :)
// {
