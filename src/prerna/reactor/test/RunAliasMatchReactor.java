  ...
  public NounMetadata execute() {
    ...
    if (inputIterator != null) {
      while (inputIterator.hasNext()) {
        ...
        int aliasIndex =
            ArrayUtilityMethods.arrayContainsValueAtIndexIgnoreCase(headers, aliasHeader);
        int hashIndex =
            ArrayUtilityMethods.arrayContainsValueAtIndexIgnoreCase(headers, hashCodeHeader);
