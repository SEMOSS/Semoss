...
public class PixelGenerator {
	...
	private String generatePixelFormula() {
		...
		if (randomint == 0)
			return generateNewPixel(probabilityOfReactor);
		else
			return generateNewPixelValue(probabilityOfReactor) + getRandomOperator()
					+ generateNewPixelValue(probabilityOfReactor);
	}
