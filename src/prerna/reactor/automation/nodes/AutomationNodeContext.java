...
/**
 * Single param object bundling everything an {@link IAutomationNodeExecutor} needs to run one
 ...
 * @param node               this node's full definition from {@code automation.json}
 ...
 * @param configMap          the automation's {@code automation-config.json} key/value pairs
 ...
 *                           {@code SubAutomationNodeExecutor} for the self/transitive-call cycle
 *                           guard
 ...
 * @param childAutomationRunner runs an entire target project's automation graph as a nested child
 *                           run - see {@link ChildAutomationRunner}. Only used by
 *                           {@code SubAutomationNodeExecutor}
 */
public record AutomationNodeContext(
		...
		ChildAutomationRunner childAutomationRunner) {
