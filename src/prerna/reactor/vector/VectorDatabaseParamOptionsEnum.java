...
public enum VectorDatabaseParamOptionsEnum {
  ...
  CHUNK_UNIT(
      "chunkUnit",
      "The unit that detemines how to measures the length of given chunks. Options are \"tokens\" or \"characters\"."),
  CONTENT_LENGTH(
      "contentLength",
  ...
  COLUMNS_TO_INDEX(
      "columnsToIndex",
      "A list of column names in the data you want to create the embeddings from"),
  COLUMNS_TO_REMOVE(
      "columnsToRemove",
      "A list of column names in the data that you dont want to store in the database"),
  COLUMNS_TO_RETURN(
      "columnsToReturn", "A list of column names in the data you want returned in the response"),
  EXTRACTION_METHOD(
      "extractionMethod",
      "The name of the extraction method used to pull data from PDF(s). Options are \"fitz\" or \"default\"."),
  CHUNKING_METHOD(
      "chunkingMethod",
      "The chunking method to be used during text splitting. Options are \"token\" (default), \"recursive\", or \"semantic\"."),
  CUSTOM_DOCUMENT_PROCESSOR(
      "customDocumentProcessor",
      "Boolean flag to determine whether a custom function is being used to process a document"),
  CUSTOM_DOCUMENT_PROCESSOR_FUNCTION_ID(
      "customDocumentProcessorFunctionID",
      "Indicates the function ID used to custom process a document"),
  KEYWORD_SEARCH_PARAM(
      "keywordSearchParam",
      "Create keywords from the extracted chunks and use them to when to create embeddings."),
  ...
  public enum CreateEmbeddingsParamOptions {
    ...
    private static Map<String, String> initializeRequirementStatusMap(
        CreateEmbeddingsParamOptions option) {
      ...
      switch (option) {
        case FAISS:
          ...
          map.put(
              VectorDatabaseParamOptionsEnum.CUSTOM_DOCUMENT_PROCESSOR_FUNCTION_ID.getKey(),
              OPTIONAL);
          break;
        default:
     ...
     * @return
     */
    public static CreateEmbeddingsParamOptions getEnumFromVectorDbType(
        VectorDatabaseTypeEnum vectorDbType) {
  ...
  public enum VectorQueryParamOptions {
    ...
    private static Map<String, String> initializeRequirementStatusMap(
        VectorQueryParamOptions option) {
      Map<String, String> map = new LinkedHashMap<>();
      // Set the requirement status for each parameter key based on the option
      switch (option) {
        case FAISS:
     ...
     * @return
     */
    public static VectorQueryParamOptions getEnumFromVectorDbType(
        VectorDatabaseTypeEnum vectorDbType) {
