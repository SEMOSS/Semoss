...
public class ListAllRecordsInVectorDatabaseReactor extends AbstractReactor {
	...
	public NounMetadata execute() {
		...
		return new NounMetadata(engine.listAllRecords(paramMap), PixelDataType.CUSTOM_DATA_STRUCTURE,
	...
	public String getReactorDescription() {
		...
		headerBuilder.append("'").append(VectorDatabaseCSVTable.SOURCE).append("', ").append("'")
				.append(VectorDatabaseCSVTable.SOURCE).append("', ").append("'").append(VectorDatabaseCSVTable.MODALITY)
				.append("', ").append("'").append(VectorDatabaseCSVTable.DIVIDER).append("', ").append("'")
				.append(VectorDatabaseCSVTable.PART).append("', ").append("'").append(VectorDatabaseCSVTable.TOKENS)
				.append("', ").append("'").append(VectorDatabaseCSVTable.CONTENT).append("'");
