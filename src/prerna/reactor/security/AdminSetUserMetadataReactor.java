...
public class AdminSetUserMetadataReactor extends AbstractSetMetadataReactor {
	...
	public NounMetadata execute() {
		...
		adminUtils.updateUserMetadata(userId, AuthProvider.getProviderFromString(userType), metadata);
