...
public class DatabaseInfoReactor extends AbstractReactor {
	...
	public NounMetadata execute() {
		...
		databaseInfo.putAll(SecurityEngineUtils.getAggregateEngineMetadata(databaseId, metaKeys, true));
	...
	public String getReactorDescription() {
		return """
				Deprecated: use EngineInfo instead.
				Returns information for a single engine (legacy DatabaseInfo name) when the user can access it or it is discoverable.
