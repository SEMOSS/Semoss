...
public class PBEDecryptReactor extends AbstractReactor {
	...
	/**
	 * We allow 2 different input types Single string input or Byte [] (passed as
	 * array of numbers)
	 *
	 * @return
	 */
	...
	private static String getPassword() {
		...
		synchronized (PBEDecryptReactor.class) {
			...
			PBEDecryptReactor.password = DIHelper.getInstance()
					.getProperty(Constants.PM_SEMOSS_EXECUTE_SQL_ENCRYPTION_PASSWORD);
		}
