...
public class PBEDecryptReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    try {
      ...
      throw new IllegalArgumentException(
          "Error occurred decrypting with message = " + e.getMessage());
    }
  }

  /**
   * We allow 2 different input types Single string input or Byte [] (passed as array of numbers)
   *
   * @return
   */
  ...
  private static String getPassword() {
    if (PBEDecryptReactor.password != null) {
      //			logger.debug("Decrypting with password >> " +
      // Utility.cleanLogString(PBEDecryptReactor.password));
