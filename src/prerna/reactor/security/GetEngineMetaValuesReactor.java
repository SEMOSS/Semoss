...
public class GetEngineMetaValuesReactor extends AbstractReactor {
    ...
    public GetEngineMetaValuesReactor() {
        this.keysToGet = new String[] {ReactorKeysEnum.ENGINE_TYPE.getKey(), ReactorKeysEnum.META_KEYS.getKey(), "engineIdList"};
    ...
    public NounMetadata execute() {
		...
		List<String> engineIdList = getEngineIdList();
		List<String> engineList;

		if (engineIdList != null && !engineIdList.isEmpty()) {
			// Search mode: use the engineIdList directly
			engineList = engineIdList;
		} else {
    ...
    private List<String> getEngineIdList() {
