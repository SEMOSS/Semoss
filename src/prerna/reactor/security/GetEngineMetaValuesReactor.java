...
public class GetEngineMetaValuesReactor extends AbstractReactor {
  ...
  public GetEngineMetaValuesReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.ENGINE_TYPE.getKey(), ReactorKeysEnum.META_KEYS.getKey()};
  }
  ...
  public NounMetadata execute() {
    ...
    List<Map<String, Object>> ret =
        SecurityEngineUtils.getAvailableMetaValues(
            engineList, getListValues(ReactorKeysEnum.META_KEYS.getKey()));
