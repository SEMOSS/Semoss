...
public class SetProjectMetakeyOptionsReactor extends AbstractInsightReactor {

	private static final String METAOPTIONS = "metaoptions";

	public SetProjectMetakeyOptionsReactor() {
	...
	public NounMetadata execute() {
		...
		if (res) {
			noun.addAdditionalReturn(
					NounMetadata.getSuccessNounMessage("Successfully updated the new metakey for metakey options"));
		} else {
			noun.addAdditionalReturn(NounMetadata
					.getErrorNounMessage("Did not update metakey options. Please check your inputs and try again."));
		}
		return noun;
	}
