...
public class GetInsightsReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    List<Map<String, Object>> results =
        SecurityInsightUtils.searchUserInsights(
            this.insight.getUser(),
            projectFilters,
            searchTerm,
            favoritesOnly,
            sortBy,
            insightMetadataFilter,
            limit,
            offset);
    ...
    if (!noMeta) {
      ...
      if (!projectIdsToInsight.isEmpty()) {
        IRawSelectWrapper wrapper =
            SecurityInsightUtils.getInsightMetadataWrapper(projectIdsToInsight, META_KEYS_LIST);
    ...
    NounMetadata retNoun =
        new NounMetadata(
            results, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.APP_INSIGHTS);
