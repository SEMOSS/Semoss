...
public class AddPanelEventsReactor extends AbstractInsightPanelReactor {
	...
	/**
	 * Method to decode the query portion of the events map This is needed because
	 * our grammar does not allow for look behind logic for escaped quotes when
	 * deciding what a string is/is not So we encode it, but we need to decode it so
	 * that it is an accurate pixel
	 *
	 * @param events
	 */
