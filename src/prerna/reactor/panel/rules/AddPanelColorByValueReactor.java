...
public class AddPanelColorByValueReactor extends AbstractPanelColorByValueReactor {
  ...
  public NounMetadata execute() {
    ...
    //		if(cbvOptions == null) {
    //			throw new NullPointerException("Must define the options associated with the color by value
    // rule");
    //		}
    ...
    return new NounMetadata(
        retMap, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.ADD_PANEL_COLOR_BY_VALUE);
  }
