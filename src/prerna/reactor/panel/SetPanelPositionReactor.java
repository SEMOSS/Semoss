...
public class SetPanelPositionReactor extends AbstractInsightPanelReactor {
  ...
  public SetPanelPositionReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.PANEL.getKey(), ReactorKeysEnum.PANEL_POSITION_KEY.getKey()};
  }
  ...
  public NounMetadata execute() {
    ...
    return new NounMetadata(
        retMap, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.PANEL_POSITION);
