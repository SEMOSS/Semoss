...
public class SetPanelPositionReactor extends AbstractInsightPanelReactor {
	...
	public NounMetadata execute() {
		...
		/*
		 * Once the FE is done pushing We will delete the panel_position op type And can
		 * return the entire insight panel
		 */
		...
		// return new NounMetadata(insightPanel, PixelDataType.PANEL,
		// PixelOperationType.PANEL_CONFIG);
	}
