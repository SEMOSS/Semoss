...
public class RetrievePanelOrnamentsReactor extends AbstractInsightPanelReactor {
  ...
  public RetrievePanelOrnamentsReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.PANEL.getKey(), ReactorKeysEnum.TRAVERSAL.getKey()};
  }
  ...
  public NounMetadata execute() {
    ...
    return new NounMetadata(
        ornamentData, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.PANEL_ORNAMENT);
  }
}
