...
public class CalcVarReactor extends AbstractReactor {
  ...
  // sample - String [] formulas = new String[]{"x=1", "age_sum = frame_d['age'].astype(int).sum()",
  ...
  public NounMetadata execute() {
    ...
    Map<String, Object> varValue =
        InsightUtility.calculateDynamicVars(this.insight, dynamicVarNames);
