...
/**
 * This reactor is responsible for taking the output of an execution and assigning the result as a
 * variable
 */
public class AssignmentReactor extends AbstractReactor implements JavaExecutable {
  ...
  public NounMetadata execute() {
    ...
    if (result.getNounType() == PixelDataType.FORMATTED_DATA_SET
        && result.getValue() instanceof ITask) {
      ...
      result =
          new NounMetadata(flushedOutValue, PixelDataType.FORMATTED_DATA_SET, result.getOpType());
    }
