 ...
 */
public class ProjectGitCheckoutReactor extends AbstractReactor {

	private static final Logger classLogger = LogManager.getLogger(ProjectGitCheckoutReactor.class);
	private static final String BRANCH_KEY = "branch";

	public ProjectGitCheckoutReactor() {
		this.keysToGet = new String[] { ReactorKeysEnum.PROJECT.getKey(), BRANCH_KEY };
	...
	public NounMetadata execute() {
		...
		try (Git thisGit = Git.open(new File(versionFolder))) {
			...
			classLogger.error("Error occurred checking out branch for project {}", projectId, e);
	...
	public String getReactorDescription() {
		return "This reactor checks out an existing local or remote-tracking branch in a project's git repository";
	}
