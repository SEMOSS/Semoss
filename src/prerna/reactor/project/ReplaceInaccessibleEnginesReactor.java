...
public class ReplaceInaccessibleEnginesReactor extends AbstractReactor {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(ReplaceInaccessibleEnginesReactor.class);
    ...
    replacementMap
        ...
        .forEach(
            k -> {
              ...
              successInfo.put(
                  "engineName", SecurityEngineUtils.getEngineAliasForId(replacementMap.get(k)));
                  ...
                  for (String line : lines) {
                    ...
                    for (Map.Entry<String, String> entry : replacementMap.entrySet()) {
                      ...
                      if (updatedLine.contains(inaccessibleEngineId)) {
                        ...
                        Set<String> files =
                            (Set<String>) uuidSuccessFiles.get(inaccessibleEngineId).get("files");
                  ...
                  for (Map.Entry<String, Boolean> entry : replacedInThisFile.entrySet()) {
                    ...
                    if (!wasReplaced) {
                      ...
                      if (uuidWasPresent) {
                        ...
                        classLogger.warn(
                            "Engine ID {} was not replaced in file: {}", uuid, path.toString());
                      }
                    }
                  }
