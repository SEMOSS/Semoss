...
public class CreateAppFromBlocksReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    // if project name is not valid, throw error
    if (!Utility.validateName(newProjectName)) {
    ...
    String projectVersionFolder =
        AssetUtility.getProjectVersionFolder(
            newProject.getProjectName(), newProject.getProjectId());
    ...
    Map<String, Object> retMap =
        UploadUtilities.getProjectReturnData(this.insight.getUser(), newProject.getProjectId());
