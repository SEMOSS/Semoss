...
/**
 * Stages or unstages a set of repo-relative paths in a project's git
 * repository and returns the refreshed {@code ProjectGitStatus} payload.
 */
public class ProjectGitStageReactor extends AbstractReactor {

	private static final Logger classLogger = LogManager.getLogger(ProjectGitStageReactor.class);
	private static final String PATHS_KEY = "paths";
	private static final String ACTION_KEY = "action";

	public ProjectGitStageReactor() {
		this.keysToGet = new String[] { ReactorKeysEnum.PROJECT.getKey(), PATHS_KEY, ACTION_KEY };
	...
	public NounMetadata execute() {
		...
		try (Git thisGit = Git.open(new File(versionFolder))) {
			...
			classLogger.error("Error occurred staging files for project {}", projectId, e);
	...
	public String getReactorDescription() {
		return "This reactor stages or unstages files in a project's git repository and returns the refreshed status";
	}
