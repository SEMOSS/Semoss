...
public class SearchAppAssetsReactor extends AbstractReactor {
    ...
    public NounMetadata execute() {
       ...
       this.dateTimeFormatter =DateTimeFormatter.ofPattern("MM/dd/yyyy HH:mm:ss").withZone(user.getZoneId());
        ...
        String projectId = keyValue.get(ReactorKeysEnum.PROJECT.getKey()); 
        ...
        if (!SecurityProjectUtils.userCanViewProject(user, projectId)) {
            throw new IllegalArgumentException("Project " + projectId + " does not exist or user has no access.");
        }
        ...
        String appRoot = AssetUtility.getProjectAppRootFolder(project.getProjectName(), project.getProjectId());
        int baseLen = appRoot.length();
        String searchRoot = appRoot + (relativeFilePath != null ? relativeFilePath : "");
