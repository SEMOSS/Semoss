...
/**
 * This reactor will fetch the place holder information from the selected template file place holder
 * is a bookmark tagged to a cell with a name, default value and cell value. intent is to
 * dynamically place the content
 *
...
public class GetPlaceHoldersReactor extends AbstractReactor {
  ...
  public GetPlaceHoldersReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.PROJECT.getKey(), ReactorKeysEnum.TEMPLATE_NAME.getKey()};
  }
  ...
  public NounMetadata execute() {
    ...
    Map<String, List<String>> placeHoldersMap =
        TemplateUtility.getPlaceHolderInfo(projectId, templateName);
