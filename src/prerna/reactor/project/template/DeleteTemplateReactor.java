...
/**
 * This reactor will delete the existing template information from the app corresponding template
 * property file.
 *
...
public class DeleteTemplateReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    Map<String, String> templateDataMap =
        TemplateUtility.deleteTemplate(projectId, templateFile, templateName);
