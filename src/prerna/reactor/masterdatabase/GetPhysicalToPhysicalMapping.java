...
public class GetPhysicalToPhysicalMapping extends AbstractReactor {
	...
	public NounMetadata execute() {
		String query = "SELECT " + "e.engineName as \"engine1\", " + "ec.physicalName as \"physicalname1\", "
				+ "c.logicalName as \"logicalname\", " + "ec2.physicalName as \"physicalname2\", "
				+ "e2.engineName as \"engine2\" " + "from Engine e " + "INNER JOIN EngineConcept ec ON e.id=ec.engine "
