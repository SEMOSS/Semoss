...
public class Rectangles {
	 ...
	 *
	 * @param rectanglesToFix
	 *            the map of rectangles to declutter
	 */
		...
		while (hasIntersections) {
			...
			for (Entry<String, Rectangle2D> rectangles : rectanglesToDraw.entrySet()) {
				...
				if (intersectingRects.size() > 0) {
					...
					// Move R by v.
					rectangle.setRect(rectangle.getX() + movementVector.getX(),
							rectangle.getY() + movementVector.getY(), rectangle.getWidth(), rectangle.getHeight());
	...
	/**
	 * Given a rectangle, finds the rectangles from the rectMap that intersect with
	 * it.
	 *
	 * @param rect
	 *            the rectangle to find intersections on
	 * @param rectMap
	 *            a map of all the rectangles in question
	 */
	 ...
	 *
	 * @param rectangles
	 *            map of rectangle names and x and y coordinates
	 */
