...
public class GetMetaTagsReactor extends AbstractMetaDBReactor {
  /**
   * This reactor gets the tags from the concept metadata table The inputs to the reactor are: 1)
   * the engine 2) the the concept
   */
  ...
  public NounMetadata execute() {
    ...
    return new NounMetadata(
        list, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.CODE_EXECUTION);
  }
}
