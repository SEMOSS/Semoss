...
/**
 * Evaluates a single feature flag for the current user and returns true or
 * false.
 *
 * Pixel: CheckFeatureFlag(app="myApp", flagId="uuid")
 *
 * Any authenticated user with access to the app may call this.
 */
public class CheckFeatureFlagReactor extends AbstractReactor {

	private static final String APP_KEY = "app";
	private static final String FLAG_ID_PARAM = "flagId";

	public CheckFeatureFlagReactor() {
	...
	public NounMetadata execute() {
		...
		boolean result = AppFeatureFlagUtils.evaluate(appId, flagId, user);
