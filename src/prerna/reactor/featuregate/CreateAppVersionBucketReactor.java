...
/**
 * Creates an empty version bucket for a feature flag to enable UI rendering
 * before users are assigned.
 *
 * Pixel: CreateAppVersionBucket(app="myApp", flagId="uuid", version=2,
 * description="Beta testers")
 *
 * This allows you to pre-create versions for UI purposes. Later, you can assign
 * users to these versions
 * using SetUserAppVersion. The bucket will appear in GetAppVersionBuckets even
 * before any users are assigned.
 *
 * Requires app owner or admin.
 */
public class CreateAppVersionBucketReactor extends AbstractReactor {

    private static final String APP_KEY = "app";
    private static final String FLAG_ID_PARAM = "flagId";
    private static final String VERSION_KEY = "version";

    public CreateAppVersionBucketReactor() {
    ...
    public NounMetadata execute() {
        ...
        AppFeatureFlagUtils.createVersionBucket(appId, flagId, version, description);
