...
/**
 * Deletes a version bucket definition. User assignments are not affected.
 *
 * Pixel: DeleteAppVersionBucket(app="myApp", flagId="uuid", version=2)
 *
 * Requires app owner or admin.
 */
public class DeleteAppVersionBucketReactor extends AbstractReactor {

    private static final String APP_KEY = "app";
    private static final String FLAG_ID_PARAM = "flagId";
    private static final String VERSION_KEY = "version";

    public DeleteAppVersionBucketReactor() {
    ...
    public NounMetadata execute() {
        ...
        AppFeatureFlagUtils.deleteVersionBucket(appId, flagId, version);
