...
/**
 * Removes a user from a feature flag. User falls back to the flag's
 * defaultVersion.
 *
 * Pixel: RemoveUserFromFeatureFlag(app="myApp", flagId="uuid", user="jsmith")
 *
 * Requires app owner or admin.
 */
public class RemoveUserFromFeatureFlagReactor extends AbstractReactor {

    private static final String APP_KEY = "app";
    private static final String FLAG_ID_PARAM = "flagId";
    private static final String USER_KEY = "user";

    public RemoveUserFromFeatureFlagReactor() {
    ...
    public NounMetadata execute() {
        ...
        String userId = this.keyValue.get(USER_KEY);
        ...
        AppFeatureFlagUtils.removeUserFromFlag(appId, flagId, userId);
