...
//@Deprecated
///**
// * See new H2Frame {@link prerna.sablecc2.reactor.imports.RdbmsFrameImporter.java}
// */
//public class H2Importer extends AbstractImporter {
//
//	private static AbstractSqlQueryUtil QUERY_UTIL = SqlQueryUtilFactor.initialize(RdbmsTypeEnum.H2_DB);
//	
...
//			String joinQuery = QUERY_UTIL.createNewTableFromJoiningTables(innerJoinTable, leftTableName, leftTableTypes, rightTableName, rightTableTypes, joins, new HashMap<String, String>(), new HashMap<String, String>());
//			try {
...
//			try {
//				this.dataframe.getBuilder().runQuery(QUERY_UTIL.dropTable(rightTableName));
//			} catch (Exception e) {
//				e.printStackTrace();
//			}
//		}
...
//		try {
//			this.dataframe.getBuilder().runQuery(QUERY_UTIL.dropTable(mergeTable));
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//		
...
//				String leftOuterJoin = QUERY_UTIL.createNewTableFromJoiningTables(leftJoinReturnTableName, leftTableName, leftTableTypes, rightTableName, 
...
//				String rightOuterJoin = QUERY_UTIL.createNewTableFromJoiningTables(rightJoinReturnTableName, leftTableName, leftTableTypes, rightTableName, 
//						rightTableTypes, joins, leftTableAlias, rightTableAlias);
...
//				String joinQuery = QUERY_UTIL.createNewTableFromJoiningTables(returnTableName, leftTableName, leftTableTypes, rightTableName, 
//						rightTableTypes, joins, leftTableAlias, rightTableAlias);
//				this.dataframe.getBuilder().runQuery(joinQuery);
//			}
...
//				try {
//					this.dataframe.getBuilder().runQuery(QUERY_UTIL.dropTable(leftJoinReturnTableName));
//				} catch (Exception e) {
//					e.printStackTrace();
//				}
//			}
...
//				try {
//					this.dataframe.getBuilder().runQuery(QUERY_UTIL.dropTable(rightJoinReturnTableName));
//				} catch (Exception e) {
//					e.printStackTrace();
//				}
//			}
...
//		if(successfullyAddedData) {
//			try {
//				this.dataframe.getBuilder().runQuery(QUERY_UTIL.dropTable(leftTableName));
//			} catch (Exception e) {
//				e.printStackTrace();
//			}
//			try {
