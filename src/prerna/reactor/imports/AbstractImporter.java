...
public abstract class AbstractImporter implements IImporter {
	...
	/**
	 * Perform to see if the string v is contained within the set taking into
	 * consideration an ignore set
	 *
	 * @param v
	 * @param set
	 * @param ignoreSet
	 ...
	 */
	protected static void updateMetaWithAlias(ITableDataFrame dataframe, SelectQueryStruct qs,
			Iterator<IHeadersDataRow> it, List<Join> joins, Map<String, String> rightTableAlias) {
	 ...
	 * This helps to determine if we need to perform an insert vs. an update query
	 * to fill the frame
	 *
	 * @param headers1
	 ...
	 * @param joins
	 *            Needs to take into consideration the joins since we can join on
