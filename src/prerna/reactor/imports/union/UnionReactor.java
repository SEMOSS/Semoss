...
/**
 * This reactor is the entry point for the Union functionality. It extends the
 * AbstractFrameReactor, hence it overrides the execute method. In the execute
 * method, it takes the two frames from from the pipeline and then based on the
 * frame types it gets the specific Py\R routines.
 *
 * <p>
 * Note - As of now only Py and R routines has been implemented because of
 * upcoming Nov release and later its going to get expanded to Grid and Native.
 */
public class UnionReactor extends AbstractFrameReactor {
	...
	private static final String UNION_TYPE = "unionType";
	private static final String UNION_COL_MAPPING = "mapping";
	...
	public NounMetadata execute() {
		...
		NounMetadata noun = new NounMetadata(unionFrame, PixelDataType.FRAME, PixelOperationType.FRAME_DATA_CHANGE,
