...
public class LoadClientReactor extends AbstractLoadClient {
	...
	protected PixelPlanner createPlanner() {
		...
		try {
			...
			HashMap<String, String> mainMap = (HashMap<String, String>) plannerT.getPlanner().getProperty("MAIN_MAP",
					"MAIN_MAP");
			int count = 0;
			while (iterator.hasNext()) {
				...
				// else we just want to add the value of the constant/decimal directly to the
				// planner
				else {
