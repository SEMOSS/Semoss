...
public abstract class AbstractPlannerReactor extends AbstractReactor {
	...
	/**
	 * Runs through and get all downstream vertices based on the execution order and
	 * will continue to traverse down and get downstream vertices that it can
	 * execute
	 *
	 * @param vertsToRun
	...
	/**
	 * Given a set of roots Find the downstream nouns Within the planner, find the
	 * ops that have the downstream nouns as inputs Return those as the new roots
	 *
	 * @param roots
	 * @param planner
	 * @return
