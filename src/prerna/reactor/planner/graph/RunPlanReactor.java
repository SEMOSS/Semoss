...
public class RunPlanReactor extends AbstractPlannerReactor {
	...
	public NounMetadata execute() {
		...
		LOGGER.info("****************    Build Super Clases with Fields " + (endTime - startTime)
				+ "ms      *************************");
	...
	private Class<BaseJavaRuntime> buildSuperClassWithOnlyFields(List<String> fieldsList,
			Class<BaseJavaRuntime> superClass) {
