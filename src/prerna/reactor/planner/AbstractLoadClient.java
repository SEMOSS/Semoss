...
public abstract class AbstractLoadClient extends AbstractReactor {
	...
	/**
	 * @return This abtract method is defined by the child class to have control as
	 *         to what type of planner to create, all other operations are the same
	 */
	 ...
	 * @param value
	 *            <p>
	 *            This method will directly add the variable to the planner instead
	 *            of adding an assignment pksl
	 */
	protected void addVariable(PixelPlanner planner, String assignment, Object value) {
		if (assignment.equals(value.toString()))
			return;
		if (assignment.equals(value.toString()))
			return;
