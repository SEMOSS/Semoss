...
public class PixelPlanner {
	...
	// this is primarily the tinker graph that would be used for planning the
	// operation
  ...
  ////////////////////////////////////////////////////////////////////////
	...
	/*
	 * New planner methods for pipeline... TODO: see how to perform previous logic
	 * (unused currently) with new structure
	 */
  ...
  ////////////////////////////////////////////////////////////////////////
	...
	// specify what type is the output is going to be sitting in store or is it
	// sitting in query
	...
	public void addInputs(String opName, CodeBlock codeBlock, List<String> inputs, List<String> asInputs,
	...
	public Iterator runMyPlan(String output) {
		...
		// everytime I find the input to be a block, I need to stack it up i.e. only the
		// code operation
		...
		// when there is a reduce which multiple thing depends on, I need to validatee
		// so that it
		// doesn't do it twice
	...
	private StageKeeper loadVertex3(StageKeeper keeper, List<Vertex> verticesToProcess) {
		...
		while (inputs.hasNext()) {
			...
			// I should do this at a later point because I dont know when it will be a
			// reduce..
	...
	// whenever there is an existing piece of code it should take the order and
	// reinsert it to top
	// i.e. vector
	// I also need
