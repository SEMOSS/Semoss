...
public class JsonValidatorReactorFactory {
...

	{
		...
		// createReactorHash.put("Parent2",
		// "prerna.sablecc2.reactor.json.validator.Parent2Validator");
		// reactorHash.put("array2",
		// "prerna.sablecc2.reactor.json.validator.Parent2Validator");
	}
	...
	private Hashtable<String, String> getRequestTypeHash(String requestType) {
		...
		if (requestType.equals("VIEW")) {
			...
			throw new IllegalArgumentException(
					"You need to define the request type as either: \"CREATE\", \"EDIT\", or \"VIEW\"");
		}
	}
}
