        ...
        if (parentHash.containsKey(CHILDS)) {
          ...
          for (int childIndex = 0; childIndex < childs.size(); childIndex++) {
            ...
            if (parentHash.containsKey(childName)) {
              ...
              if (parentHash.get(childName) instanceof Hashtable) {
                ...
                if (thisChildHash.containsKey(SQL)) {
                  ...
                  if (thisChildHash.containsKey(CHILDS)) {
                    ...
                    if (sqlOutput instanceof Hashtable) childOutput = (Hashtable) sqlOutput;
                    else {
                  ...
                  // add this back
                  // if there are no childs, this child will get fully replaced with whatever out
                  // put comes from sql
              ...
              } else System.out.println("Nothing to do here");
  ...
  public Object executeQuery(String query) {
    ...
    try (Statement stmt = conn.createStatement()) {
      ...
      for (int colIndex = 1; colIndex <= colCount; colIndex++) {
        ...
        if (colKeyHash.containsKey(colLabel)) aliases.add(colKeyHash.get(colLabel));
        else aliases.add(colLabel); // leave it to what it is
      }
    ...
    else if (finalHash != null) return finalHash;
