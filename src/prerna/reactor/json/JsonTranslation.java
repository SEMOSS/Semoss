...
public class JsonTranslation extends LazyJsonTranslation {
	...
	protected void deInitReactor() {
		...
		if (curReactor != null) {
			...
			// the beginning of the pksl command the beginning of each pipe is an
	...
	protected void postProcess(String pkslExpression) {
		...
		if (noun != null) {
			...
			this.runner.addResult(pkslExpression, new NounMetadata("no output", PixelDataType.CONST_STRING),
					this.isMeta);
		}
		curReactor = null;
		prevReactor = null;
