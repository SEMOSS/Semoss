...
public class ReactorFactory {
	...
	private static void createReactorHash(Map<String, Class<? extends IReactor>> reactorHash) {
		...
		// reactorHash.put("CatalogDescriptionGenerator",
		// CatalogDescriptionGeneratorReactor.class);
		...
		// reactorHash.put("MetaSemanticSimilarity",
		// MetaSemanticSimilarityReactor.class);
	 ...
	 * @param parentReactor
	 *            - the parent reactor
	 * @return This will simply return the IReactor responsible for execution based
	 *         on the reactorId
	 *         <p>
			...
			if (expressionHash.containsKey(reactorId.toUpperCase())) {
				...
				if (parentReactor != null) {
					if (!(parentReactor instanceof AbstractQueryStructReactor)
						...
						reactor = (IReactor) expressionHash.get(reactorId.toUpperCase()).getDeclaredConstructor()
								.newInstance();
						return reactor;
					}
				} else {
