...
public class OpSumIf extends OpBasic {
  ...
  public OpSumIf() {
    ...
    this.keysToGet =
        new String[] {
          ...
          ReactorKeysEnum.CRITERIA.getKey(),
  ...
  protected NounMetadata evaluate(Object[] values) {
    ...
    } else if (criteriaType == PixelDataType.CONST_INT
        || criteriaType == PixelDataType.CONST_DECIMAL) {
   ...
   * @return
   */
  private static BigDecimal evalNumericalExpression(
      Number rangeVal, String filterPrefix, Number filterNum, Number sumVal) {
