...
public class RemoveFrameReactor extends RemoveVariableReactor {
	...
	public NounMetadata execute() {
		...
		NounMetadata noun = new NounMetadata(variableName, PixelDataType.REMOVE_VARIABLE,
				PixelOperationType.REMOVE_FRAME, PixelOperationType.FORCE_SAVE_DATA_TRANSFORMATION);
