...
public class AddOperationAliasReactor extends AbstractReactor {
	...
	/**
	 * This reactor takes in the name of a reactor and allows the user to assign it
	 * an alias The inputs to the reactor are: 1) the name of the reactor 2) the
	 * alias for the reactor
	 */
	...
	public NounMetadata execute() {
		...
		// // first: check the regular reactor hash to see if the reactor is specified
		// there
		...
		// // get the properties object, if the reactor can be found in the properties
		// object
		...
		// Properties prop =
		// addReactorAliasToProperties(ReactorFactory.REACTOR_PROP_PATH, reactorName,
		// alias);
		...
		//
		// // expression hash
		// prop = addReactorAliasToProperties(ReactorFactory.EXPRESSION_PROP_PATH,
		// reactorName, alias);
		// if (prop != null && prop.size() > 0) {
		...
		// if (counter < 1) {
		// prop = addReactorAliasToProperties(ReactorFactory.H2_FRAME_PROP_PATH,
		// reactorName, alias);
		// if (prop != null && prop.size() > 0) {
		...
		// }
		//
		// prop = addReactorAliasToProperties(ReactorFactory.R_FRAME_PROP_PATH,
		// reactorName, alias);
		// if (prop != null && prop.size() > 0) {
		...
		// }
		//
		// prop = addReactorAliasToProperties(ReactorFactory.NATIVE_FRAME_PROP_PATH,
		// reactorName,
		// alias);
		// if (prop != null && prop.size() > 0) {
		...
		// }
		//
		// prop = addReactorAliasToProperties(ReactorFactory.TINKER_FRAME_PROP_PATH,
		// reactorName,
		// alias);
		// if (prop != null && prop.size() > 0) {
		...
		// return new NounMetadata(fileUpdated, PixelDataType.BOOLEAN,
