...
public class DatabaseProfileReactor extends AbstractFrameReactor {
  ...
  public NounMetadata execute() {
    ...
    for (String concept : conceptList) {
      List<String> pixelSelectors =
          MasterDatabaseUtility.getConceptPixelSelectors(concept, databaseId);
      ...
      for (String selector : pixelSelectors) {
        ...
        String dataType =
            MasterDatabaseUtility.getBasicDataType(databaseId, semossName, parentSemossName);
  ...
  private Object getValue(
      IDatabaseEngine database, String selector, String functionName, boolean distinct) {
    SelectQueryStruct qs2 = new SelectQueryStruct();
    {
