...
public class GetEngineUsageReactor extends AbstractReactor {
	...
	private List<Map<String, Object>> getModelUsage(String engineId) {
		...
		{
			Map<String, Object> usageMap = fillMap(PIXEL, "How to use in Javascript", "Generation\r\n" + "```\r\n"
					+ "LLM(engine = \"" + engineId
		...
		{
			Map<String, Object> usageMap = fillMap(PYTHON, "How to use in Python", "```python\r\n"
		...
		{
			Map<String, Object> usageMap = fillMap("LANGCHAIN", "How to use with Langchain API", "```python\r\n"
					+ "from ai_server import ModelEngine\r\n" + "model = ModelEngine(engine_id = \"" + engineId
	...
	private List<Map<String, Object>> getStorageUsage(String engineId) {
		List<Map<String, Object>> usage = new ArrayList<>();
		{
			Map<String, Object> usageMap = fillMap(PIXEL, "How to use in Javascript", "```\r\n" + "Storage(storage = \""
					+ engineId + "\") | ListStoragePath(storagePath='/your/storage/path');\r\n" + "Storage(storage = \""
					+ engineId + "\") | ListStoragePathDetails(storagePath='/your/storage/path');\r\n"
					+ "Storage(storage = \"" + engineId
	...
	private List<Map<String, Object>> getVectorUsage(String engineId) {
		List<Map<String, Object>> usage = new ArrayList<>();
		{
			Map<String, Object> usageMap = fillMap(PIXEL, "How to use in Javascript",
					"#### List all the documents the vector database currently comprises of ##\r\n" + "```\r\n"
							...
							+ "CreateEmbeddingsFromDocuments (engine = \"" + engineId
							...
							+ "```\r\n" + "CreateEmbeddingsFromVectorCSVFile (engine = \"" + engineId
		...
		{
			Map<String, Object> usageMap = fillMap(JAVA, "How to use in Java", "```java\r\n" + "// imports\r\n"
