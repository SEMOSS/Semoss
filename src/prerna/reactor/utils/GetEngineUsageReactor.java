		...
		List<Map<String, Object>> usage = new ArrayList<>();
		{
			Map<String, Object> usageMap = fillMap(PIXEL, "How to use in Javascript",
					"""
							...
							```python
							LLM(engine = "<engineid>", command = "<encode>Sample Question</encode>", paramValues=[{'max_completion_tokens':2000,'temperature':0.3}], roomId = "<roomid>", image = ["image1.png", "image2.png", ..., "imageX.png"], url =  ["url1", "url2", ..., "urlX"]);

							LLM ( engine = "<engineid>" , command = "<encode>Sample Question With Image", paramValues=[{'image_url':'https://your_image_url.com'}], roomId = "<roomid>", image = ["image1.png", "image2.png", ..., "imageX.png"], url =  ["url1", "url2", ..., "urlX"]);
							LLM ( engine = "<engineid>" , command = "<encode>Sample Question With Image", paramValues=[{'image_encoded':'base64_of_image'}], roomId = "<roomid>", image = ["image1.png", "image2.png", ..., "imageX.png"], url =  ["url1", "url2", ..., "urlX"]);
							```
							...
							LLM(engine = "<engineid>", command = "<encode>ignore</encode>", paramValues=[
							    ...
							    'temperature':0.3
							}], roomId = "<roomid>", image = ["image1.png", "image2.png", ..., "imageX.png"], url =  ["url1", "url2", ..., "urlX"]);
							```
