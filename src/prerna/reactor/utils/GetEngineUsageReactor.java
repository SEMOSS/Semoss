...
public class GetEngineUsageReactor extends AbstractReactor {
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "Generation\r\n"
                  ...
                  + "LLM(engine = \""
                  + engineId
                  + "\", command = \"<encode>Sample Question</encode>\", paramValues=[{'max_completion_tokens':2000,'temperature':0.3}]);\r\n\r\n"
                  + "LLM ( engine = \""
                  + engineId
                  + "\" , command = \"<encode>Sample Question With Image\", paramValues=[{'image_url':'https://your_image_url.com'}]);\r\n"
                  + "LLM ( engine = \""
                  + engineId
                  + "\" , command = \"<encode>Sample Question With Image\", paramValues=[{'image_encoded':'base64_of_image'}]);\r\n"
                  + "```\r\n\r\n"
                  + "Geneartion with ChatML\r\n"
                  + "```\r\n"
                  + "LLM(engine = \""
                  + engineId
                  + "\", command = \"<encode>ignore</encode>\", paramValues=[\r\n"
                  + "    {\"full_prompt\":[\r\n"
                  ...
                  + "Embeddings(engine = \""
                  + engineId
                  + "\", values = [\"Sample String 1\", \"Sample String 2\"], paramValues=[{}]);\r\n"
                  + "```\r\n\r\n"
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```java\r\n"
                  ...
                  + "IModelEngine modelEngine = Utility.getModel(\""
                  + engineId
                  + "\");\r\n"
                  + "```");
      usage.add(usageMap);
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```\r\n"
                  + "Storage(storage = \""
                  + engineId
                  + "\") | ListStoragePath(storagePath='/your/storage/path');\r\n"
                  + "Storage(storage = \""
                  + engineId
                  + "\") | ListStoragePathDetails(storagePath='/your/storage/path');\r\n"
                  + "Storage(storage = \""
                  + engineId
                  + "\") | PullFromStorage(storagePath='/your/storage/path', filePath='/your/local/path');\r\n"
                  + "Storage(storage = \""
                  + engineId
                  + "\") | PushToStorage(storagePath='/your/storage/path', filePath='/your/local/path', metadata=[{'metaKey':'metaValue'}]);\r\n"
                  + "Storage(storage = \""
                  + engineId
                  + "\") | SyncStorageToLocal(storagePath='/your/storage/path', filePath='/your/local/path');\r\n"
                  + "Storage(storage = \""
                  + engineId
                  + "\") | SyncLocalToStorage(storagePath='/your/storage/path', filePath='/your/local/path', metadata=[{'metaKey':'metaValue'}]);\r\n"
                  + "Storage(storage = \""
                  + engineId
                  + "\") | DeleteFromStorage(storagePath='/your/storage/path', leaveFolderStructure=false);\r\n"
                  + "```");
      usage.add(usageMap);
    }
    {
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```python\r\n"
                  ...
                  + "storageEngine = StorageEngine(engine_id = \""
                  + engineId
                  + "\")\r\n"
    ...
    }
    {
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```python\r\n"
                  + "from ai_server import StorageEngine\r\n"
                  + "storage = StorageEngine(engine_id = \""
                  + engineId
                  + "\")\r\n"
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```java\r\n"
                  ...
                  + "IStorageEngine storage = Utility.getStorage(\""
                  + engineId
                  + "\");"
                  + "```");
      usage.add(usageMap);
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```\r\n"
                  + "Database(database = \""
                  + engineId
                  + "\")|Query(\"<encode> your select query </encode>\")|Collect(500);\r\n"
                  + "Database(database = \""
                  + engineId
                  + "\")|Query(\"<encode> your insert/update/delete query </encode>\")|ExecQuery();\r\n"
                  + "```");
      usage.add(usageMap);
    }
    {
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```python\r\n"
                  ...
                  + "databaseEngine = DatabaseEngine(engine_id = \""
                  + engineId
                  + "\")\r\n"
    ...
    }
    {
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```python\r\n"
                  + "from ai_server import DatabaseEngine\r\n"
                  + "database = DatabaseEngine(engine_id = \""
                  + engineId
                  + "\")\r\n"
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```\r\n"
                  ...
                  + "IDatabaseEngine database = Utility.getDatabase(\""
                  + engineId
                  + "\");\r\n"
                  + "```");
      usage.add(usageMap);
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "#### List all the documents the vector database currently comprises of ##\r\n"
                  + "```\r\n"
                  + "ListDocumentsInVectorDatabase (engine = \""
                  + engineId
                  + "\");\r\n"
                  + "```\r\n"
                  ...
                  + engineId
                  + "\", filePaths = [\"fileName1.pdf\", \"fileName2.pdf\", ..., \"fileNameX.pdf\"]);\r\n"
                  + "```\r\n"
                  + "#### Add the VectorCSVFile Formatted CSVs that have been uploaded to the insight ##\r\n"
                  + "```\r\n"
                  + "CreateEmbeddingsFromVectorCSVFile (engine = \""
                  + engineId
                  + "\", filePaths = [\"fileName1.csv\", \"fileName2.csv\", ..., \"fileNameX.csv\"]);\r\n"
                  + "```\r\n"
                  ...
                  + "VectorDatabaseQuery (engine = \""
                  + engineId
                  + "\", command = \"Sample Search Statement\", limit = 5, filters=[], metaFilters=[]);\r\n"
                  + "```\r\n"
                  + "\r\n#### Remove document(s) from the vector database ##\r\n"
                  + "```\r\n"
                  + "RemoveDocumentFromVectorDatabase (engine = \""
                  + engineId
                  + "\", filePaths = [\"fileName1.pdf\", \"fileName2.pdf\", ..., \"fileNameX.pdf\"]);\r\n"
                  + "```\r\n");
      usage.add(usageMap);
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```python\r\n"
                  ...
                  + "vectorEngine = VectorEngine(engine_id = \""
                  + engineId
                  + "\")\r\n"
                  + "\n# List all the documents the vector database currently comprises of\r\n"
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```java\r\n"
                  ...
                  + "IVectorDatabaseEngine vectorEngine = Utility.getVectorDatabase(\""
                  + engineId
                  + "\");\r\n"
                  + "\n// List all the documents the vector database currently comprises of\r\n"
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```python\r\n"
                  ...
                  + "function = FunctionEngine(engine_id = \""
                  + engineId
                  + "\")\r\n"
      ...
      Map<String, Object> usageMap =
          fillMap(
              ...
              "```java\r\n"
                  + "import prerna.util.Utility;\r\n"
                  + "import prerna.engine.api.IFunctionEngine;\r\n"
                  + "IFunctionEngine function = Utility.getFunction(\""
                  + engineId
                  + "\");\r\n"
                  + "```",
              paramInfo);
  ...
  private List<Map<String, Object>> getPendingUsage() {
    ...
    {
      Map<String, Object> usageMap =
          fillMap(PIXEL, "How to use in Javascript", "Documentation pending");
      usage.add(usageMap);
    }
    {
      Map<String, Object> usageMap =
          fillMap(PYTHON, "How to use in Python", "Documentation pending");
      usage.add(usageMap);
    }
    {
  ...
  private Map<String, Object> fillMap(
      String type, String label, String code, List<Map<String, Object>> paramInfo) {
    Map<String, Object> usageMap = new HashMap<>();
    usageMap.put(TYPE, type);
    usageMap.put(LABEL, label);
    usageMap.put(CODE, code);
