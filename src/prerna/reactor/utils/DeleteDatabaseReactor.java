  ...
  public NounMetadata execute() {
    ...
    if (!isAdmin) {
      for (String databaseId : databaseIds) {
        ...
        databaseId =
            SecurityQueryUtils.testUserEngineIdForAlias(this.insight.getUser(), databaseId);
    ...
    for (String databaseId : databaseIds) {
      ...
      if (ClusterUtil.IS_CLUSTER) {
        Thread deleteAppThread =
            new Thread(new DeleteEngineRunner(databaseId, database.getCatalogType()));
