...
public class AdditionalTypesHelpReactor extends AbstractReactor {
  ...
  /**
   * This reactor allows the user to view the names of all additional types There are no inputs to
   * the reactor
   */
  ...
  public NounMetadata execute() {
    if (enumDescriptionsString == null) {
      ...
      mapOfEnumDescriptions.forEach(
          (adtlType, description) -> {
            allDescriptions
                .append("Name: ")
                .append(adtlType)
                .append(" | ")
    ...
    return new NounMetadata(
        enumDescriptionsString, PixelDataType.CONST_STRING, PixelOperationType.HELP);
  }
}
