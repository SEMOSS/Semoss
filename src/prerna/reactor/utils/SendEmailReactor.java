...
public class SendEmailReactor extends AbstractReactor {
	...
	public NounMetadata execute() {
		...
		// if (message == null || (message=message.trim()).isEmpty()) {
		// throw new IllegalArgumentException("Need to define the email message as " +
		// EMAIL_MESSAGE +
		...
		// send email
		boolean success = EmailUtility.sendEmail(emailSession, to, cc, bcc, sender, subject, message, isHtml,
				attachments);
