...
public class GetAwsSecretManagerValueReactor extends AbstractReactor {
	...
	public GetAwsSecretManagerValueReactor() {
		this.keysToGet = new String[]{ReactorKeysEnum.URL.getKey(), "accessKey", "secretKey", "secretId", "versionId",
				"versionStage", ReactorKeysEnum.USE_APPLICATION_CERT.getKey()};
	}
	...
	public NounMetadata execute() {
		...
		boolean useApplicationCerts = Boolean
