...
public class HelpReactor extends AbstractReactor {
	...
	/**
	 * This reactor allows the user to view the names of all reactors There are no
	...
	private String formatOutput(TreeSet t, boolean isAdmin) {
		...
		// use a count so that we can go to a new line every three entries (create three
		// columns)
		int count = 0;
