...
public class ReactorInputHelper {
  ...
  private final Map<String, Object>
      argumentsMap; // The map containing ENGINE, METHOD_NAME, CONFIG, etc.
  ...
  /**
   * Retrieves a method argument by its name (e.g., "arg0", "question"). This relies on how
   * arguments are mapped in PipelineInvocationHandler.
   *
