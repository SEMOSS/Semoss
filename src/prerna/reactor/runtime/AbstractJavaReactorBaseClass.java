...
public abstract class AbstractJavaReactorBaseClass extends AbstractReactor {
  ...
  ////////////////////// Frame Methods ///////////////////////
	...
	// */
	// protected void runAnomaly(String timeColumn, String seriesColumn, String
	// aggregateFunction,
	// double maxAnoms,
	...
	// AnomalyDetector anomalyDetector = new AnomalyDetector(dataframe, pkql,
	// timeColumn,
	// seriesColumn,
	...
	// * sensitive to this input
	// */
	// protected void runCategoricalAnomaly(String timeColumn, String eventColumn,
	// String groupColumn,
	// String aggregateFunction, double maxAnoms, String direction, double alpha,
	// int period) {
	// java.lang.System.setSecurityManager(curManager);
	//
	// // Convert string direction to AnomDirection
	...
	// * desired argument
	// */
	// protected void runRRoutine(String scriptName, String rSyncFrameName, String
	// selectedColumns,
	// String rReturnFrameName, String arguments) {
	// java.lang.System.setSecurityManager(curManager);
	// RRoutine rRoutine = new RRoutine.Builder(dataframe, pkql, scriptName,
	// rSyncFrameName)
	//
  ...
  //////////////////////// Tinker Methods ////////////////////////
	...
	protected void removeNode(String type) {
		...
		if (this.dataframe instanceof TinkerFrame) {
			...
			// set the output so the FE knows what occurred
			this.nounMetaOutput
					.add(new NounMetadata(this.dataframe, PixelDataType.FRAME, PixelOperationType.FRAME_DATA_CHANGE));
		}
		// java.lang.System.setSecurityManager(reactorManager);
	}
	...
	// if(this.dataframe instanceof TinkerFrame)
	// {
	// TinkerFrame newDataFrame = DataFrameHelper.generateNewGraph((TinkerFrame)
	// this.dataframe,
	// edgeHashStr, traversalHashStr);
	// if(newDataFrame == null) {
	// System.out.println("ERROR: Generated graph is empty! Please modify inputs to
	// get a frame
	// which has data");
	// } else {
	// // set the output so the FE knows what occurred
	...
	//
	// /**
	// * Find shared vertices between group of instances with a certain number of
	// traversals away
	// * @param type
	// * @param instances
	// * @param numTraversals
	// */
	// protected void findSharedVertices(String type, String[] instances, int
	// numTraversals) {
	// java.lang.System.setSecurityManager(curManager);
	// if(this.dataframe instanceof TinkerFrame)
	// {
	// TinkerFrame newDataFrame = DataFrameHelper.findSharedVertices((TinkerFrame)
	// this.dataframe,
	...
	// System.out.println("Filtered to keep only vertices which are shared between
	// defined
	// instances");
	// }
	// java.lang.System.setSecurityManager(reactorManager);
	...
	// * @param traversal
	// */
	// protected void shiftToNodeProperty(String conceptName, String propertyName,
	// Map<String,
	// Set<String>> traversal) {
	// java.lang.System.setSecurityManager(curManager);
	// if(this.dataframe instanceof TinkerFrame)
	// {
	// DataFrameHelper.shiftToNodeProperty((TinkerFrame) this.dataframe,
	...
	// * @param traversal
	// */
	// protected void shiftToEdgeProperty(String[] relationship, String
	// propertyName, Map<String,
	// Set<String>> traversal) {
	// java.lang.System.setSecurityManager(curManager);
	// if(this.dataframe instanceof TinkerFrame)
	// {
	// DataFrameHelper.shiftToEdgeProperty((TinkerFrame) this.dataframe,
	...
	// }
	//
	// protected void shiftToEdgeProperty(String relationship, String propertyName,
	// String traversal)
	// {
	// java.lang.System.setSecurityManager(curManager);
	// if(this.dataframe instanceof TinkerFrame)
	...
	protected void runDisconnectedNodesIdentifier(String type, String instance) {
		// java.lang.System.setSecurityManager(curManager);
		if (this.dataframe instanceof TinkerFrame) {
			String disconnectedNodes = TinkerAlgorithmUtility
					.runDisconnectedNodesIdentifier((TinkerFrame) this.dataframe, type, instance);
			System.out.println(disconnectedNodes);

			// set the output so the FE knows what occurred
			this.nounMetaOutput
					.add(new NounMetadata(disconnectedNodes, PixelDataType.CONST_STRING, PixelOperationType.OPERATION));
		}
		// java.lang.System.setSecurityManager(reactorManager);
	}
