  ...
  protected AbstractQueryStruct createQueryStruct() {
    ...
    if (size < 2) {
      throw new IllegalArgumentException(
          "Must pass in at least 2 parameters, a column and a regex string");
    }
    ...
    filter.setFunctionSelector(
        genFunctionSelector(QueryFunctionHelper.REGEXP_LIKE, innerSelectors));
