...
public class IfReactor extends SelectReactor {
	...
	// condition - - this could be a query selector - mandatory - specifies what is
	// the condition
	// under which this is valid
	// then - the precedent - what happens when the condition is true - mandatory
	// again
	// else - the antecedent - what happens if the condition is invalid. PLease note
	// that these
