...
public class FileReadReactor extends AbstractQueryStructReactor {
  ...
  private static final String ADDITIONAL_DATA_TYPES =
   ...
   * <p>FILE=["filePath"]
   *
   * <p>for csv must add delim = ["delimiter"] for excel must add sheetName = ["sheetName"]
   *
   * <p>to set dataTypes dataTypesMap = [{"column", "type"}] to set newHeaders newHeaders =
   * [{"oldColumn", "newColumn"}]
   */
  ...
  private String getSheetName() {
    ...
    if (sheetGRS != null) {
      ...
      throw new IllegalArgumentException(
          "Need to specify " + SHEET_NAME + "=[sheetName] in pixel command");
    }
    return sheetName;
  }
  ...
  private String getRange() {
    ...
    if (rangeGRS != null) {
      ...
      throw new IllegalArgumentException(
          "Need to specify " + SHEET_RANGE + "=[sheetRange] in pixel command");
    }
    return sheetRange;
  }
  ...
  //		} else {
  //			throw new IllegalArgumentException("Need to specify " + FILEPATH + "=[filePath] in pixel
  // command");
  //		}
  //
    ...
    if (parentReactor != null) {
      ...
      if (parentReactor instanceof EmbeddedScriptReactor
        ...
        GenRowStruct parentQSInput =
            parentReactor.getNounStore().makeNoun(PixelDataType.QUERY_STRUCT.toString());
  ...
  private String getPlanFileUpload() {
    ...
    if (fileGrs == null || fileGrs.isEmpty()) {
      throw new IllegalArgumentException(
          "Must pass in the relative file path as " + FILEPATH + "=[\"input_path\"]");
    }
