...
public class PyReactor extends AbstractPyFrameReactor implements ICodeExecution {
	...
	public NounMetadata execute() {
		...
		/*
		 * else { //output = pyTranslator.runScript(code) + ""; output =
		 * pyTranslator.runScript(insight.getUser().getVarMap(), code) + ""; }
		 */
		// }catch(SemossPixelException ex)
		// {
		// output = ex.getMessage();
		// execNoun = new NounMetadata(output, PixelDataType.ERROR,
