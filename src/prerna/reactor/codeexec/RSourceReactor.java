...
public class RSourceReactor extends AbstractRFrameReactor {
  ...
  public NounMetadata execute() {
    ...
    String disable_script_scource =
        DIHelper.getInstance().getProperty(Constants.DISABLE_SCRIPT_SOURCE);
    ...
    String strict_script_source =
        DIHelper.getInstance().getProperty(Constants.STRICT_SCRIPT_SOURCE);
