...
public class RSourceReactor extends AbstractRFrameReactor {
	...
	public NounMetadata execute() {
		...
		// if
		// (Boolean.parseBoolean(DIHelper.getInstance().getProperty(Constants.CHROOT_ENABLE)))
		// {
		// //get the app_root folder for the project
		// this.insight.getUser().getUserMountHelper().mountFolder(assetFolder,assetFolder,
		// false);
		// }
