...
public class TaxRetrieveValue2 extends AbstractReactor {
  ...
  /**
   * This reactor takes in 2 nouns store -> this points to the store name this will automatically be
   * replaced with the NounMetadata that is in the pixel planner
   *
   * <p>key -> the key that the value is stored under
   */
  @Override
  public NounMetadata execute() {
    PixelPlanner planner = getPlanner();
    Class<BaseJavaRuntime> javaClass =
        (Class<BaseJavaRuntime>) planner.getProperty("RUN_CLASS", "RUN_CLASS");
