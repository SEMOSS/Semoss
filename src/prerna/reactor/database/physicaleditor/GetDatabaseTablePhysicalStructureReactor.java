...
public class GetDatabaseTablePhysicalStructureReactor extends AbstractReactor {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(GetDatabaseTablePhysicalStructureReactor.class);

  public GetDatabaseTablePhysicalStructureReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.DATABASE.getKey(), ReactorKeysEnum.TABLE.getKey()};
  }
  ...
  public NounMetadata execute() {
    ...
    if (table == null || (table = table.trim()).isEmpty()) {
      throw new IllegalArgumentException(
          "Must pass in " + ReactorKeysEnum.TABLE.getKey() + " to pull the schema from");
    }
