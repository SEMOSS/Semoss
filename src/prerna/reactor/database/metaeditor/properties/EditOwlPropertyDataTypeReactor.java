...
public class EditOwlPropertyDataTypeReactor extends AbstractMetaEditorReactor {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(EditOwlPropertyDataTypeReactor.class);
  ...
  public NounMetadata execute() {
    ...
    try (WriteOWLEngine owlEngine = database.getOWLEngineFactory().getWriteOWL()) {
      ...
      owlEngine.addToBaseEngine(
          new Object[] {
            propertyPhysicalURI, RDFS.CLASS.stringValue(), "TYPE:" + newDataType, true
          });
      ...
      if (newAdditionalDataType != null && !newAdditionalDataType.isEmpty()) {
        ...
        if (currentAdditionalDataType != null) {
          ...
          owlEngine.removeFromBaseEngine(
              new Object[] {
                propertyPhysicalURI,
                AbstractOWLEngine.ADDITIONAL_DATATYPE_RELATION_URI,
                currentAdditionalDataType,
                false
              });
        }
        owlEngine.addToBaseEngine(
    ...
    noun.addAdditionalReturn(
        new NounMetadata(
            "Successfully edited data type of " + property + " to " + newDataType,
            PixelDataType.CONST_STRING,
