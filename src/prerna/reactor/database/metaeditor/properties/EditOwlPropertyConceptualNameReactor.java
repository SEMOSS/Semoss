...
public class EditOwlPropertyConceptualNameReactor extends AbstractMetaEditorReactor {
	...
	public EditOwlPropertyConceptualNameReactor() {
		this.keysToGet = new String[]{ReactorKeysEnum.DATABASE.getKey(), ReactorKeysEnum.CONCEPT.getKey(),
				ReactorKeysEnum.COLUMN.getKey(), CONCEPTUAL_NAME};
	}
	...
	public NounMetadata execute() {
		...
		try (WriteOWLEngine owlEngine = database.getOWLEngineFactory().getWriteOWL()) {
			...
			owlEngine.addToBaseEngine(
					new Object[]{propertyPhysicalURI, AbstractOWLEngine.PIXEL_RELATION_URI, newPixelURI, true});
		...
		noun.addAdditionalReturn(
				new NounMetadata("Successfully edited concept name from " + property + " to " + newPixelName,
