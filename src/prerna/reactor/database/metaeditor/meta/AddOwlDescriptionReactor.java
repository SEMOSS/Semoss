...
public class AddOwlDescriptionReactor extends AbstractMetaEditorReactor {
	...
	private static final Logger classLogger = LogManager.getLogger(AddOwlDescriptionReactor.class);
	...
	public NounMetadata execute() {
		...
		try (WriteOWLEngine owlEngine = database.getOWLEngineFactory().getWriteOWL()) {
			...
			try {
				...
				noun.addAdditionalReturn(new NounMetadata("An error occurred attempting to add description",
		...
		noun.addAdditionalReturn(new NounMetadata("Successfully added descriptions", PixelDataType.CONST_STRING,
