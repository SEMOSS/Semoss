...
public class RemoveOwlLogicalNamesReactor extends AbstractMetaEditorReactor {
	...
	public RemoveOwlLogicalNamesReactor() {
		this.keysToGet = new String[]{ReactorKeysEnum.DATABASE.getKey(), ReactorKeysEnum.CONCEPT.getKey(),
				ReactorKeysEnum.COLUMN.getKey(), ReactorKeysEnum.LOGICAL_NAME.getKey()};
	}
	...
	public NounMetadata execute() {
		...
		try (WriteOWLEngine owlEngine = database.getOWLEngineFactory().getWriteOWL()) {
			...
			try {
				...
				noun.addAdditionalReturn(new NounMetadata(
						"An error occurred attempting to remove logical names : " + Arrays.toString(logicalNames),
		...
		noun.addAdditionalReturn(
				new NounMetadata("Successfully removed logical names : " + Arrays.toString(logicalNames),
