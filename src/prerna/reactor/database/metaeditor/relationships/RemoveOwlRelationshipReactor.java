...
public class RemoveOwlRelationshipReactor extends AbstractMetaEditorReactor {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(RemoveOwlRelationshipReactor.class);
  ...
  public RemoveOwlRelationshipReactor() {
    this.keysToGet =
        new String[] {
          ReactorKeysEnum.DATABASE.getKey(), "startT", "endT", "startC", "endC", STORE_VALUES_FRAME
        };
  }
    ...
    try (WriteOWLEngine owlEngine = database.getOWLEngineFactory().getWriteOWL()) {
      ...
      try {
        ...
        noun.addAdditionalReturn(
            new NounMetadata(
                "An error occurred attempting to add the relationships defined",
