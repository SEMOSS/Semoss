...
/**
 * @author chpiper DownloadOwlRelationships ( database =
 *         "f9b656cc-06e7-4cce-bae8-b5f92075b6da" ) ; This reactor exports the
 *         relationships between tables the user has added to the owl file to an
 *         excel. getPhysicalRelationships returns these relationships.
 */
