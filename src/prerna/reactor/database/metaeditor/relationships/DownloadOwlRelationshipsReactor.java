...
/**
 * @author chpiper DownloadOwlRelationships ( database = "f9b656cc-06e7-4cce-bae8-b5f92075b6da" ) ;
 *     This reactor exports the relationships between tables the user has added to the owl file to
 *     an excel. getPhysicalRelationships returns these relationships.
 */
public class DownloadOwlRelationshipsReactor extends AbstractReactor {

  private static final Logger classLogger =
      LogManager.getLogger(DownloadOwlRelationshipsReactor.class);
  ...
  public NounMetadata execute() {
    ...
    retNoun.addAdditionalReturn(
        NounMetadata.getSuccessNounMessage("Successfully generated the relationship excel file"));
    return retNoun;
  }
  ...
  public void createExcelFile(List<String[]> relationships, String userId, String fileLocation) {
    ...
    SemossDate sDate = new SemossDate(ZonedDateTime.now(zoneId).toLocalDateTime());
