...
public class FindIndirectOwlRelationshipsReactor extends AbstractMetaEditorReactor {
   ...
   *
   * <p>source("C:/workspace/Semoss_Dev/R/OwlMatchRoutines/OwlColumnNamesFuzzyMatch.R"); allTables
   * <-
  ...
  public NounMetadata execute() {
    ...
    String[] colNames =
        new String[] {"sourceCol", "targetCol", "distance", "sourceTable", "targetTable"};
    String[] colTypes =
        new String[] {"character", "character", "numeric", "character", "character"};
