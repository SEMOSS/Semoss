...
public class FindSemanticColumnOwlRelationshipsReactor extends AbstractMetaEditorReactor {
  ...
  private static final String CLASS_NAME =
      FindSemanticColumnOwlRelationshipsReactor.class.getName();

  /**
   * Example script to run:
   *
   * <p>source("C:/workspace/Semoss_Dev/R/OwlMatchRoutines/OwlColumnCosineDistance.R"); allTables <-
  ...
  public NounMetadata execute() {
    ...
    for (int i = 0; i < size; i++) {
      ...
      String description =
          database.getDescription(
              "http://semoss.org/ontologies/Relation/Contains/" + cName + "/" + tName);
    ...
    if (existingDefinitions == null) {
      ...
      script
          ...
          .append(allColumnsVar)
          .append(",")
          .append(existingDefinitions.toString())
          .append(");");
    }
    // execute!
