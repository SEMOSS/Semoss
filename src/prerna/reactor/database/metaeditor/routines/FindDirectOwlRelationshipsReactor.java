...
public class FindDirectOwlRelationshipsReactor extends AbstractMetaEditorReactor {
  ...
  public NounMetadata execute() {
    ...
    try {
      frame.addRowsViaIterator(
          new Iterator<IHeadersDataRow>() {
                ...
                for (; targetTableIndex < size; targetTableIndex++) {
                  ...
                  for (int cIndex = 0; cIndex < sourceColumnsToTest.size(); cIndex++) {
                    ...
                    if (otherColumn != null) {
                      ...
                      String[] headers =
                          new String[] {
                            "targetTable", "targetCol", "sourceTable", "sourceCol", "distance"
                          };
                      Object[] value =
                          new Object[] {sourceTable, testColumn, targetTable, otherColumn, 1.0};
    ...
    if (emptyMessage) {
      retNoun.addAdditionalReturn(
          NounMetadata.getWarningNounMessage("There are no direct matches"));
    }
    // store in insight
