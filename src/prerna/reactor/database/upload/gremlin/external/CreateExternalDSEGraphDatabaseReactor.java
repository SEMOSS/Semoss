...
public class CreateExternalDSEGraphDatabaseReactor extends AbstractCreateExternalGraphReactor {
  ...
  protected void validateUserInput() {
    ...
    if (this.host == null) {
      SemossPixelException exception =
          new SemossPixelException(
              new NounMetadata(
                  "Requires host to save.", PixelDataType.CONST_STRING, PixelOperationType.ERROR));
    ...
    if (this.port == null) {
      SemossPixelException exception =
          new SemossPixelException(
              new NounMetadata(
                  "Requires port to save.", PixelDataType.CONST_STRING, PixelOperationType.ERROR));
      exception.setContinueThreadOfExecution(false);
      throw exception;
    }
  ...
  protected File generateTempSmss(File owlFile) throws IOException {
    return UploadUtilities.generateTemporaryDatastaxSmss(
        this.newDatabaseId,
