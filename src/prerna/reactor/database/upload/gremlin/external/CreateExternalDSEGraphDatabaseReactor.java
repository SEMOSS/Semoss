...
public class CreateExternalDSEGraphDatabaseReactor extends AbstractCreateExternalGraphReactor {
	...
	protected File generateTempSmss(File owlFile) throws IOException {
		return UploadUtilities.generateTemporaryDatastaxSmss(this.newDatabaseId, this.newDatabaseName, owlFile,
				this.host, this.port, this.username, this.password, this.graphName, this.typeMap, this.nameMap,
				useLabel());
	}
