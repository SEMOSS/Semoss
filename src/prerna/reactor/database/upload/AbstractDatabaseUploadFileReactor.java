...
public abstract class AbstractDatabaseUploadFileReactor extends AbstractReactor {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(AbstractDatabaseUploadFileReactor.class);

  /**
   * Every reactor that extends this needs to define its own inputs However, every one needs to have
   * the following in the keysToGet array: UploadUtility.DATABASE UploadInputUtility.FILE_PATH
  ...
  public abstract void generateNewDatabase(
      User user, final String newDatabaseName, final String filePath) throws Exception;
