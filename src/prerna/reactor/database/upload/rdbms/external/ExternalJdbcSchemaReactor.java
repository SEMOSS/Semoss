...
public class ExternalJdbcSchemaReactor extends AbstractReactor {
  ...
  public ExternalJdbcSchemaReactor() {
    this.keysToGet =
        new String[] {
          ReactorKeysEnum.CONNECTION_DETAILS.getKey(), ReactorKeysEnum.FILTERS.getKey()
        };
  }
  ...
  public NounMetadata execute() {
    ...
    try {
      ...
      try {
        ...
        String errorMessage =
            "Unable to establish connection given the connection details.\nDriver produced error: \" ";
      ...
      CustomTableAndViewIterator tableViewIterator =
          new CustomTableAndViewIterator(
              con, meta, catalogFilter, schemaFilter, driverEnum, tableAndViewFilters);
