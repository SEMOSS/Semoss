...
// ChangeAppNameReactor.class.getName();
//
...
// if (security) {
// appId = SecurityQueryUtils.testUserEngineIdForAlias(this.insight.getUser(),
// appId);
// boolean isAdmin = SecurityAdminUtils.userIsAdmin(user);
// if (!isAdmin) {
// boolean isOwner = SecurityAppUtils.userIsOwner(user, appId);
// if (!isOwner) {
// throw new IllegalArgumentException("User must be the owner to perform this
// function.");
// }
// }
//
...
// }
// String smssDbFolder =
// DIHelper.getInstance().getProperty(Constants.BASE_FOLDER) + DIR_SEPARATOR
// + "db";
// IEngine engine = Utility.getEngine(appId);
// String oldAppName = engine.getEngineName();
//
// // smss paths
// String oldSmssFile = smssDbFolder + DIR_SEPARATOR +
// SmssUtilities.getUniqueName(oldAppName,
// appId)
// + Constants.SEMOSS_EXTENSION;
// String newSmssFile = smssDbFolder + DIR_SEPARATOR +
// SmssUtilities.getUniqueName(newAppName,
// appId)
// + Constants.SEMOSS_EXTENSION;
//
// // app folder paths
// String oldAppFolderPath = smssDbFolder + DIR_SEPARATOR +
// SmssUtilities.getUniqueName(oldAppName,
// appId);
// String newAppFolderPath = smssDbFolder + DIR_SEPARATOR +
// SmssUtilities.getUniqueName(newAppName,
// appId);
...
// // create new owl
// File newOwlFile =
// SmssUtilities.getOwlFile(Utility.loadProperties(newSmssFile));
// FileUtils.copyFile(oldOwlFile, newOwlFile);
//
// // update engine with new paths
// DIHelper.getInstance().getCoreProp().setProperty(appId + "_" +
// Constants.STORE, newSmssFile);
...
// ret.addAdditionalReturn(NounMetadata.getSuccessNounMessage("Successfuly
// changed app name!"));
// return ret;
// }
// }
