...
public class GenerateIdColumnReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    try {
      ...
      database.insertData(
          queryUtil.createTable(tempTable, columnNames, types.toArray(new String[0])));
      ...
      ps =
          conn.prepareStatement(
              queryUtil.createInsertPreparedStatementString(tempTable, columnNames));
      ...
      noun.addAdditionalReturn(
          getSuccess("Successfully added id column: " + newColumn + " to " + tableName));
      return noun;
  ...
  private IRawSelectWrapper getData(
      RDBMSNativeEngine database, String tableName, List<String> columns) {
