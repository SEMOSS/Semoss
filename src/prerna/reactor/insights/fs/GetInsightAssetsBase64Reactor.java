...
public class GetInsightAssetsBase64Reactor extends AbstractReactor {

	public GetInsightAssetsBase64Reactor() {
	...
	public String getReactorDescription() {
		return "Retrieve the contents of a file (image, pdf, etc.) as base64 encoded string in the insight";
	}
