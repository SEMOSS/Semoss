...
public class InsightRecipeReactor extends AbstractInsightReactor {
  ...
  public InsightRecipeReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.PROJECT.getKey(), ReactorKeysEnum.ID.getKey(), VECTOR_KEY};
  }
  ...
  public NounMetadata execute() {
    ...
    if (vec) {
      return new NounMetadata(
          recipeSteps, PixelDataType.CONST_STRING, PixelOperationType.SAVED_INSIGHT_RECIPE);
    }
    ...
    return new NounMetadata(
        bigRecipe.toString(), PixelDataType.CONST_STRING, PixelOperationType.SAVED_INSIGHT_RECIPE);
  }
}
