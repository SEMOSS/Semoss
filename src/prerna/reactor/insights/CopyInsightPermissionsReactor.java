...
public class CopyInsightPermissionsReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    String sourceInsightName =
        SecurityQueryUtils.getInsightNameForId(sourceProjectId, sourceInsightId);
    String targetInsightName =
        SecurityQueryUtils.getInsightNameForId(targetProjectId, targetInsightId);
    ...
    try {
      SecurityInsightUtils.copyInsightPermissions(
          sourceProjectId, sourceInsightId, targetProjectId, targetInsightId);
    } catch (Exception e) {
    ...
    return new NounMetadata(
        "Copied permissions from project "
            + sourceProject
            + "__"
            + sourceProjectId
            + " insight \""
