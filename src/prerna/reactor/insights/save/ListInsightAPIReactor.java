...
public class ListInsightAPIReactor extends AbstractReactor {
  ...
  public ListInsightAPIReactor() {
    ...
    this.keysToGet =
        new String[] {
          ReactorKeysEnum.PROJECT.getKey(), ReactorKeysEnum.ID.getKey(),
        };
  ...
  public NounMetadata execute() {
    ...
    try {
      ...
      String existingSQL =
          "SELECT CONSUMER_ID, API_KEY, DISABLED from API_KEY where Project_ID = '"
              + projectId
              + "\' and INSIGHT_ID = '"
              + insightId
              + "'";
      ...
      while (wrapper.hasNext()) {
        ...
        if (disabled) consumerId = "Disabled  <" + consumerId + ">";
