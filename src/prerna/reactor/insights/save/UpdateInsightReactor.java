...
public class UpdateInsightReactor extends AbstractInsightReactor {
  ...
  public NounMetadata execute() {
    ...
    editRegisteredInsightAndMetadata(
        project,
        existingId,
        insightName,
        layout,
    ...
    GitRepoUtils.commitAddedFiles(
        projectVersion,
        GitUtils.getDateMessage(
            "Update insight '" + existingId + "' (+" + insightName + ") recipe on"),
        author,
        email);
   ...
   */
  private void editRegisteredInsightAndMetadata(
      IProject project,
