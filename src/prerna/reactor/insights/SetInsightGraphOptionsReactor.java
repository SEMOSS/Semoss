...
public class SetInsightGraphOptionsReactor extends AbstractReactor {
  ...
  // "GRAPH_SHAPES":{...} ]);
  // SetInsightGraphOptions ( options = [ { "GRAPH_COLORS" : { "System" : "BLUE" , "Interface" :
  // "Yellow" } , "GRAPH_SHAPES" : { "System" : "Triangle" , "Interface" : "CIRCLE" } } ] ) ;
  // SetInsightGraphOptions ( options = [ { "GRAPH_COLORS" : { "System" : "BLUE" , "Interface" :
  // "Yellow" } } ] ) ;
  // SetInsightGraphOptions ( options = [ { "GRAPH_COLORS" : { "System" : BLUE , "Interface" :
  // Yellow } } ] ) ;
    ...
    if (grs != null) {
      ...
      for (Object value : values) {
        ...
        return new NounMetadata(
            mapValue, PixelDataType.MAP, PixelOperationType.FORCE_SAVE_DATA_TRANSFORMATION);
      }
    }
    return new NounMetadata(
