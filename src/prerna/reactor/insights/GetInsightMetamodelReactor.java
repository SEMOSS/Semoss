  ...
  public NounMetadata execute() {
    ...
    if (!SecurityInsightUtils.userCanViewInsight(this.insight.getUser(), projectId, id)) {
      throw new IllegalArgumentException(
          "Insight does not exist or user does not have permission to view this insight");
    }
    ...
    return new NounMetadata(
        result, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.INSIGHT_METAMODEL);
  }
