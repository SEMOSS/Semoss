...
public class CountIfReactor extends AbstractFrameReactor {
  ...
  public NounMetadata execute() {
    ...
    // 2) create a temp column to replace the matching string in the column to count with a
    // replacement string
    ...
    // 3) Update the count column by setting it to the length of the col - replacing the temp column
    // with empty string
    String updateCountColumn =
        "UPDATE "
            + table
            + " SET "
            + newColumnName
