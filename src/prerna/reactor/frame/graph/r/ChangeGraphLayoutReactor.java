...
/**
 * Run a layout in iGraph and store back into tinker objects Possible values: Fruchterman -
 * layout_with_fr KK - layout_with_kk sugiyama - layout_with_sugiyama layout_as_tree layout_as_star
 * layout.auto http://igraph.org/r/doc/layout_with_fr.html
 */
public class ChangeGraphLayoutReactor extends AbstractRFrameReactor {
  ...
  public ChangeGraphLayoutReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.GRAPH_LAYOUT.getKey(), "yMin", "yMax", "xMin", "xMax"};
  }
  ...
  public NounMetadata execute() {
    ...
    try {
      ...
      this.rJavaTranslator.executeEmptyR(
          "" + tempOutputLayout + " <- " + inputLayout + "(" + graphName + ")");
