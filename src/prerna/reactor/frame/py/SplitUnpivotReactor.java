...
public class SplitUnpivotReactor extends AbstractPyFrameReactor {
  ...
  /**
   * This reactor splits columns based on a separator The split values will be combined into a
   * single column The inputs to the reactor are: 1) the columns to split "columns" 2) the
   * delimiters "delimiters"
   */
  public SplitUnpivotReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.COLUMNS.getKey(), ReactorKeysEnum.DELIMITER.getKey()};
  }
