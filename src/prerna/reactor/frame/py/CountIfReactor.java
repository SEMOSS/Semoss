...
public class CountIfReactor extends AbstractPyFrameReactor {
  ...
  /**
   * This reactor creates a new column based on the count of regex matches of an existing column The
   * inputs to the reactor are: 1) the column to count regex instances in 2) the regex 3) the new
   * column name
   */
  ...
  public NounMetadata execute() {
    ...
    metaData.setDataTypeToProperty(
        frame.getName() + "__" + newColName, SemossDataType.DOUBLE.toString());
