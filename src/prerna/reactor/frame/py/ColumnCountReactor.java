...
public class ColumnCountReactor extends AbstractPyFrameReactor {
	 ...
	 * values in a matrix 1) column to use 2) boolean indicator (optional) if true
	 * (default), sort by descending frequency of items in a column if false, sort
	 * ascending 3) panelId (defaults to zero if nothing is entered)
	 */
