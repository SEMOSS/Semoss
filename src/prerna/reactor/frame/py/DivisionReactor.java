...
public class DivisionReactor extends AbstractPyFrameReactor {
  ...
  public DivisionReactor() {
    this.keysToGet =
        new String[] {NUMERATOR, DENOMINATOR, ROUND, ReactorKeysEnum.NEW_COLUMN.getKey()};
  }
  ...
  public NounMetadata execute() {
    ...
    if (numerator == null
        || !startingColumnsList.contains(numerator)
        || denominator == null
        || !startingColumnsList.contains(denominator)) {
      throw new IllegalArgumentException(
          "Need to define existing numerator and denominator columns.");
    }
    ...
    */
    ...
    retNoun.addAdditionalReturn(
        NounMetadata.getSuccessNounMessage("Successfully performed column division"));
    return retNoun;
  }
