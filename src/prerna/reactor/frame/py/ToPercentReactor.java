...
public class ToPercentReactor extends AbstractPyFrameReactor {
  ...
  public ToPercentReactor() {
    this.keysToGet =
        new String[] {
          ReactorKeysEnum.COLUMN.getKey(), SIG_DIGITS, BY100, ReactorKeysEnum.NEW_COLUMN.getKey()
        };
  }
  ...
  public NounMetadata execute() {
    ...
    if (newColName != null && !newColName.equals("") && !newColName.equals("null")) {
      ...
      script =
          wrapperFrameName + ".to_pct('" + srcCol + "', '" + newColName + "', " + sigDigits + ", ";
    }
    ...
    if (sigDigits < 0) {
      throw new IllegalArgumentException(
          "Significant digits must be greater than or equal to zero.");
    }
    ...
    if (newColName != null && !newColName.equals("") && !newColName.equals("null")) {
      ...
      metaData.modifyDataTypeToProperty(
          frameName + "__" + srcCol, frameName, SemossDataType.STRING.toString());
    }
