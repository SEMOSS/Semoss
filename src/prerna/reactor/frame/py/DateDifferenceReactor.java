...
public class DateDifferenceReactor extends AbstractPyFrameReactor {
  ...
  public DateDifferenceReactor() {
    this.keysToGet =
        new String[] {
          START_COLUMN, END_COLUMN, INPUT_USE, INPUT_DATE, UNIT, ReactorKeysEnum.NEW_COLUMN.getKey()
        };
  }
  ...
  public NounMetadata execute() {
    ...
    if (!unitsList.contains(unit)) {
      throw new IllegalArgumentException(
          "Please pass an appropriate unit value (day, week, month, year).");
    }
    ...
    String addedColumnDataType =
        unit.equals(DAY) ? SemossDataType.INT.toString() : SemossDataType.DOUBLE.toString();
    if (inputUse.equals("none") || inputUse.equals("")) {
      script
          .append(wrapperName)
          .append(".date_difference_columns(")
          .append(endCol)
          .append(",")
          .append(startCol)
          .append(",")
      ...
      script
          .append(wrapperName)
          .append(".date_difference_constant(")
          .append(endCol)
          .append(",")
          .append(inputDate)
          .append(",")
    ...
    retNoun.addAdditionalReturn(
        NounMetadata.getSuccessNounMessage("Successfully performed date arithmetic."));
    return retNoun;
  }
}
