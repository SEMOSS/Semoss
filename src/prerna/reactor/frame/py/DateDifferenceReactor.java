...
public class DateDifferenceReactor extends AbstractPyFrameReactor {
	...
	public NounMetadata execute() {
		...
		String addedColumnDataType = unit.equals(DAY)
				? SemossDataType.INT.toString()
				: SemossDataType.DOUBLE.toString();
		if (inputUse.equals("none") || inputUse.equals("")) {
			script.append(wrapperName).append(".date_difference_columns(").append(endCol).append(",").append(startCol)
					.append(",").append(unit).append(",").append(newColName);
		} else if (inputUse.equals("start")) {
			script.append(wrapperName).append(".date_difference_constant(").append(endCol).append(",").append(inputDate)
					.append(",").append("True,").append(unit).append(",").append(newColName);
		} else if (inputUse.equals("end")) {
			script.append(wrapperName).append(".date_difference_constant(").append(startCol).append(",")
					.append(inputDate).append(",").append("False,").append(unit).append(",").append(newColName);
		}
