  ...
  public NounMetadata execute() {
    ...
    if (filters == null) {
      ...
      return new NounMetadata(
          new ArrayList<Object>(), PixelDataType.FILTER, PixelOperationType.FRAME_FILTER);
    }
    return new NounMetadata(
        filters.getFormatedFilters(), PixelDataType.FILTER, PixelOperationType.FRAME_FILTER);
  }
}
