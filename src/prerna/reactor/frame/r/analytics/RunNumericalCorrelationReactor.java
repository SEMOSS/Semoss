...
public class RunNumericalCorrelationReactor extends AbstractRFrameReactor {
  ...
  public RunNumericalCorrelationReactor() {
    this.keysToGet =
        new String[] {
          ...
          ReactorKeysEnum.DEFAULT_VALUE_KEY.getKey(),
  ...
  public NounMetadata execute() {
    ...
    ITask taskData =
        ConstantTaskCreationHelper.getHeatMapData(
            panelId, "Column_Header_X", "Column_Header_Y", "Correlation", retOutput);
    ...
    noun.addAdditionalReturn(
        NounMetadata.getSuccessNounMessage("Numerical Correlation ran successfully!"));
    return noun;
  }
  ...
  private String runRCorrelation(String frameName, String[] retHeaders) {
    ...
    String correlationScriptFilePath =
        getBaseFolder() + "\\R\\AnalyticsRoutineScripts\\NumericalCorrelation.R";
    correlationScriptFilePath = correlationScriptFilePath.replace("\\", "/");
    rsb.append("source(\"" + correlationScriptFilePath + "\");");
    // R syntax for the routine: ResultsTableName <- getCorrelationTable(frameName, c("col1",
    // "col2"))
