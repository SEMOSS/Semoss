...
public class RunDescriptionGeneratorReactor extends AbstractRFrameReactor {
	...
	public NounMetadata execute() {
		...
		if (nullResults) {
			...
			NounMetadata noun = new NounMetadata("Unable to obtain descriptions", PixelDataType.CONST_STRING,
		...
		rsb.append(tempFrame + "<-data.frame(" + instanceCol + "=" + instances + "," + descriptionHeader + "="
				+ descriptionCol + ");");
		rsb.append(dataFrame + " <-merge(" + dataFrame + "," + tempFrame + ", by.x=\"" + instanceCol + "\", by.y=\""
				+ instanceCol + "\");");
