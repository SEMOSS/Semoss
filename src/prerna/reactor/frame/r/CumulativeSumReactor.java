...
public class CumulativeSumReactor extends AbstractRFrameReactor {
  ...
  public NounMetadata execute() {
    ...
    // determine if the value column datatype is int or double this will define the new column
    // datatype
    ...
    frame.executeRScript(
        RSyntaxHelper.asDataTable(dataFrame, outputFrame) + "; rm(" + outputFrame + ")");
