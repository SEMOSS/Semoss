...
public class DateDifferenceReactor extends AbstractRFrameReactor {
	...
	public NounMetadata execute() {
		...
		if (inputUse.equals("none") || inputUse.equals("")) {
			script.append(table).append("$").append(newColName).append(" <- round(as.numeric(difftime(").append(table)
			...
			script.append(table).append("$").append(newColName).append(" <- round(as.numeric(difftime(")
					.append("as.Date(\"").append(inputDate).append("\"), ");
			script.append(table).append("$").append(startCol);
		}
