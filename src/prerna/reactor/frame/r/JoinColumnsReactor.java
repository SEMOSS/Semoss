...
public class JoinColumnsReactor extends AbstractRFrameReactor {
  ...
  /**
   * This reactor joins columns, and puts the joined string into a new column with values separated
   * by a separator The inputs to the reactor are: 1) the new column name 2) the delimiter 3) the
   * columns to join
   */
  ...
  public NounMetadata execute() {
    ...
    // script will be of the form: FRAME$mynewcolumn <- paste(FRAME$Year, FRAME$Title,
    // FRAME$Director, sep = ", ")
