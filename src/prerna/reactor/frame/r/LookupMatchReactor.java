  ...
  public NounMetadata execute() {
    ...
    this.rJavaTranslator.runR(
        "rm("
            ...
            + catalog
            + ");gc();"
            + RSyntaxHelper.setWorkingDirectory(currentWd));

    // convert to {instance:[{}]} (easier processing)
    Map<String, List<Map<String, Object>>> returnData =
    ...
    return new NounMetadata(
        returnData, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.OPERATION);
  }
