...
public class ToPercentReactor extends AbstractRFrameReactor {
  ...
  public NounMetadata execute() {
    ...
    if (srcCol == null
        || !startingColumnsList.contains(srcCol)
        || !Utility.isNumericType(
            metaData.getHeaderTypeAsEnum(rFrameName + "__" + srcCol).toString())) {
    ...
    if (newColName != null && !newColName.equals("")) {
      ...
      metaData.modifyDataTypeToProperty(
          rFrameName + "__" + srcCol, rFrameName, SemossDataType.STRING.toString());
    }
    return retNoun;
  }
