...
public class SynchronizeToRReactor extends AbstractRFrameReactor {
  ...
  /**
   * This reactor takes a frame and synchronizes it to an r frame inputs are: 1) table name for the
   * synchronized frame 2) working directory, which is optional and only used for tinker frame
   */
  ...
  private void synchronizeGraphToR(ITableDataFrame frame, String rDataTableName, String wd) {
    ...
    try {
      ...
      System.out.println(
          "Successfully synchronized, your graph is now available as " + rDataTableName);
