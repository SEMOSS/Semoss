...
public class TCPRTranslator extends AbstractRJavaTranslator {
  ...
  public Object executeR(String rScript) {
    ...
    if (nc != null) {
      ...
      if (ps != null && ps.ex == null) {
        return ps.payload[0];
      } else if (ps != null) logger.info(ps.ex);
    }
  ...
  public void runR(String rScript) {
    if (nc != null) {
      ...
      ps.hasReturn = false;
      ps = (PayloadStruct) nc.executeCommand(ps);
      if (ps != null && ps.ex != null) logger.info(Utility.cleanLogString(ps.ex));
    }
  }
  ...
  public String runRAndReturnOutput(String rScript) {
    if (nc != null) {
      ...
      if (retPS.processed) return retPS.payload[0] + "";
      else return " Script " + ps.payload[0] + " Failed with " + retPS.ex;
    }
    return null;
  }
  ...
  public String[] getStringArray(String script) {
    if (nc != null) {
      ...
      if (ps != null) logger.info(Utility.cleanLogString(ps.ex));
    }
    return null;
  }
  ...
  Object executeRDirect(String rScript) {
    if (nc != null) {
      ...
      } else if (ps != null) return ps.payload[0];
    }
    return null;
  }
  ...
  public Map<String, Object> getHistogramBreaksAndCounts(String script) {
    if (nc != null) {
      ...
      if (ps != null && ps.ex != null) {
        logger.info("Exception " + ps.ex);
      } else if (ps != null) return (Map<String, Object>) ps.payload[0];
    }
    return null;
  }
  ...
  public Object[] getDataRow(String rScript, String[] headerOrdering) {
    if (nc != null) {
      ...
      if (ps != null && ps.ex != null) {
        logger.info("Exception " + Utility.cleanLogString(ps.ex));
      } else if (ps != null) return (Object[]) ps.payload[0];
    }
    return null;
  }
  ...
  public List<Object[]> getBulkDataRow(String rScript, String[] headerOrdering) {
    if (nc != null) {
      ...
      if (ps != null && ps.ex != null) {
        logger.info("Exception " + Utility.cleanLogString(ps.ex));
      } else if (ps != null) return (List<Object[]>) ps.payload[0];
    }
    return null;
  }
  ...
  public void changeColumnType(
    ...
    if (nc != null) {
      String methodName = new Object() {}.getClass().getEnclosingMethod().getName();
      PayloadStruct ps =
          constructPayload(methodName, frameName, columnName, typeToConvert, currentType);
      ps.payloadClasses =
          new Class[] {String.class, String.class, SemossDataType.class, SemossDataType.class};
      ps.hasReturn = false;
      ps = (PayloadStruct) nc.executeCommand(ps);
      if (ps != null && ps.ex != null) {
        logger.info(ps.ex);
