...
public class RJavaRserveTranslator extends AbstractRJavaTranslator {
  ...
  /**
   * This will start R, only if it has not already been started In this case we are establishing a
   * connection for Rserve
   */
  @Override
  public void startR() {
          ...
          if (this.retCon == null) {
            ...
            if (this.insight != null) {
              this.insight
                  .getVarStore()
                  .put(
                      AbstractBaseRClass.R_CONN,
                      new NounMetadata(retCon, PixelDataType.R_CONNECTION));
              this.insight
                  .getVarStore()
                  .put(
                      AbstractBaseRClass.R_PORT,
