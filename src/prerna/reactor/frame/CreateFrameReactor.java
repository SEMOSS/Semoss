...
public class CreateFrameReactor extends AbstractReactor {
  ...
  public CreateFrameReactor() {
    this.keysToGet =
        new String[] {
          ReactorKeysEnum.FRAME_TYPE.getKey(), OVERRIDE, ReactorKeysEnum.ALIAS.getKey()
        };
  }
  ...
  public NounMetadata execute() {
    ...
    if (alias == null || alias.trim().isEmpty()) {
      ...
      try {
        ...
        alias = "";
        logger.info(
            "Invalid alias - creating new frame of type = " + frameType + " with a random alias");
      }
    }
  ...
  public List<NounMetadata> getOutputs() {
    ...
    NounMetadata output =
        new NounMetadata(this.signature, PixelDataType.FRAME, PixelOperationType.FRAME);
    outputs.add(output);
    return outputs;
  }
    ...
    if (parentReactor != null) {
      ...
      if (parentReactor instanceof EmbeddedScriptReactor
        ...
        GenRowStruct parentInput =
            parentReactor.getNounStore().makeNoun(PixelDataType.FRAME.getKey());
