...
public class FillFormReactor extends AbstractGaasBaseReactor {
	...
	// the model string to send is "siamese / haystack / somehting else" Right now
	// only siamese is
	// implemented
	...
	public NounMetadata execute() {
		...
		Object output = pt.runScript(semossModelName + ".search_form_fields(input_data='" + inputContext
				+ "', form_fields=" + fields + ", pipe=" + modelVariable + ")");
