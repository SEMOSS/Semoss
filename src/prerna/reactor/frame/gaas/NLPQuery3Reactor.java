  ...
  public NounMetadata execute() {
    ...
    if (engine == null) {
      throw new IllegalArgumentException(
          "Model engine ID must be passed in or added as a property");
    }
    ...
    for (ITableDataFrame thisFrame : theseFrames) {
      ...
      //			finalDbString.append(". Be Concise. Provide as markdown. Output should start and end with
      // ``` markdown.");
      //
      finalDbString2.append(")\n\n");
      ...
      Map<String, Object> modelOutput =
          engine.ask(finalDbString2 + "", null, this.insight, params).toMap();
