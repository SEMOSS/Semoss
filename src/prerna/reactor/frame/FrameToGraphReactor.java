...
//                    "- The 'values' array inside the 'data' object must always be present, but must remain empty (i.e., values: []). Do not include any data or example records in this array."
//                    "- Leave the "values" array inside the "data" field empty in the generated JSON specification.
