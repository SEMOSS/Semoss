...
public class CreateGoogleFuntionEngineReactor extends AbstractReactor {

	private static final Logger classLogger = LogManager.getLogger(CreateGoogleFuntionEngineReactor.class);
	...
	public CreateGoogleFuntionEngineReactor() {
