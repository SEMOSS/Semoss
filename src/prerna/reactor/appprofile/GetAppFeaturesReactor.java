...
/**
 * Get all feature keys defined for an app.
 *
 * <p>Pixel: {@code GetAppFeatures(app=["appId"]);}</p>
 */
public class GetAppFeaturesReactor extends AbstractReactor {

	private static final Logger classLogger = LogManager.getLogger(GetAppFeaturesReactor.class);
