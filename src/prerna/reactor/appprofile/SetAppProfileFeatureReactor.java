 ...
 *
 * <p>Pixel: {@code SetAppProfileFeature(app=["appId"], profile=["profileId"], feature=["featureId"], enabled=["true"]);}</p>
 */
public class SetAppProfileFeatureReactor extends AbstractReactor {

	private static final Logger classLogger = LogManager.getLogger(SetAppProfileFeatureReactor.class);

	public SetAppProfileFeatureReactor() {
		this.keysToGet = new String[] { ReactorKeysEnum.APP.getKey(), ReactorKeysEnum.PROFILE_ID.getKey(), ReactorKeysEnum.FEATURE_ID.getKey(), ReactorKeysEnum.ENABLED.getKey() };
