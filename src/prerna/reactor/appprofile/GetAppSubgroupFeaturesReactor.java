...
public class GetAppSubgroupFeaturesReactor extends AbstractReactor {
	...
	public GetAppSubgroupFeaturesReactor() {
	...
	public NounMetadata execute() {
		...
		List<Map<String, Object>> result = AppProfileUtils.getSubgroupFeatures(appId, subgroupId);
		return new NounMetadata(result, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.OPERATION);
	}

	@Override
	public String getReactorDescription() {
		return "Get all feature flags for a sub-group.";
	}
}
