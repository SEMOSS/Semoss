...
public class GetOptimizedRecipeReactor extends AbstractReactor {
	...
	/**
	 * This reactor creates an optimized recipe - it removes from the recipe
	 * instances of pixels with TaskOptions that are not needed No inputs are used
	 */
	@Override
	public NounMetadata execute() {
		...
		return new NounMetadata(getModifiedRecipeString(pixelRecipe), PixelDataType.CONST_STRING,
				PixelOperationType.CURRENT_INSIGHT_RECIPE);
	}

	/**
	 * This method is used to retrieve the recipe as a String rather than as
	 * List<String>
	 *
	 * @param recipe
	...
	public List<String> getOptimizedRecipe(List<String> recipe) {
		// create a new translation object that will do the work of figuring out which
		// pixel expressions
		// to keep
