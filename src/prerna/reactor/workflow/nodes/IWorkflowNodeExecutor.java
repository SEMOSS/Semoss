...
/**
 * Executes one workflow node's operation, given all the context that node type needs.
 *
 ...
 * {@code Map<String, IWorkflowNodeExecutor>} registry in
 * {@link prerna.reactor.workflow.TriggerWorkflowReactor#executeSingleNode} instead of the
 ...
 * concurrent runs - all per-run/per-node state is passed in via {@link WorkflowNodeContext}, not
...
public interface IWorkflowNodeExecutor {
	 ...
	 */
	Object execute(WorkflowNodeContext ctx) throws Exception;
}
