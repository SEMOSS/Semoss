...
/**
 * Lists workflow run history for a project.
 *
 * <p>Pixel: {@code ListWorkflowRuns(app=["appId"], limit=["25"])}
 *
 * <p>Reads from WORKFLOW_RUNS in the scheduler DB.
 */
public class ListWorkflowRunsReactor extends AbstractReactor {
	...
	public NounMetadata execute() {
		...
		List<Map<String, Object>> runs = WorkflowDatabaseUtility.getRunsForProject(projectId, limit);
		if (runs == null) {
			runs = new ArrayList<>();
		}
