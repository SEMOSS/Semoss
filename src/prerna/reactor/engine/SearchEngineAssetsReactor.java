...
public class SearchEngineAssetsReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    int flags =
        optionsList.stream().anyMatch(s -> "case".equalsIgnoreCase(s))
            ? 0
    ...
    return new NounMetadata(
        results, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.OPERATION);
  }
  ...
  private void searchRecursive(
      File dir, Pattern pattern, int baseLen, List<Map<String, Object>> results) {
