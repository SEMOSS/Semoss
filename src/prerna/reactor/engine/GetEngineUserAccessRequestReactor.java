  ...
  public NounMetadata execute() {
    ...
    if (!SecurityAdminUtils.userIsAdmin(user)
      ...
      throw new IllegalArgumentException(
          "User does not have permission to view access requests for this engine");
    }
    List<Map<String, Object>> requests =
        SecurityEngineUtils.getUserAccessRequestsByEngine(engineId);
    return new NounMetadata(
        requests, PixelDataType.CUSTOM_DATA_STRUCTURE, PixelOperationType.ENGINE_INFO);
  }
}
