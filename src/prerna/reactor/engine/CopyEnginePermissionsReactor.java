...
public class CopyEnginePermissionsReactor extends AbstractReactor {
	...
	private static final Logger classLogger = LogManager.getLogger(CopyEnginePermissionsReactor.class);
	...
	public NounMetadata execute() {
		...
		return new NounMetadata("Copied permissions from database " + sourceDatabase + "__" + sourceEngineId + " to "
				+ targetDatabase + "__" + targetEngineId, PixelDataType.CONST_STRING);
	}
