 ...
 * UNSTAGED, or CONFLICT) of an engine's git repository.
 */
public class EngineGitDiffReactor extends AbstractReactor {

	private static final Logger classLogger = LogManager.getLogger(EngineGitDiffReactor.class);
	private static final String SIDE_KEY = "side";

	public EngineGitDiffReactor() {
	...
	public NounMetadata execute() {
		...
		try (Git thisGit = Git.open(new File(versionFolder))) {
			...
			classLogger.error("Error occurred getting git diff for engine {}", engineId, e);
