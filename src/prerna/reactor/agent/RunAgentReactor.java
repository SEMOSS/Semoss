...
public class RunAgentReactor extends AbstractReactor {
	...
	public RunAgentReactor() {
		this.keysToGet = new String[] { ReactorKeysEnum.ROOM_ID.getKey(), ReactorKeysEnum.COMMAND.getKey(),
				ReactorKeysEnum.ENGINE.getKey(), HARNESS_TYPE_KEY, WORKSPACE_ID_KEY, SPACE_KEY, MAX_TURNS_KEY,
				MAX_REFLECTIONS_KEY, WAIT_KEY, WAIT_TIMEOUT_MS_KEY, ReactorKeysEnum.PARAM_VALUES_MAP.getKey(),
	...
	public NounMetadata execute() {
		...
		if (paramMap.containsKey(AgentRunner.PARAM_SPACE)) {
			throw new IllegalArgumentException(
					"RunAgent space must be provided as a top-level argument, not paramValues.space");
		}
		...
		logger.info(
				"RunAgentReactor: roomId={} engineFallback={} harnessType={} workspaceId={} space={} maxTurns={} maxReflections={} wait={} waitTimeoutMs={} media={} urls={}",
				roomId, engineIdFallback, harnessType, explicitWorkspaceId, requestedSpace, maxTurns, maxReflections,
				wait, waitTimeoutMs, sizeOf(inputMedia), sizeOf(inputMediaURLs));
