...
/**
 * Agent-facing alias for {@link prerna.reactor.insights.fs.DeleteInsightAssetsReactor}.
 *
 * <p>Deletes one or more files in the insight assets folder. The parent reactor handles path
 * resolution, sandbox enforcement, and the actual removal; this subclass exists so the Pixel
 * surface exposes the familiar {@code DeleteFile} name and an agent-tuned description.
 */
