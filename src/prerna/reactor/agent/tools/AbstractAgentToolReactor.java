...
/**
 * Base class for all Agent_Tools reactors.
 *
 * <p>Tools operate relative to the insight's working directory (insight folder), which GenericAgent
 * sets to the room folder. All path arguments must be relative; absolute paths and path traversal
 * (../) are rejected.
 */
