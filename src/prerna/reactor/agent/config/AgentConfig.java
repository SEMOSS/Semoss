 ...
 *
 * <p>
 * Built once by {@link AgentConfigLoader} and shared across harnesses. It
...
public final class AgentConfig {
	...
	/**
	 * JSON schema version of this object. Starts at 1; bumps independently from
	 * {@code WORKSPACE.CONFIG_VERSION}.
	 */
	...
	// Skill refs (union of WORKSPACE_RESOURCE['SKILL'] + CONFIG_JSON.skills[] +
	// room.options.skills[])
	...
	// Named subagent specs (resolved from CONFIG_JSON.subagents[]; never null,
	// empty when none configured).
	// Semoss harness synthesizes one MCP tool per spec; CLI harnesses ignore this
	// field.
	...
	AgentConfig(Builder b) {
		...
		if (b.toolParameterDefaults != null) {
			b.toolParameterDefaults.forEach((name, params) -> defaults.put(name, Map.copyOf(params)));
		}
		...
		this.modelParams = b.modelParams != null ? Collections.unmodifiableMap(new HashMap<>(b.modelParams))
		...
		this.mcps = b.mcps != null ? Collections.unmodifiableList(new ArrayList<>(b.mcps)) : Collections.emptyList();
		this.skills = b.skills != null ? Collections.unmodifiableList(new ArrayList<>(b.skills))
		...
		this.runHooks = b.runHooks != null ? Collections.unmodifiableList(new ArrayList<>(b.runHooks))
				: Collections.emptyList();
		this.toolHooks = b.toolHooks != null ? Collections.unmodifiableList(new ArrayList<>(b.toolHooks))
				: Collections.emptyList();
		this.subagents = b.subagents != null ? Collections.unmodifiableList(new ArrayList<>(b.subagents))
				: Collections.emptyList();
	}

	// Identity
	/**
	 * Workspace id ({@code workspace.workspace_id}); {@code null} for ad-hoc rooms
	...
	// Prompt layers
	/**
	 * The resolved authored prompt: workspace instructions with room instructions
	 * appended when {@code overrideSystemPrompt=false}. True or omitted preserves
	 * room replacement behavior. {@code null} when neither layer is set.
	 */
	...
	/**
	 * Contents of the agent's own {@code AGENTS.md} / {@code CLAUDE.md}, loaded
	 * from the workspace's project assets folder. {@code null} when not present or
	 * not yet wired.
	 */
	...
	/**
	 * Contents of {@code AGENTS.md} / {@code CLAUDE.md} discovered by walking up
	 * from the working directory. {@code null} when none found.
	 */
	...
	// Model
	/**
	 * Model engine id the agent should run against; {@code null} when not yet
	 * resolved.
	 */
	 ...
	 *
	 * <p>
	 * In v1, this is the {@code paramMap} originally passed to
	...
	/**
	 * Parameters for the agent.. Useful for passing parameters to hooks Never
	 * {@code null}; always an unmodifiable view.
	 */
	 ...
	 */
	public String getResultTool() {
		return resultTool;
	}

	/**
	 * Working-directory-relative paths protected from the built-in file mutation
	 * tools.
	 */
	...
	public Map<String, Object> getToolParameterDefaults(String tool) {
		return toolParameterDefaults.getOrDefault(tool, Map.of());
	}

	/**
	 * Remaining tool rounds at which the model is instructed to finish verification
	 * and delivery.
	 */
	public int getFinishingTurns() {
		return finishingTurns;
	}

	public Map<String, Object> getPptxWorkflow() {
		return pptxWorkflow;
	}

	public boolean hasPptxWorkflow() {
		return Boolean.TRUE.equals(pptxWorkflow.get("enabled"));
	}

	// Filesystem
	/**
	 * Working directory the agent operates in (the project being worked on). Used
	 * by file/tool resolution and by {@code AGENTS.md} discovery. {@code null} or
	 * empty when not set.
	 */
	 ...
	 *
	 * <p>
	 * Entries come from workspace resources plus any room-level additions. CLI
	 * harnesses use these ids to configure external MCP clients, while the
	 ...
	 *
	 * <p>
	 * Each entry includes {@code skill_id} and an optional {@code pinned_version}.
	 * {@link prerna.reactor.agent.skill.SkillStager} consumes this list to
	 * materialize the working copy under {@code .claude/skills/}.
	 */
	...
	// Tool hooks - fired before/after each tool dispatch inside
	// HarnessToolExecutor.
	 ...
	 *
	 * <p>
	 * The semoss harness exposes them as synthesized tools. CLI harnesses read but
	 * ignore this list.
	 */
	...
	public static final class Builder {
		...
		public Builder authoredPrompt(String v) {
			this.authoredPrompt = v;
			return this;
		}

		public Builder agentAgentsMd(String v) {
			this.agentAgentsMd = v;
			return this;
		}

		public Builder workdirAgentsMd(String v) {
			this.workdirAgentsMd = v;
			return this;
		}

		public Builder selectedEnginesPrompt(String v) {
			this.selectedEnginesPrompt = v;
			return this;
		}
		...
		public Builder modelParams(Map<String, Object> v) {
			this.modelParams = v;
			return this;
		}

		public Builder agentParams(Map<String, Object> v) {
			this.agentParams = v;
			return this;
		}
		...
		public Builder disabledDefaultTools(Set<String> v) {
			this.disabledDefaultTools = v;
			return this;
		}

		public Builder resultTool(String v) {
			this.resultTool = v;
			return this;
		}

		public Builder readOnlyPaths(Set<String> v) {
			this.readOnlyPaths = v;
			return this;
		}

		public Builder toolParameterDefaults(Map<String, Map<String, Object>> v) {
			this.toolParameterDefaults = v;
			return this;
		}

		public Builder finishingTurns(int v) {
			this.finishingTurns = v;
			return this;
		}

		public Builder pptxWorkflow(Map<String, Object> v) {
			this.pptxWorkflow = v;
			return this;
		}

		public Builder workingDir(String v) {
			this.workingDir = v;
			return this;
		}

		public Builder mcps(List<Map<String, String>> v) {
			this.mcps = v;
			return this;
		}

		public Builder skills(List<Map<String, String>> v) {
			this.skills = v;
			return this;
		}

		public Builder budgets(Budgets v) {
			this.budgets = v;
			return this;
		}

		public Builder spawnPolicy(SubAgentSpawnPolicy v) {
			this.spawnPolicy = v;
			return this;
		}

		public Builder runHooks(List<IAgentRunHook> v) {
			this.runHooks = v;
			return this;
		}

		public Builder toolHooks(List<IToolHook> v) {
			this.toolHooks = v;
			return this;
		}

		public Builder subagents(List<SubAgentSpec> v) {
			this.subagents = v;
			return this;
		}
	...
	public static final class Budgets {
		...
		/**
		 * Default budgets: turn cap {@value #DEFAULT_MAX_TURNS}, no reflections, no
		 * time limit.
		 */
	...
	public static final class SubAgentSpawnPolicy {
		...
		public int getMaxSubagentsPerRun() {
			return maxSubagentsPerRun;
		}
		...
		public static SubAgentSpawnPolicy defaults() {
			return new SubAgentSpawnPolicy(DEFAULT_MAX_SUBAGENT_DEPTH, DEFAULT_MAX_SUBAGENTS_PER_RUN,
