    ...
    if (language != null) {
      if (language.equalsIgnoreCase("r")) {
        ...
        try {
          ...
          String obj =
              this.insight
                      .getRJavaTranslator(this.getClass().getCanonicalName())
          ...
          if (obj != null
            ...
            return NounMetadata.getErrorNounMessage(
                "Expression has error, please correct " + expression);
          }
        } catch (Exception ex) {
    ...
    if (success) {
      ...
      retNoun =
          NounMetadata.getErrorNounMessage(
              "One or more of the frames this variable uses is not available");
    }
    return retNoun;
  }
}
