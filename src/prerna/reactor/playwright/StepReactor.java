...
public class StepReactor extends AbstractReactor {
	...
	public ScreenshotResponse executeStep(String sessionId, PlaywrightStep step, String tabId) {
		PlaywrightSession s = this.insight.getUser().getPlaywrightSession(sessionId);
		Map<String, Object> stepResult = PlaywrightSessionUtility.applyStep(s, step, tabId);
	...
	private void addStepToHistory(PlaywrightSession s, PlaywrightStep step, boolean isPageChanged, String tabId,
	...
	protected String getDescriptionForKey(String key) {
		if (key.equals("sessionId")) {
			...
			return SHOULD_STORE_KEY_DESCRIPTION;
		} else if (key.equals("paramValues")) {
			return INPUTS_KEY_DESCRIPTION;
		}
