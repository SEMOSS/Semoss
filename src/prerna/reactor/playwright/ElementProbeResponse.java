...
public record ElementProbeResponse(String tag, // "input", "textarea", "button", "a", ...
		...
		String placeholder, String labelText, // <label for=...>, aria-label, or nearest text
		String value, // current value (for inputs/textarea)
		String href, // if link
		boolean contentEditable, ElementRect rect, // viewport-relative rect in CSS px
