...
public class GenerateInputDescriptionReactor extends AbstractReactor {
    ...
    /**
     * Constructor for the GenerateInputDescriptionReactor.
     * Initializes the required keys the reactor expects: engineId, sessionId, selector, and tabId.
     */
    public GenerateInputDescriptionReactor() {
        this.keysToGet = new String[] {"engineId", "sessionId", "selector", "tabId"};
     ...
     *
     * @return NounMetadata containing the generated description for the input field.
     ...
     * @throws IllegalArgumentException if the element is not found or context extraction fails
     */
    @Override
    ...
    private Map<String, Object> extractDomContext(PlaywrightSession session, String selector, String tabId) {
        ...
        if (result == null) {
            throw new IllegalArgumentException("Element not found or context extraction failed for selector: " + selector);
        }
    ...
    /**
     * Generates a user-friendly description for an input field based on its DOM context.
     *
     ...
     */
    private String generateInputDescription(String engineId, Map<String, Object> domContext, PlaywrightSession session, String tabId) {
        // Get page title
    ...
    /**
     * Generates a prompt string for the model engine based on the DOM context and page title.
     *
     * @param domContext The extracted DOM context of the input field.
    ...
    private String generatePrompt(Map<String, Object> domContext, String pageTitle) {
        ...
        prompt.append("Generate a user-friendly description for an input field based on the provided context. Describe the input field and the context of the page it's in but not in a command form and not with too technical details. ");
    ...
    /**
     * Appends a label and value to the prompt string if the value is not null or empty.
     *
    ...
    protected String getDescriptionForKey(String key) {
        return switch (key) {
            case "engineId" -> "The ID of the model engine to use for generating the description.";
            case "sessionId" -> "The Playwright session ID containing the target input field.";
            case "selector" -> "The CSS selector for the target input field element.";
            case "tabId" -> "The ID of the tab containing the target input field.";
