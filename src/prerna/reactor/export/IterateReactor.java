...
public class IterateReactor extends AbstractReactor {
  ...
  public IterateReactor() {
    this.keysToGet =
        new String[] {
          ReactorKeysEnum.QUERY_STRUCT.getKey(), ReactorKeysEnum.USE_FRAME_FILTERS.getKey()
        };
  }
  ...
  private NounMetadata createJob() {
    ...
    if (inMemStore != null) {
      ...
      // TODO: remove hard coded classes when we establish querystruct2 and sqlinterpreter2 function
      // properly
