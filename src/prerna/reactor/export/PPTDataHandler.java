...
public class PPTDataHandler {
	...
	/**
	 * Automatically figure out whether to build XDDFDataSource from String Array or
	 * Number Array
	 *
	 * @param col
	 * @return
	...
	public XDDFDataSource<?> getColumnAsXDDFDataSourceByType(String col, int xAxisIndx) {
		if (this.typesArr[xAxisIndx] == SemossDataType.STRING || this.typesArr[xAxisIndx] == SemossDataType.DATE
