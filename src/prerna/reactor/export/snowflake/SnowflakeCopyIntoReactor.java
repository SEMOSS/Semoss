...
public class SnowflakeCopyIntoReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
...

    {
      ...
      Boolean parseHeader =
          Boolean.parseBoolean(this.keyValue.getOrDefault("parseHeader", "true") + "");
      if (parseHeader != null) {
      ...
      String fieldOptionallyEnclosedBy =
          this.keyValue.getOrDefault("fieldOptionallyEnclosedBy", "NONE");
    ...
    try {
      ...
      throw new IllegalArgumentException(
          "A SQL exception was thrown. Detailed error = " + e.getMessage());
    } finally {
