...
public class CollectVizNetworkReactor extends TaskBuilderReactor {
	...
	public NounMetadata execute() {
		...
		// which assumes that it will fit into the visNetwork method for generating the
		// file
		...
		builder.append("with_dir(\"").append(filePath).append("\", saveWidget(").append(randomGraphVar)
				.append(", file=\"").append(randomHtmlFile).append("\"));");
