...
public class POIExportUtility {
  ...
  public static void positionDisplayValues(
      ChartTypes chartType, CTDLbls dLbls, String displayValuesPosition) {
  ...
  public static CellStyle getCurrentStyle(
      Workbook workbook, String metamodelAdditionalDataType, Map<String, String> panelFormatting) {
  ...
  public static String[] getHexColorCode(
      String colorName, Object customColors, Object colorObject) {
    if (colorObject == null) {
