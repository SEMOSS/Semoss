...
public class Assimilator extends AbstractReactor implements JavaExecutable {
    ...
    for (String formula : formulas) {
      this.signature =
          StringUtils.replaceOnce(
              this.signature, formula, "( 1.0 * " + formula.substring(1, formula.length()));
    }
  ...
  /**
   * @param stringMethod
   * @return method responsible for building a new assimilator class from a stringified method
   */
  private AssimilatorEvaluator buildAssimilatorEvaluator(
      String stringMethod, Map<String, Object> vars) {
  ...
  private String buildMethodString(Map<String, Object> vars) {
    ...
    if (this.containsStringValue) {
      ...
      expressionBuilder
          .append("return new java.math.BigDecimal(1.0 * ")
    ...
    for (String input : uniqueInputs) {
      ...
      if (dataType == PixelDataType.CONST_DECIMAL) {
        expressionBuilder
            ...
            .append(input)
            .append(" = ")
            .append("((Number)super.vars.get(" + "\"" + input + "\")).doubleValue()")
            .append(";");
        ...
        expressionBuilder
            ...
            .append(input)
            .append(" = ")
            .append("((Number)super.vars.get(" + "\"" + input + "\")).intValue()")
            .append(";");
        vars.put(input, value);
        ...
        expressionBuilder
            ...
            .append(input)
            .append(" = ")
            .append("(String)super.vars.get(" + "\"" + input + "\")")
            .append(";");
        vars.put(input, value);
      ...
      if (n.getValue() instanceof EmbeddedScriptReactor) {
        ...
        if (dataType == PixelDataType.CONST_DECIMAL || dataType == PixelDataType.CONST_INT) {
          ...
          if (formatData == null) {
            ...
            PixelDataType newDataType = formatData.getNounType();
            if (newDataType == PixelDataType.CONST_DECIMAL
                || newDataType == PixelDataType.CONST_INT) {
              this.signature =
                  StringUtils.replaceOnce(
                      this.signature,
                      ((EmbeddedScriptReactor) n.getValue()).getOriginalSignature(),
  ...
  protected String modifyJavaSignature(
      String javaSignature, String stringToFind, String stringReplacement) {
