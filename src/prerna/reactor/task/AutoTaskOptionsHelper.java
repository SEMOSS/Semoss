...
public class AutoTaskOptionsHelper {
	...
	public static TaskOptions getAutoOptions(BasicIteratorTask task, SelectQueryStruct qs, String panelId,
			String layout) throws Exception {
		return getAutoOptions(task, qs, panelId, layout, null);
	}

	public static TaskOptions getAutoOptions(BasicIteratorTask task, SelectQueryStruct qs, String panelId,
			String layout, Map<String, Object> optMap) {
	...
	public static Map<String, Object> generateMultiDimensionTaskOptions(SelectQueryStruct qs, String panelId,
			String layout) {
		return generateMultiDimensionTaskOptions(getSelectorsFromQs(qs), panelId, layout);
	}

	public static Map<String, Object> generateMultiGroupTaskOptions(SelectQueryStruct qs, String panelId,
			String layout) {
	...
	public static Map<String, Object> generateGraphTaskOptions(Map<String, Object> optMap, String panelId,
			String layout) {
		if (optMap == null) {
			return null;
		}
	...
	public static Map<String, Object> generateSingleValueTaskOptions(SelectQueryStruct qs, String panelId,
			String layout) {
	...
	public static Map<String, Object> generateMultiValueTaskOptions(SelectQueryStruct qs, String panelId,
			String layout) {
	...
	public static Map<String, Object> generateMultiDimensionTaskOptions(List<String> selectors, String panelId,
			String layout) {
		int size = selectors.size();
	...
	public static Map<String, Object> generateMultiGroupTaskOptions(List<String> selectors, String panelId,
			String layout) {
		int size = selectors.size();
	...
	public static Map<String, Object> generateSingleValueTaskOptions(List<String> selectors, String panelId,
			String layout) {
		int size = selectors.size();
		// grab inputs
		Map<String, String[]> labelMap = new HashMap<String, String[]>();
	...
	public static Map<String, Object> generateMultiValueTaskOptions(List<String> selectors, String panelId,
			String layout) {
		int size = selectors.size();
		// label array
