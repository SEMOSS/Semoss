...
public class AutoTaskOptionsHelper {
  ...
  public static TaskOptions getAutoOptions(
      SelectQueryStruct qs, String panelId, String layout, Map<String, Object> optMap) {
    return getAutoOptions(getSelectorsFromQs(qs), panelId, layout, optMap);
  }

  public static TaskOptions getAutoOptions(
      BasicIteratorTask task, SelectQueryStruct qs, String panelId, String layout)
      throws Exception {
    return getAutoOptions(task, qs, panelId, layout, null);
  }

  public static TaskOptions getAutoOptions(
      BasicIteratorTask task,
  ...
  public static TaskOptions getAutoOptions(
      List<String> selectors, String panelId, String layout, Map<String, Object> optMap) {
  ...
  public static Map<String, Object> generateWaterfallTaskOptions(
      SelectQueryStruct qs, String panelId) {
    return generateWaterfallTaskOptions(getSelectorsFromQs(qs), panelId);
  }

  public static Map<String, Object> generateTreeMapTaskOptions(
      SelectQueryStruct qs, String panelId) {
    return generateTreeMapTaskOptions(getSelectorsFromQs(qs), panelId);
  }

  public static Map<String, Object> generateSingleAxisClusterTaskOptions(
      SelectQueryStruct qs, String panelId) {
    return generateSingleAxisClusterTaskOptions(getSelectorsFromQs(qs), panelId);
  }

  public static Map<String, Object> generateSankeyTaskOptions(
      SelectQueryStruct qs, String panelId) {
    return generateSankeyTaskOptions(getSelectorsFromQs(qs), panelId);
  }

  public static Map<String, Object> generateMultiDimensionTaskOptions(
      SelectQueryStruct qs, String panelId, String layout) {
    return generateMultiDimensionTaskOptions(getSelectorsFromQs(qs), panelId, layout);
  }

  public static Map<String, Object> generateMultiGroupTaskOptions(
      SelectQueryStruct qs, String panelId, String layout) {
    return generateMultiGroupTaskOptions(getSelectorsFromQs(qs), panelId, layout);
  }

  public static Map<String, Object> generateHeatMapTaskOptions(
      SelectQueryStruct qs, String panelId) {
    return generateHeatMapTaskOptions(getSelectorsFromQs(qs), panelId);
  }

  public static Map<String, Object> generateGraphTaskOptions(
      Map<String, Object> optMap, String panelId, String layout) {
    if (optMap == null) {
      return null;
    }
  ...
  public static Map<String, Object> generateDendrogramTaskOptions(
      SelectQueryStruct qs, String panelId) {
    return generateDendrogramTaskOptions(getSelectorsFromQs(qs), panelId);
  }

  public static Map<String, Object> generateClusterTaskOptions(
      SelectQueryStruct qs, String panelId) {
    return generateClusterTaskOptions(getSelectorsFromQs(qs), panelId);
  }

  public static Map<String, Object> generateBulletTaskOptions(
      SelectQueryStruct qs, String panelId) {
  ...
  public static Map<String, Object> generateSingleValueTaskOptions(
      SelectQueryStruct qs, String panelId, String layout) {
    return generateSingleValueTaskOptions(getSelectorsFromQs(qs), panelId, layout);
  }

  public static Map<String, Object> generateScatterTaskOptions(
      SelectQueryStruct qs, String panelId) {
    return generateScatterTaskOptions(getSelectorsFromQs(qs), panelId);
  }

  public static Map<String, Object> generateScatter3DTaskOptions(
      SelectQueryStruct qs, String panelId) {
    return generateScatter3DTaskOptions(getSelectorsFromQs(qs), panelId);
  }

  public static Map<String, Object> generateMultiValueTaskOptions(
      SelectQueryStruct qs, String panelId, String layout) {
  ...
  public static Map<String, Object> generateWaterfallTaskOptions(
      List<String> selectors, String panelId) {
  ...
  public static Map<String, Object> generateMultiDimensionTaskOptions(
      List<String> selectors, String panelId, String layout) {
    int size = selectors.size();
  ...
  public static Map<String, Object> generateGridTaskOptions(
      List<String> selectors, String panelId) {
    int size = selectors.size();
    String[] aliasArr = new String[size];
    for (int i = 0; i < size; i++) {
