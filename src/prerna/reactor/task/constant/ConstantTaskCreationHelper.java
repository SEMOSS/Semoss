...
public class ConstantTaskCreationHelper {
	...
	/*
	 * Below methods are for sending data to the FE as ConstantDataTask's This is
	 * because the FE needs certain information to know how to paint ^i.e. task
	 * options, etc. So creating wrappers to facilitate that
	 */

	/**
	 * This method allows us to create a bar chart from the data values object[][]
	 * created with the breaks and counts
	 *
	 * @param label
	 * @param value
	 *            - for the histogram this is "Frequency"
	 * @param dataValues
	 *            - this better be a List<Object[]> or Object[][] since the
	 *            serialization to JSON is the same
	 */
	...
	/**
	 * This method allows us to create a grid view from the data values object[][]
	 * created with the breaks and counts
	 *
	 * @param panelId
	 *            - panel id
	...
	/**
	 * This method allows us to create a heatmap from the data values object[][]
	 * created with the breaks and counts
	 *
	 * @param panelId
	 *            - panel id
	...
	/**
	 * This method allows us to create a scatterplot from the data values object[][]
	 * created with the breaks and counts
	 *
	 * @param panelId
	 *            - panel id
	 ...
	 *            serialization to JSON is the same
	 */
	public static ConstantDataTask getScatterPlotData(String panelId, String label, String x, String y,
			Object dataValues) {
	...
	public static ConstantDataTask getScatterPlotData(String panelId, String[] labels, Object dataValues, String series,
		...
		ConstantDataTask task = new ConstantDataTask();
		task.setId("TEMP_ID");
		Map<String, Object> returnData = new Hashtable<String, Object>(); // returnData makes up the "data" parent
																			// element
		returnData.put("values", dataValues);
		returnData.put("headers", labels);
		task.setOutputData(returnData);
