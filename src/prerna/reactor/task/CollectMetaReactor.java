...
public class CollectMetaReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    NounMetadata result =
        new NounMetadata(
            metaData, PixelDataType.FORMATTED_DATA_SET, PixelOperationType.TASK_METADATA);
  ...
  public List<NounMetadata> getOutputs() {
    ...
    NounMetadata output =
        new NounMetadata(
            this.signature, PixelDataType.FORMATTED_DATA_SET, PixelOperationType.TASK_METADATA);
    outputs.add(output);
    return outputs;
  }
