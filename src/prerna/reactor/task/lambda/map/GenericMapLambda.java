...
public class GenericMapLambda extends AbstractMapLambda {
  ...
  public void init(String code, List<String> imports)
      throws InstantiationException, IllegalAccessException {
    // class maker will help us compile our new lambda function
    ClassMaker myClass =
        new ClassMaker(
            AbstractMapLambda.class.getPackage().getName(), "c" + Utility.getRandomString(12));
...
/**
 * I just need a base class with a constructor that is a IMapTransformation Cannot use the interface
