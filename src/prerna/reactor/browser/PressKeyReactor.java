...
public class PressKeyReactor extends AbstractReactor {
	...
	private static final String REACTOR_DESCRIPTION = "Key to press on the Browser App rendered on the server.";
	private static final String INPUT_KEY_DESCRIPTION = "The the key to press of the browser app rendered on the server.";
