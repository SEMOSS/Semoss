...
public class CloseURLReactor extends AbstractReactor {
	...
	private static final String REACTOR_DESCRIPTION = "Close the URL of the Browser App rendered on the server.";
	private static final String URL_KEY_DESCRIPTION = "A URL address to close on the Browser App rendered on the server.";
	...
	public NounMetadata execute() {
		 ...
		 * So in this case, we simply just close the open browser. Edge case may be
		 * opening tabs or something like this.
		 */
