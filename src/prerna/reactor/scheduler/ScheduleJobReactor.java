...
public class ScheduleJobReactor extends AbstractReactor {
  ...
  public ScheduleJobReactor() {
    this.keysToGet =
        new String[] {
          ReactorKeysEnum.JOB_NAME.getKey(),
          ReactorKeysEnum.JOB_GROUP.getKey(),
          ReactorKeysEnum.CRON_EXPRESSION.getKey(),
          ReactorKeysEnum.CRON_TZ.getKey(),
          ReactorKeysEnum.RECIPE.getKey(),
          ReactorKeysEnum.RECIPE_PARAMETERS.getKey(),
          TRIGGER_ON_LOAD,
          TRIGGER_NOW,
          UI_STATE,
  ...
  public NounMetadata execute() {
    ...
    try {
      ...
      SchedulerDatabaseUtility.insertIntoJobRecipesTable(
          userId,
          jobId,
          jobName,
          jobGroup,
      ...
      throw new IllegalArgumentException(
          "Unable to schedule the job. Error message = " + se.getMessage());
    }
  }
  ...
  protected JobKey scheduleJob(
    ...
    Trigger trigger =
        TriggerBuilder.newTrigger()
            ...
            .withSchedule(CronScheduleBuilder.cronSchedule(cronExpression).inTimeZone(cronTimeZone))
            .build();
    ...
    classLogger.info(
        "Scheduled "
            + Utility.cleanLogString(jobId)
            + " to run on the following schedule: "
   ...
   * @return
   */
  public static Map<String, Object> createRetMap(
      String jobId,
      String jobName,
      String jobGroup,
      String cronExpression,
