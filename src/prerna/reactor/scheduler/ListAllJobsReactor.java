...
public class ListAllJobsReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
     ...
     *
     * <p>This reactor will return all jobs based on app and user, if no parameters are passed it
     * will check if user has admin permissions, if so it will return all jobs, if not it will throw
     * error.
     */
