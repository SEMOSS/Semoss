...
public class RemoveJobFromDBReactor extends AbstractReactor {
  ...
  public NounMetadata execute() {
    ...
    /**
     * This reactor deletes jobs from both Quartz and the Job DB table. It verifies permissions
     * before deletion.
     */
    organizeKeys();
    ...
    // Return a map containing jobIds of successfully and unsuccessfully deleted (in both Quartz and
    // DB) jobs
    NounMetadata retNoun =
        new NounMetadata(jobDeletionResult, PixelDataType.MAP, PixelOperationType.UNSCHEDULE_JOB);
  ...
  protected String getDescriptionForKey(String key) {
    if (key.equals(ReactorKeysEnum.JOB_ID.getKey())) {
      ...
      return "Job Groups where each entry matches the corresponding index in "
          + ReactorKeysEnum.JOB_ID.getKey();
    }
