...
public class SchedulerHistoryReactor extends AbstractReactor {
	...
	public NounMetadata execute() {
		 ...
		 * tagSelector.addInnerSelector(new
		 * QueryColumnSelector(SchedulerConstants.SMSS_JOB_TAGS+ "__" +
		 * SchedulerConstants.JOB_TAG));
		 * tagSelector.setFunction(QueryFunctionHelper.UNIQUE_GROUP_CONCAT);
		 * tagSelector.setDistinct(true); qs.addSelector(tagSelector);
		 * qs.addSelector(new QueryColumnSelector(SchedulerConstants.SMSS_JOB_TAGS+ "__"
		 * + SchedulerConstants.JOB_TAG)); qs.addGroupBy( new
		 * QueryColumnSelector(SchedulerConstants.SMSS_JOB_TAGS+ "__" +
		 * SchedulerConstants.JOB_TAG)); qs.addGroupBy( new
		 * QueryColumnSelector(SchedulerConstants.SMSS_JOB_RECIPES+ "__" +
		 * SchedulerConstants.JOB_NAME)); qs.addGroupBy( new
		 * QueryColumnSelector(SchedulerConstants.SMSS_AUDIT_TRAIL+ "__" +
		 * SchedulerConstants.JOB_ID)); qs.addGroupBy( new
		 * QueryColumnSelector(SchedulerConstants.SMSS_AUDIT_TRAIL+ "__" +
		 * SchedulerConstants.EXECUTION_START));
		 * qs.addRelation(SchedulerConstants.SMSS_AUDIT_TRAIL+"__"+SchedulerConstants.
		 * JOB_ID, SchedulerConstants.SMSS_JOB_TAGS+"__"+SchedulerConstants.JOB_ID,
		 * "inner.join");
		 */
