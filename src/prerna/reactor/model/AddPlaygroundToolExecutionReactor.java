...
/** AddToolExecutionReactor: Input: roomId, toolId, toolName, tool_execution_response, tool_ */
public class AddPlaygroundToolExecutionReactor extends AbstractReactor {
  ...
  @Deprecated private final String tool_execution_response = "tool_execution_response";
  ...
  public AddPlaygroundToolExecutionReactor() {
    ...
    // TODO: once we remove the legacy tool_execution_response, we will make toolExecutionResponse
    // mandatory field
  ...
  public NounMetadata execute() {
    ...
    if (messages.isEmpty()) {
      throw new IllegalStateException(
          "Room message history is empty. Cannot add tool execution results.");
    }
    ...
    if (response == null) {
      ...
      pixelReturn.put(
          "responseMessage", jsonToMap(MessageUtils.toJson(room.getMessages().getLast())));
