...
// *
// * Data mode: compares encrypted instance data across datasources txt files
// are
// * written to SemossBase\R\XrayCompatibility\Temp\MatchingRepository
// *
// * Semantic mode: predicts instance data headers based on wikipedia and
// compares
...
// GenerateH2FrameFromRVariableReactor sync = new
// GenerateH2FrameFromRVariableReactor();
...
// this.rJavaTranslator.runR(cleanUpScript.toString());
//
// NounMetadata noun = new NounMetadata("Unable to obtain X-ray results",
