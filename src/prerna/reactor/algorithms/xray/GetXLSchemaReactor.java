...
public class GetXLSchemaReactor extends AbstractReactor {
  public GetXLSchemaReactor() {
    this.keysToGet =
        new String[] {ReactorKeysEnum.FILE_PATH.getKey(), ReactorKeysEnum.SHEET_NAME.getKey()};
  }
  ...
  public NounMetadata execute() {
    ...
    if (sheetName == null) {
      throw new IllegalArgumentException(
          "Need to define the " + ReactorKeysEnum.SHEET_NAME.getKey());
    }
    ...
    String[] predicatedDataTypes =
        FileHelperUtil.generateDataTypeArrayFromPrediction(helper.predictTypes(sheetName));
