...
public class GenerateXRayMatchingReactor extends AbstractRFrameReactor {
  ...
  public NounMetadata execute() {
    ...
    List<String> databaseIds =
        (List<String>) filesHash.get(GenerateXRayHashingReactor.DATABASE_IDS_KEY);
    ...
    noun.addAdditionalReturn(
        NounMetadata.getSuccessNounMessage("Successfully ran LSH for matching column values"));
    if (addSameDbWarn) {
      noun.addAdditionalReturn(
