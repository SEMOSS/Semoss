...
public class RAlgReactor extends AbstractRFrameReactor {
  ...
  /**
   * Merging all the inputs into R specific syntax Will generate appropriate vector syntax vs.
   * scalar syntax for inputs NOTE ::: Cannot have the variable name "all" since its already used by
   * the reactor
   *
   * @return
   */
