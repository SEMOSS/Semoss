...
public class RunNumericalCorrelationReactor extends AbstractFrameReactor {
	...
	public NounMetadata execute() {
		...
		ITask taskData = ConstantTaskCreationHelper.getHeatMapData(getPanelId(), "Column Header X", "Column Header Y",
				"Correlation", data);
		...
		// NEW TRACKING
		UserTrackerFactory.getInstance().trackAnalyticsWidget(this.insight, dataFrame, "NumericalCorrelation",
	...
	private double[][] runCorrelation(Iterator<IHeadersDataRow> it, int numHeaders, double defaultVal, Logger logger) {
		// sum of x
