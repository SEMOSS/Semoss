...
public class RunNumericalCorrelationReactor extends AbstractFrameReactor {
  ...
  private static final Logger classLogger =
      LogManager.getLogger(RunNumericalCorrelationReactor.class);
  ...
  public NounMetadata execute() {
    ...
    ITask taskData =
        ConstantTaskCreationHelper.getHeatMapData(
            getPanelId(), "Column Header X", "Column Header Y", "Correlation", data);
  ...
  private double[][] runCorrelation(
      Iterator<IHeadersDataRow> it, int numHeaders, double defaultVal, Logger logger) {
    // sum of x
