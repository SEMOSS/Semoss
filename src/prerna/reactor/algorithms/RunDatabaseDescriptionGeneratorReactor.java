...
public class RunDatabaseDescriptionGeneratorReactor extends AbstractRFrameReactor {
  ...
  public NounMetadata execute() {
    ...
    // source the files
    rsb.append(
        "source(\"" + baseFolder.replace("\\", "/") + "/R/AnalyticsRoutineScripts/proceed.R\");");
    ...
    noun.addAdditionalReturn(
        NounMetadata.getSuccessNounMessage("Database Description generated successfully!"));
    // return all
    return noun;
  }
  ...
  private String getCurrentDbTable(IDatabaseEngine database, StringBuilder rStr) {
    ...
    List<Object[]> allTableCols =
        MasterDatabaseUtility.getAllTablesAndColumns(database.getEngineId());
    ...
    rStr.append(
        rDbTable + " <- data.frame(Column = " + rColNames + " , Table = " + rTableNames + ");");
