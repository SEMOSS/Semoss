...
public class AlgorithmMergeHelper {
  ...
  public static ITableDataFrame mergeSimpleAlgResult(
      ITableDataFrame dataFrame,
      String colNmae,
      String algorithmColName,
      String algorithmColType,
      AlgorithmSingleColStore results) {
    ...
    if (existingUniqueColName.contains("__")) {
      ...
      dataTypes.put(
          split[1], dataFrame.getMetaData().getHeaderTypeAsString(existingUniqueColName, split[0]));
      ...
      dataTypes.put(
          existingUniqueColName,
          dataFrame.getMetaData().getHeaderTypeAsString(existingUniqueColName, null));
