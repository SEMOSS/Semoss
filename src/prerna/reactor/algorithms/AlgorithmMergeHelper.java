...
public class AlgorithmMergeHelper {
	...
	public static ITableDataFrame mergeSimpleAlgResult(ITableDataFrame dataFrame, String colNmae,
			String algorithmColName, String algorithmColType, AlgorithmSingleColStore results) {
		...
		if (existingUniqueColName.contains("__")) {
			...
			dataTypes.put(existingUniqueColName,
