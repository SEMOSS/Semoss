...
public class RunDataQualityReactor extends AbstractRFrameReactor {
  ...
  // This gets the basic format of the data. The information put in here will be in the format of
  // the
  ...
  public NounMetadata execute() {
    ...
    if (inputTable != null) {
      return new NounMetadata(
          inputTable, PixelDataType.FRAME, PixelOperationType.FRAME_DATA_CHANGE);
    }
    // make a new frame
