...
public class DownloadUserAssetReactor extends AbstractReactor {

	public DownloadUserAssetReactor() {
	...
	public String getReactorDescription() {
		return "Download a file or directory from within the user's assets folder";
	}
