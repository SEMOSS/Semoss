...
public class NewUserAssetsFileReactor extends AbstractReactor {

	public NewUserAssetsFileReactor() {
	...
	public String getReactorDescription() {
		return "Create a new empty file in the user's assets folder";
	}
