...
public class CopyUserAssetReactor extends AbstractReactor {

	public CopyUserAssetReactor() {
	...
	public String getReactorDescription() {
		return "Copy (clone) a file or directory in the user's assets folder to a new path";
	}
