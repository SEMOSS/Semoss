...
public class NewUserAssetsDirectoryReactor extends AbstractReactor {

	public NewUserAssetsDirectoryReactor() {
	...
	public String getReactorDescription() {
		return "Create a new empty directory in the user's assets folder";
	}
	...
	protected String getDescriptionForKey(String key) {
		if (key.equals(ReactorKeysEnum.FILE_PATH.getKey())) {
			...
			return "Comment to add while creating and saving the new file within the git repository for the user's asset project";
		}
