 ...
 *
 */
public class AutoGeneratedInsightListener extends AbstractAction implements IChakraListener{

	@Override
	public void actionPerformed(ActionEvent e) {
		JComboBox<String> autoGenerateQueriesForEngineCombobox = (JComboBox<String>) DIHelper.getInstance().getLocalProp(Constants.AUTO_GENERATE_INSIGHTS_FOR_ENGINE_COMBOBOX);
		String engineName = autoGenerateQueriesForEngineCombobox.getSelectedItem().toString();
