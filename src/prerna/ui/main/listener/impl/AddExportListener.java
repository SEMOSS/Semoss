...
public class AddExportListener implements IChakraListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		for(int i = 2; i <= Constants.MAX_EXPORTS; i++) {
			JComboBox subject = (JComboBox) Utility.getDIHelperLocalProperty(genericSubjectNodeTypeComboBox + i);
			JComboBox object = (JComboBox) Utility.getDIHelperLocalProperty(genericObjectNodeTypeComboBox + i);
			JComboBox relationship = (JComboBox) Utility.getDIHelperLocalProperty(genericNodeRelationshipComboBox + i);
