...
//TODO: this is the same as SourceSelectAllListener

/**
 * Selects all the different services to be included in the Transition Cost Report
 */
public class ServiceSelectAllListener implements ActionListener {
	
	Hashtable checkHash;
	
	/**
	 * Default is to have all the services selected in ServicesSelectPanel to be included in the Transition Cost Report
	 * Allows the user to toggle between selecting all the services or no services 
	 * @param e ActionEvent
	 */
