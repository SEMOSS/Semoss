 ...
 */
public class BLUCheckBoxSelectorListener extends CheckBoxSelectorListener {
	JCheckBox hsdCheck, hssCheck, fhpCheck, dhmsmCheck;
	Vector<String> hsdCheckList, hssCheckList, fhpCheckList, dhmsmCheckList;

	public BLUCheckBoxSelectorListener (IEngine engine,SelectScrollList scrollList,JCheckBox allElemCheckBox,JCheckBox hsdCheck,JCheckBox hssCheck,JCheckBox fhpCheck,JCheckBox dhmsmCheck) {
		super(engine,scrollList,"BusinessLogicUnit",allElemCheckBox);
