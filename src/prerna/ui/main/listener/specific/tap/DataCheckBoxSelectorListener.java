 ...
 */
public class DataCheckBoxSelectorListener implements ActionListener{
	...
	public DataCheckBoxSelectorListener (SysOptCheckboxListUpdater checkboxListUpdater,SelectScrollList scrollList,JCheckBox allElemCheckBox,JCheckBox hsdCheck,JCheckBox hssCheck,JCheckBox fhpCheck,JCheckBox dhmsmCheck) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		Vector<String> dataToSelect = checkboxListUpdater.getSelectedDataList(dhmsmCheck.isSelected(), hsdCheck.isSelected(), hssCheck.isSelected(), fhpCheck.isSelected());
