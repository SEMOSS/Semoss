...
//		queries.put(out,"SELECT DISTINCT ?System ?Data ?crm (COALESCE(?ICD, ?ICD2) AS ?ICDOUTPUT) WHERE { {?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/System>;}{?Provide <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Provide>;}{?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject>;}{?Provide <http://semoss.org/ontologies/Relation/Contains/CRM> ?crm;}{?System ?Provide ?Data}{?Has <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Has>;}{?System ?Has ?SystemCategory}BIND(<http://health.mil/ontologies/Concept/SystemCategory/DHIMS> AS ?SystemCategory){{?ICD <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/InterfaceControlDocument> ;}{?Downstream <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Consume>;}{?ICD ?Downstream ?System} {?Carries <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>;} {?ICD ?Carries ?Data}} UNION {{?ICD2 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/InterfaceControlDocument> ;}{?Upstream <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Provide>;}{?System ?Upstream ?ICD2}{?Carries2 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>;} {?ICD2 ?Carries2 ?Data} }} ORDER BY ?System ?Data ?crm ?ICDOUTPUT");
	...
	public void createFiles(Hashtable<String, ArrayList<ArrayList<String>>> allSystemsDataHash)
	{
		...
		ArrayList<String> systemList = createSystemList("SELECT DISTINCT ?System  WHERE { BIND(<http://health.mil/ontologies/Concept/SystemCategory/DHIMS> AS ?Portfolio) {?Has <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Has>;} {?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/System>;} {?System ?Has ?Portfolio}} ORDER BY ?System");
