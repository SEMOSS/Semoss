...
public class SysOptBtnListener extends SerOptBtnListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		{	
			...
			((SysNetSavingsOptimizer)optimizer).setSelectDropDowns(((SysOptPlaySheet)playSheet).systemSelectPanel,((SysOptPlaySheet)playSheet).capSelectDropDown,((SysOptPlaySheet)playSheet).dataBLUSelectPanel,((SysOptPlaySheet)playSheet).showSystemSelectBtn.isSelected(),((SysOptPlaySheet)playSheet).updateDataBLUPanelButton.isSelected(),((SysOptPlaySheet)playSheet).includeRegionalizationCheckbox.isSelected());
