...
public class HighSystemCheckBoxSelectorListener implements ActionListener {
	...
	public HighSystemCheckBoxSelectorListener(IDatabaseEngine engine, SelectScrollList scrollList,JCheckBox allElemCheckBox,JCheckBox ehrCoreCheckBox) {
		this.engine = engine;
	 ...
	 */
	public Vector<String> getList(IDatabaseEngine engine, String type, String sparqlQuery)
	{
