...
public class SourceReportTaskWeightButtonListener implements IChakraListener {
	...
	public void actionPerformed(ActionEvent actionevent) {
		...
		repo = repos[0] +"";
		engine = (IDatabaseEngine)DIHelper.getInstance().getLocalProp(repo);
	...
	public Hashtable<String,Double> calculateTaskWeights(ArrayList<String> tasks)
	{
		...
		String changedDB = "TAP_Core_Data";
		...
		engine = (IDatabaseEngine)DIHelper.getInstance().getLocalProp(changedDB);
