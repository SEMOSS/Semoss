...
/**
 * This is used to extend the functionalities of the text field in the combo
 * box.
 */
public class PlayTextField extends PlainDocument {
	...
	*//**
		 * Gets the prototype value. Returns the renderer used to display the selected
		 * item in the JComboBox field. Iterates through the model and gets the list
		 * cell renderer components to get prototype values.
		 * 
	...
	*//**
		 * Get a JList that displays a list of objects and allows the user to select an
		 * item. Gets the fields that refer to the UI and the list box.
		 * 
