...
/**
 */
public abstract class AbstractGraphPlaySheet extends AbstractPlaySheet {
	 ...
	 */
	private static final Logger logger = LogManager.getLogger(AbstractGraphPlaySheet.class.getName());
			...
			this.addComponentListener(
					new ComponentAdapter(){
						public void componentResized(ComponentEvent e){
							...
							AbstractGraphPlaySheet gps = (AbstractGraphPlaySheet) e.getSource();
