...
public class DataMakerComponent {
	 ...
	 * @param query      The query corresponding to the data maker component to be
	 *                   run on the engine
	 */
	 ...
	 * @param query  The query corresponding to the data maker component to be run
	 *               on the engine
	 */
	 ...
	 * 
	 * @param builderData The query builder data needed to build the query for this
	 *                    component
	 */
	...
	/**
	 * Setter for the user selected parameters on a component Finds the specified
	 * Filter PreTransformation and appends the "VALUES_KEY" value
	 * 
	 * @param paramHash
	 * @param filterNum
	 */
	public void setParamHash(Map<String, List<Object>> paramHash, int filterNum) {
		...
		if (trans instanceof FilterTransformation) {
			...
			props.put(FilterTransformation.VALUES_KEY,
					paramHash.get(props.get(FilterTransformation.COLUMN_HEADER_KEY)));
		} else {
