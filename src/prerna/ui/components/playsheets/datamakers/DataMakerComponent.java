...
public class DataMakerComponent {
	 ...
	 * @param query
	 *            The query corresponding to the data maker component to be run on
	 *            the engine
	 */
	 ...
	 * @param metamodelData
	 *            The map to build the query based on the OWL
	 */
	 ...
	 * Constructor for the data maker component object
	 *
	 * @param dataFrameLocation
	 *            The string location for the serialized data frame
	 */
	 ...
	 *
	 * @param builderData
	 *            The query builder data needed to build the query for this
	 *            component
	 */
