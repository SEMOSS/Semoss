...
public class DataMakerComponent {
  ...
  /**
   * Setter for the user selected parameters on a component Finds the specified Filter
   * PreTransformation and appends the "VALUES_KEY" value
   *
   * @param paramHash
   * @param filterNum
   */
  public void setParamHash(Map<String, List<Object>> paramHash, int filterNum) {
    ...
    if (trans instanceof FilterTransformation) {
      ...
      props.put(
          FilterTransformation.VALUES_KEY,
