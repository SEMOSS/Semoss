...
public class JoinTransformation extends AbstractTransformation {
  ...
  private void processPostTransformation() {
    ...
    //		((TinkerFrame)dm).removeExtraneousNodes(); though this call makes sense in terms of keeping
    // the tinker free of unnecessary nodes, it is quite slow. Going to try to call this only when
    // necessary (serializing)
  }
