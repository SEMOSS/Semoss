...
/**
 * This Interface defines responsibilities of a data maker Data makers are used
 * to generate the data necessary for a view Data makers are fed data maker
 * components one by one and the maker performs necessary actions to consume
 * component
 *
 * @author bisutton
 */
...
public interface IDataMaker {
	...
	@Deprecated
	void processPostTransformations(DataMakerComponent dmc, List<ISEMOSSTransformation> transforms,
	...
	// @Deprecated
	// List<Object> processActions(DataMakerComponent dmc, List<ISEMOSSAction>
	// actions, IDataMaker...
	// dataMaker);
	//
	// @Deprecated
	...
	/**
	 * Returns the name of the data maker This name must match that which is defined
	 * within RDF_MAP
	 *
	 * @return
	 */
