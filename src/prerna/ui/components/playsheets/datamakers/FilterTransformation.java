...
public class FilterTransformation extends AbstractTransformation {
	 ...
	 *
	 * @param colHeader
	 *            The name of type to filter
	 * @param values
	 *            The list of values for the filter
	 * @param metamodelData
	 *            The metamodel data
	 */
	private void addFilterToComponentData(String colHeader, List<Object> values, QueryStruct builderData) {
		...
		// if(builderData.getFilterData() != null &&
		// !builderData.getFilterData().isEmpty()) {
	 ...
	 *
	 * @param colHeader
	 *            The name of the type to filter
	 * @param values
