...
public class MathTransformation extends AbstractTransformation {
  ...
  public static final String GROUPBY_COLUMNS =
      "groupByColumns"; // TODO : change this to be join columns
  ...
  public void runMethod() {
    ...
    functionMap =
        createColumnNamesForColumnGrouping(groupByCols, functionMap, dm.getColumnHeaders());
  ...
  /**
   * This method creates a new column name by combining the function name with the column header its
   * operated on.
   *
   ...
   * @return
   */
  public static Map<String, Object> createColumnNamesForColumnGrouping(
      List<String> columnHeaders, Map<String, Object> functionMap, String[] tableHeaders) {
    String columnHeader = "";
   ...
   *
   * <p>This transformation is required to be modified for after processing
   */
