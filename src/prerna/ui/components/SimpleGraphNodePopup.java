...
public class SimpleGraphNodePopup extends JPopupMenu {
	 ...
	 */
	public SimpleGraphNodePopup(SQLGraphPlaysheet ps, SEMOSSVertex [] pickedVertex, Component comp, int x, int y)
	{
		super();
		...
		this.engine = (IDatabaseEngine)DIHelper.getInstance().getLocalProp(repo+"");
