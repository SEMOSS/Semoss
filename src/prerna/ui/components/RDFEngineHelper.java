...
/**
 * This class is responsible for loading many of the hierarchies available in RDF through the
...
public class RDFEngineHelper {
  ...
  public static void loadConceptHierarchy(
      IDatabaseEngine fromEngine, String subjects, String objects, GraphDataModel ps) {
  ...
  public static void loadRelationHierarchy(
      IDatabaseEngine fromEngine, String predicates, GraphDataModel ps) {
  ...
  public static void loadPropertyHierarchy(
      IDatabaseEngine fromEngine, String predicates, String containsRelation, GraphDataModel ps) {
    // same concept as the subject, but only for relations
    String relationHierarchy = "";
   ...
   */
  public static void genPropertiesRemote(
      IDatabaseEngine fromEngine,
      String subjects,
      String objects,
      String predicates,
   ...
   *
   * @param rc Repository connection: main interface for updating data in and performing queries on
   *     a Sesame repository.
   * @param containsRelation String that shows the relation for the property query.
   * @param ps Graph playsheet where edge properties are added.
   */
  public static void genNodePropertiesLocal(
      RepositoryConnection rc, String containsRelation, GraphDataModel ps, Boolean subclassCreate) {
    ...
    if (subclassCreate) {
      propertyQuery =
          "CONSTRUCT { ?Subject ?Predicate ?Property} WHERE {"
              + "{?Predicate "
              + "<http://www.w3.org/1999/02/22-rdf-syntax-ns#type> "
              + containsRelation
              + ";}"
   ...
   * @param ps Graph playsheet where edge properties are added.
   */
  public static void genEdgePropertiesLocal(
      RepositoryConnection rc, String containsRelation, GraphDataModel ps) {
  ...
  public static void addQueryData(
      IDatabaseEngine fromEngine, RepositoryConnection toRC, String query) {
  ...
  public static void removeAllData(IDatabaseEngine fromEngine, RepositoryConnection toRC) {
    ...
    IConstructWrapper sjsc =
        WrapperManager.getInstance().getCWrapper(fromEngine, constructAllQuery);
