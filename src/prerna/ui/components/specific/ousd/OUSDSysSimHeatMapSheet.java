...
//		Hashtable overallHash;
		...
		String defaultSystemsQuery = "SELECT DISTINCT ?System WHERE {{?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/System>}}";
		...
		String bluQuery = "SELECT DISTINCT ?System ?BLU WHERE {{?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/System>}{?BLU <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/BusinessLogicUnit>;}{?System <http://semoss.org/ontologies/Relation/Performs> ?BLU }}";
...
//		
//		String actQuery ="SELECT DISTINCT ?System ?Activity WHERE { {?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/System> ;} {?Activity <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/Activity> ;} {?System <http://semoss.org/ontologies/Relation/Supports> ?Activity}}";
...
//		uiHash = processHashForCharting(uiHash);
		...
		if (dataDownHash != null && !dataDownHash.isEmpty()) {
			paramDataHash.put("Data_Provided", dataDownHash);
			allQueriesAreEmpty = false;
		}
		if (dataUpHash != null && !dataDownHash.isEmpty()) {
			paramDataHash.put("Data_Consumed", dataUpHash);
			allQueriesAreEmpty = false;
		}
