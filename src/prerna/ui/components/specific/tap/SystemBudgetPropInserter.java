...
public class SystemBudgetPropInserter {
	...
	public void runInsert(){
		...
		proc.setEngine((IDatabaseEngine) DIHelper.getInstance().getLocalProp(tapEngineName));
	...
	private void runQuery(){
		...
		{
			//get specific engine
			IDatabaseEngine selectedEngine = (IDatabaseEngine)DIHelper.getInstance().getLocalProp(repos[repoIndex]+"");
