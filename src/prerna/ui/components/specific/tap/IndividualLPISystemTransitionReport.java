...
public class IndividualLPISystemTransitionReport extends AbstractRDFPlaySheet{
	...
	public void createData() {
		...
		sysInterfacesQuery = sysInterfacesQuery.replace("@SYSTEM@", systemURI);
		...
		sysLPIInterfaceHash.put(dataKey, getSysLPIInterfaceData.getNames());
		sysLPIInterfaceHash.put(dataKey, getSysLPIInterfaceData.getList());
