...
public class DHMSMHelper {
	...
	public void runData(IDatabaseEngine engine)
	{
	...
	public ArrayList<Integer> getNumOfCapabilitiesSupported(String system)
	{
		...
		ISelectWrapper sjswQuery = processQuery(capabilityGroup, (IDatabaseEngine)DIHelper.getInstance().getLocalProp("TAP_Core_Data"));
