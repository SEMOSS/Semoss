...
public class DataCriticalityHeatMapSheet extends SimilarityHeatMapSheet {
	...
	private Hashtable<String, Hashtable<String, Double>> dataHash = new Hashtable<String, Hashtable<String, Double>>();
	...
	public void createData() {
		...
		IDatabaseEngine tapCoreEngine = (IDatabaseEngine) DIHelper.getInstance().getLocalProp(tapCoreDB);
		...
		comparisonObjectList = sdf.createComparisonObjectList(tapCoreDB, capabilityQuery);
