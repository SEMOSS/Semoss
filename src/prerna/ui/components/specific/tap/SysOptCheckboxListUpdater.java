...
public class SysOptCheckboxListUpdater {
	...
	public SysOptCheckboxListUpdater(IDatabaseEngine engine) {
		this.engine = engine;
	...
	public SysOptCheckboxListUpdater(IDatabaseEngine engine, Boolean runSystem, Boolean runFullCap, Boolean runDataBLU) {
		this.engine = engine;
		if(runSystem)
			createSystemCheckBoxLists(false);
		if(runFullCap)
	...
	public SysOptCheckboxListUpdater(IDatabaseEngine engine, Boolean runSystem, Boolean runCap, Boolean runDataBLU, Boolean costGreaterThanZero) {
		this.engine = engine;
		if(runSystem)
