...
public class SysOptCheckboxListUpdater {
	...
	private void createSystemCheckBoxLists(Boolean costGreaterThanZero) {
		...
		recdSysList = new Vector<String> (SysOptUtilityMethods.runListQuery(engine,"SELECT DISTINCT ?entity WHERE {{?entity <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>  <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?entity <http://semoss.org/ontologies/Relation/Contains/Device> 'N'} {?entity <http://semoss.org/ontologies/Relation/Contains/Review_Status> ?Review_Status}FILTER (?Review_Status in('FAC Approved','FCLG Approved')) {?entity <http://semoss.org/ontologies/Relation/Contains/Disposition> ?Disp}"+ costGreaterThanZeroTriples + "} ORDER BY ?entity"));
		lpiSysList = new Vector<String> (SysOptUtilityMethods.runListQuery(engine,"SELECT DISTINCT ?entity WHERE {{?entity <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>  <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?entity <http://semoss.org/ontologies/Relation/Contains/Device> 'N'}{?entity <http://semoss.org/ontologies/Relation/Contains/Review_Status> ?Review_Status}FILTER (?Review_Status in('FAC Approved','FCLG Approved')) {?entity <http://semoss.org/ontologies/Relation/Contains/Disposition> 'LPI'}"+ costGreaterThanZeroTriples + "}"));
		lpniSysList = new Vector<String> (SysOptUtilityMethods.runListQuery(engine,"SELECT DISTINCT ?entity WHERE {{?entity <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>  <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?entity <http://semoss.org/ontologies/Relation/Contains/Device> 'N'}{?entity <http://semoss.org/ontologies/Relation/Contains/Review_Status> ?Review_Status}FILTER (?Review_Status in('FAC Approved','FCLG Approved')) {?entity <http://semoss.org/ontologies/Relation/Contains/Disposition> 'LPNI'}"+ costGreaterThanZeroTriples + "}"));
		highSysList = new Vector<String> (SysOptUtilityMethods.runListQuery(engine,"SELECT DISTINCT ?entity WHERE {{?entity <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>  <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?entity <http://semoss.org/ontologies/Relation/Contains/Device> 'N'}{?entity <http://semoss.org/ontologies/Relation/Contains/Review_Status> ?Review_Status}FILTER (?Review_Status in('FAC Approved','FCLG Approved')) {?entity <http://semoss.org/ontologies/Relation/Contains/Disposition> 'High'}"+ costGreaterThanZeroTriples + "}"));
