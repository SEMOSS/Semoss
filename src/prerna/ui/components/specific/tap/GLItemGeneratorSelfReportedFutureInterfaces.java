...
public class GLItemGeneratorSelfReportedFutureInterfaces extends AggregationHelper{
	 ...
	 */
	public GLItemGeneratorSelfReportedFutureInterfaces(IDatabaseEngine tapCoreEngine, IDatabaseEngine futureState, IDatabaseEngine futureCostDB) {
	...
	public void getData(Hashtable<String, Vector<String[]>> allData) {
		...
		final String ICD = "http://health.mil/ontologies/Concept/SystemInterface/";
	...
	private void prepareGLItemGenerator(GLItemGeneratorICDValidated generator){
		generator.setCoreEngine(tapCoreEngine);
