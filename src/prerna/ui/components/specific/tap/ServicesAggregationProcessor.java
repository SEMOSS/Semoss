...
public class ServicesAggregationProcessor extends AggregationHelper {
	...
	private String TAP_SERVICES_AGGREGATE_COMPONENT_SYSTEM_QUERY = "SELECT DISTINCT ?system ?ComprisedOf ?systemService WHERE{{?system <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/System>} {?systemService <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemService>}{?system <http://semoss.org/ontologies/Relation/ConsistsOf> ?systemService}{?ComprisedOf <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/ComprisedOf>}{?system ?ComprisedOf ?systemService}}";
	...
	//	private String TAP_CORE_AND_SERVICES_AGGREGATE_ICD_DATAOBJECT_COMMENT_QUERY = "SELECT DISTINCT ?Payload ?pred ?prop1 WHERE{{?ICD <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface>} {?data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject>} {?Payload <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>} {?ICD ?Payload ?data} BIND(<http://semoss.org/ontologies/Relation/Contains/Comments> AS ?pred) {?Payload ?pred ?prop1} }";
