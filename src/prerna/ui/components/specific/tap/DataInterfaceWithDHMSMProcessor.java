...
public class DataInterfaceWithDHMSMProcessor {
	...
	String hrCoreEngineName = "TAP_Core_Data";
	...
	public void processDHMSMInterfaceQueries() {
		...
		String dataConsumerQuery1 = "SELECT DISTINCT ?Data (COALESCE(?Format,'') AS ?Data_Protocol) (COALESCE(?Protocol,'') AS ?Wire_Protocol) ?LowMedProbSystem ?ConsumingProviding_Data_FromTo_DHMSM (COALESCE(?CCD2,'') AS ?CCD) (COALESCE(?Interface,'Y') AS ?Interface_Needed) WHERE {BIND('Consuming' AS ?ConsumingProviding_Data_FromTo_DHMSM) {?HighProbSystem <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem>;}{?LowMedProbSystem <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem>;}{?ICD1 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface>;}{?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject>;}{?payload <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>}  {?LowMedProbSystem <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> ?LowMed}{?LowMedProbSystem <http://semoss.org/ontologies/Relation/Contains/Device_Interface> 'N'}{?HighProbSystem <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}{?HighProbSystem <http://semoss.org/ontologies/Relation/Provide> ?ICD1} {?ICD1 <http://semoss.org/ontologies/Relation/Consume> ?LowMedProbSystem}{?ICD1 ?payload ?Data}OPTIONAL{{?payload1 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>}{?payload1 <http://semoss.org/ontologies/Relation/Contains/Protocol> ?Protocol ;}{?payload1 <http://semoss.org/ontologies/Relation/Contains/Format> ?Format ;}{?ICD1 ?payload1 ?Data}}OPTIONAL{{?CCD2 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/CCD>;}{?Data <http://semoss.org/ontologies/Relation/MapsTo> ?CCD2}}OPTIONAL{?LowMedProbSystem <http://semoss.org/ontologies/Relation/Contains/Interface_Needed> ?Interface} } ORDER BY ?Data BINDINGS ?LowMed {('Low')('Medium')}";
//		String dataConsumerQuery1 = "SELECT DISTINCT ?Data (COALESCE(?Format,'') AS ?Data_Protocol) (COALESCE(?Protocol,'') AS ?Wire_Protocol) ?System ?ConsumingProviding_Data_FromTo_DHMSM ?CCD_Element WHERE { filter( !regex(str(?crm),'R')){?HighSystem <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> }{?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> } {?icd <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> }{?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject> }{?CCD <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/CCD> }  {?provideData <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Provide>}  {?provideData <http://semoss.org/ontologies/Relation/Contains/CRM> ?crm}{?payload <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>}{?HighSystem <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}{?System <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> ?LowMed}{?HighSystem <http://semoss.org/ontologies/Relation/Provide> ?icd}{?icd <http://semoss.org/ontologies/Relation/Consume> ?System ;}{?icd ?payload ?Data}{?HighSystem ?provideData ?Data}{?Data <http://semoss.org/ontologies/Relation/MapsTo> ?CCD}BIND('Consuming' AS ?ConsumingProviding_Data_FromTo_DHMSM)OPTIONAL{{?carries <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>}{?icd ?carries ?Data}{?carries <http://semoss.org/ontologies/Relation/Contains/Protocol> ?Protocol ;}{?carries <http://semoss.org/ontologies/Relation/Contains/Format> ?Format ;} }  } ORDER BY ?System ?Data BINDINGS ?LowMed {('Low')('Medium')}";
//		String dataConsumerQuery2 = "SELECT DISTINCT ?Data (COALESCE(?Format,'') AS ?Data_Protocol) (COALESCE(?Protocol,'') AS ?Wire_Protocol) ?System ?ConsumingProviding_Data_FromTo_DHMSM ?CCD_Element WHERE {BIND('Consuming' AS ?ConsumingProviding_Data_FromTo_DHMSM)  {?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject> } {?HighSystem <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> }{?icd <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> ;}{?CCD <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/CCD> } {?payload <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>}OPTIONAL{{?icd2 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> ;}{?icd2 <http://semoss.org/ontologies/Relation/Consume> ?HighSystem}{?icd2 <http://semoss.org/ontologies/Relation/Payload> ?Data}}{?HighSystem <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}{?System <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> ?LowMed}{?HighSystem <http://semoss.org/ontologies/Relation/Provide> ?icd ;}{?icd <http://semoss.org/ontologies/Relation/Consume> ?System ;}{?icd ?payload ?Data ;}{?Data <http://semoss.org/ontologies/Relation/MapsTo> ?CCD}FILTER(!BOUND(?icd2))OPTIONAL{{?carries <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>}{?icd ?carries ?Data}{?carries <http://semoss.org/ontologies/Relation/Contains/Protocol> ?Protocol ;}{?carries <http://semoss.org/ontologies/Relation/Contains/Format> ?Format ;} } } ORDER BY ?System ?Data BINDINGS ?LowMed {('Low')('Medium')}";
		
		//systems that provide data to DHMSM
		String dataProviderQuery1 = "SELECT DISTINCT ?Data (COALESCE(?Format,'') AS ?Data_Protocol) (COALESCE(?Protocol,'') AS ?Wire_Protocol) ?LowMedProbSystem ?ConsumingProviding_Data_FromTo_DHMSM (COALESCE(?CCD2,'') AS ?CCD) (COALESCE(?Interface,'Y') AS ?Interface_Needed) WHERE {BIND('Providing' AS ?ConsumingProviding_Data_FromTo_DHMSM) {?HighProbSystem <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem>;}{?LowMedProbSystem <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem>;}{?ICD1 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface>;}{?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject>;}{?LowMedProbSystem <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> ?LowMed}{?LowMedProbSystem <http://semoss.org/ontologies/Relation/Contains/Device_Interface> 'N'}{?HighProbSystem <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}{?LowMedProbSystem <http://semoss.org/ontologies/Relation/Provide> ?ICD1} {?ICD1 <http://semoss.org/ontologies/Relation/Consume> ?HighProbSystem}{?ICD1 <http://semoss.org/ontologies/Relation/Payload> ?Data}OPTIONAL{{?payload1 <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>}{?ICD1 ?payload1 ?Data}{?payload1 <http://semoss.org/ontologies/Relation/Contains/Protocol> ?Protocol ;}{?payload1 <http://semoss.org/ontologies/Relation/Contains/Format> ?Format ;}}OPTIONAL{{?CCD2 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/CCD>;}{?Data <http://semoss.org/ontologies/Relation/MapsTo> ?CCD2}}OPTIONAL{?LowMedProbSystem <http://semoss.org/ontologies/Relation/Contains/Interface_Needed> ?Interface}} ORDER BY ?Data BINDINGS ?LowMed {('Low')('Medium')}";
...
//		String dataProviderQuery2 = "SELECT DISTINCT ?Data (COALESCE(?Format,'') AS ?Data_Protocol) (COALESCE(?Protocol,'') AS ?Wire_Protocol) ?System ?ConsumingProviding_Data_FromTo_DHMSM ?CCD_Element WHERE {BIND('Providing' AS ?ConsumingProviding_Data_FromTo_DHMSM)  {?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject> } {?HighSystem <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> }{?icd <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> ;}{?CCD <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/CCD> } {?payload <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>}OPTIONAL{{?icd2 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> ;}{?icd2 <http://semoss.org/ontologies/Relation/Consume> ?System}{?icd2 <http://semoss.org/ontologies/Relation/Payload> ?Data}}{?HighSystem <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}{?System <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> ?LowMed}{?System <http://semoss.org/ontologies/Relation/Provide> ?icd ;}{?icd <http://semoss.org/ontologies/Relation/Consume> ?HighSystem ;}{?icd ?payload ?Data ;}{?Data <http://semoss.org/ontologies/Relation/MapsTo> ?CCD}FILTER(!BOUND(?icd2))OPTIONAL{{?carries <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Payload>}{?icd ?carries ?Data}{?carries <http://semoss.org/ontologies/Relation/Contains/Protocol> ?Protocol ;}{?carries <http://semoss.org/ontologies/Relation/Contains/Format> ?Format ;} } } ORDER BY ?System ?Data BINDINGS ?LowMed {('Low')('Medium')}";
	...
	public void processIOCFOCQueries() {
		...
		String iocFOCInterfaceQuery1 = "SELECT DISTINCT ?Data ?Data_Protocol ?Wire_Protocol ?HighSystem ?ConsumingProviding_Data_FromTo_DHMSM (COALESCE(?CCD2,'') AS ?CCD) WHERE { BIND('TBD' AS ?Data_Protocol) BIND('TBD' AS ?Wire_Protocol)BIND('Providing and Consuming' AS ?ConsumingProviding_Data_FromTo_DHMSM) filter( !regex(str(?crm),'R')){?HighSystem <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> }{?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> } {?icd <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> }{?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject> } {?provideData <http://www.w3.org/2000/01/rdf-schema#subPropertyOf> <http://semoss.org/ontologies/Relation/Provide>}{?HighSystem <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}{?System <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}  {?provideData <http://semoss.org/ontologies/Relation/Contains/CRM> ?crm}{?HighSystem <http://semoss.org/ontologies/Relation/Provide> ?icd}{?icd <http://semoss.org/ontologies/Relation/Consume> ?System ;}{?icd <http://semoss.org/ontologies/Relation/Payload> ?Data}{?HighSystem ?provideData ?Data}OPTIONAL{{?CCD2 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/CCD> } {?Data <http://semoss.org/ontologies/Relation/MapsTo> ?CCD2}}} ORDER BY ?System ?Data";
		String iocFOCInterfaceQuery2 = "SELECT DISTINCT ?Data ?Data_Protocol ?Wire_Protocol ?HighSystem ?ConsumingProviding_Data_FromTo_DHMSM (COALESCE(?CCD2,'') AS ?CCD) WHERE { BIND('TBD' AS ?Data_Protocol) BIND('TBD' AS ?Wire_Protocol) BIND('Providing and Consuming' AS ?ConsumingProviding_Data_FromTo_DHMSM){?HighSystem <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> } {?icd <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> ;} {?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject> } {?HighSystem <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}{?System <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}{?HighSystem <http://semoss.org/ontologies/Relation/Provide> ?icd ;}{?icd <http://semoss.org/ontologies/Relation/Consume> ?System ;}{?icd <http://semoss.org/ontologies/Relation/Payload> ?Data ;}OPTIONAL{{?icd2 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> ;}{?icd2 <http://semoss.org/ontologies/Relation/Consume> ?HighSystem}{?icd2 <http://semoss.org/ontologies/Relation/Payload> ?Data}}OPTIONAL{{?CCD2 <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/CCD> }{?Data <http://semoss.org/ontologies/Relation/MapsTo> ?CCD2}} FILTER(!BOUND(?icd2))} ORDER BY ?System ?Data";
	...
	public void processDeviceQueries() {
		...
		//systems that consume data from DHMSM
		String deviceQuery = "SELECT DISTINCT ?Data ?ConsumingProviding_Data_FromTo_DHMSM ?Device_Category ?System WHERE { { SELECT DISTINCT ?System ?ConsumingProviding_Data_FromTo_DHMSM ?Data WHERE {BIND('Providing' AS ?ConsumingProviding_Data_FromTo_DHMSM) {?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> ;} {?DownstreamSys <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?Interface <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> ;} {?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject>;} {?DownstreamSys <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'}{?System <http://semoss.org/ontologies/Relation/Contains/Device_Interface> '?'} {?Interface <http://semoss.org/ontologies/Relation/Payload> ?Data;} {?System <http://semoss.org/ontologies/Relation/Provide> ?Interface ;}{?Interface <http://semoss.org/ontologies/Relation/Consume> ?DownstreamSys ;} BIND('Downstream' AS ?type)} } UNION { SELECT DISTINCT ?System ?ConsumingProviding_Data_FromTo_DHMSM ?Data WHERE {BIND('Consuming' AS ?ConsumingProviding_Data_FromTo_DHMSM){?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> ;} {?UpstreamSys <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?Interface <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/SystemInterface> ;}{?System <http://semoss.org/ontologies/Relation/Contains/Device_Interface> '?'} {?UpstreamSys <http://semoss.org/ontologies/Relation/Contains/Probability_of_Included_BoS_Enterprise_EHRS> 'High'} {?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject>;} {?Interface <http://semoss.org/ontologies/Relation/Payload> ?Data;}{?UpstreamSys <http://semoss.org/ontologies/Relation/Provide> ?Interface ;}{?Interface <http://semoss.org/ontologies/Relation/Consume> ?System ;} BIND('Upstream' AS ?type) } } }";
