	...
	private void processSystemReadData(ArrayList <Object []> list)
	{
		for (int i=0; i<list.size(); i++)
		{
			...
			if(sysReadDataHash.containsKey(system))
			{
				...
				if(sysToDataToCostHash.get(system).containsKey(data))
				{
