...
public class SystemTransitionOrganizer {
	...
	private static String systemProbQuery = "SELECT DISTINCT ?System WHERE {{?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> ;}{?System <http://semoss.org/ontologies/Relation/Contains/Disposition> 'High'} {?System <http://semoss.org/ontologies/Relation/Contains/Device> 'N'} {?System <http://semoss.org/ontologies/Relation/Contains/Review_Status> ?Review_Status}FILTER (?Review_Status in('FAC Approved','FCLG Approved'))}";
	...
	{
		ArrayList <Object []> list = createData(tapCoreDB, systemProbQuery);
		...
		list = createData(tapCoreDB, systemDataQuery);
