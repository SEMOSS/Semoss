...
public class ServiceICDCostAnalyzer {
	...
	public void runServiceResults()
	{
		...
		ISelectWrapper sjswQuery = processQuery(icdCountQueryUpstream, (IEngine)DIHelper.getInstance().getLocalProp("TAP_Core_Data"));
		processDataSerICD(sjswQuery);
		sjswQuery = processQuery(icdCountQueryDownstream, (IEngine)DIHelper.getInstance().getLocalProp("TAP_Core_Data"));
		processDataSerICD(sjswQuery);
		
		//organizes dataobjects and services
		sjswQuery = processQuery(dataSerCountQuery, (IEngine)DIHelper.getInstance().getLocalProp("TAP_Core_Data"));
