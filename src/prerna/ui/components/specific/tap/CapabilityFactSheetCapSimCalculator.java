...
//		printValues2();
	...
	public void performAnalysis() 
	{
		...
		capList = sdf.createComparisonObjectList(tapCoreDB, query);
		...
		Hashtable attributeHash = sdf.compareObjectParameterScore(tapCoreDB, attributeQuery, SimilarityFunctions.VALUE);
