...
public class OTMReport extends TablePlaySheet {
	...
	public void setTAP_Core_Data(IDatabaseEngine TAP_Core_Data) {
		this.TAP_Core_Data = TAP_Core_Data;
	}
	
	//Set Future Database
	public void setFutureDB(IDatabaseEngine FutureDB) {
		this.FutureDB = FutureDB;
	}
	//Set Future Database
	public void setTAP_Site_Data(IDatabaseEngine TAP_Site_Data) {
