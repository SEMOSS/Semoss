...
public class OTMReport extends TablePlaySheet {
	...
	private String dataSourceQuery = "SELECT DISTINCT ?System ?Data  WHERE { BIND(<http://health.mil/ontologies/Concept/SourceType/MigrationReference> AS ?sourceType ) {?System <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem> ;} {?System <http://semoss.org/ontologies/Relation/Contains/Disposition> 'LPI'} {?System <http://semoss.org/ontologies/Relation/Contains/Device> 'N' ;} {?System <http://semoss.org/ontologies/Relation/Contains/Review_Status> ?Review_Status}FILTER (?Review_Status in('FAC Approved','FCLG Approved')) {?DOS <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObjectSource> ;} {?Data <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/DataObject> ;} {?System <http://semoss.org/ontologies/Relation/Designated> ?DOS ;} {?DOS <http://semoss.org/ontologies/Relation/Delivers> ?Data ;}{?DOS <http://semoss.org/ontologies/Relation/LabeledAs> ?sourceType ;} } ";
