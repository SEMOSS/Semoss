...
//		existingEngine.addStatement(new Object[]{activeSystemURI, AbstractOWLEngine.SEMOSS_URI_PREFIX + AbstractOWLEngine.DEFAULT_RELATION_CLASS + "/" + AbstractOWLEngine.CONCEPTUAL_RELATION_NAME, activeSystemURI, true});
//
