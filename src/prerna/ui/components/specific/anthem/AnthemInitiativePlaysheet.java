...
public class AnthemInitiativePlaysheet extends TablePlaySheet implements IDataMaker {
	...
	static String masterQuery = "SELECT DISTINCT OBA_L1.OBA_L0_FK AS OBA_L0, OBA_L1.OBA_L1 AS OBA_L1, OBA_L2.OBA_L2 AS OBA_L2, INITIATIVE.INITIATIVE_NAME AS INITIATIVE "
			+ "FROM OBA_L1, INITIATIVE "
			+ "INNER JOIN OBA_L2 ON OBA_L1.OBA_L1 = OBA_L2.OBA_L1_FK ";

	//OBA_L0.OBA_L0.OBA_L1.OBA_L0_FK

	public static String instanceOfPlaysheet = "prerna.ui.components.specific.tap.AnthemInitiativePlaysheet";
