...
public final class TypeColorShapeTable {
	 ...
	 *
	 * @param type
	 *            String - The type of the shape (serves as a key in the hashtable)
	 * @param shape
	 *            String - the shape itself.
	 */
	...
	public Shape getShapeL(String type, String vertName) {
		...
		if (shapeHashL.containsKey(vertName))
			...
			// try to search the properties file for the first time
			retShape = (Shape) DIHelper.getInstance()
					.getLocalProp(DIHelper.getInstance().getProperty(type + "_SHAPE") + Constants.LEGEND);
		if (retShape == null) {
			// instead of returning default color, going to return random color that hasn't
			// been used yet
			for (String shape : shapes) {
	 ...
	 *
	 * @param rgbString
	 *            String - rgb string - the appropriate rgb string the method will
	 *            try to convert
	 */
	 ...
	 *
	 * @param vertName
	 *            String - vertex name - the key for the desired shape in the
	 *            hashtable
	 ...
	 *
	 * @param vertName
	 *            String - vertex name - the key for the desired color in the
	 *            hashtable
