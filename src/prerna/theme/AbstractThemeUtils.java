...
public abstract class AbstractThemeUtils {
	...
	private static void initialize() throws SQLException {
		...
		blocksTemplateColNames = new String[] { "ID", "NAME", "SECTION", "IMAGE", "HOVER_IMAGE", "JSON" , "CLASSIFICATION"};
		blocksTemplateTypes = new String[] { "varchar(255)", "varchar(255)", "varchar(255)", "varchar(255)", "varchar(255)", queryUtil.getClobDataTypeName(), "varchar(255)" };
		if(queryUtil.allowsIfExistsTableSyntax()) {
			...
			// insert default blocks
				themeDb.insertData(queryUtil.insertIntoTable(ThemeDbTable.BLOCKS_TEMPLATE.getThemeDbTableName(), blocksTemplateColNames, blocksTemplateTypes,
					    new Object[] {
					        ...
					        "{widget: 'audio-player', data: {label: 'Audio Player', autoplay: false, controls: true, loop: false, source: ''}, listeners: {}, slots: {}}", "DEFAULT"
					    })
					);
