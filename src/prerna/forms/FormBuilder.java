...
//	private static void removeRDFNodeProp(IDatabase engine, String instanceConceptURI, String propertyURI, IDatabase formEng, String auditLogTableName, String user) {
...
//		engine.doAction(IDatabase.ACTION_TYPE.REMOVE_STATEMENT, new Object[]{conceptURI, RDF.TYPE, typeURI, true});
//		engine.doAction(IDatabase.ACTION_TYPE.REMOVE_STATEMENT, new Object[]{conceptURI, RDFS.LABEL, Utility.getInstanceName(conceptURI), false});
//	}
