...
public class SysSiteOptDataStore{
	...
	public void fillSysSiteOptDataStores(ArrayList<String> sysList, ArrayList<String> allSysList, ArrayList<String> dataList,ArrayList<String> bluList,ArrayList<String> siteList, IEngine systemEngine, IEngine siteEngine, double centralPercOfBudget, double trainingPerc, Boolean localSystems) {
	...
	public void fillSiteLatLon(ArrayList<String> siteList, IEngine siteEngine) {
	...
	private void fillSystemFunctionality(ArrayList<String> sysList,ArrayList<String> dataList,ArrayList<String> bluList,IEngine systemEngine) {
	...
	private void fillSystemHasUpstreamInterface(ArrayList<String> sysList, ArrayList<String> allSysList, IEngine systemEngine) {
	...
	private void fillSystemSite(ArrayList<String> sysList, ArrayList<String> siteList, IEngine siteEngine) {
	...
	private void fillLocalSystemCost(ArrayList<String> sysList, IEngine systemEngine, double centralPercOfBudget, double deploymentFactor, double interfacePercOfDeployment, double trainingPerc) {
...
String query = "SELECT DISTINCT ?sys (COALESCE(?cost,0) AS ?Cost) WHERE {{?sys <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/System>}{?sys <http://semoss.org/ontologies/Relation/Contains/SustainmentBudget> ?cost}}BINDINGS ?sys @SYSTEM-BINDINGS@";
	...
	private void fillCentralSystemCost(ArrayList<String> sysList, IEngine systemEngine, double centralPercOfBudget, double deploymentFactor, double interfacePercOfDeployment, double trainingPerc, int numSites) {
	...
	private void fillSystemTheaterGarrison(ArrayList<String> sysList, IEngine systemEngine,boolean includeTheater,boolean includeGarrison)
	{
