...
public class UnivariateOpt implements IAlgorithm{
	...
	public void createTabAndDisplayList(String[] colNames,ArrayList <Object []> list, String panelTitle, Boolean addScroll) {
		JPanel panel;
		int tabIndex = playSheet.displayTabbedPane.indexOfTab(panelTitle);
		if(tabIndex < 0) {
			panel = new JPanel();
			playSheet.displayTabbedPane.addTab(panelTitle, null, panel, null);
			...
			panel = (JPanel)playSheet.displayTabbedPane.getComponentAt(tabIndex);
