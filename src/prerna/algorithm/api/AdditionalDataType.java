...
public enum AdditionalDataType {
  ...
  private static final Map<String, AdditionalDataType> stringToEnum =
      new HashMap<String, AdditionalDataType>();
  private static final Map<AdditionalDataType, String> mapOfEnumDescriptions =
      new TreeMap<AdditionalDataType, String>();
