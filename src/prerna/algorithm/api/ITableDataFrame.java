...
public interface ITableDataFrame extends IDataMaker {
	 ...
	 *
	 * @param rowCleanData
	 *            The array of clean values where indices match the columns in the
	 *            data-frame
	 * @param headers
	 *            The headers corresponding to the new row to add
	 */
	 ...
	 *
	 * @param columnHeader
	 *            The column header to determine if it is numeric or categorical
	 ...
	 *
	 * @param columnHeader
	 *            The column header to get the values for
	 ...
	 *
	 * @param columnHeader
	 *            The column header to remove the filter on
	 ...
	 *
	 * @param columnHeader
	 *            The column header to remove from the data-frame
	 */
  ...
  //////////////////////////////////////////////////
	...
	// /**
	// * Perform the inputed analytical routine onto the data frame. The routine
	...
	// */
	// @Deprecated
	// void performAnalyticAction(IAnalyticActionRoutine routine) throws
	// RuntimeException;
