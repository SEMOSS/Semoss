...
import prerna.quartz.specific.anthem.ComposeTSAnomalyEmailJob;
...
public class WebWatcherTest extends AbstractFileWatcher {
	...
	public void run() {
		...
		// Logic here:
		// Chain 1) Import TS data, get data from insight, detect anomalies, determine if anomaly, if anomaly then chain 2	
