...
public class GsonSerializer {
    ...
    private static JsonElement toJsonTree(Object value, Set<Object> visited) {
        ...
        if (value instanceof Room) {
            ...
            o.addProperty(SemossLogUtils.PROJECT_ID,r.getInsight().getContextProjectId());
            o.addProperty(SemossLogUtils.PROJECT_NAME,r.getInsight().getContextProjectName());

            o.add("insight", toJsonTree(r.getInsight(), visited));
		 ...
		 * 
		 * Insight i = (Insight) value;
		 * 
		 * JsonObject o = new JsonObject();
		 * 
		 * o.addProperty(SemossLogUtils.INSIGHT_ID,i.getInsightId());
		 * o.addProperty(SemossLogUtils.PROJECT_ID,i.getContextProjectId());
		 * o.addProperty(SemossLogUtils.PROJECT_NAME,i.getContextProjectName());
		 * 
		 * return o;
		 * 
		 * }
