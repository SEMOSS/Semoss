...
public final class FormUtility {
	...
	public static String getInputComponent(String variableToBind) {
		return new StringBuilder(
				"<smss-input ng-model=\"form.dataModel." + variableToBind + ".selected\"></smss-input>\\n").toString();
	}
	...
	public static String getDropdownComponent(String variableToBind) {
		return new StringBuilder(
				"<smss-dropdown model=\"form.dataModel." + variableToBind + ".selected\" options=\"form.dataModel."
	...
	public static String getSliderComponent(String min, String max, String sensitivity) {
		return new StringBuilder("<smss-slider min=\"" + min + "\" max=\"" + max + "\" sensitivity=\"" + sensitivity
	...
	public static String getSliderComponent(String min, String max, String sensitivity, String variableToBind) {
		return new StringBuilder("<smss-slider min=\"" + min + "\" max=\"" + max + "\" sensitivity=\"" + sensitivity
				+ "\" model=\"form.dataModel." + variableToBind + ".selected\"> numerical=\"\"></smss-slider>\\n")
				.toString();
	}

	public static String getTextAreaComponent(String variableToBind) {
		return new StringBuilder(
				"<smss-textarea ng-model=\"form.dataModel." + variableToBind + ".selected\"></smss-textarea>\\n")
				.toString();
	}
	...
	public static String getSubmitComponent(String crudOperation) {
		return new StringBuilder(
				"<div smss-form-model=\"Submit\" class=\"form-builder__submit\"><smss-btn class=\"smss-btn--primary\""
						+ " ng-click=\"form.runPixel(form.pixelModel." + crudOperation
