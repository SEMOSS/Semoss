...
public class NodeLoadingSheetWriter {
	 ...
	 * and saves it in a workbook The data is reorganized in a Hashtable<String,
	 * Vector<String[]>> where the keys become the sheet name and the instance data
	 ...
	 *            ExportNodeLoadSheetsListener, which gets the data from querying
	 *            the engine
	 * @param engine
	 * @param nodeTypes
	 */
	...
	private Hashtable<String, Vector<String[]>> queryData(IDatabaseEngine engine, ArrayList<String> nodeTypes) {
		...
		for (String nodeType : nodeTypes) {
			...
			if (nodeKey.length() > 31)
				nodeKey = nodeKey.substring(0, 31);
	 ...
	 *
	 * @param oldHash
	 *            Hashtable containing the data from ExportNodeLoadSheetsListener,
	...
	/**
	 * Writes the sheet containing the information for all the node instances and
	 * properties for the node type specified by the user
	 *
	 * @param key
	 *            String containing the name of the sheet to write
	 * @param sheetVector
	 *            Vector<String[]> containing the data, all the node instance and
