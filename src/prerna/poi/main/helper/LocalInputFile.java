...
/**
 * This implements the org.apache.parquet.io.InputFile interface based on a
 * local file so we don't have to use
 * org.apache.parquet.hadoop.util.HadoopInputFile and org.apache.hadoop.fs.Path
 * which would require a huge number of dependencies on Hadoop libraries. See
