...
public class CSVFileHelper {
	...
	// values
	// without getting an error when there are duplicate headers within the
	// univocity api
	 ...
	 *
	 * @param fileLocation
	 *            The String location of the fileName
	 */
	...
	/**
	 * Get all the headers used in the csv file This is the clean version of the csv
	 * headers
	 *
	 * @return
	 */
	 ...
	 *
	 * @param columns
	 *            The String[] containing the headers you want
	 */
	 ...
	 * that we create on the BE If the name is already valid, it just points to
	 * itself
	 *
	 * @return
	 */
	...
	/**
	 * This will return the original headers of the csv file Before we performed any
	 * cleaning of data
	 *
	 * @return
	 */
	 ...
	 * @param dataTypes
	 *            The smss data type for each column in the values array
