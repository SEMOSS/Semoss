...
public class ExcelDataValidationHelper {
   ...
   * @return
   */
  public static Map<String, Object> getDataValidation(
      Sheet sheet,
   ...
   * @return
   */
  public static Map<String, Object> getHeaderComments(
      Sheet sheet,
      Map<String, String> newHeaders,
      String[] headers,
      SemossDataType[] types,
  ...
  public static Map<String, Object> createInsertForm(
      String appId, String sheetName, Map<String, Object> dataValidationMap, String[] headerList) {
   ...
   * @return
   */
  public static Map<String, Object> createUpdateForm(
      String appId, String sheetName, Map<String, Object> dataValidationMap) {
  ...
  //		Map<String, Object> dataValidationMap = getDataValidation(sheet, new HashMap<>(), headers,
  // types,
  //				headerInidcies, 1);
