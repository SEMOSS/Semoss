...
//		}
	...
	public static Map getConnectedConceptsRDBMS(List<String> conceptLogicalNames, List<String> databaseFilters) {
		...
		// c, engineconcept ec, engine e where c.logicalname in ('Title') and
...
//				+ "and c.localconceptid=ec.localconceptid";
		...
		// er.relationname, c.logicalname , er.engine, er.targetconceptid,
		// ec.physicalname from enginerelation er, engineconcept ec, concept c, engine e
		// where er.sourceconceptid in (select physicalnameid from engineconcept where
		// localconceptid in (select localconceptid from concept where logicalname in
		// ('Title')))
		// and ec.physicalnameid=er.targetconceptid and
		// c.localconceptid=ec.localconceptid and e.id=er.engine;
...
//				+ "and ec.physicalnameid=er.sourceconceptid and c.localconceptid=ec.localconceptid";
	...
	public static String getPhysicalConceptId(String databaseId, String conceptualName) {
		...
		// engineconcept.engine='' AND concept.conceptualname='Title'
