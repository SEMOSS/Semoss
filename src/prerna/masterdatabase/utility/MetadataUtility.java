...
public class MetadataUtility {
	...
	public static boolean ignoreConceptData(IDatabaseEngine.DATABASE_TYPE type) {
		return type == IDatabaseEngine.DATABASE_TYPE.RDBMS || type == IDatabaseEngine.DATABASE_TYPE.R
	 ...
	 * @return
	 */
	public static boolean propertyExistsForConcept(IDatabaseEngine engine, String conceptPhysicalUri,
			String propertyName) {
