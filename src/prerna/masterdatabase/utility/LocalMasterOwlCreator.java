...
public class LocalMasterOwlCreator {
  ...
  public boolean needsRemake() {
...

    {
      ...
      List<String> props =
          localMasterDb.getPropertyUris4PhysicalUri(
              "http://semoss.org/ontologies/Concept/CONCEPTMETADATA");
      if (!props.contains(
          "http://semoss.org/ontologies/Relation/Contains/METAKEY/CONCEPTMETADATA")) {
        return true;
      }
    }
  ...
  private void writeNewOwl(WriteOWLEngine owler) throws Exception {
    ...
    owler.addRelation(
        "ENGINECONCEPT", "CONCEPT", "ENGINECONCEPT.LOCALCONCEPTID.CONCEPT.LOCALCONCEPTID");
    owler.addRelation(
        "ENGINECONCEPT",
        "ENGINERELATION",
