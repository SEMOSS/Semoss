...
public class DeleteFromMasterDB {
  ...
  public boolean deleteEngineRDBMS(String engineId) {
    ...
    try {
      ...
      String metaDeleteSql =
          "DELETE FROM conceptmetadata WHERE physicalnameid in (SELECT physicalnameid FROM engineconcept WHERE engine = ?)";
  ...
  //
  //			LOGGER.info("TIME TO DELETE ALL TRIPLES ::: " + (removeDataEndTime - removeDataStartTime) + "
  // ms" );
  //
  //			success = true;
  //		} catch(Exception ex) {
  ...
  //	 */
  //	private void addEngineConceptTriplesToRemove(String engineName, IEngine localMaster,
  ...
  //	 * @param deleteTriplesList
  //	 */
  //	private void addAllEnginePropertyTriplesToDelete(String engineName, IEngine localMaster,
  // List<Object[]> deleteTriplesList) {
  //		// delete the relationship between the engine-concept composite to engine-concept-property
  // composite
  ...
  //	 * @param deleteTriplesList
  //	 */
  //	private void addEngineRelationshipTriplesToDelete(String engineName, IEngine localMaster,
  // List<Object[]> deleteTriplesList) {
  ...
  //	 * @param fromEngine
  //	 */
  //	private void addEngineMetadataToDelete(String engineName, IEngine localMaster, List<Object[]>
  // deleteTriplesList) {
