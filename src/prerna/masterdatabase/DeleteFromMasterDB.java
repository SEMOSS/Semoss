...
public class DeleteFromMasterDB {
	...
	// delete from engineconcept where engine in (select id from engine where
	// enginename='Mv1')
	// delete from enginerelation where engine in (select id from engine where
	// enginename='Mv1')
	...
	//
	// LOGGER.info("TIME TO GET ALL TRIPLES TO REMOVE::: " + (getTriplesEndTime -
	// getTriplesStartTime) + " ms" );
	//
	//
	...
	//
	// LOGGER.info("TIME TO DELETE ALL TRIPLES ::: " + (removeDataEndTime -
	// removeDataStartTime) + "
	// ms" );
	//
	// success = true;
	...
	// */
	// private void addEngineConceptTriplesToRemove(String engineName, IEngine
	// localMaster,
	// List<Object[]> deleteTriplesList) {
	...
	// + "{?conceptComposite <http://semoss.org/ontologies/Relation/presentin>
	// <http://semoss.org/ontologies/meta/engine/" + engineName + ">}"
  ...
  ////				+ 	")"
	// + "}";
	// IRawSelectWrapper manager =
	// WrapperManager.getInstance().getRawWrapper(localMaster, query);
  ...
  ////				+ 	")"
	...
	// + "BIND(<http://semoss.org/ontologies/Relation/logical> AS
	// ?conceptLogicalRel) "
	// + "{?conceptComposite <http://semoss.org/ontologies/Relation/presentin>
	// <http://semoss.org/ontologies/meta/engine/" + engineName + ">}"
  ...
  ////				+ 	")"
	...
	// {"
	// + "BIND(<http://semoss.org/ontologies/Relation/conceptual> AS
	// ?conceptConceptualRel) "
	// + "{?conceptComposite <http://semoss.org/ontologies/Relation/presentin>
	// <http://semoss.org/ontologies/meta/engine/" + engineName + ">}"
  ...
  ////				+ 	")"
	...
	// * @param deleteTriplesList
	// */
	// private void addAllEnginePropertyTriplesToDelete(String engineName, IEngine
	// localMaster,
	// List<Object[]> deleteTriplesList) {
	// // delete the relationship between the engine-concept composite to
	// engine-concept-property
	// composite
	...
	// + "{?conceptComposite <http://semoss.org/ontologies/Relation/presentin>
	// <http://semoss.org/ontologies/meta/engine/" + engineName + ">}"
	// // unique engine-concept composite to all its unique engine-concept-property
	// composite
  ...
  ////				+ 	")"
	...
	// }
	//
	// // // delete all logical names assigned to this engine-concept-property
	// composite
	// query = "SELECT DISTINCT ?propertyComposite ?propertyLogicalRel
	// ?propertyLogical WHERE {"
	// + "BIND( <http://www.w3.org/2002/07/owl#DatatypeProperty> AS ?prop) "
	// + "BIND( <http://semoss.org/ontologies/Relation/logical> AS
	// ?propertyLogicalRel ) "
	// // unique engine-concept present in engine we are deleting
  ...
  ////				+ 	")"
	...
	// query = "SELECT DISTINCT ?propertyComposite ?propertyConceptualRel
	// ?propertyConceptual WHERE
	// {"
	// + "BIND( <http://www.w3.org/2002/07/owl#DatatypeProperty> AS ?prop) "
	// + "BIND( <http://semoss.org/ontologies/Relation/conceptual> AS
	// ?propertyConceptualRel ) "
	// // unique engine-concept present in engine we are deleting
	// + "{?conceptComposite <http://semoss.org/ontologies/Relation/presentin>
	// <http://semoss.org/ontologies/meta/engine/" + engineName + ">}"
	// // unique engine-concept composite to all its unique engine-concept-property
  ...
  ////				+ 	")"
	...
	// * @param deleteTriplesList
	// */
	// private void addEngineRelationshipTriplesToDelete(String engineName, IEngine
	// localMaster,
	// List<Object[]> deleteTriplesList) {
	...
	// + "{?anotherConceptConcept <http://semoss.org/ontologies/Relation/presentin>
	// <http://semoss.org/ontologies/meta/engine/" + engineName + ">}"
	// // relationship between the two nodes
	// + "{?conceptComposite ?rel ?anotherConceptConcept}"
	// // any inferencing crap that is associated with the relationship between the
	// nodes
	// + "{?rel ?anyPred ?anyObj}"
	// + "}";
	//
	// String query = "SELECT DISTINCT ?conceptComposite ?rel ?anotherConceptConcept
	// " +
	// whereStatement;
	// IRawSelectWrapper manager =
	// WrapperManager.getInstance().getRawWrapper(localMaster, query);
	...
	// * @param fromEngine
	// */
	// private void addEngineMetadataToDelete(String engineName, IEngine
	// localMaster, List<Object[]>
	// deleteTriplesList) {
	// String query = "SELECT DISTINCT ?engine ?anyPred ?anyObj WHERE {"
	// + "BIND(<http://semoss.org/ontologies/meta/engine/" + engineName + "> AS
	// ?engine) "
	...
	// * @param fromEngine
	// */
	// private void deleteEngineConceptsWithProperties(String engineName, IEngine
	// fromEngine)
	// {
	...
	//
	// LOGGER.info("TIME TO DELETE CONCEPTS W/ PROPERTIES ::: " + (endTime -
	// startTime) + " ms" );
	// }
	//
	// /**
	...
	// * @param fromEngine
	// */
	// private void deleteEngineConceptsWithoutProperties(String engineName, IEngine
	// fromEngine)
	// {
	// // delete concepts without properties
	// // need to delete logical
	...
	// long endTime = System.currentTimeMillis();
	//
	// LOGGER.info("TIME TO DELETE CONCEPTS W/O PROPERTIES ::: " + (endTime -
	// startTime) + " ms" );
	// }
	//
	// /**
	...
	// + "} WHERE { "
	// // make sure node is in the engine
	// + "{?conceptComposite ?in <http://semoss.org/ontologies/meta/engine/" +
	// engineName + ">}"
	// // make sure other node is in the engine
	// + "{?anotherConceptConcept ?in <http://semoss.org/ontologies/meta/engine/" +
	// engineName +
	// ">}"
	// // relationship between the two nodes
	...
	// long endTime = System.currentTimeMillis();
	//
	// LOGGER.info("TIME TO DELETE RELATIONSHIPS ::: " + (endTime - startTime) + "
	// ms" );
	// }
	//
	// // private
