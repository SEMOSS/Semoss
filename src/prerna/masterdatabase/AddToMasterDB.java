...
public class AddToMasterDB {
	...
	private LocalMasterConceptIdHash conceptIdHash = null;
	...
	public boolean registerEngineLocal(String smssFile, Properties prop, String engineId) {
		...
		try {
			...
			conceptIdHash = LocalMasterConceptIdHash.getInstance();
	...
	public boolean addMetadata(String engineId, String concept, String key, String value) {
		...
		String[] colNames = new String[] { Constants.LM_PHYSICAL_NAME_ID, Constants.LM_META_KEY,
