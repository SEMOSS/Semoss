...
public final class DIHelper {
	 ...
	 *
	 * @param coreProp
	 *            Properties Obtained list of core properties.
	 */
	 ...
	 *
	 * @param String
	 *            Key used to retrieve properties
	 ...
	 *            String Hash key.
	 * @param value
	 *            String Value mapped to specific key.
	 */
	...
	public Shape createStar() {
		...
		double points[][] = {{0 * x, -15 * x}, {4.5 * x, -5 * x}, {14.5 * x, -5 * x}, {7.5 * x, 3 * x},
				{10.5 * x, 13 * x}, {0 * x, 7 * x}, {-10.5 * x, 13 * x}, {-7.5 * x, 3 * x}, {-14.5 * x, -5 * x},
				{-4.5 * x, -5 * x}, {0, -15 * x}};
	...
	public Shape createStarL() {
		...
		// 10.5}, {2.2, 14},
		// {3.5, 9}, {0,5}, {5, 5}, {7.5, 0}};
		double points[][] = {{10, 0}, {13, 6.66}, {20, 6.66}, {14.66, 12}, {16.66, 18.66}, {10, 14}, {3.33, 18.66},
				{5.33, 12}, {0, 6.66}, {7, 6.66}, {10, 0}};
