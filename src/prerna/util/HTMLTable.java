...
public class HTMLTable {
	...
	// DIHelper.getInstance().setLocalProperty("92cf8a9f-c66d-4af1-ad9b-ef7a8f014dbe",
	// engine);
	// HardSelectQueryStruct qs = new HardSelectQueryStruct();
	// qs.setQuery("Select * From MOVIES LIMIT 10");
	// IRawSelectWrapper it = WrapperManager.getInstance().getRawWrapper(engine,
	// qs);
	//
	...
	// emailTable.setTdStyle("valign='middle' align='left' style='padding: 8px;
	// border: 1px solid
	// #cccccc;'");
	// emailTable.setTableNameStyle("style='margin: 0; margin-bottom: 4px; color:
	// #003E73;'");
