...
public class HTMLTable {
  ...
  private static final String SMSS_TABLE_STYLE =
      "style='border-collapse: collapse; border: 1px solid #d9d9d9; font-family: Arial, Helvetica, sans-serif; width: 100%; max-width: 600px;'";
  ...
  private static final String TABLE_NAME_STYLE =
      "style='font-family: Arial, Helvetica, sans-serif; margin: 0; margin-bottom: 4px; color: #5c5c5c;'";
  ...
  //		String engineProp =
  // "C:\\Users\\rramirezjimenez\\Documents\\workspace\\Semoss\\db\\movTst__92cf8a9f-c66d-4af1-ad9b-ef7a8f014dbe.smss";
  ...
  //		emailTable.setTableStyle("border='1' cellpadding='8' cellspacing='0'
  // style='border-collapse:collapse; border: 1px solid #cccccc;'");
  //		emailTable.setThStyle("style='padding: 8px; font-size: 14px; color: #ffffff;
  // background-color:#003E73; border: 1px solid #cccccc;'");
  //		emailTable.setTdStyle("valign='middle' align='left' style='padding: 8px; border: 1px solid
  // #cccccc;'");
