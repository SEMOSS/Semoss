...
public class JenaSesameUtils {
  ...
  public static org.openrdf.model.Literal asSesameLiteral(Literal theLiteral) {
    if (theLiteral == null) {
      ...
      return FACTORY.createLiteral(
          theLiteral.getLexicalForm(), FACTORY.createURI(theLiteral.getDatatypeURI()));
    } else {
   ...
   */
  public static org.apache.jena.rdf.model.Resource asJenaResource(
   ...
   */
  public static org.apache.jena.rdf.model.Literal asJenaLiteral(
    ...
    if (theLiteral == null) {
      ...
      return mInternalModel.createTypedLiteral(
          theLiteral.getLabel(), theLiteral.getDatatype().toString());
    } else {
  ...
  public static Statement asJenaStatement(org.openrdf.model.Statement theStatement) {
    return mInternalModel.createStatement(
