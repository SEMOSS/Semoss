...
public class ChromeDriverUtility {
  ...
  public static void captureImage(
      String feUrl, String url, String imagePath, String sessionId, Integer timeout) {
  ...
  public static Object makeChromeDriver(String feUrl, String url, int height, int width) {
    ...
    String customGoogleBinaryLocation =
        Utility.getDIHelperProperty(Constants.LOAD_BALANCER_COOKIE_NAME);
  ...
  public static void captureImagePersistent(
      Object driverObj,
      String feUrl,
      String url,
      String imagePath,
    ...
    if (driverObj instanceof ChromeDriver) driver = (ChromeDriver) driverObj;
  ...
  //		ChromeDriver driver =
  // (ChromeDriver)ChromeDriverUtility.makeChromeDriver("https://www.buzzfeed.com/hbraga/best-gifts-2020",
