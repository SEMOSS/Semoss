...
public interface ILdapAuthenticator extends Closeable {
  ...
  String LDAP_USE_CUSTOM_CONTEXT_FOR_PWD_CHANGE_KEY =
      LDAP_PREFIX + "use_custom_context_for_pwd_change";
  String LDAP_USE_CUSTOM_CONTEXT_FOR_PWD_USERNAME_KEY =
      LDAP_PREFIX + "use_custom_context_for_pwd_username";
  String LDAP_USE_CUSTOM_CONTEXT_FOR_PWD_PASSWORD_KEY =
      LDAP_PREFIX + "use_custom_context_for_pwd_password";
   ...
   * @throws Exception
   */
  DirContext createLdapContext(String providerUrl, String principalDN, String password)
      throws Exception;
   ...
   */
  ZonedDateTime getLastPwdChange(
   ...
   * @throws NamingException
   */
  List<AccessToken> findUsers(String searchContextName, String searchFilter, int searchContextScope)
      throws Exception;
}
