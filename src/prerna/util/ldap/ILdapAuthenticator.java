...
public interface ILdapAuthenticator extends Closeable {
	...
	// the key in the template where we will put the user input into the above
	// template
	 ...
	 * @throws Exception
	 */
	AccessToken generateAccessToken(Attributes attributes, String userDN, String attributeIdKey,
	 ...
	 */
	ZonedDateTime getLastPwdChange(Attributes attributes, String attributeLastPwdChangeKey,
