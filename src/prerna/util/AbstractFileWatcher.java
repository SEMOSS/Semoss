...
public abstract class AbstractFileWatcher implements Runnable, FilenameFilter {
	...
	@Override
	public void run() {
		classLogger.info("Starting Watcher Thread for type " + this.engineType + " with class "
				+ this.getClass().getName() + " with ID " + Thread.currentThread().getId());
		loadFirst();
	 ...
	 *
	 * @param arg0
	 *            File Folder in which the file was found.
	 * @param arg1
	 *            String Name of the file.
