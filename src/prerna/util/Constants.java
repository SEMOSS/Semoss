...
public class Constants {
  ...
  public static final String ENTER_SEARCH_DISABLED_TEXT =
      "Search is disabled for faster processing";
  ...
  public static final String DEFAULT_PROPERTY_URI =
  ...
  @Deprecated public static final String HIDDEN_DATABASE = "HIDDEN_DATABASE";
  ...
  public static final String NEIGHBORHOOD_PREDICATE_FINDER_QUERY =
      "NEIGHBORHOOD_PREDICATE_FINDER_QUERY";
  public static final String NEIGHBORHOOD_PREDICATE_ALT2_FINDER_QUERY =
      "NEIGHBORHOOD_PREDICATE_ALT2_FINDER_QUERY";
  public static final String NEIGHBORHOOD_PREDICATE_ALT3_FINDER_QUERY =
      "NEIGHBORHOOD_PREDICATE_ALT3_FINDER_QUERY";
  ...
  public static final String TRANSITION_COST_INSERT_WITH_OVERHEAD =
      "TRANSITION_COST_INSERT_WITH_OVERHEAD";
  public static final String TRANSITION_COST_INSERT_WITHOUT_OVERHEAD =
      "TRANSITION_COST_INSERT_WITHOUT_OVERHEAD";
  public static final String TRANSITION_COST_DELETE = "TRANSITION_COST_DELETE";
  public static final String TRANSITION_COST_INSERT_SITEGLITEM =
      "TRANSITION_COST_INSERT_SITEGLITEM";
  public static final String TRANSITION_QUERY_SEPARATOR = "&";
  public static final String TRANSITION_COST_INSERT_SUSTAINMENT =
  ...
  public static final String TRANSITION_DATA_FEDERATION_PHASE_INDEPENDENT =
      "TRANSITION_DATA_FEDERATION_PHASE_INDEPENDENT";
  ...
  public static final String TRANSITION_SPECIFIC_DATA_CONSUMER =
      "TRANSITION_SPECIFIC_DATA_CONSUMER";
  ...
  public static final String TRANSITION_SPECIFIC_SITE_CONSUMER =
      "TRANSITION_SPECIFIC_SITE_CONSUMER";
  ...
  public static final String SOA_TRANSITION_ALL_GENERIC_DATA_QUERY =
      "SOA_TRANSITION_ALL_GENERIC_DATA_QUERY";
  public static final String SOA_TRANSITION_ALL_GENERIC_BLU_QUERY =
      "SOA_TRANSITION_ALL_GENERIC_BLU_QUERY";
  ...
  public static final String EXPORT_LOAD_SHEET_SUBJECT_NODE_TYPE_COMBOBOX =
      "subjectNodeTypeComboBox";
  public static final String EXPORT_LOAD_SHEET_OBJECT_NODE_TYPE_COMBOBOX = "objectNodeTypeComboBox";
  public static final String EXPORT_LOAD_SHEET_NODE_RELATIONSHIP_COMBOBOX =
      "nodeRelationshipComboBox";
  ...
  @Deprecated public static final String PIXEL_UPDATE = "PIXEL_UPDATE";
  ...
  @Deprecated public static final String MAX_INPUT_TOKENS = "MAX_INPUT_TOKENS";
  ...
  public static final String LEAK_DETECTION_THRESHOLD_MILLISECONDS =
      "LEAK_DETECTION_THRESHOLD_MILLISECONDS";
   ...
   * This level includes the prohibitions in <code>TRANSACTION_REPEATABLE_READ</code> and further
   * prohibits the situation where one transaction reads all rows that satisfy a <code>WHERE</code>
   * condition, a second transaction inserts a row that satisfies that <code>WHERE</code> condition,
  ...
  public static final String AUTO_GENERATE_INSIGHTS_FOR_ENGINE_COMBOBOX =
      "autoGenerateQueriesForEngineSelector";
  ...
  // this is so in the server.xml you can update the access-log to contain the userid by adding:
  // %{log_semoss_user_id}s
  ...
  @Deprecated public static final String ADMIN_SET_PUBLISHER = "admin-set-publisher";
  ...
  public static final String ADMIN_ONLY_PROJECT_SET_DISCOVERABLE =
  ...
  public static final String ADMIN_ONLY_MODEL_SET_DISCOVERABLE =
  ...
  public static final String ADMIN_ONLY_STORAGE_SET_DISCOVERABLE =
  ...
  public static final String ADMIN_ONLY_VECTOR_SET_DISCOVERABLE =
  ...
  public static final String ADMIN_ONLY_FUNCTION_SET_DISCOVERABLE =
  ...
  @Deprecated public static final String PIPELINE_LANDING_FILTER = "PIPELINE_LANDING_FILTER";
  @Deprecated public static final String PIPELINE_SOURCE_FILTER = "PIPELINE_SOURCE_FILTER";
  ...
  // RDBMS specific
  public static final String USE_OUTER_JOINS =
      "USE_OUTER_JOINS"; // if present and true use outer joins instead of inner joins
  public static final String USE_CONNECTION_POOLING = "USE_CONNECTION_POOLING";
  public static final String H2_BASE_CONNECTION_URL =
      "jdbc:h2:@"
  ...
  public static final String RDBMS_INSIGHTS_CONNECTION_URL_END =
      "RDBMS_INSIGHTS_CONNECTION_URL_END";
  ...
  public static final String PM_SEMOSS_EXECUTE_SQL_ENCRYPTION_PASSWORD =
  ...
  public static final String[] COLOR_SEMOSS = {
    "#4FA4DE", "#5E61E3", "#ffe750", "#FFB350", "#f7724a", "#F54D83", "#9C25E1", "#1A936F",
    "#88D498", "#BDC3C7"
  };
  ...
  // model
  @Deprecated public static final String KEEP_CONTEXT = "KEEP_CONTEXT";
  ...
  public static final String CUSTOM_DOCUMENT_PROCESSOR_FUNCTION_ID =
  ...
  public static final String USER_TOKEN_LIMIT_EXCEEDED_MESSAGE =
      "Token limit exceeded for user level : You have used %d tokens, but the limit is %d";
  public static final String USER_RESPONSE_TIME_LIMIT_EXCEEDED_MESSAGE =
      "Response time limit exceeded for user level : You have reached %.2f seconds, but the limit is %.2f seconds.";
  public static final String ENGINE_TOKEN_LIMIT_EXCEEDED_MESSAGE =
      "Token limit exceeded for engine level: You have used %d tokens, but the limit is %d";
  public static final String ENGINE_RESPONSE_TIME_LIMIT_EXCEEDED_MESSAGE =
      "Response time limit exceeded for engine level : You have reached %.2f seconds, but the limit is %.2f seconds.";

  // External Permission Management
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_ENABLED =
      "EXTERNAL_PERMISSION_MANAGEMENT_ENABLED";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_URL =
      "EXTERNAL_PERMISSION_MANAGEMENT_URL";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_AUTH_USERNAME =
      "EXTERNAL_PERMISSION_MANAGEMENT_AUTH_USERNAME";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_AUTH_PASSWORD =
      "EXTERNAL_PERMISSION_MANAGEMENT_AUTH_PASSWORD";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_REQUEST_KEY =
      "EXTERNAL_PERMISSION_MANAGEMENT_REQUEST_KEY";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_RESPONSE_JMES_PATH =
      "EXTERNAL_PERMISSION_MANAGEMENT_RESPONSE_JMES_PATH";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_ENGINEID =
      "EXTERNAL_PERMISSION_MANAGEMENT_ENGINEID";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_ENGINENAME =
      "EXTERNAL_PERMISSION_MANAGEMENT_ENGINENAME";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_ENGINETYPE =
      "EXTERNAL_PERMISSION_MANAGEMENT_ENGINETYPE";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_ENGINESUBTYPE =
      "EXTERNAL_PERMISSION_MANAGEMENT_ENGINESUBTYPE";

  public static final String EXTERNAL_PERMISSION_MANAGEMENT_DEFAULT_ENGINE_TYPE =
      "EXTERNAL_PERMISSION_MANAGEMENT_DEFAULT_ENGINE_TYPE";
  public static final String EXTERNAL_PERMISSION_MANAGEMENT_DEFAULT_PERMISSION =
      "EXTERNAL_PERMISSION_MANAGEMENT_DEFAULT_PERMISSION";

  // External Database OWL Metadata
  public static final String EXTERNAL_DATABASE_MANAGEMENT_ENABLED =
      "EXTERNAL_DATABASE_MANAGEMENT_ENABLED";
  public static final String EXTERNAL_DATABASE_MANAGEMENT_URL = "EXTERNAL_DATABASE_MANAGEMENT_URL";
  public static final String EXTERNAL_DATABASE_MANAGEMENT_AUTH_USERNAME =
      "EXTERNAL_DATABASE_MANAGEMENT_AUTH_USERNAME";
  public static final String EXTERNAL_DATABASE_MANAGEMENT_AUTH_PASSWORD =
      "EXTERNAL_DATABASE_MANAGEMENT_AUTH_PASSWORD";
  public static final String EXTERNAL_DATABASE_MANAGEMENT_REQUEST_KEY =
      "EXTERNAL_DATABASE_MANAGEMENT_REQUEST_KEY";
  public static final String EXTERNAL_DATABASE_MANAGEMENT_RESPONSE_JMES_PATH =
      "EXTERNAL_DATABASE_MANAGEMENT_RESPONSE_JMES_PATH";
  public static final String EXTERNAL_DATABASE_MANAGEMENT_TABLENAME =
      "EXTERNAL_DATABASE_MANAGEMENT_TABLENAME";
  public static final String EXTERNAL_DATABASE_MANAGEMENT_COLUMNNAME =
      "EXTERNAL_DATABASE_MANAGEMENT_COLUMNNAME";
  public static final String EXTERNAL_DATABASE_MANAGEMENT_DATATYPE =
      "EXTERNAL_DATABASE_MANAGEMENT_DATATYPE";
  ...
  public static final String ADMIN_ONLY_NON_APPROVED_PROD_ITEM =
