...
public class UnsavedInsightAdapter extends TypeAdapter<Insight> {
  ...
  /**
   * Can set to cache all the values except the frames This is useful for the {@link
   * CopyInsightReactor} where we copy the insight but only a subset of the data
   *
   * @param cacheFrames
   */
  ...
  /**
   * This will only return a value when you call the write to return the frames in the insight
   *
   * @return
   */
