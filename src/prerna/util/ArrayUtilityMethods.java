...
public final class ArrayUtilityMethods {
	 ...
	 * @param startRow
	 *            The first row you want returned from the dataMatrix, inclusive
	 * @param endRow
	 *            The last row you want returned from the dataMatrix, exclusive
	 ...
	 *            The array of indices to keep in the dataMatrix
	 ...
	 *
	 * @param dataMatrix
	 *            The main dataMatrix you plan on taking a section from
	 * @param positionsToRemove
	 *            The array of indices to remove from the dataMatrix
