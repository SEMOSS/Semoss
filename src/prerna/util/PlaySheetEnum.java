...
public enum PlaySheetEnum {
	...
	Clustering("Clustering", "prerna.ui.components.playsheets.ClusteringPlaySheet", "ClusteringPlaySheet Hint: numClusters;SELECT ?instance ?categoricalProp ?numericalProp WHERE { ... }"),
