...
public final class UploadUtilities {
  ...
  public static final String EXPLORE_INSIGHT_INSIGHT_NAME =
      "Explore an instance of a selected node type";
  ...
  public static final String AUDIT_MODIFICATION_VIEW_INSIGHT_NAME =
      "What are the modifications made to specific column(s)?";
  public static final String AUDIT_MODIFICATION_VIEW_LAYOUT = "Bar";

  public static final String AUDIT_TIMELINE_INSIGHT_NAME =
   ...
   * @param smssFile
   */
  public static void updateDIHelper(
      String newEngineId, String newEngineName, IEngine engine, File smssFile) {
    DIHelper.getInstance()
        .setEngineProperty(newEngineId + "_" + Constants.STORE, smssFile.getAbsolutePath());
  ...
  /**
   * Validate the engine name Does validation that: 1) The input is not null/empty 2) That the
   * database folder doesn't exist in the file directory
   *
   * @param engineName
   * @throws IOException
   */
  public static void validateEngine(
      IEngine.CATALOG_TYPE engineType, User user, String engineName, String engineId)
      throws IOException {
    ...
    String engineLocation =
        EngineUtility.getSpecificEngineBaseFolder(engineType, engineId, engineName);
    File engineFolder = new File(engineLocation);
    if (engineFolder.exists()) {
      throw new IOException(
          "Engine folder already contains a directory with the same name. "
   ...
   * @return
   */
  public static File generateSpecificEngineFolder(
      IEngine.CATALOG_TYPE engineType, String engineId, String engineName) {
    String specificEngineLocation =
        EngineUtility.getSpecificEngineBaseFolder(engineType, engineId, engineName);
   ...
   * @return
   */
  public static File generateOwlFile(
      IEngine.CATALOG_TYPE engineType, String engineId, String engineName) {
    String owlLocation =
        EngineUtility.getSpecificEngineAssetsFolder(engineType, engineId, engineName) + "/";
    if (engineName != null) {
   ...
   * @param logicalNames
   */
  public static void insertOwlMetadataToGraphicalEngine(
      WriteOWLEngine owlEngine,
      Map<String, List<String>> nodeProps,
   ...
   * @param logicalNames
   */
  public static void insertFlatOwlMetadata(
      WriteOWLEngine owlEngine,
      String tableName,
      String[] headers,
      Map<String, String> descriptions,
   ...
   * @throws IOException
   */
  public static File createTemporaryRdbmsSmss(
      String databaseId, String databaseName, File owlFile, RdbmsTypeEnum rdbmsType, String file)
      throws IOException {
    String dbTempSmssLoc =
        getEngineTempSmssLoc(IEngine.CATALOG_TYPE.DATABASE, databaseId, databaseName);
    ...
    try (FileWriter writer = new FileWriter(dbTempSmss);
      ...
      writeDefaultDatabaseSettings(
          bufferedWriter, databaseId, databaseName, owlFile, dbClassName, newLine, tab);
   ...
   * @throws IOException
   */
  public static File generateTemporaryTinkerSmss(
      String databaseId,
      String databaseName,
      File owlFile,
      TinkerEngine.TINKER_DRIVER tinkerDriverType)
      throws IOException {
    String dbTempSmssLoc =
        getEngineTempSmssLoc(IEngine.CATALOG_TYPE.DATABASE, databaseId, databaseName);
    ...
    try (FileWriter writer = new FileWriter(dbTempSmssLoc);
      ...
      if (tinkerDriverType == TinkerEngine.TINKER_DRIVER.NEO4J) {
        ...
        bufferedWriter.write(
            Constants.TINKER_FILE + tinkerFilePath + "." + tinkerDriverType + "\n");
      }
   ...
   * @throws IOException
   */
  public static File createTemporaryRdfSmss(
      IEngine thisEngine, String databaseId, String databaseName, File owlFile, String baseUri)
      throws IOException {
    String dbTempSmssLoc =
        getEngineTempSmssLoc(IEngine.CATALOG_TYPE.DATABASE, databaseId, databaseName);
    ...
    try (FileWriter writer = new FileWriter(dbTempSmssLoc);
      ...
      if (dbClassName.endsWith("BigDataEngine")) {
        ...
        String jnlName =
            Constants.DATABASE_FOLDER
                + DIR_SEPARATOR
                + SmssUtilities.ENGINE_REPLACEMENT
                + DIR_SEPARATOR
                + databaseName
                + ".jnl";
        jnlName =
            jnlName.replace('\\', '/'); // Needed as prop file cannot contain single back slash
   ...
   * @throws IOException
   */
  public static File generateTemporaryJanusGraphSmss(
      String databaseId,
      String databaseName,
      File owlFile,
      String janusConfPath,
   ...
   * @throws IOException
   */
  public static File generateTemporaryExternalTinkerSmss(
      String databaseId,
      String databaseName,
      File owlFile,
      String tinkerFilePath,
   ...
   * @throws IOException
   */
  public static File generateTemporaryDatastaxSmss(
      String databaseId,
      String databaseName,
      File owlFile,
      String host,
    ...
    try (FileWriter writer = new FileWriter(dbTempSmssLoc);
      ...
      writeDefaultDatabaseSettings(
          ...
          databaseName,
          owlFile,
          DataStaxGraphEngine.class.getName(),
          newLine,
          tab);
   ...
   * @throws IOException
   */
  public static File generateTemporaryExternalNeo4jSmss(
      String databaseId,
      String databaseName,
      File owlFile,
   ...
   * @throws IOException
   */
  public static File generateTemporaryEmbeddedNeo4jSmss(
      String databaseId,
      String databaseName,
      File owlFile,
      String filePath,
   ...
   * @throws SQLException
   */
  public static File createTemporaryExternalRdbmsSmss(
      String databaseId,
      String databaseName,
      File owlFile,
      String dbClassName,
      RdbmsTypeEnum dbType,
      String connectionUrl,
      Map<String, Object> connectionDetails,
      Map<String, Object> jdbcPropertiesMap)
   ...
   * @throws IOException
   */
  public static File createTemporaryRSmss(
      String databaseId,
      String databaseName,
      File owlFile,
      String fileName,
    ...
    try (FileWriter writer = new FileWriter(dbTempSmss);
      ...
      writeDefaultDatabaseSettings(
          bufferedWriter, databaseId, databaseName, owlFile, engineClassName, newLine, tab);
      String dataFile =
          "db" + DIR_SEPARATOR + SmssUtilities.ENGINE_REPLACEMENT + DIR_SEPARATOR + fileName;
      bufferedWriter.write(
          AbstractDatabaseEngine.DATA_FILE + tab + dataFile.replace('\\', '/') + newLine);
      // stringify maps
      Gson gson = new GsonBuilder().create();
   ...
   * @throws IOException
   */
  public static File createTemporaryStorageSmss(
      String engineId, String engineName, String className, Map<String, Object> properties)
      throws IOException {
    return createTemporaryEngineSmss(
        IEngine.CATALOG_TYPE.STORAGE, engineId, engineName, className, properties);
  }
   ...
   * @throws IOException
   */
  public static File createTemporaryModelSmss(
      String engineId, String engineName, String className, Map<String, Object> properties)
      throws IOException {
    return createTemporaryEngineSmss(
        IEngine.CATALOG_TYPE.MODEL, engineId, engineName, className, properties);
  }
   ...
   * @throws IOException
   */
  public static File createTemporaryVectorDatabaseSmss(
      String engineId, String engineName, String className, Map<String, Object> properties)
      throws IOException {
    return createTemporaryEngineSmss(
        IEngine.CATALOG_TYPE.VECTOR, engineId, engineName, className, properties);
  }
   ...
   * @throws IOException
   */
  public static File createTemporaryFunctionSmss(
      String engineId, String engineName, String className, Map<String, Object> properties)
      throws IOException {
    return createTemporaryEngineSmss(
        IEngine.CATALOG_TYPE.FUNCTION, engineId, engineName, className, properties);
  }
   ...
   * @throws IOException
   */
  public static File createTemporaryVenvSmss(
      String engineId, String engineName, String className, Map<String, Object> properties)
      throws IOException {
    return createTemporaryEngineSmss(
        IEngine.CATALOG_TYPE.VENV, engineId, engineName, className, properties);
  }
   ...
   * @throws IOException
   */
  public static File createTemporaryEngineSmss(
   ...
   * @return
   */
  private static String getEngineTempSmssLoc(
      IEngine.CATALOG_TYPE engineType, String engineId, String engineName) {
   ...
   * @throws IOException
   */
  private static void writeDefaultEngineSettings(
  ...
  /**
   * Writes the shared properties across majority of databases. This includes: 1) database Name 2)
   * database Type 3) OWL file location
   *
   * @param bufferedWriter
   * @param databaseName
   * @param owlFile
   ...
   * @throws IOException
   */
  private static void writeDefaultDatabaseSettings(
      BufferedWriter bufferedWriter,
      String databaseId,
      String databaseName,
      File owlFile,
   ...
   * @return
   */
  public static String getInsightName(
      String databaseOrProjectName, String tableName, String baseName) {
    return databaseOrProjectName + " - " + baseName;
  }
   ...
   */
  public static Map<String, Object> addExploreInstanceInsight(
      String projectId,
      String projectName,
      String databaseId,
      String databaseName,
    ...
    if (exploreF.exists()) {
      String newPixel =
          "META | AddPanel(0); META | Panel ( 0 ) | SetPanelView ( \"param\" , \"<encode> {\"json\":";
      try {
        newPixel +=
            new String(Files.readAllBytes(exploreF.toPath()))
                .replaceAll("\n|\r|\t", "")
                .replaceAll("\\s\\s+", "")
        ...
        String schemaName =
            SecurityInsightUtils.makeInsightSchemaNameUnique(projectId, insightName);

        String insightId =
            admin.addInsight(
                insightName,
                EXPLORE_INSIGHT_LAYOUT,
                pixelRecipeToSave,
                global,
                cacheable,
                cacheMinutes,
        ...
        MosfetSyncHelper.makeMosfitFile(
            projectId,
            projectName,
            insightId,
            insightName,
        ...
        GitRepoUtils.commitAddedFiles(
            gitFolder, GitUtils.getDateMessage("Saved " + insightName + " insight on"));
  ...
  public static Map<String, Object> addInsightUsageStats(
      String projectId, String projectName, RDBMSNativeEngine insightEngine) {
    InsightAdministrator admin = new InsightAdministrator(insightEngine);
    List<String> pixelRecipeToSave = new ArrayList<>();
    ...
    pixelRecipeToSave.add(
        "useageFrame = InsightUsageStatistics ( project = [ \""
            + projectId
            + "\" ] , panel = [ \"0\" ] ) ;");
    pixelRecipeToSave.add(
    ...
    try {
      ...
      List<String> tags = null;
      String schemaName =
          SecurityInsightUtils.makeInsightSchemaNameUnique(
              projectId, INSIGHT_USAGE_STATS_INSIGHT_NAME);

      String insightId =
          admin.addInsight(
              INSIGHT_USAGE_STATS_INSIGHT_NAME,
              INSIGHT_USAGE_STATS_LAYOUT,
              pixelRecipeToSave,
              global,
              cacheable,
              cacheMinutes,
   ...
   * @return String containing the new insight id
   */
  public static Map<String, Object> addGridDeltaInsight(
      String projectId,
      String projectName,
      String databaseId,
      String databaseName,
    ...
    List<String> pixelRecipeToSave = new ArrayList<>();
    pixelRecipeToSave.add(
        "META | AddPanel(0); META | Panel(0) | SetPanelView(\"grid-delta\",\"<encode>{\"database\":\""
            + databaseId
            + "\"}</encode>\");");
   ...
   * @param insightEngine
   */
  public static Map<String, Object> addAuditModificationView(
      String projectId,
      String projectName,
      String databaseId,
      String databaseName,
    ...
    if (jsonFile.exists()) {
      ...
      try {
        ...
        String insightId =
            admin.addInsight(
                insightName,
                AUDIT_MODIFICATION_VIEW_LAYOUT,
                pixelRecipeToSave,
                global,
                cacheable,
                cacheMinutes,
   ...
   * @param insightEngine
   */
  public static Map<String, Object> addAuditTimelineView(
      String projectId,
      String projectName,
      String databaseId,
      String databaseName,
   ...
   * @return
   */
  public static Map<String, Object> addInsertFormInsight(
      String projectId,
      String projectName,
      String databaseId,
      String databaseName,
      ...
      String[] headers) {
    InsightAdministrator admin = new InsightAdministrator(insightEngine);
    Map<String, Map<String, SemossDataType>> metamodel =
        getExistingMetamodel(Utility.getDatabase(databaseId).getOWLEngineFactory().getReadOWL());
    ...
    String newPixel =
        "META | AddPanel(0); META | Panel(0) | SetPanelView(\""
            + INSERT_FORM_LAYOUT
            + "\", \"<encode>{\"json\":"
   ...
   */
  public static Map<String, Object> addInsertFormInsight(
      RDBMSNativeEngine insightDatabase,
      String projectId,
      String projectName,
      String databaseId,
      String databaseName,
   ...
   * @return
   */
  public static Map<String, Map<String, SemossDataType>> getExistingMetamodel(
      AbstractOWLEngine helper) {
   ...
   * @return
   */
  public static Map<String, Object> createInsertForm(
      String databaseId,
  ...
  public static Map<String, Object> createUpdateMap(
      String appId, String concept, Map<String, SemossDataType> propMap) {
   ...
   * @return
   */
  public static CSVFileHelper getHelper(
   ...
   * @return
   */
  public static Object[] getHeadersAndTypes(
    ...
    if (dataTypesMap == null || dataTypesMap.isEmpty()) {
      Map[] retMap =
          FileHelperUtil.generateDataTypeMapsFromPrediction(headers, helper.predictTypes());
   ...
   * @return
   */
  public static boolean createPropFile(
      String databaseId, String databaseName, String csvFilePath, Map<String, Object> metamodel) {
  ...
  public static Map<String, Object> getEngineReturnData(User user, String engineId) {
    List<Map<String, Object>> baseInfo =
        SecurityEngineUtils.getUserEngineList(user, engineId, null);
