...
public class SystemDefaultEngines {
	...
	private static final List<String> APP_BUILDER_SKILLS = List.of(Constants.SKILL_AGENT_RUN,
			...
			Constants.SKILL_MODEL, Constants.SKILL_PAGINATION, Constants.SKILL_PERMISSIONS, Constants.SKILL_PYTHON,
	...
	private static final List<String> SYSTEM_MCPS = List.of(Constants.MCP_APP_FILESYSTEM,
			Constants.MCP_BROWSER_AUTOMATION, Constants.MCP_DATABASE_MAKER, Constants.MCP_MEMORY,
			Constants.MCP_NODE_BUILDER, Constants.MCP_REACTOR_HELP, Constants.MCP_ROOM_FILESYSTEM);
	...
	private static final List<String> SYSTEM_AGENTS = List.of(Constants.AGENT_APP_BUILDER, Constants.AGENT_PPTX,
