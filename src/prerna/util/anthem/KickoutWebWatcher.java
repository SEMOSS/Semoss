...
public class KickoutWebWatcher extends AbstractKickoutWebWatcher {
	...
	public KickoutWebWatcher() {
		...
		timeDbName = DIHelper.getInstance().getProperty("ANTHEM_KICKOUT_TIME_DB_NAME");
	...
	protected void ingestMetadataIntoSeparateDB(Map<String, String> valueMap, Map<String, String> typeMap, boolean createIndexes) {
		...
		options.setRDBMSDriverType(dbType); // TODO implement MariaDB
