  ...
  public NounMetadata execute() {
    ...
    File usersim =
        new File(
            baseFolder
                ...
                + "Recommendations"
                + DIR_SEPARATOR
                + "dataitem-usersim.rds");
    if (!itemsim.exists() || !usersim.exists()) {
      String message =
          "Necessary files missing to generate recommendations. Please run UpdateQueryData().";
      NounMetadata noun =
    ...
    if (rJavaTranslator.checkPackages(packages, logger) && user != null) {
      ...
      if (communityJson != null) {
        Gson gson = new Gson();
        ArrayList<HashMap<String, ArrayList<String>>> myList =
            gson.fromJson(
                communityJson,
                new TypeToken<ArrayList<HashMap<String, ArrayList<String>>>>() {}.getType());
        ...
        for (int i = 0; i < myList.size(); i++) {
          ...
          for (String key : map.keySet()) {
            ...
            ArrayList<HashMap<String, Object>> convertedMembers =
      ...
      if (userSpecificJson != null) {
        Gson gson = new Gson();
        ArrayList<Map<String, String>> recList =
            gson.fromJson(
                userSpecificJson, new TypeToken<ArrayList<HashMap<String, String>>>() {}.getType());
