...
public class Settings {
	...
	public static final String LOAD_DB_ON_SOCKET = "LOAD_DB_ON_SOCKET"; // load the db again on the socket side or give
	...
	public static final String REQUIREMENTS = "REQUIREMENTS"; // this is a JSON of all the requirements for a SMSS
																// engine like GPU
	// requirement etc. etc.

	// FOR REMOTE CLIENTS
	public static final String MODEL = "MODEL"; // The short name for a model.. Can't use the HuggingFace model repo id
												// here due to
	// naming restrictions on kubernetes resources
	...
	public static final String LOGGER_LEVEL = "LOGGER_LEVEL"; // the python logger level — DEBUG, INFO, WARNING, or
																// CRITICAL
}
