...
public final class DHMSMTransitionUtility {
	...
	public static final String LPI_SYS_QUERY = "SELECT DISTINCT ?entity WHERE { {?entity <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem>}{?entity <http://semoss.org/ontologies/Relation/Contains/Device> 'N'}{?entity <http://semoss.org/ontologies/Relation/Contains/Disposition> 'LPI'}{?entity <http://semoss.org/ontologies/Relation/Contains/Review_Status> ?Review_Status}FILTER (?Review_Status in('FAC Approved','FCLG Approved')) }";
	public static final String SYS_TYPE_QUERY = "SELECT DISTINCT ?entity ?Disposition WHERE { {?entity <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://semoss.org/ontologies/Concept/ActiveSystem>} {?entity <http://semoss.org/ontologies/Relation/Contains/Device> 'N'}{?entity <http://semoss.org/ontologies/Relation/Contains/Disposition> ?Disposition}{?entity <http://semoss.org/ontologies/Relation/Contains/Review_Status> ?Review_Status}FILTER (?Review_Status in('FAC Approved','FCLG Approved')) }";
...
//	}
	...
	public static Map<String, Map<String, String>> getProviderFutureICDFrequency(IEngine engine) {
		return runFutureICDFreq(engine, DETERMINE_PROVIDER_FUTURE_ICD_FREQUENCY);
	}

	public static Map<String, Map<String, String>> getConsumerFutureICDFrequency(IEngine engine) {
		return runFutureICDFreq(engine, DETERMINE_CONSUMER_FUTURE_ICD_FREQUENCY);
	}
	
	public static Map<String, Map<String, String>> runFutureICDFreq(IEngine engine, String query) {
		/*
	 ...
	 */
	public static String[] getExistingIcdRelUris(IEngine engine, String systemInterfaceUri) {
