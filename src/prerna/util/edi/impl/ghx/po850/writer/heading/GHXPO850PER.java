...
public class GHXPO850PER implements IPO850PER {
	...
	public String generateX12(String elementDelimiter, String segmentDelimiter) {
		...
		String builder = "PER" + elementDelimiter + per01 + elementDelimiter + per02 + elementDelimiter + per03
				+ elementDelimiter + per04 + elementDelimiter + per05 + elementDelimiter + per06 + segmentDelimiter;
	...
	public static void main(String[] args) {
		GHXPO850PER per = new GHXPO850PER().setContactFunctionCode("BD") // 1 - BD=Buyer Name
