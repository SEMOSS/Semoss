...
public class PO850N4 implements IX12Format {
	...
	public String generateX12(String elementDelimiter, String segmentDelimiter) {
		String builder = "N4" + elementDelimiter + n401 + elementDelimiter + n402 + elementDelimiter + n403
				+ elementDelimiter + n404 + segmentDelimiter;
	...
	public static void main(String[] args) {
		PO850N4 n4 = new PO850N4().setCity("Anchorage").setState("AK").setZip("99504").setCountryCode("US");
