...
public class GHXPO850 implements IPO850 {
	...
	public static void main(String[] args) {
		...
		po850.setIsa(new GHXPO850ISA().setAuthorizationInfoQualifier("00") // 1
				...
				.addFunctionalGroup(new GHXPO850FunctionalGroup().setGs(new GHXPO850GS().setSenderId("SENDER1234") // 2
						.setReceiverId("RECEIVER12") // 3
						.setDateAndTime(now) // 4, 5
						.setGroupControlNumber("001") // 6
				).addTransactionSet(
						new GHXPO850TransactionSet().setSt(new GHXPO850ST().setTransactionSetControlNumber("0001"))
								.setBeg(new GHXPO850BEG().setPurchaseOrderTypeCode(PO850BEGQualifierIdEnum.NE)
										.setTransactionPurposeCode("00") // 1
										.setPurchaseOrderNumber("RequestID-001") // 3
										.setDateAndTime(now))
								.setRef(new GHXPO850REF().setReferenceIdQualifier("ZZ") // 1
										.setReferenceId("NCRT-Demo"))
								.setPer(new GHXPO850PER().setContactFunctionCode("BD") // 1 - BD=Buyer Name
										.setContactName("Maher Khalil") // 2
										.setTelephone("(202)222-2222") // 4
										.setEmail("mahkhalil@deloitte.com") // 6
								)
								.setN1loop(new PO850N1Loop()
										.addN1Group(new PO850N1Entity().setN1(new PO850N1().setEntityCode("ST") // 1 -
																												// ship
																												// to
												...
												.setN4(new PO850N4().setCity("Anchorage").setState("AK").setZip("99504")
														.setCountryCode("US")))
										.addN1Group(new PO850N1Entity().setN1(new PO850N1().setEntityCode("SE") // 1 -
																												// selling
																												// party
												...
												.setN4(new PO850N4().setCity("Chester").setState("VA").setZip("23836")
														.setCountryCode("US"))))
								.setPo1loop(new PO850PO1Loop().addPO1(new PO850PO1Entity()
										.setPo1(new PO850PO1().setUniqueId("1") // 1 - unique id
										...
										.addPO1(new PO850PO1Entity().setPo1(new PO850PO1().setUniqueId("2") // 1 -
																											// unique id
												...
												.setPid(new PO850PID().setItemDescription(
														"PIN SKULL ADULT DISPO SS 3/PK 12/BX, FOB (Destination), Manufacturer (BECTON, DICKINSON AND COMPANY); BOX of 12"))))
								.calculateCtt().calculateSe())
						.calculateGe())
				.setIea(new GHXPO850IEA().setTotalGroups(po850.getFunctionalGroups().size() + "")
