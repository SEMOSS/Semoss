                                ...
                                .addN1Group(
                                    new PO850N1Entity()
                                        ...
                                        .setN3(
                                            new PO850N3()
                                                .setAddressInfo1(
                                                    "1900 Meadowville Technology Pkwy"))
                                        .setN4(
                                            new PO850N4()
                                                .setCity("Chester")
                                                .setState("VA")
                                    ...
                                    new PO850PO1Entity()
                                        .setPo1(
                                            new PO850PO1()
                                                ...
                                                .addQualifierAndValue(
                                                    PO850PO1QualifierIdEnum.VC, "BXTS1040")
                                                .addQualifierAndValue(
                                                    PO850PO1QualifierIdEnum.IN, "299176"))
                                        .setPid(
                                            new PO850PID()
                                                .setItemDescription(
                                    ...
                                    new PO850PO1Entity()
                                        .setPo1(
                                            new PO850PO1()
                                                ...
                                                .addQualifierAndValue(
                                                    PO850PO1QualifierIdEnum.VC, "VMRM1535")
                                                .addQualifierAndValue(
                                                    PO850PO1QualifierIdEnum.IN, "299188"))
                                        .setPid(
                                            new PO850PID()
                                                .setItemDescription(
