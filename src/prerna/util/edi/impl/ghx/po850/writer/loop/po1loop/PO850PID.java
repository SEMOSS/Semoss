...
public class PO850PID implements IX12Format {
	...
	public String generateX12(String elementDelimiter, String segmentDelimiter) {
		...
		String builder = "PID" + elementDelimiter + pid01 + elementDelimiter + pid02 + elementDelimiter + pid03
				+ elementDelimiter + pid04 + elementDelimiter + pid05 + segmentDelimiter;
	...
	public static void main(String[] args) {
		PO850PID pid = new PO850PID().setItemDescription(
