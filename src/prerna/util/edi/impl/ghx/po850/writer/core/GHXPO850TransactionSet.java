...
public class GHXPO850TransactionSet implements IPO850TransactionSet {
	...
	public GHXPO850TransactionSet calculateSe() {
		...
		this.se.setTotalSegments((1 // sf
				+ 1 // beg
				+ 1 // ref
				+ 1 // per
				+ n1loop.getNumSegments() + po1loop.getNumSegments() + 1 // ctt
				+ 1 // se
		) + "");
	...
	public GHXPO850TransactionSet calculateCtt() {
		...
		this.ctt = new GHXPO850CTT().setNumPO1Segments(numPo1).setSumPO102Qualities(sumPo101);
		return this;
	}
	...
	public static void main(String[] args) {
		...
		GHXPO850TransactionSet st = new GHXPO850TransactionSet()
				.setSt(new GHXPO850ST().setTransactionSetControlNumber("0001"))
				...
				.setRef(new GHXPO850REF().setReferenceIdQualifier("ZZ") // 1
				...
				).setN1loop(new PO850N1Loop().addN1Group(new PO850N1Entity().setN1(new PO850N1().setEntityCode("ST") // 1
																														// -
																														// ship
																														// to
						...
						.setN4(new PO850N4().setCity("Anchorage").setState("AK").setZip("99504").setCountryCode("US")))
						.addN1Group(new PO850N1Entity().setN1(new PO850N1().setEntityCode("SE") // 1 - selling party
								.setName("MEDLINE") // 2 - name
								.setIdentificationCodeQualifier("91") // 3 - 91=assigned by seller
								.setIdentificationCode("MEDLINE-DEMO-ID"))
								.setN3(new PO850N3().setAddressInfo1("1900 Meadowville Technology Pkwy"))
								.setN4(new PO850N4().setCity("Chester").setState("VA").setZip("23836")
										.setCountryCode("US"))))
				.setPo1loop(new PO850PO1Loop().addPO1(new PO850PO1Entity().setPo1(new PO850PO1().setUniqueId("1") // 1 -
																													// unique
																													// id
						...
						.addPO1(new PO850PO1Entity().setPo1(new PO850PO1().setUniqueId("2") // 1 - unique id
