...
public class GHXPO850BEG implements IPO850BEG {
	...
	public String generateX12(String elementDelimiter, String segmentDelimiter) {
		String builder = "BEG" + elementDelimiter + beg01 + elementDelimiter + beg02 + elementDelimiter + beg03
				+ elementDelimiter + beg04 + elementDelimiter + beg05 + segmentDelimiter;
	...
	public static void main(String[] args) {
		GHXPO850BEG beg = new GHXPO850BEG().setTransactionPurposeCode("00") // 1
