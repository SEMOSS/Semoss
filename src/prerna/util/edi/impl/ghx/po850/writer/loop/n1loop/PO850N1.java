...
public class PO850N1 implements IX12Format, IPO850N1 {
  ...
  private String n101 =
      ""; // entity identifier code - ST=ShipTo, SE=SellingParty, BT=BillToParty, BY=BuyingParty,
  // VN=Vendor
  private String n102 = ""; // name for n101
  private String n103 =
      ""; // identification code qualifier - 91=assigned by seller, 92=assigned by buyer
