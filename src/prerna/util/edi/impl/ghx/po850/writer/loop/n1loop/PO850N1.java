...
public class PO850N1 implements IX12Format, IPO850N1 {
	...
	private String n101 = ""; // entity identifier code - ST=ShipTo, SE=SellingParty, BT=BillToParty,
								// BY=BuyingParty,
	// VN=Vendor
	...
	public String generateX12(String elementDelimiter, String segmentDelimiter) {
		String builder = "N1" + elementDelimiter + n101 + elementDelimiter + n102 + elementDelimiter + n103
				+ elementDelimiter + n104 + segmentDelimiter;
	...
	public static void main(String[] args) {
		PO850N1 n1 = new PO850N1().setEntityCode("ST") // 1 - ship to
