...
public class PO850ISA implements IX12Format {
	...
	private int size_isa01 = 2;
	private int size_isa02 = 10;
	private int size_isa03 = 2;
	private int size_isa04 = 10;
	private int size_isa05 = 2;
	private int size_isa06 = 15;
	private int size_isa07 = 2;
	private int size_isa08 = 15;
	private int size_isa09 = 6;
	private int size_isa10 = 4;
	private int size_isa11 = 1;
	private int size_isa12 = 5;
	private int size_isa13 = 9;
	private int size_isa14 = 1;
	private int size_isa15 = 1;
	private int size_isa16 = 3;
	...
	public String generateX12(String elementDelimiter, String segmentDelimiter) {
		...
		String builder = "ISA" 
				+ elementDelimiter + formatToFixedLength(isa01, size_isa01)
				+ elementDelimiter + formatToFixedLength(isa02, size_isa02)
				+ elementDelimiter + formatToFixedLength(isa03, size_isa03)
				+ elementDelimiter + formatToFixedLength(isa04, size_isa04)
				+ elementDelimiter + formatToFixedLength(isa05, size_isa05)
				+ elementDelimiter + formatToFixedLength(isa06, size_isa06)
				+ elementDelimiter + formatToFixedLength(isa07, size_isa07)
				+ elementDelimiter + formatToFixedLength(isa08, size_isa08)
				+ elementDelimiter + formatToFixedLength(isa09, size_isa09)
				+ elementDelimiter + formatToFixedLength(isa10, size_isa10)
				+ elementDelimiter + formatToFixedLength(isa11, size_isa11)
				+ elementDelimiter + formatToFixedLength(isa12, size_isa12)
				+ elementDelimiter + formatToFixedLength(isa13, size_isa13)
				+ elementDelimiter + formatToFixedLength(isa14, size_isa14)
				+ elementDelimiter + formatToFixedLength(isa15, size_isa15)
				+ isa16;
		
		return builder;
	}

	private String formatToFixedLength(String val, int size) {
