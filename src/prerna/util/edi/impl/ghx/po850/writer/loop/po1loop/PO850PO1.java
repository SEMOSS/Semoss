...
public class PO850PO1 implements IX12Format {
	...
	public String generateX12(String elementDelimiter, String segmentDelimiter) {
		...
		String builder = "PO1" + elementDelimiter + po101 + elementDelimiter + po102 + elementDelimiter + po103
				+ elementDelimiter + po104 + elementDelimiter + ((po105 == null) ? "" : po105);
		for (PO850PO1QualifierAndVal qualAndVal : qualAndVals) {
			builder = builder + elementDelimiter + qualAndVal.getQualifier() + elementDelimiter + qualAndVal.getValue();
		}
	...
	public static void main(String[] args) {
		PO850PO1 po1 = new PO850PO1().setUniqueId("1") // 1 - unique id
