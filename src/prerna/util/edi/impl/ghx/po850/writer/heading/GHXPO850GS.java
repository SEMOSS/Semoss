...
public class GHXPO850GS implements IPO850GS {
	...
	private String gs07 = "X"; // issuer of the standard used with GS08 - T = Transportation Data Coordinating
								// Committe
	// (TDCC), X = Accredited Standards Committee X12
	private String gs08 = "004010"; // version industry identifier

	@Override
	public String generateX12(String elementDelimiter, String segmentDelimiter) {

		String builder = "GS" + elementDelimiter + gs01 + elementDelimiter + gs02 + elementDelimiter + gs03
				+ elementDelimiter + gs04 + elementDelimiter + gs05 + elementDelimiter + gs06 + elementDelimiter + gs07
				+ elementDelimiter + gs08 + segmentDelimiter;
	...
	public static void main(String[] args) {
		GHXPO850GS gs = new GHXPO850GS().setSenderId("SENDER1234") // 2
