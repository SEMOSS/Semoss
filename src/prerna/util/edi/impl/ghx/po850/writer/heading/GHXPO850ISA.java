...
public class GHXPO850ISA implements IPO850ISA {
  ...
  public String generateX12(String elementDelimiter, String segmentDelimiter) {
    ...
    String builder =
        "ISA"
            + elementDelimiter
            + formatToFixedLength(isa01, IPO850ISA.SIZE_ISA01)
            + elementDelimiter
            + formatToFixedLength(isa02, IPO850ISA.SIZE_ISA02)
            + elementDelimiter
            + formatToFixedLength(isa03, IPO850ISA.SIZE_ISA03)
            + elementDelimiter
            + formatToFixedLength(isa04, IPO850ISA.SIZE_ISA04)
            + elementDelimiter
            + formatToFixedLength(isa05, IPO850ISA.SIZE_ISA05)
            + elementDelimiter
            + formatToFixedLength(isa06, IPO850ISA.SIZE_ISA06)
            + elementDelimiter
            + formatToFixedLength(isa07, IPO850ISA.SIZE_ISA07)
            + elementDelimiter
            + formatToFixedLength(isa08, IPO850ISA.SIZE_ISA08)
            + elementDelimiter
            + formatToFixedLength(isa09, IPO850ISA.SIZE_ISA09)
            + elementDelimiter
            + formatToFixedLength(isa10, IPO850ISA.SIZE_ISA10)
            + elementDelimiter
            + formatToFixedLength(isa11, IPO850ISA.SIZE_ISA11)
            + elementDelimiter
            + formatToFixedLength(isa12, IPO850ISA.SIZE_ISA12)
            + elementDelimiter
            + formatToFixedLength(isa13, IPO850ISA.SIZE_ISA13)
            + elementDelimiter
            + formatToFixedLength(isa14, IPO850ISA.SIZE_ISA14)
            + elementDelimiter
            + formatToFixedLength(isa15, IPO850ISA.SIZE_ISA15)
            + isa16;
