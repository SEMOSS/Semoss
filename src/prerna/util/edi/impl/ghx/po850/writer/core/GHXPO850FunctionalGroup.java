...
public class GHXPO850FunctionalGroup implements IPO850FunctionalGroup {
	...
	public static void main(String[] args) {
		...
		GHXPO850FunctionalGroup fg = new GHXPO850FunctionalGroup().setGs(new GHXPO850GS().setSenderId("SENDER1234") // 2
				...
				new GHXPO850TransactionSet().setSt(new GHXPO850ST().setTransactionSetControlNumber("0001"))
						...
						.setN1loop(new PO850N1Loop()
								.addN1Group(new PO850N1Entity().setN1(new PO850N1().setEntityCode("ST") // 1 - ship to
										...
										.setN4(new PO850N4().setCity("Anchorage").setState("AK").setZip("99504")
												.setCountryCode("US")))
								.addN1Group(new PO850N1Entity().setN1(new PO850N1().setEntityCode("SE") // 1 - selling
																										// party
