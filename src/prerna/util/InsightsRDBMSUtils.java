...
public final class InsightsRDBMSUtils {
  ...
  public static RDBMSNativeEngine generateInsightsDatabase(String projectId, String projectName)
     ...
     */
    insightSmssProp.putAll(
        getNewInsightDatabaseConnectionPropValues(rdbmsType, projectId, projectName));
  ...
  public static void runInsightCreateTableQueries(RDBMSNativeEngine insightEngine) {
    ...
    try {
      if (!queryUtil.tableExists(
        ...
        columns =
            new String[] {
              InsightAdministrator.QUESTION_ID_COL,
              InsightAdministrator.QUESTION_NAME_COL,
              ...
              "QUESTION_MAKEUP",
              "DATA_TABLE_ALIGN",
              InsightAdministrator.HIDDEN_INSIGHT_COL,
              InsightAdministrator.CACHEABLE_COL,
   ...
   * @return
   */
  public static final Map<String, Object> getNewInsightDatabaseConnectionPropValues(
   ...
   * @throws Exception
   */
  public static RDBMSNativeEngine generateInsightsDatabase(
      String projectId, RdbmsTypeEnum rdbmsType, String folderLocation) throws Exception {
    if (rdbmsType == null) {
      String rdbmsTypeStr = DIHelper.getInstance().getProperty(Constants.DEFAULT_INSIGHTS_RDBMS);
      if (rdbmsTypeStr == null) {
        // default will be h2
   ...
   */
  public static final Map<String, Object> getNewInsightDatabaseConnectionPropValues(
      RdbmsTypeEnum rdbmsType, String folderLocation) {
    Map<String, Object> retMap = new HashMap<>();
    retMap.put(Constants.DRIVER, rdbmsType.getDriver());
    retMap.put(Constants.RDBMS_TYPE, rdbmsType.getLabel());
