...
public class CSVToOwlMaker {
	...
	public void makeOwl(String csvFile, IEngine.ENGINE_TYPE engineType)
	{
		// assumes the same name as engine with owl
	...
	public void makeOwl(String csvFile, String owlFileLocation, IEngine.ENGINE_TYPE engineType)
	{
		...
		for(int headerIndex = 0; headerIndex < headers.length; headerIndex++) {
			...
			owler.addProp(cleanTableName, identityColumn, cleanHeader, dataTypes[headerIndex]);
		}
		owler.commit();
		try {
			owler.export();
