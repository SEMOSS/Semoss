...
public class SemossClassloader extends ClassLoader {
	...
	/**
	 * Loads a given class from .class file just like the default ClassLoader. This
	 * method could be changed to load the class over network from some other server
	 ...
	 * is in "javablogging" package, it will load it using the
	...
	/**
	 * Loads a given file (presumably .class) into a byte array. The file should be
	 * accessible as a resource, for example it could be located on the classpath.
	 *
	 * <p>
