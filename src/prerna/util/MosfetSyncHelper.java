...
public class MosfetSyncHelper {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static String getMosfetFolderLocation(String projectId, String projectName, String rdbmsId) {
		return Utility.getBaseFolder() + DIR_SEPARATOR + Constants.PROJECT_FOLDER + DIR_SEPARATOR
				+ SmssUtilities.getUniqueName(projectName, projectId) + DIR_SEPARATOR + "app_root" + DIR_SEPARATOR
				+ "version" + DIR_SEPARATOR + rdbmsId;
	}
	...
	public static void addInsightToEngineRdbms(IProject project, MosfetFile mosfet) {
		...
		admin.addInsight(id, insightName, layout, recipe, global, cacheable, cacheMinutes, cacheCron, cachedOn,
				cacheEncrypt, schemaName);
		SecurityInsightUtils.addInsight(projectId, id, insightName, global, layout, cacheable, cacheMinutes, cacheCron,
	...
	public static void updateInsightInEngineRdbms(MosfetFile mosfet) {
		...
		InsightAdministrator admin = new InsightAdministrator(project.getInsightDatabase());
		// just put the recipe into an array
		admin.updateInsight(id, insightName, layout, recipe, global, cacheable, cacheMinutes, cacheCron, cachedOn,
				cacheEncrypt, schemaName);
		SecurityInsightUtils.updateInsight(projectId, id, insightName, global, layout, cacheable, cacheMinutes,
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/*
	 * These methods only update the mosfet file itself and not the metadata
	 * (security db or insights db)
	 */
	...
	public static File makeMosfitFile(String projectId, String projectName, String rdbmsId, String insightName,
			String layout, List<String> recipe, boolean hidden, boolean cacheable, int cacheMinutes, String cacheCron,
			ZonedDateTime cachedOn, boolean cacheEncrypt, String description, List<String> tags, String schemaName)
			throws IOException {
		return makeMosfitFile(projectId, projectName, rdbmsId, insightName, layout, recipe, hidden, cacheable,
				cacheMinutes, cacheCron, cachedOn, cacheEncrypt, description, tags, schemaName, false);
	}
	 ...
	 * @throws IOException
	 */
	public static File updateMosfitFile(File mosfetFile, String projectId, String projectName, String rdbmsId,
			String insightName, String layout, String imageFileName, List<String> recipe, boolean hidden,
