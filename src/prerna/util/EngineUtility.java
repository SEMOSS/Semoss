...
public class EngineUtility {
   ...
   * @return
   */
  public static String getSpecificEngineBaseFolder(
      IEngine.CATALOG_TYPE type, String engineId, String engineName) {
   ...
   * @return
   */
  public static String getSpecificEngineAppRootFolder(
      IEngine.CATALOG_TYPE type, String engineId, String engineName) {
    return getSpecificEngineBaseFolder(type, SmssUtilities.getUniqueName(engineName, engineId));
  }
   ...
   * @return
   */
  public static String getSpecificEngineVersionFolder(
      IEngine.CATALOG_TYPE type, String engineId, String engineName) {
   ...
   * @return
   */
  public static String getSpecificEngineAssetsFolder(
      IEngine.CATALOG_TYPE type, String engineId, String engineName) {
   ...
   */
  public static String getSpecificEngineBaseFolder(
      IEngine.CATALOG_TYPE type, String engineIdAndName) {
