...
public class SqlQueryUtilFactory {
  ...
  private static Map<RdbmsTypeEnum, List<String>> keywordsMap =
      new HashMap<RdbmsTypeEnum, List<String>>();
  ...
  public static AbstractSqlQueryUtil initialize(RdbmsTypeEnum dbType) {
    ...
    if (dbType == ASTER) {
      ...
      throw new IllegalArgumentException(
          "Unknown DB Type. Please define a query util for the DB Type " + dbType);
    }
  ...
  public static AbstractSqlQueryUtil initialize(
      RdbmsTypeEnum dbType, String connectionUrl, String username, String password) {
    AbstractSqlQueryUtil queryUtil = null;
    if (dbType == ASTER) {
  ...
  private static List<String> loadReservedWords(RdbmsTypeEnum type) {
    ...
    String keywordsString =
        Utility.getDIHelperProperty(type.getLabel().toUpperCase() + Constants.KEYWORDS_SUFFIX);
