...
public class PostgresQueryUtil extends AnsiSqlQueryUtil {
	...
	// @Override
	// public String getIndexDetails(String indexName, String tableName, String
	// database, String
	// schema) {
	// return "select tablename from pg_indexes where indexname = '" +
	...
	//
	// @Override
	// public String allIndexForTableQuery(String tableName, String database, String
	// schema) {
	// return "SELECT INDEX_NAME, COLUMN_NAME FROM INFORMATION_SCHEMA.INDEXES WHERE
	// TABLE_NAME='" +
