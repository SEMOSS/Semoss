...
public class PostgresQueryUtil extends AnsiSqlQueryUtil {
  ...
  public IQueryFilter getSearchRegexFilter(String columnQs, String searchTerm) {
    ...
    NounMetadata rComparison =
        new NounMetadata(searchTerm.toLowerCase(), PixelDataType.CONST_STRING);
  ...
  public String getIndexList(String database, String schema) {
    return "select indexname, tablename from pg_indexes where schema = '"
        + schema.toLowerCase()
        + "'";
  }

  //	@Override
  //	public String getIndexDetails(String indexName, String tableName, String database, String
  // schema) {
  //		return "select tablename from pg_indexes where indexname = '" + indexName.toLowerCase() + "
  // and schema = '" + schema.toLowerCase()
