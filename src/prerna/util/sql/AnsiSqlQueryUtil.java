...
public abstract class AnsiSqlQueryUtil extends AbstractSqlQueryUtil {
  ...
  @Override
  public String processGroupByFunction(
      String selectExpression, String separator, boolean distinct) {
    if (distinct) {
      return getSqlFunctionSyntax(QueryFunctionHelper.GROUP_CONCAT)
          + "(DISTINCT "
          + selectExpression
          + " SEPARATOR '"
          + separator
  ...
  @Override
  public String getDateDiffFunctionSyntax(
    ...
    for (int jIdx = 0; jIdx < numJoins; jIdx++) {
      ...
      if (leftColType == rightColType) {
        joinString
            ...
            .append(".")
            .append(leftTableJoinCol)
            .append(" ")
            .append(joinComparator)
            .append(" ")
            .append(RIGHT_TABLE_ALIAS)
            .append(".")
  ...
  @Override
  public String selectFromJoiningTables(
      String leftTableName,
      Map<String, SemossDataType> leftTableTypes,
      String rightTableName,
      Map<String, SemossDataType> rightTableTypes,
  ...
  @Override
  public String createUpdatePreparedStatementString(
  ...
  @Override
  public void handleInsertionOfBlob(
  ...
  @Override
  public void handleInsertionOfClob(
  ...
  @Override
  public String createTableWithDefaults(
  ...
  @Override
  public String createTableWithCustomConstraints(
  ...
  @Override
  public String createTableIfNotExistsWithDefaults(
      String tableName, String[] colNames, String[] types, Object[] defaultValues) {
    if (!allowsIfExistsTableSyntax()) {
      throw new UnsupportedOperationException("Does not support if exists table syntax");
    }
  ...
  @Override
  public String createTableIfNotExistsWithCustomConstraints(
      String tableName, String[] colNames, String[] types, Object[] customConstraints) {
    if (!allowsIfExistsTableSyntax()) {
      throw new UnsupportedOperationException("Does not support if exists table syntax");
    }
  ...
  @Override
  public String alterTableAddColumnWithDefault(
  ...
  @Override
  public String alterTableAddColumnIfNotExists(
  ...
  @Override
  public String alterTableAddColumnIfNotExistsWithDefault(
      String tableName, String newColumn, String newColType, Object defualtValue) {
    if (!allowAddColumn()) {
      throw new UnsupportedOperationException("Does not support add column syntax");
    }
  ...
  @Override
  public String alterTableAddColumnsWithDefaults(
  ...
  @Override
  public String modColumnTypeWithDefault(
  ...
  @Override
  public String modColumnTypeIfExistsWithDefault(
      String tableName, String columnName, String dataType, Object defualtValue) {
    if (!allowRedefineColumn()) {
      throw new UnsupportedOperationException("Does not support redefinition of column syntax");
    }
  ...
  public String createIndex(String indexName, String tableName, Collection<String> columns) {
    ...
    builder.append("CREATE INDEX ").append(indexName).append(" ON ").append(tableName).append("(");
      ...
      if (dataType == SemossDataType.BOOLEAN
        ...
        if (value instanceof SemossDate) {
          ...
          if (d == null) {
            ...
            template
                .append("'")
                .append(((SemossDate) value).getFormatted("yyyy-MM-dd"))
                .append("'");
          }
        ...
        if (value instanceof SemossDate) {
          ...
          if (d == null) {
            ...
            template
                .append("'")
                .append(((SemossDate) value).getFormatted("yyyy-MM-dd HH:mm:ss"))
                .append("'");
          }
  ...
  public String tableExistsQuery(String tableName, String database, String schema) {
    ...
    throw new UnsupportedOperationException(
        "This operation does not have a standard across rdbms types. Please update the code for the specific RDBMS query util");
  }

  @Override
  public String tableConstraintExistsQuery(
  ...
  @Override
  public String referentialConstraintExistsQuery(
  ...
  @Override
  /** Default in AnsiSql for using urlPrefix://hostname:port/schema;additionalProps */
  public String setConnectionDetailsFromSMSS(CaseInsensitiveProperties prop)
  ...
  public String buildConnectionString() {
    ...
    this.connectionUrl =
        this.dbType.getUrlPrefix() + "://" + this.hostname + port + "/" + this.schema;
