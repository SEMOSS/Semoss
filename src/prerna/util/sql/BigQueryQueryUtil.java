...
public class BigQueryQueryUtil extends AnsiSqlQueryUtil {
	...
	public String setConnectionDetailsfromMap(Map<String, Object> configMap) throws RuntimeException {
		...
		if (this.connectionUrl == null || this.connectionUrl.isEmpty()) {
			this.connectionUrl = this.dbType.getUrlPrefix() + "://" + this.hostname + ":" + this.port + ";ProjectId="
					+ this.projectId + ";OAuthType=" + oauthType + ";DefaultDataset=" + this.schema;
			if (this.oauthType.equals("0")) {
				this.connectionUrl += ";OAuthServiceAcctEmail=" + this.oauthServiceAcctEmail + ";OAuthPvtKeyPath="
						+ this.oauthPrivateKeyPath;
				...
				this.connectionUrl += ";OAuthClientId=" + this.oauthClientId + ";OAuthClientSecret="
	...
	public String buildConnectionString() {
		...
		this.connectionUrl = this.dbType.getUrlPrefix() + "://" + this.hostname + ":" + this.port + ";ProjectId="
				+ this.projectId + ";OAuthType=" + this.oauthType + ";DefaultDataset=" + this.schema;
		if (this.oauthType.equals("0")) {
			this.connectionUrl += ";OAuthServiceAcctEmail=" + this.oauthServiceAcctEmail + ";OAuthPvtKeyPath="
					+ this.oauthPrivateKeyPath;
