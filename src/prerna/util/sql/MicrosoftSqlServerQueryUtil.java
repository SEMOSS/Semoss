...
public class MicrosoftSqlServerQueryUtil extends AnsiSqlQueryUtil {
  ...
  public String processGroupByFunction(
    ...
    //		if(distinct) {
    //			return getSqlFunctionSyntax(QueryFunctionHelper.GROUP_CONCAT) + "(DISTINCT " +
  ...
  public String tableExistsQuery(String tableName, String database, String schema) {
    return "SELECT TABLE_NAME, TABLE_TYPE FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_CATALOG='"
        + database
        + "' AND TABLE_SCHEMA='"
        + schema
        + "' AND TABLE_NAME='"
    ...
    for (int colIndex = 0; colIndex < columnNames.length; colIndex++) {
      ...
      if (dataType == SemossDataType.INT || dataType == SemossDataType.DOUBLE) {
        ...
        template.append(value);
          ...
          || dataType == SemossDataType.STRING
