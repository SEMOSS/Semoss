...
public enum RdbmsTypeEnum {
	...
	ELASTIC_SEARCH_AWS("ELASTIC_SEARCH_AWS", "com.amazon.opendistroforelasticsearch.jdbc.Driver", "jdbc:elasticsearch"),
	ELASTIC_SEARCH_NATIVE("ELASTIC_SEARCH_NATIVE", "org.elasticsearch.xpack.sql.jdbc.EsDriver", "jdbc:es"),
