...
public class GitlabPullLastSuccessfulJobArtifactReactor extends AbstractReactor {
	...
	public GitlabPullLastSuccessfulJobArtifactReactor() {
		this.keysToGet = new String[]{ReactorKeysEnum.HOST.getKey(), ReactorKeysEnum.GITLAB_PROJECT_ID.getKey(),
				...
				ReactorKeysEnum.GITLAB_PRIVATE_TOKEN.getKey(), ReactorKeysEnum.USE_APPLICATION_CERT.getKey()};
	}
	...
	public NounMetadata execute() {
		...
		File artifact = GitlabUtility.pullLastSuccessfulJobArtifact(host, gitProjectId, gitBranch, gitJobName, null,
				gitPrivateToken, useApplicationCert, saveFilePath, null);
