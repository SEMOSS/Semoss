...
public class GitlabUtility {
	 ...
	 * @return
	 */
	public static List<Map<String, Object>> getGitlabJobs(String host, String gitProjectId, String personalOAuthToken,
			String privateToken, String scope, boolean useApplicationCert) {
		String url = host;
		if (url.endsWith("/")) {
	 ...
	 * @return
	 */
	public static List<Map<String, Object>> getGitlabBranches(String host, String gitProjectId,
			String personalOAuthToken, String privateToken, boolean useApplicationCert) {
		String url = host;
		if (url.endsWith("/")) {
	 ...
	 * @return
	 */
	public static File pullJobArtifact(String host, String gitProjectId, String jobId, String personalOAuthToken,
			String privateToken, boolean useApplicationCert, String saveFilePath, String saveFileName) {
		String url = host;
		if (url.endsWith("/")) {
		...
		File artifact = HttpHelperUtility.getRequestFileDownload(url, headersMap, keyStore, keyStorePass, keyPass,
	 ...
	 * @return
	 */
	public static File pullLastSuccessfulJobArtifact(String host, String gitProjectId, String branch, String jobName,
			String personalOAuthToken, String privateToken, boolean useApplicationCert, String saveFilePath,
			String saveFileName) {
