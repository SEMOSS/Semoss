...
public class GitCreator {
	 ...
	 * @param password
	 */
	public static void makeRemoteFromDatabase(String databaseId, String databaseName, String remoteDatabaseName,
			String username, String password, boolean syncDatabase, String token) {
		// first, need to login
		GitHub git = null;
		if (!token.isEmpty()) {
