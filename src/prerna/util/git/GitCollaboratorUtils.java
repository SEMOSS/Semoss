...
public class GitCollaboratorUtils {
	...
	public static void addCollaborator(String remoteRepositoryName, String username, String password,
			String collaborator) {
	 ...
	 */
	public static void addCollaborator(String remoteRepositoryName, String username, String password,
			String collaborator, int attempt) {
	...
	public static void removeCollaborator(String remoteRepositoryName, String username, String password,
			String collaborator) {
		int attempt = 1;
			...
			try {
				...
				if (e.getResponseCode() == 403) {
					throw new IllegalArgumentException(
							"User " + "" + " does not have permission to get list of collaborators from repository "
									+ remoteRepositoryName);
				} else if (e.getResponseCode() == -1) {
					attempt = attempt + 1;
