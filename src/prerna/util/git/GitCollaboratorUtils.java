...
public class GitCollaboratorUtils {
  ...
  public static void addCollaborator(
      String remoteRepositoryName, String username, String password, String collaborator) {
   ...
   * @return
   */
  public static List<Map<String, String>> searchUsers(
   ...
   */
  public static List<Map<String, String>> searchUsers(
      String query, String username, String password, int attempt) {
  ...
  public static List<String> listCollaborators(
      String remoteRepositoryName, String username, String password) {
  ...
  public static List<String> listCollaborators(
      String remoteRepositoryName, String username, String password, int attempt) {
      ...
      try {
        ...
        if (e.getResponseCode() == 403) {
          throw new IllegalArgumentException(
              "User "
                  + username
                  + " does not have permission to get list of collaborators from repository "
  ...
  public static void addCollaborator(
      String remoteRepositoryName, String collaborator, String token) {
   ...
   */
  public static void addCollaborator(
      String remoteRepositoryName, String collaborator, String token, int attempt) {
  ...
  public static List<String> listCollaborators(
      String remoteRepositoryName, String token, int attempt) {
    List<String> collabVector = new Vector<String>();
    GitHub gh = GitUtils.login(token);
    GHRepository ghr = null;
