...
public class GitDiffUtils {
  ...
  public static String printDiff(String gitFolder, String comm1, String comm2, String fileName)
      throws Exception {
    ...
    try (Git thisGit = Git.open(new File(gitFolder))) {
      ...
      DiffFormatter df =
          new DiffFormatter(
              outputStream); // use NullOutputStream.INSTANCE if you don't need the diff output
