...
public class GitAssetUtils {
  ...
  public static List<Map<String, Object>> getAssetMetadata(String gitFolder, String replacer) {
    ...
    for (File f : listOfFiles) {
      ...
      String relative =
          new File(replacer).toURI().relativize(new File(f.getAbsolutePath()).toURI()).getPath();
   ...
   * @return
   */
  public static List<Map<String, Object>> getAssetMetadata(
      String gitFolder, String replacer, String prefix, boolean addApp) {
    List<Map<String, Object>> retList = new Vector<>();
    File folder = new File(gitFolder);
    File[] listOfFiles = folder.listFiles();
    if (listOfFiles == null) {
  ...
  public void getAssets(String gitFolder, List<String> dirList) {
    File folder = new File(gitFolder);
    File[] listOfFiles = folder.listFiles();
    if (dirList == null) dirList = new ArrayList<String>();
  ...
  public static List<String> listAssets(
      String gitFolder, String extn, String replacer, List<String> dirList, List<String> retList) {
    if (dirList == null) {
  ...
  public static List<Map<String, Object>> listAssetMetadata(
      String gitFolder,
      String extn,
      String replacer,
      List<String> dirList,
  ...
  // gives the information in 2 chunks
  // files and directories
  public static Map<String, List<String>> browse(
      String gitFolder, String replacer, String replaceWith) {
