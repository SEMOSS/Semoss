...
public class SyncAppFilesO extends GitBaseReactor {
	...
	public SyncAppFilesO() {
		this.keysToGet = new String[]{ReactorKeysEnum.DATABASE.getKey(), ReactorKeysEnum.REPOSITORY.getKey(),
				ReactorKeysEnum.SYNC_PULL.getKey(), ReactorKeysEnum.SYNC_DATABASE.getKey(), "files"};
	}
	...
	public NounMetadata execute() {
		...
		Map<String, List<String>> filesChanged = GitSynchronizer.synchronizeSpecific(databaseId, databaseName,
				repository, token, filesToSync, dual);
