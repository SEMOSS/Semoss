	...
	public NounMetadata execute() {
		...
		try {
			...
			if (this.keyValue.size() == 5) {
				GitCreator.makeRemoteFromDatabase(databaseId, databaseName, repository, username, password,
						syncDatabase, "");
			} else {
				...
				GitCreator.makeRemoteFromDatabase(databaseId, databaseName, repository, username, "", syncDatabase,
						token);
