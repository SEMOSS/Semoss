...
public class DownloadAssetReactor extends AbstractReactor {
	...
	private void zipFolder(String folder, String downloadPath) {
		...
		try {
			...
			classLogger.error("Error zipping folder <{}> with download path <{}>.", folder, downloadPath, e);
			...
			try {
				...
				classLogger.error("Failed to flush or close zip output stream for download path <{}>.", downloadPath,
						e);
