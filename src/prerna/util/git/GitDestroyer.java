...
public class GitDestroyer {
  ...
  public static void removeFiles(
      String localRepository, boolean ignoreTheIgnoreFiles, boolean deleteFile) {
    Git thisGit = null;
    Status status = null;
    try {
    ...
    if (removed) {
      try {
        ...
        classLogger.error(Constants.STACKTRACE, e);
        throw new IllegalArgumentException(
            "Unable to remove files to Git directory at " + localRepository);
      }
    }
  ...
  public static void removeSpecificFiles(
      String localRepository, boolean deleteFile, List<String> files) {
  ...
  public static void removeSpecificFiles(
      String localRepository, boolean deleteFile, File... files) {
