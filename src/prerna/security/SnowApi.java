...
public class SnowApi {
	...
	public String encryptMessage(String message, String password, String inputFile, String outputFile) {
		// String [] args = {"-C", "-m", message, "-p", password, inputFile};//,
		// outputFile};
	...
	// //snow.decryptMessage("password",
	// "C:\\Users\\pkapaleeswaran\\workspacej3\\Exp\\output.txt");
	//
	//
	// // encrypt the file
	// //snow.encryptFile("C:\\Users\\pkapaleeswaran\\workspacej3\\Exp\\message.txt",
	// "password",
	// "C:\\Users\\pkapaleeswaran\\workspacej3\\Exp\\input.txt",
	// "C:\\Users\\pkapaleeswaran\\workspacej3\\Exp\\output.txt");
	//
	// SnowApi snow2 = new SnowApi();
	// //snow.decryptFile("C:\\Users\\pkapaleeswaran\\workspacej3\\Exp\\output.txt",
	// "hello",
