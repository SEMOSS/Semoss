...
public class PromptUtils extends AbstractPromptUtils {
	...
	private static final String promptQuery = "INSERT INTO PROMPT (ID, TITLE, CONTEXT, VERSION, INTENT, CREATED_BY, DATE_CREATED, IS_LATEST) "
			+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
	...
	// PROMPT_VARIABLE (ID, PROMPT_ID,
	// PROMPT_INPUT_ID, TYPE, META) "
	// + "VALUES (?, ?, ?, ?, ?)";

	private static final String promptMetaQuery = "INSERT INTO PROMPT_VARIABLE (ID, PROMPT_ID, PROMPT_INPUT_ID, TYPE, META) "
			+ "VALUES (?, ?, ?, ?, ?)";

	private static final List<String> PROMPT_COLUMNS = Arrays.asList("ID", "TITLE", "CONTEXT", "VERSION", "INTENT",
