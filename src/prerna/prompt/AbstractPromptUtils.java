...
public class AbstractPromptUtils {
	...
	private static void initialize() throws SQLException {
		...
		colNames = new String[]{"ID", "TITLE", "CONTEXT", "VERSION", "INTENT", "CREATED_BY", "DATE_CREATED",
				"IS_LATEST"};
		types = new String[]{"VARCHAR(255)", "VARCHAR(255)", CLOB_DATATYPE_NAME, INTEGER_DATATYPE_NAME, "VARCHAR(255)",
				"VARCHAR(255)", TIMESTAMP_DATATYPE_NAME, BOOLEAN_DATATYPE_NAME};
