...
public class ZKTesting {
  ...
  public static void printTimeLockDetails(ZKCuratorUtility utility) throws Exception {
    ...
    LocalDateTime endTime =
        new Gson().fromJson(dataMap.get("endTime").toString(), LocalDateTime.class);
        ...
        new Watcher() {
          ...
          public void process(WatchedEvent event) {
            if (event.getType() == EventType.NodeChildrenChanged) {
              ...
              try {
                engine.copyToLocal(
                    "/ncrt/catalogPictures/" + itemName,
                    "/opt/semosshome/catalogAttachments" + itemName);
