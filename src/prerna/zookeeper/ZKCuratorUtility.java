...
public final class ZKCuratorUtility {
  ...
  /**
   * This method returns of list a list of children nodes based on the path passed in.
   *
   * @param path
   * @throws Exception
   */
  ...
  /**
   * This method attemps to acquire a lock on znode. If successful it will return a {@code
   * InterProcessMutex} object, otherwise it will return null.
   *
