...
public class UserCatalogVoteUtils extends UserTrackingUtils {
   ...
   * @return
   */
  public static Map<Pair<String, String>, Integer> getVote(
      List<Pair<String, String>> creds, String catalogId) {
    ...
    for (Pair<String, String> cred : creds) {
      ...
      af.addFilter(
          SimpleQueryFilter.makeColToValFilter(VOTE_PRE + "USERID", "==", cred.getValue0()));
      af.addFilter(SimpleQueryFilter.makeColToValFilter(VOTE_PRE + "TYPE", "==", cred.getValue1()));
      of.addFilter(af);
    }
    qs.addExplicitFilter(of);
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(VOTE_PRE + "ENGINEID", "==", catalogId));
   ...
   * @return
   */
  public static Map<String, Boolean> userEngineVotes(
      List<Pair<String, String>> creds, Set<String> engineIds) {
    SelectQueryStruct qs = new SelectQueryStruct();
    ...
    if (engineIds != null && !engineIds.isEmpty()) {
      qs.addExplicitFilter(
          SimpleQueryFilter.makeColToValFilter(VOTE_PRE + "ENGINEID", "==", engineIds));
    }
  ...
  public static int getAllVotes(String databaseId) {
    ...
    qs.addSelector(sum);
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(VOTE_PRE + "ENGINEID", "==", databaseId));
  ...
  public static Map<String, Integer> getAllVotes(List<String> databaseIds) {
    ...
    qs.addSelector(sum);
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(VOTE_PRE + "ENGINEID", "==", databaseIds));
   ...
   * @throws Exception
   */
  public static IRawSelectWrapper getAllVotesWrapper(Collection<String> databaseIds)
      throws Exception {
    SelectQueryStruct qs = new SelectQueryStruct();
    qs.addSelector(new QueryColumnSelector(VOTE_PRE + "ENGINEID"));
    QueryFunctionSelector sum = new QueryFunctionSelector();
  ...
  public static List<String> getRecommendedDatabases(int limit, List<String> accessibleDbs) {
    ...
    qs.addExplicitFilter(
        SimpleQueryFilter.makeColToValFilter(VOTE_PRE + "ENGINEID", "==", accessibleDbs));
