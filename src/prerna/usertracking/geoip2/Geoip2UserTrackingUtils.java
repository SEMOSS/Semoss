...
public class Geoip2UserTrackingUtils extends AbstractUserTrackingUtils {
  ...
  private static final CityResponse NULL_CR =
      new CityResponse(null, null, null, null, null, null, null, null, null, null);
  ...
  private UserTrackingDetails cityResponseToUserTrackingDetails(CityResponse cr, String ip) {
    ...
    String state =
        cr.getLeastSpecificSubdivision() != null
            ? cr.getLeastSpecificSubdivision().getName()
            : null;
