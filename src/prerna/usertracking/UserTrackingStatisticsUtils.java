...
public class UserTrackingStatisticsUtils {
  ...
  private static double calculateSecurityScore(String databaseId) {
    ...
    Map<String, Object> keyVals =
        SecurityEngineUtils.getAggregateEngineMetadata(databaseId, keys, false);
  ...
  private static double scoreRemainingKeys(
      Map<String, Object> keyVals, int keysAccounted, List<String> keys) {
