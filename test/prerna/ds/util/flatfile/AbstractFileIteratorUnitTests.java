...
public class AbstractFileIteratorUnitTests {
  ...
  void setUp() throws Exception {
    ...
    fileIterator.types =
        new SemossDataType[] {SemossDataType.INT, SemossDataType.DOUBLE, SemossDataType.BOOLEAN};
  ...
  void testCleanRow() throws Exception {
    ...
    Object[] cleanRow =
        fileIterator.cleanRow(row, fileIterator.types, fileIterator.additionalTypes);
