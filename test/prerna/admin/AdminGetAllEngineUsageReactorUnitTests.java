...
public class AdminGetAllEngineUsageReactorUnitTests {
	...
	public void test() {
		...
		try (MockedStatic<SecurityAdminUtils> sau = Mockito.mockStatic(SecurityAdminUtils.class);
				...
				MockedStatic<ModelInferenceLogsUtils> modelInference = Mockito
			...
			modelInference
					.when(() -> ModelInferenceLogsUtils.getOverAllEngineUsageFromModelInferenceLogs("engine", "limit",
							"offset", ReactorKeysEnum.START_DATE.getKey(), ReactorKeysEnum.END_DATE.getKey()))
