...
public class AdminExecQueryReactorUnitTests {
	...
	// try (MockedStatic<SecurityAdminUtils> sau =
	...
	// reactor::execute);
	// assertEquals("Input to admin exec query requires a query struct on an
	// engine",
	// e.getMessage());
	// }
	// }
	...
	// @Test
	// void testNullInsertDataIntoEngine(QUERY_STRUCT_TYPE qsType,
	...
	// String query = null;
	// try {
	// doThrow(new SemossPixelException(query)).when(engine).insertData("SELECT *
	// FROM table");
	// } catch (Exception e) {
