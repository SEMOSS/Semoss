...
public class ModelEngineInferenceLogsWorkerUnitTests {
  ...
  void test() {
    ...
    try (MockedStatic<Utility> util = Mockito.mockStatic(Utility.class);
        MockedStatic<ModelInferenceLogsUtils> milUtils =
          ...
          .when(
              () ->
                  ModelInferenceLogsUtils.doCreateNewAgent(
                      engineId, engineName, null, "", "tokenId"))
      ...
      milUtils
          .when(() -> ModelInferenceLogsUtils.setRoomContext(insightId, "userId", "userUsername"))
          .thenAnswer((Answer<Void>) invocation -> null);
