...
class PathSecurityUtilsUnitTests {
	...
	void preservesIdentifiersAndDisplayNames() {
		for (String value : new String[] { "abc-123", "platform__room", "Model Name" }) {
	...
	void rejectsTraversalAndCrossPlatformSeparators() {
		for (String value : new String[] { "", " ", ".", "..", "../other", "a/b", "a\\b", "C:other", "a\n",
				"\uff0e\uff0e", "a\uff0fb", "a\uff3cb" }) {
			assertThrows(IllegalArgumentException.class,
					() -> PathSecurityUtils.requireSinglePathSegment(value, "ID"), value);
		}
		assertThrows(IllegalArgumentException.class, () -> PathSecurityUtils.requireSinglePathSegment(null, "ID"));
	}
