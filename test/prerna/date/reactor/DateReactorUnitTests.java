...
public class DateReactorUnitTests {
	...
	void test() {
		...
		assertEquals("Get todays date or return a date based on a specific date input and format",
				reactor.getReactorDescription());
		assertEquals("A specific date to return. This is a string and assumes a date of yyyy-MM-dd",
				reactor.getDescriptionForKey("date"));
		assertEquals("A specified format for the date parameter to parse. This should be a Java compliant format",
