...
public class SecurityEngineUtilsUnitTests extends AbstractSecurityUtilsUnitTestsSetup {
    ...
    void testAddEngine() {
        User user = UnitTestSecurityAuthUtils.createUser("admin", true);
        SecurityEngineUtils.addEngine("engineId", "engineName", IEngine.CATALOG_TYPE.DATABASE,
                "subtype", "cost", true, user);
    ...
    void testGetDisplayDatabaseOwnersAndEditors_engineGlobal() {
        ...
        Map<String, Object> admin = ownersAndEditors.stream().filter(s -> s.get("name").equals("adminname")).
                findFirst().get();
        ...
        Map<String, Object> publicDatabase = ownersAndEditors.stream().filter(s -> s.get("name")
                .equals("PUBLIC DATABASE")).findFirst().get();
    ...
    void testAddEngineUsersPermissions_errors() {
        ...
        assertEquals("The following users already have access to this engine. Please edit the existing permission level: admin2id",
                argEx.getMessage());
        ...
        assertEquals("As a non-owner, you cannot add owner user access.",
                argEx.getMessage());
    }
    ...
    void testEditEngineUser() throws IllegalAccessException {
        ...
        // user not editor
        IllegalAccessException ex = assertThrows(IllegalAccessException.class,
                () -> SecurityEngineUtils.editEngineUserPermission(user2, "user3id", "testId", "OWNER", null, null, null, 0, 0));

        assertEquals("Insufficient privileges to modify this engine's permissions.", ex.getMessage());

        // user does not have permissions
        IllegalArgumentException argEx = assertThrows(IllegalArgumentException.class,
                () -> SecurityEngineUtils.editEngineUserPermission(user, "admin2id", "testId", "OWNER", null, null, null, 0, 0));
        assertEquals("Attempting to modify engine permission for a user who does not currently have access to the engine",
                argEx.getMessage());
        ...
        ex = assertThrows(IllegalAccessException.class,
                () -> SecurityEngineUtils.editEngineUserPermission(user2, "adminid", "testId", "EDIT", null, null, null, 0, 0));
    ...
    void testEditEngineUsersPermissions() throws IllegalAccessException {
        ...
        assertEquals("Attempting to modify user permission for the following users who do not currently have access to the engine: admin2id",
                argEx.getMessage());
        ...
        assertEquals("As a non-owner, you cannot edit access of an owner.",
                argEx.getMessage());
        ...
        assertEquals("As a non-owner, you cannot give a user access as an owner.",
                argEx.getMessage());
    ...
    void testRemoveEngineUsersPermissions() throws IllegalAccessException {
        ...
        assertEquals("Attempting to modify engine permission for the following users who do not currently have access to the engine: admin2id",
                argEx.getMessage());
        ...
        assertEquals("As a non-owner, you cannot remove access of an owner.",
                ex.getMessage());
    ...
    void testEngineFavorite() throws IllegalAccessException {
        ...
        List<Map<String, Object>> list = SecurityEngineUtils
                .getUserEngineList(user, null, null, false, null, null, null, null, null, null);
        ...
        assertEquals("1", SecurityEngineUtils.getUserEngineList(user, null, null, false, null, null, null, null, null, null)
    ...
    void testSetEngineName() throws IllegalAccessException {
        ...
        assertEquals("The user doesn't have the permission to change the engine name. Only the owner can perform this action.",
                ex.getMessage());
    ...
    void testMetadata() {
        ...
        Map<String, Object> meta = Map.of("domain", "value1", "description", List.of("list1", "list2"), "markdown", "#title");
    ...
    void testGetEngineUsersNoCredentials() throws IllegalAccessException {
        ...
        IllegalAccessException ex = assertThrows(IllegalAccessException.class, () -> SecurityEngineUtils
                .getEngineUsersNoCredentials(user3, "testId", null, 0, 0));
        assertEquals("The user does not have access to view this engine", ex.getMessage());
    ...
    void testGetUserHasExplicitAccess() {
        ...
        // NOTE: This seems weird that two methods called something similar differ on if the engine is set to
        // global
    ...
    void testGetUserEngineIdList() {
        ...
        List<String> ids = SecurityEngineUtils.getUserEngineIdList(user, List.of("DATABASE", "MODEL"), true, true, true);
    ...
    void testGetAvailableMetaValues() {
        ...
        Map<String, Object> meta = Map.of("domain", "value1", "description", List.of("list1", "list2"),
                "markdown", "#title");
        SecurityEngineUtils.updateEngineMetadata("testId", meta);
    ...
    void testGetUserDiscoverableEngineList() throws IllegalAccessException {
        ...
        List<Map<String, Object>> vals = SecurityEngineUtils.getUserDiscoverableEngineList(user, List.of("DATABASE", "FUNCTION"),
                List.of("testId", "testId2"), Map.of("domain", "value1"), null, "0", "0");
