...
public class AdminReloadSocialPropertiesReactorUnitTests {

	private AdminReloadSocialPropertiesReactor reactor;
	...
	@BeforeEach
	void setup() {
		reactor = new AdminReloadSocialPropertiesReactor();
