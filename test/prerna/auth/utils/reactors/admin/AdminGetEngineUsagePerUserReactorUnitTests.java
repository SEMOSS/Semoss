...
public class AdminGetEngineUsagePerUserReactorUnitTests {

	private AdminGetEngineUsagePerUserReactor reactor;
	...
	@BeforeEach
	void setup() {
		reactor = new AdminGetEngineUsagePerUserReactor();
	...
	void testSuccess() {
		...
		try (MockedStatic<SecurityAdminUtils> sau = Mockito.mockStatic(SecurityAdminUtils.class);
			...
			mil.when(() -> ModelInferenceLogsUtils.getUserUsagePerEngine(
