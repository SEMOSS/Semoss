...
public class ImportTestUtility {
   ...
   * @return
   */
  public static ITableDataFrame createMovieFrame(
  ...
  public static String fileRead(
      ...
      Map<String, Object> additionalDataTypes) {
    String fileName = new File(filePath).getName();
    String framePixel =
        ApiSemossTestUtils.buildPixelCall(
            FileReadReactor.class,
            ...
            additionalDataTypes,
            ReactorKeysEnum.NEW_HEADER_NAMES.getKey(),
            newHeaders);
  ...
  private static ITableDataFrame runImportMoviePixels(String databaseId, String framePixel) {
    ...
    PixelChain db =
        new PixelChain(DatabaseReactor.class, ReactorKeysEnum.DATABASE.getKey(), databaseId);
    PixelChain select =
        new PixelChain(
            SelectTableReactor.class,
