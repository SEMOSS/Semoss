...
public class PredictDataTypesReactorTests extends AbstractBaseSemossApiTests {
	...
	public void testPredictTypes() {
		...
		Map<String, Object> predictedTypes = UploadTestUtility
				.predictDataTypes(ApiTestsSemossConstants.MOVIE_CSV_FILE_NAME, ApiTestsSemossConstants.DELIMITER);
		...
		Assert.assertArrayEquals(new String[]{"Nominated", "Title", "Genre", "Studio", "Director", "Revenue_Domestic",
				"MovieBudget", "Revenue_International", "RottenTomatoes_Critics", "RottenTomatoes_Audience"},
				cleanHeaders);
