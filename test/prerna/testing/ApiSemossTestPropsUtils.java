...
public class ApiSemossTestPropsUtils {
  ...
  static void loadDIHelper() throws IOException {
    Files.copy(
        ApiTestsSemossConstants.BASE_RDF_MAP,
        ApiTestsSemossConstants.TEST_RDF_MAP,
        StandardCopyOption.REPLACE_EXISTING);
    Me configurationManager = new Me();
    configurationManager.changeRDFMap(
    ...
    DIHelper.getInstance()
        .loadCoreProp(ApiTestsSemossConstants.TEST_RDF_MAP.toAbsolutePath().toString());
  ...
  private static void unloadDIHelper() {
    DIHelper.getInstance()
        .loadCoreProp(ApiTestsSemossConstants.BASE_RDF_MAP.toAbsolutePath().toString());
    try {
