...
public class PromptTestUtils {
  ...
  public static String addPromptError(
      String title, String context, String intent, List<String> tags) {
    NounMetadata nm = runAddPrompt(title, context, intent, tags);
    return (String) nm.getValue();
  }

  private static NounMetadata runAddPrompt(
      String title, String context, String intent, List<String> tags) {
    ...
    String addPromptPixel =
        ApiSemossTestUtils.buildPixelCall(AddPromptReactor.class, "map", promptInputList);
  ...
  public static void updatePrompt(
      String promptId, String title, String context, String intent, List<String> tags) {
  ...
  private static NounMetadata runUpdatePrompt(
      String promptId, String title, String context, String intent, List<String> tags) {
    List<Map<String, Object>> promptInputList = new ArrayList<>();
    Map<String, Object> promptDetailMap = new HashMap<>();
    ...
    String updatePromptPixel =
        ApiSemossTestUtils.buildPixelCall(UpdatePromptReactor.class, "map", promptInputList);
  ...
  private static NounMetadata runDeletePrompt(String promptId) {
    String deletePromptPixel =
        ApiSemossTestUtils.buildPixelCall(DeletePromptReactor.class, "promptId", promptId);
    System.out.println(deletePromptPixel);
    NounMetadata nm = ApiSemossTestUtils.processRawPixel(deletePromptPixel);
    return nm;
  }

  //	private static Map<String, Map<String, Object>> makeVaraiblesMap(List<Map<String, Object>>
  // promoptInputMap) {
  ...
  public static NounMetadata listPrompts(List<String> metaTagFilterList) {
    ...
    if (metaTagFilterList != null && !metaTagFilterList.isEmpty()) {
      ...
      listPromptsPixel =
          ApiSemossTestUtils.buildPixelCall(ListPromptReactor.class, "metaFilters", finalMetaMap);
    } else {
  ...
  public static boolean checkPromptTitle(String title) {
    String checkPromptTitlePixel =
        ApiSemossTestUtils.buildPixelCall(CheckPromptTitleReactor.class, "promptTitle", title);
