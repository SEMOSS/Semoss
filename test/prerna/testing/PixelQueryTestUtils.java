...
public class PixelQueryTestUtils {
  ...
  public static PixelChain frame(String frameName) {
    PixelChain frame =
        new PixelChain(FrameReactor.class, ReactorKeysEnum.FRAME.getKey(), frameName);
    return frame;
  }
  ...
  public static List<Map<String, Object>> flushTaskToList(
      BasicIteratorTask task, Integer rowCount) {
