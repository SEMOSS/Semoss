...
public class SetParamsReactorApiTests extends AbstractBaseSemossApiTests {
	...
	/**
	 * NOTE: unable to test this class. Could not find a way to set the Insight var
	 * store to contain a var map with the ImportParamOptionsReactor.PARAM_OPTIONS
	 * key anywhere in the code base. I looked for a little but determined it wasn't
	 * worth the time. Unit tests will suffice for now but will comment out the work
	 * in case we come back to this in the future and need to explain what I was
	 * trying to do.
	 */
	@Test
